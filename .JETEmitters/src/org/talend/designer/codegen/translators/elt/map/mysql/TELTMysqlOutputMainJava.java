...
public class TELTMysqlOutputMainJava
{
  ...
  protected final String TEXT_66 = NL + "\tString select_query = null;" + NL + "\tString selectQueryColumnsName = null;";
  protected final String TEXT_67 = NL + "\t\tselect_query = (String) globalMap.get(\"";
  protected final String TEXT_68 = "\"+\"QUERY\"+\"";
  protected final String TEXT_69 = "\");" + NL + "\t\tselectQueryColumnsName = (String) globalMap.get(\"";
  protected final String TEXT_70 = "\"+\"QUERY_COLUMNS_NAME\"+\"";
  ...
  protected final String TEXT_77 = " = \"org.gjt.mm.mysql.Driver\";" + NL + "    java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_87 = "String decryptedPassword_";
  protected final String TEXT_88 = " = null;";
  protected final String TEXT_89 = " " + NL + "\tdecryptedPassword_";
  protected final String TEXT_90 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_91 = ");";
  protected final String TEXT_92 = NL + "\tdecryptedPassword_";
  protected final String TEXT_93 = " = ";
  protected final String TEXT_94 = "; ";
  protected final String TEXT_95 = NL + NL + "    String dbPwd_";
  protected final String TEXT_96 = " = decryptedPassword_";
  protected final String TEXT_97 = ";" + NL + "" + NL + "    java.sql.Connection conn_";
  protected final String TEXT_98 = " = null;    ";
  protected final String TEXT_99 = NL;
  protected final String TEXT_100 = NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_101 = " =null;" + NL;
  protected final String TEXT_102 = "\t" + NL + "\t\tString insertQuery = \"INSERT INTO ";
  protected final String TEXT_103 = "(";
  protected final String TEXT_104 = ") (\"+select_query+\")\";";
  protected final String TEXT_105 = NL + "\t\tString insertQuery = \"INSERT INTO \"+";
  protected final String TEXT_106 = "+\"(";
  protected final String TEXT_107 = ") (\"+select_query+\")\";";
  protected final String TEXT_108 = NL + "\t\tpstmt_";
  protected final String TEXT_109 = " = conn_";
  protected final String TEXT_110 = ".prepareStatement(insertQuery);";
  protected final String TEXT_111 = NL + "\t\tString updateQuery = \"UPDATE ";
  protected final String TEXT_112 = "\";";
  protected final String TEXT_113 = NL + "\t\tString updateQuery = \"UPDATE \"+";
  protected final String TEXT_114 = ";";
  protected final String TEXT_115 = NL + "\t\tupdateQuery +=\" SET ";
  protected final String TEXT_116 = " \"";
  protected final String TEXT_117 = NL + "\t\t+\"  WHERE \" + ";
  protected final String TEXT_118 = NL + "\t\t;" + NL + "\t\tpstmt_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_121 = NL + "\t\tString deleteQuery = \"DELETE  FROM ";
  protected final String TEXT_122 = "\";";
  protected final String TEXT_123 = NL + "\t\tString deleteQuery = \"DELETE  FROM \"+";
  protected final String TEXT_124 = ";";
  protected final String TEXT_125 = NL + "\t\tdeleteQuery += \" WHERE EXISTS (\"+select_query+\")\"";
  protected final String TEXT_126 = NL + "\t\t+\"  AND \" + ";
  protected final String TEXT_127 = NL + "\t\t;" + NL + "\t\tpstmt_";
  protected final String TEXT_128 = " = conn_";
  protected final String TEXT_129 = ".prepareStatement(deleteQuery);";
  protected final String TEXT_130 = NL + "\tint nb_line_";
  protected final String TEXT_131 = " = 0;" + NL + "\tint nb_line_updated_";
  protected final String TEXT_132 = " = 0;" + NL + "\tint nb_line_inserted_";
  protected final String TEXT_133 = " = 0;" + NL + "\tint nb_line_deleted_";
  protected final String TEXT_134 = " = 0;";
  protected final String TEXT_135 = NL + "\t\tSystem.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");";
  ...
  protected final String TEXT_140 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_141 = " + \" rows inserted. \\n\");";
  protected final String TEXT_142 = NL + "\t\tSystem.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");";
  protected final String TEXT_143 = " " + NL + "\t\tnb_line_";
  protected final String TEXT_144 = " += nb_line_updated_";
  ...
  protected final String TEXT_153 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_154 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_155 = " + \" rows deleted. \\n\");";
  protected final String TEXT_156 = NL + NL + "\tpstmt_";
  protected final String TEXT_157 = ".close();" + NL;
  protected final String TEXT_158 = NL + "    if(conn_";
  protected final String TEXT_159 = " != null && !conn_";
  protected final String TEXT_160 = ".isClosed()) {" + NL + "\t\t";
  ...
  protected final String TEXT_165 = "_NB_LINE_UPDATED\",nb_line_updated_";
  ...
  protected final String TEXT_172 = " - Has ";
  protected final String TEXT_173 = " records count: \" + nb_line_";
