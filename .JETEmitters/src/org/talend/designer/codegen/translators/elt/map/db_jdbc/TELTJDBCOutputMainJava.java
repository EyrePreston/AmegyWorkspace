...
public class TELTJDBCOutputMainJava
{
  ...
  protected final String TEXT_96 = "String decryptedPassword_";
  ...
  protected final String TEXT_101 = NL + "\tdecryptedPassword_";
  ...
  protected final String TEXT_109 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_110 = " =null;" + NL + "\t";
  protected final String TEXT_111 = "\t" + NL + "\tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_112 = "+\"(";
  protected final String TEXT_113 = ")  (\"+select_query+\")\";" + NL + "\tpstmt_";
  protected final String TEXT_114 = " = conn_";
  protected final String TEXT_115 = ".prepareStatement(insertQuery);" + NL;
  protected final String TEXT_116 = NL + "\tString updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_117 = "+\" SET ";
  protected final String TEXT_118 = " \"";
  protected final String TEXT_119 = NL + "\t\t+\"  WHERE \" + ";
  protected final String TEXT_120 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_121 = " = conn_";
  protected final String TEXT_122 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_123 = NL + "\t" + NL + "\tString deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_124 = "+\" WHERE EXISTS (\"+select_query+\") \" " + NL + "\t";
  protected final String TEXT_125 = NL + "\t+\"  AND \" + ";
  protected final String TEXT_126 = NL + "\t";
  protected final String TEXT_127 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_128 = " = conn_";
  protected final String TEXT_129 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_135 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");";
  ...
  protected final String TEXT_139 = NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_140 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_141 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");";
  protected final String TEXT_142 = " " + NL + "nb_line_updated_";
  protected final String TEXT_143 = " = pstmt_";
  protected final String TEXT_144 = ".executeUpdate();";
  protected final String TEXT_145 = NL + "\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_146 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_147 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_148 = " " + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_149 = " = pstmt_";
  protected final String TEXT_150 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_151 = NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_152 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_153 = NL + NL + "pstmt_";
  protected final String TEXT_154 = ".close();" + NL;
  protected final String TEXT_155 = NL + "    if(conn_";
  protected final String TEXT_156 = " != null && !conn_";
  protected final String TEXT_157 = ".isClosed()) {" + NL + "\t\t";
  protected final String TEXT_158 = NL + "    }";
  protected final String TEXT_159 = NL + "nb_line_";
  protected final String TEXT_160 = " = nb_line_updated_";
  protected final String TEXT_161 = " + nb_line_inserted_";
  protected final String TEXT_162 = " + nb_line_deleted_";
  ...
  protected final String TEXT_166 = "_NB_LINE_UPDATED\",nb_line_updated_";
  ...
  protected final String TEXT_173 = " - Has ";
  protected final String TEXT_174 = " records count: \" + nb_line_";
