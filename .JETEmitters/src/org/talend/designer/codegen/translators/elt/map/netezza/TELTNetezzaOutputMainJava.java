...
public class TELTNetezzaOutputMainJava
{
  ...
  protected final String TEXT_81 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_123 = " \" +select_query.substring(select_query.indexOf(\"FROM\"));";
  protected final String TEXT_124 = NL + "\t\tif(select_query.indexOf(\"WHERE\")==-1){" + NL + "\t\tupdateQuery +=\"  WHERE \";" + NL + "\t\t}else{" + NL + "\t\tupdateQuery +=\"  AND \";" + NL + "\t\t} " + NL + "\t\tupdateQuery+= ";
  ...
  protected final String TEXT_129 = NL + "\t\tString deleteQuery = \"DELETE  FROM ";
  protected final String TEXT_130 = "\";";
  protected final String TEXT_131 = NL + "\t\tString deleteQuery = \"DELETE  FROM \"+";
  protected final String TEXT_132 = ";";
  protected final String TEXT_133 = NL + "\t\tdeleteQuery += \" WHERE EXISTS (\"+select_query+\")\"";
  protected final String TEXT_134 = NL + "\t\t+\"  AND \" + ";
  protected final String TEXT_135 = NL + "\t\t;" + NL + "\t\tpstmt_";
  protected final String TEXT_136 = " = conn_";
  protected final String TEXT_137 = ".prepareStatement(deleteQuery);";
  protected final String TEXT_138 = NL + "\tint nb_line_";
  protected final String TEXT_139 = " = 0;" + NL + "\tint nb_line_updated_";
  protected final String TEXT_140 = " = 0;" + NL + "\tint nb_line_inserted_";
  protected final String TEXT_141 = " = 0;" + NL + "\tint nb_line_deleted_";
  protected final String TEXT_142 = " = 0;";
  protected final String TEXT_143 = NL + "\t\tSystem.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");";
  protected final String TEXT_144 = " " + NL + "\t\tnb_line_";
  ...
  protected final String TEXT_148 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_149 = " + \" rows inserted. \\n\");";
  protected final String TEXT_150 = NL + "\t\tSystem.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");";
  protected final String TEXT_151 = " " + NL + "\t\tnb_line_";
  protected final String TEXT_152 = " += nb_line_updated_";
  protected final String TEXT_153 = " = pstmt_";
  protected final String TEXT_154 = ".executeUpdate();";
  protected final String TEXT_155 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_156 = " + \" rows updated. \\n\");";
  protected final String TEXT_157 = NL + "\t\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_158 = " " + NL + "\t\tnb_line_";
  protected final String TEXT_159 = " += nb_line_deleted_";
  protected final String TEXT_160 = " = pstmt_";
  protected final String TEXT_161 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_162 = NL + "\t\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_163 = " + \" rows deleted. \\n\");";
  protected final String TEXT_164 = NL + NL + "\tpstmt_";
  protected final String TEXT_165 = ".close();";
  protected final String TEXT_166 = NL + "    if(conn_";
  protected final String TEXT_167 = " != null && !conn_";
  protected final String TEXT_168 = ".isClosed()) {" + NL + "\t\t";
