...
public class TELTPostgresqlOutputMainJava
{
  ...
  protected final String TEXT_120 = NL + "\t\t+\"  WHERE \" + ";
  protected final String TEXT_121 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_122 = " = conn_";
  protected final String TEXT_123 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_124 = NL + "\t" + NL + "\tString deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_125 = "+\" WHERE EXISTS (\"+select_query+\") \" " + NL + "\t";
  protected final String TEXT_126 = NL + "\t+\"  AND \" + ";
  protected final String TEXT_127 = NL + "\t";
  protected final String TEXT_128 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_129 = " = conn_";
  protected final String TEXT_130 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_131 = NL + "int nb_line_";
  protected final String TEXT_132 = " = 0;" + NL + "int nb_line_updated_";
  protected final String TEXT_133 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_134 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_135 = " = 0;" + NL + "\t";
  protected final String TEXT_136 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");";
  ...
  protected final String TEXT_143 = " " + NL + "nb_line_updated_";
  protected final String TEXT_144 = " = pstmt_";
  protected final String TEXT_145 = ".executeUpdate();";
  protected final String TEXT_146 = NL + "\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_147 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_148 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\t";
  ...
  protected final String TEXT_152 = NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_153 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  ...
  protected final String TEXT_157 = " != null && !conn_";
  protected final String TEXT_158 = ".isClosed()) {" + NL + "\t\t";
  ...
  protected final String TEXT_163 = " + nb_line_deleted_";
  ...
  protected final String TEXT_167 = "_NB_LINE_UPDATED\",nb_line_updated_";
  ...
  protected final String TEXT_174 = " - Has ";
  protected final String TEXT_175 = " records count: \" + nb_line_";
