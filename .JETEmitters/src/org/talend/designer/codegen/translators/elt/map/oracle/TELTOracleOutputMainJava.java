...
public class TELTOracleOutputMainJava
{
  ...
  protected final String TEXT_71 = NL + "\tString dbschema_";
  protected final String TEXT_72 = " = ";
  protected final String TEXT_73 = ";" + NL + "\tif(dbschema_";
  ...
  protected final String TEXT_86 = " = \"oracle.jdbc.driver.OracleDriver\";" + NL + "    java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_117 = NL + "\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_133 = ".getBytes()));" + NL + "\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_139 = NL + NL + "java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_143 = ") (\"+select_query+\")\";";
  protected final String TEXT_144 = "\t" + NL + "\t    StringBuffer insertStringBuffer_";
  protected final String TEXT_145 = " = new StringBuffer(insertQuery);" + NL + "\t    insertStringBuffer_";
  protected final String TEXT_146 = ".insert(insertQuery.indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_147 = " + \" \");" + NL + "\t    insertQuery =insertStringBuffer_";
  protected final String TEXT_148 = ".toString(); ";
  protected final String TEXT_149 = "   " + NL + "\tpstmt_";
  protected final String TEXT_150 = " = conn_";
  protected final String TEXT_151 = ".prepareStatement(insertQuery);" + NL;
  protected final String TEXT_152 = NL + "\tString updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_153 = "+\" SET (";
  protected final String TEXT_154 = ") = (\"+select_query+\") \"";
  protected final String TEXT_155 = NL + "\t\t+\"  WHERE \" + ";
  protected final String TEXT_156 = NL + "\t;";
  protected final String TEXT_157 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_158 = " = new StringBuffer(updateQuery);" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_159 = ".insert(updateQuery.indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_160 = "  + \" \");" + NL + "\t    updateQuery =updateStringBuffer_";
  protected final String TEXT_161 = ".toString(); ";
  protected final String TEXT_162 = NL + "\tpstmt_";
  protected final String TEXT_163 = " = conn_";
  protected final String TEXT_164 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_165 = NL + "\t" + NL + "String deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_166 = "+\" WHERE EXISTS (\"+select_query+\") \" ";
  protected final String TEXT_167 = NL + "+\"  AND \" + ";
  protected final String TEXT_168 = NL + ";";
  protected final String TEXT_169 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_170 = " = new StringBuffer(deleteQuery);" + NL + "    deleteStringBuffer_";
  protected final String TEXT_171 = ".insert(deleteQuery.indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_172 = "  + \" \" );" + NL + "    deleteQuery =deleteStringBuffer_";
  protected final String TEXT_173 = ".toString();  ";
  protected final String TEXT_174 = NL + "pstmt_";
  protected final String TEXT_175 = " = conn_";
  protected final String TEXT_176 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_177 = NL + "\tString mergeQuery = \"MERGE INTO \"+ tableName_";
  protected final String TEXT_178 = " +\" target\"  + \" USING (\" + select_query + \") source ON (\" +" + NL + "\t" + NL + "\t\t\"";
  protected final String TEXT_179 = "\" + \")\" ;" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_180 = NL + "\t\t\tmergeQuery += \" WHEN MATCHED THEN UPDATE SET ";
  protected final String TEXT_181 = " \" ;\t" + NL + "\t\t\t";
  protected final String TEXT_182 = NL + "\t\t\t\tmergeQuery += \"WHERE \" + \"\";" + NL + "\t\t\t";
  protected final String TEXT_183 = NL + "\t\t\t\t\tmergeQuery += \"WHERE \" + ";
  protected final String TEXT_184 = ";" + NL + "\t\t\t";
  protected final String TEXT_185 = NL + "\t\t\t";
  protected final String TEXT_186 = NL + "\t\t\t\t\tmergeQuery += \" DELETE WHERE \" + \"\" ;" + NL + "\t\t\t";
  protected final String TEXT_187 = NL + "\t\t\t\t\tmergeQuery += \" DELETE WHERE \" + ";
  protected final String TEXT_188 = " ;" + NL + "\t\t  ";
  protected final String TEXT_189 = NL + "\t\t";
  protected final String TEXT_190 = NL + "\t\t";
  protected final String TEXT_191 = NL + "\t\t\t\tmergeQuery += \" WHEN NOT MATCHED THEN INSERT ( ";
  protected final String TEXT_192 = ") VALUES ( ";
  protected final String TEXT_193 = ") \";" + NL + "\t\t\t";
  protected final String TEXT_194 = NL + "\t\t\t\tmergeQuery += \" WHERE \" + \"\";" + NL + "\t\t\t";
  protected final String TEXT_195 = NL + "\t\t\t\tmergeQuery += \" WHERE \" + ";
  protected final String TEXT_196 = " ;" + NL + "\t\t\t";
  protected final String TEXT_197 = "\t" + NL + " \t\t\tpstmt_";
  protected final String TEXT_198 = " = conn_";
  protected final String TEXT_199 = ".prepareStatement(mergeQuery);" + NL + "\t";
  protected final String TEXT_200 = NL + "int nb_line_";
  protected final String TEXT_201 = " = 0;" + NL + "int nb_line_updated_";
  protected final String TEXT_202 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_203 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_204 = " = 0;" + NL + "int nb_line_merged_";
  protected final String TEXT_205 = " = 0;" + NL + "\t";
  protected final String TEXT_206 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");";
  protected final String TEXT_207 = " " + NL + "nb_line_inserted_";
  protected final String TEXT_208 = " = pstmt_";
  protected final String TEXT_209 = ".executeUpdate();";
  protected final String TEXT_210 = NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_211 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_212 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");";
  protected final String TEXT_213 = " " + NL + "nb_line_updated_";
  protected final String TEXT_214 = " = pstmt_";
  protected final String TEXT_215 = ".executeUpdate();";
  protected final String TEXT_216 = NL + "\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_217 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_218 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_219 = " " + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_220 = " = pstmt_";
  protected final String TEXT_221 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_222 = NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_223 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_224 = "\t" + NL + "\tSystem.out.println(\"Merge with : \\n\" + mergeQuery +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_225 = " " + NL + "\t    nb_line_merged_";
  protected final String TEXT_226 = " = pstmt_";
  protected final String TEXT_227 = ".executeUpdate();" + NL + "\t\t";
  protected final String TEXT_228 = NL + "\tSystem.out.println(\"--> \" + nb_line_merged_";
  protected final String TEXT_229 = " + \" rows merged. \\n\");" + NL + "\t";
  protected final String TEXT_230 = NL + NL + "pstmt_";
  protected final String TEXT_231 = ".close();" + NL;
  protected final String TEXT_232 = NL + "    if(conn_";
  protected final String TEXT_233 = " != null && !conn_";
  protected final String TEXT_234 = ".isClosed()) {" + NL + "\t\t";
  protected final String TEXT_235 = NL + "    }";
  protected final String TEXT_236 = NL + "nb_line_";
  protected final String TEXT_237 = " = nb_line_updated_";
  protected final String TEXT_238 = " + nb_line_inserted_";
  protected final String TEXT_239 = " + nb_line_deleted_";
  protected final String TEXT_240 = " + nb_line_merged_";
  protected final String TEXT_241 = ";" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_242 = "_NB_LINE\",nb_line_";
  protected final String TEXT_243 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_244 = "_NB_LINE_UPDATED\",nb_line_updated_";
  protected final String TEXT_245 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_246 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_247 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_248 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_249 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_250 = "_NB_LINE_MERGED\",nb_line_merged_";
  protected final String TEXT_251 = ");" + NL;
  protected final String TEXT_252 = NL + "\tlog.info(\"";
  protected final String TEXT_253 = " - Has ";
  protected final String TEXT_254 = " records count: \" + nb_line_";
