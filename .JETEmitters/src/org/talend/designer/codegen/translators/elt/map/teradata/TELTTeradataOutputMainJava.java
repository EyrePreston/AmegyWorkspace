...
public class TELTTeradataOutputMainJava
{
  ...
  protected final String TEXT_66 = NL + "\tString select_query = null;" + NL + "\tString selectQueryColumnsName = null;" + NL + "\t";
  ...
  protected final String TEXT_81 = " = \"jdbc:teradata://\" + ";
  ...
  protected final String TEXT_88 = "String decryptedPassword_";
  protected final String TEXT_89 = " = null;";
  protected final String TEXT_90 = " " + NL + "\tdecryptedPassword_";
  protected final String TEXT_91 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_92 = ");";
  protected final String TEXT_93 = NL + "\tdecryptedPassword_";
  protected final String TEXT_94 = " = ";
  protected final String TEXT_95 = "; ";
  protected final String TEXT_96 = NL + "    " + NL + "    String dbPwd_";
  protected final String TEXT_97 = " = decryptedPassword_";
  protected final String TEXT_98 = ";";
  protected final String TEXT_99 = NL + "\t\t     //add query band begin" + NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_100 = " =  conn_";
  protected final String TEXT_101 = ".getAutoCommit();          " + NL + "             conn_";
  protected final String TEXT_102 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_103 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  protected final String TEXT_104 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" + ";
  protected final String TEXT_105 = NL + "               ";
  protected final String TEXT_106 = " + \"=\" + ";
  protected final String TEXT_107 = " + \";\" +";
  protected final String TEXT_108 = " \"' FOR SESSION\"" + NL + "           );           " + NL + "              }catch(Exception e){" + NL + "               e.printStackTrace();              " + NL + "      }" + NL + "      conn_";
  protected final String TEXT_109 = ".setAutoCommit(currentAutoCommitMode";
  ...
  protected final String TEXT_114 = NL + NL + "\tString tableName_";
  protected final String TEXT_115 = " = ";
  protected final String TEXT_116 = ";";
  protected final String TEXT_117 = "\t" + NL + "\t" + NL + "\t" + NL + "String insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_118 = "+\" (";
  protected final String TEXT_119 = ") \"+select_query;" + NL + "pstmt_";
  protected final String TEXT_120 = " = conn_";
  protected final String TEXT_121 = ".prepareStatement(insertQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_122 = NL + NL + "String updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_123 = "+\" FROM (\" + select_query + \") src SET ";
  ...
  protected final String TEXT_128 = ".prepareStatement(updateQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_129 = NL + "\t" + NL + "String deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_130 = "+\" WHERE EXISTS (\"+select_query+\") \" ";
  ...
  protected final String TEXT_164 = ".setAutoCommit(true);    " + NL + "\t\t    try{" + NL + "\t\t         conn_";
  protected final String TEXT_165 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");       " + NL + "\t\t         conn_";
  protected final String TEXT_166 = ".createStatement().execute(\"END QUERY LOGGING ON ALL\");        " + NL + "\t\t     }catch(Exception e){" + NL + "\t\t         e.printStackTrace();" + NL + "\t\t     }" + NL + "\t";
  protected final String TEXT_167 = NL + "\t\t";
  protected final String TEXT_168 = NL + "    }";
  protected final String TEXT_169 = NL + "nb_line_";
  protected final String TEXT_170 = " = nb_line_updated_";
  protected final String TEXT_171 = " + nb_line_inserted_";
  protected final String TEXT_172 = " + nb_line_deleted_";
  ...
  protected final String TEXT_176 = "_NB_LINE_UPDATED\",nb_line_updated_";
  protected final String TEXT_177 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_178 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  ...
  protected final String TEXT_183 = " - Has ";
  protected final String TEXT_184 = " records count: \" + nb_line_";
