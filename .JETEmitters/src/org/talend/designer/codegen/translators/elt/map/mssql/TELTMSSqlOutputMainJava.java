...
public class TELTMSSqlOutputMainJava
{
  ...
  protected final String TEXT_88 = " = \"net.sourceforge.jtds.jdbc.Driver\";" + NL + "    java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_101 = "; " + NL + "    }" + NL + "    url_";
  protected final String TEXT_102 = " += \";appName=\" + projectName + \";\" + ";
  ...
  protected final String TEXT_121 = NL + NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_122 = " =null;" + NL + "\t";
  protected final String TEXT_123 = "\t" + NL + "\tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_124 = "+\"(";
  protected final String TEXT_125 = ")  (\"+select_query+\")\";" + NL + "\tpstmt_";
  protected final String TEXT_126 = " = conn_";
  protected final String TEXT_127 = ".prepareStatement(insertQuery);" + NL;
  protected final String TEXT_128 = NL + "\tString updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_129 = "+\" SET ";
  protected final String TEXT_130 = " \"";
  protected final String TEXT_131 = NL + "\t\t+\"  WHERE \" + ";
  protected final String TEXT_132 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_133 = " = conn_";
  protected final String TEXT_134 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_135 = NL + "\t" + NL + "\tString deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_136 = "+\" WHERE EXISTS (\"+select_query+\") \" " + NL + "\t";
  protected final String TEXT_137 = NL + "\t+\"  AND \" + ";
  protected final String TEXT_138 = NL + "\t";
  protected final String TEXT_139 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_140 = " = conn_";
  protected final String TEXT_141 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_142 = NL + "int nb_line_";
  protected final String TEXT_143 = " = 0;" + NL + "int nb_line_updated_";
  protected final String TEXT_144 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_145 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_146 = " = 0;" + NL + "\t";
  protected final String TEXT_147 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");";
  ...
  protected final String TEXT_151 = NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_152 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_153 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");";
  protected final String TEXT_154 = " " + NL + "nb_line_updated_";
  protected final String TEXT_155 = " = pstmt_";
  protected final String TEXT_156 = ".executeUpdate();";
  protected final String TEXT_157 = NL + "\tSystem.out.println(\"--> \" + nb_line_updated_";
  protected final String TEXT_158 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_159 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\t";
  protected final String TEXT_160 = " " + NL + "\t\tnb_line_deleted_";
  ...
  protected final String TEXT_172 = " = nb_line_updated_";
