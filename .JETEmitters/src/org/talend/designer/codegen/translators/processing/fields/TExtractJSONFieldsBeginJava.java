...
public class TExtractJSONFieldsBeginJava
{
  ...
  protected final String TEXT_38 = NL + "                String xmlStr_";
  protected final String TEXT_39 = ",org.dom4j.tree.AbstractNode temp_";
  protected final String TEXT_40 = ",String loopQuery_";
  protected final String TEXT_41 = ",java.util.HashMap xmlNameSpaceMap_";
  protected final String TEXT_42 = ",org.dom4j.Node node_";
  protected final String TEXT_43 = "," + NL + "                    String str_";
  protected final String TEXT_44 = ",XML_API_";
  protected final String TEXT_45 = " xml_api_";
  protected final String TEXT_46 = ",OriginalJSONString_";
  protected final String TEXT_47 = " originalJSONString_";
  protected final String TEXT_48 = ",ConvertJSONString_";
  protected final String TEXT_49 = " cjs_";
  protected final String TEXT_50 = ",boolean isGetWholeJson_";
  protected final String TEXT_51 = " ) throws java.lang.Exception {";
  protected final String TEXT_52 = NL + "                    \tisGetWholeJson_";
  protected final String TEXT_53 = "  = true;";
  protected final String TEXT_54 = NL + "                org.dom4j.XPath xTmp";
  protected final String TEXT_55 = "_";
  protected final String TEXT_56 = " = temp_";
  protected final String TEXT_57 = ".createXPath(";
  protected final String TEXT_58 = ");" + NL + "                xTmp";
  protected final String TEXT_59 = "_";
  protected final String TEXT_60 = ".setNamespaceURIs(xmlNameSpaceMap_";
  ...
  protected final String TEXT_97 = NL + "\t\t\t\t\t\tString xmlStrTemp";
  protected final String TEXT_98 = "_";
  protected final String TEXT_99 = " = \"\";" + NL + "\t\t\t\t\t\tfor(Object tempNode_";
  protected final String TEXT_100 = " : xTmp";
  protected final String TEXT_101 = "_";
  protected final String TEXT_102 = ".selectNodes(temp_";
  protected final String TEXT_103 = ")){" + NL + "\t\t\t\t\t\t\tnode_";
  protected final String TEXT_104 = " = (org.dom4j.Node)tempNode_";
  protected final String TEXT_105 = ";" + NL + "\t\t\t\t\t\t\txmlStrTemp";
  protected final String TEXT_106 = "_";
  protected final String TEXT_107 = " += node_";
  protected final String TEXT_108 = ".asXML();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tif(\"\".equals(xmlStrTemp";
  protected final String TEXT_109 = "_";
  protected final String TEXT_110 = ")){" + NL + "\t\t\t\t\t\t\tstr_";
  protected final String TEXT_111 = " = null;" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\tstr_";
  protected final String TEXT_112 = " = originalJSONString_";
  protected final String TEXT_113 = ".getOriginalJSONString(xmlStrTemp";
  protected final String TEXT_114 = "_";
  protected final String TEXT_115 = ",cjs_";
  protected final String TEXT_116 = ".getAdditionRoot(),";
  protected final String TEXT_117 = ",isGetWholeJson_";
  protected final String TEXT_118 = ", true);" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tisGetWholeJson_";
  protected final String TEXT_119 = " = false;" + NL + "                \t";
  protected final String TEXT_120 = NL + "\t\t\t\t\t\tjava.util.List<String> xmlListTemp";
  protected final String TEXT_121 = "_";
  protected final String TEXT_122 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t\tfor(Object tempNode_";
  protected final String TEXT_123 = " : xTmp";
  protected final String TEXT_124 = "_";
  protected final String TEXT_125 = ".selectNodes(temp_";
  protected final String TEXT_126 = ")){" + NL + "\t\t\t\t\t\t\txmlListTemp";
  protected final String TEXT_127 = "_";
  protected final String TEXT_128 = ".add(((org.dom4j.Node)tempNode_";
  protected final String TEXT_129 = ").getStringValue());" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_130 = NL + "                                    ";
  protected final String TEXT_131 = ".";
  protected final String TEXT_132 = " = str_";
  protected final String TEXT_133 = ";";
  protected final String TEXT_134 = NL + "                                    if(xml_api_";
  protected final String TEXT_135 = ".isDefNull(node_";
  ...
  protected final String TEXT_144 = " =\"\";" + NL + "                                    }else if(xml_api_";
  protected final String TEXT_145 = ".isMissing(node_";
  protected final String TEXT_146 = " )){ ";
  protected final String TEXT_147 = NL + "                                        ";
  protected final String TEXT_148 = ".";
  protected final String TEXT_149 = " =";
  protected final String TEXT_150 = ";" + NL + "                                    }else{";
  protected final String TEXT_151 = NL + "\t\t\t\t\t\t\t\t\tif(xml_api_";
  protected final String TEXT_152 = ".isEmpty(node_";
  protected final String TEXT_153 = ")){" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_154 = ".";
  protected final String TEXT_155 = " =\"\";" + NL + "\t\t\t\t\t\t\t\t\t}else if(xml_api_";
  protected final String TEXT_156 = ".isMissing(node_";
  protected final String TEXT_157 = " )){ " + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_158 = ".";
  protected final String TEXT_159 = " =";
  protected final String TEXT_160 = ";" + NL + "\t\t\t\t\t\t\t\t\t}else{";
  protected final String TEXT_161 = "\t" + NL + "                                \tif(xml_api_";
  protected final String TEXT_162 = ".isDefNull(node_";
  protected final String TEXT_163 = ")){" + NL + "                                    \t";
  protected final String TEXT_164 = ".";
  protected final String TEXT_165 = " = null;" + NL + "                                \t}else if(xml_api_";
  protected final String TEXT_166 = ".isEmpty(node_";
  protected final String TEXT_167 = ") || xml_api_";
  protected final String TEXT_168 = ".isMissing(node_";
  protected final String TEXT_169 = ")){" + NL + "                                    \t";
  protected final String TEXT_170 = ".";
  protected final String TEXT_171 = " = ";
  protected final String TEXT_172 = ";" + NL + "                                \t}else{";
  protected final String TEXT_173 = NL + "\t\t\t\t\t\t\t\t\t\tif(xml_api_";
  protected final String TEXT_174 = ".isMissing(node_";
  protected final String TEXT_175 = ") || xml_api_";
  protected final String TEXT_176 = ".isEmpty(node_";
  ...
  protected final String TEXT_183 = " = str_";
  protected final String TEXT_184 = ";";
  protected final String TEXT_185 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_186 = ".";
  protected final String TEXT_187 = " = ParserUtils.parseTo_Date(str_";
  protected final String TEXT_188 = ", ";
  protected final String TEXT_189 = ");";
  protected final String TEXT_190 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_191 = ".";
  protected final String TEXT_192 = " = ParserUtils.parseTo_";
  protected final String TEXT_193 = "(str_";
  protected final String TEXT_194 = ");";
  protected final String TEXT_195 = NL + "\t\t\t\t\t\t\t\t\t}";
  protected final String TEXT_196 = NL + "\t\t\t\t\t\t\t\tif(xmlListTemp";
  protected final String TEXT_197 = "_";
  protected final String TEXT_198 = ".isEmpty()){" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_199 = ".";
  protected final String TEXT_200 = " = null;\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_201 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_202 = ".";
  protected final String TEXT_203 = " = xmlListTemp";
  protected final String TEXT_204 = "_";
  protected final String TEXT_205 = ".toString();" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_206 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_207 = ".";
  protected final String TEXT_208 = " = xmlListTemp";
  protected final String TEXT_209 = "_";
  protected final String TEXT_210 = ";" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_211 = NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_212 = NL + "            }";
  protected final String TEXT_213 = NL + "            }";
  protected final String TEXT_214 = NL + "            public void putRejectValueBeforeExtract_";
  ...
  protected final String TEXT_227 = NL + "            public void putRejectValueAfterExtract_";
  ...
  protected final String TEXT_240 = NL + "}" + NL + "" + NL + "    String jsonStr_";
  protected final String TEXT_241 = " = \"\";" + NL + "    String xmlStr_";
  protected final String TEXT_242 = " = \"\";" + NL + "" + NL + "XML_API_";
  protected final String TEXT_243 = " xml_api_";
  protected final String TEXT_244 = " = new XML_API_";
