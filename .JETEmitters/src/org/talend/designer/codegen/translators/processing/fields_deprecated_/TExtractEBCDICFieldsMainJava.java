...
public class TExtractEBCDICFieldsMainJava
{
  ...
  protected final String TEXT_94 = " - Extracting the record \" + nb_line_";
  protected final String TEXT_95 = " + \" to the file.\");";
  protected final String TEXT_96 = NL + "}catch(java.lang.Exception ex_";
  protected final String TEXT_97 = "){";
  protected final String TEXT_98 = NL + "\t\tthrow(ex_";
  ...
  protected final String TEXT_108 = NL + "\t\t\textractEBCDICFieldUtil_";
  protected final String TEXT_109 = ".putValue_reject_";
  protected final String TEXT_110 = "(";
  protected final String TEXT_111 = ",";
  protected final String TEXT_112 = ");";
  protected final String TEXT_113 = "    " + NL + "\t\t    ";
  protected final String TEXT_114 = ".errorMessage = ex_";
  protected final String TEXT_115 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_116 = ";" + NL + "\t\t    ";
  protected final String TEXT_117 = " = null;";
  protected final String TEXT_118 = NL + "\t\t\t";
  protected final String TEXT_119 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_120 = " - \" + ex_";
  protected final String TEXT_121 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_122 = NL + "\t\t    System.err.println(ex_";
  protected final String TEXT_123 = ".getMessage());" + NL + "\t\t    ";
  protected final String TEXT_124 = " = null;";
  protected final String TEXT_125 = NL + "\t\t\t";
  protected final String TEXT_126 = ".errorMessage = ex_";
  protected final String TEXT_127 = ".getMessage() + \" - Line: \" + tos_count_";
