...
public class TInterbaseOutputBeginJava {
  ...
  protected final String TEXT_70 = " = \"jdbc:interbase://\" + ";
  ...
  protected final String TEXT_82 = NL + "      " + NL + "    " + NL + "    String dbPwd_";
  ...
  protected final String TEXT_94 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_95 = " = ";
  protected final String TEXT_96 = ";            " + NL + "        int commitCounter_";
  ...
  protected final String TEXT_128 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_144 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_154 = NL + "            deletedCount_";
  protected final String TEXT_155 = " = deletedCount_";
  protected final String TEXT_156 = " + stmtClear_";
  ...
  protected final String TEXT_167 = NL + "\t    String update_";
  protected final String TEXT_168 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_169 = " + \"\\\" SET ";
  ...
  protected final String TEXT_173 = ".prepareStatement(update_";
  protected final String TEXT_174 = ");" + NL + "\t    ";
  protected final String TEXT_175 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_176 = " = conn_";
  protected final String TEXT_177 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  ...
  protected final String TEXT_209 = NL + "\t    String delete_";
  protected final String TEXT_210 = " = \"DELETE  FROM \\\"\" + ";
  protected final String TEXT_211 = " + \"\\\" WHERE ";
  protected final String TEXT_212 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_213 = " = conn_";
  protected final String TEXT_214 = ".prepareStatement(delete_";
  protected final String TEXT_215 = ");" + NL + "\t    ";
  protected final String TEXT_216 = NL + "        StringBuffer query_";
  protected final String TEXT_217 = " = null;" + NL + "       \t";
  protected final String TEXT_218 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_219 = " = insert_";
  ...
  protected final String TEXT_228 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_229 = " = insert_";
  protected final String TEXT_230 = ".split(\"\\\\?\");";
  protected final String TEXT_231 = NL + "\t\t\tdelete_";
  protected final String TEXT_232 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_233 = " = delete_";
  protected final String TEXT_234 = ".split(\"\\\\?\");";
  protected final String TEXT_235 = NL + "\t\t\treplace_";
  protected final String TEXT_236 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_237 = " = replace_";
  protected final String TEXT_238 = ".split(\"\\\\?\");";
  protected final String TEXT_239 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_240 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_241 = " = insertIgnore_";
