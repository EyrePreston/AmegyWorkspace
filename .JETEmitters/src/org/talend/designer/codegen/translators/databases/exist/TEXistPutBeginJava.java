...
public class TEXistPutBeginJava
{
  ...
  protected final String TEXT_41 = NL + "\t\t" + NL + "\t\torg.xmldb.api.base.Collection col_";
  ...
  protected final String TEXT_79 = "\t" + NL + "" + NL + "\t\tString localdir_";
  protected final String TEXT_80 = "  = ";
  protected final String TEXT_81 = ";\t" + NL + "\t\tfor(java.util.Map<String, String> map_";
