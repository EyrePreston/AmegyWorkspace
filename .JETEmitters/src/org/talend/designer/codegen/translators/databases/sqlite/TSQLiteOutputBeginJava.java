...
public class TSQLiteOutputBeginJava {
  ...
  protected final String TEXT_71 = " = \"jdbc:sqlite:\"+ \"/\" + ";
  ...
  protected final String TEXT_76 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_77 = "\", conn_";
  protected final String TEXT_78 = ");";
  protected final String TEXT_79 = NL + "        conn_";
  protected final String TEXT_80 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_81 = " = ";
  protected final String TEXT_82 = ";" + NL + "        int commitCounter_";
  ...
  protected final String TEXT_132 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_142 = NL + "            deletedCount_";
  ...
  protected final String TEXT_165 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  ...
  protected final String TEXT_178 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_193 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_194 = " = conn_";
  protected final String TEXT_195 = ".prepareStatement(insert_";
  protected final String TEXT_196 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_197 = NL + "\t    String delete_";
  protected final String TEXT_198 = " = \"DELETE FROM \\\"\" + ";
  ...
  protected final String TEXT_202 = ".prepareStatement(delete_";
  protected final String TEXT_203 = ");" + NL + "\t    ";
  protected final String TEXT_204 = NL + "        StringBuffer query_";
  protected final String TEXT_205 = " = null;" + NL + "       \t";
  protected final String TEXT_206 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_207 = " = insert_";
  protected final String TEXT_208 = ".split(\"\\\\?\");";
  protected final String TEXT_209 = NL + "\t\t\tupdate_";
  protected final String TEXT_210 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_211 = " = update_";
  protected final String TEXT_212 = ".split(\"\\\\?\");";
  protected final String TEXT_213 = NL + "\t\t\tupdate_";
  protected final String TEXT_214 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_215 = " = update_";
  protected final String TEXT_216 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_217 = " = insert_";
  protected final String TEXT_218 = ".split(\"\\\\?\");";
  protected final String TEXT_219 = NL + "\t\t\tdelete_";
  protected final String TEXT_220 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_221 = " = delete_";
  protected final String TEXT_222 = ".split(\"\\\\?\");";
  protected final String TEXT_223 = NL + "\t\t\treplace_";
  protected final String TEXT_224 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_225 = " = replace_";
  protected final String TEXT_226 = ".split(\"\\\\?\");";
  protected final String TEXT_227 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_228 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_229 = " = insertIgnore_";
