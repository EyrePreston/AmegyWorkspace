...
public class TSybaseRowBeginJava
{
  ...
  protected final String TEXT_117 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_136 = ";" + NL + "\t\t\t\t}" + NL + "\t\t\t\tstmt_";
  protected final String TEXT_137 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_138 = " +\" ON\");" + NL + "\t\t\t";
