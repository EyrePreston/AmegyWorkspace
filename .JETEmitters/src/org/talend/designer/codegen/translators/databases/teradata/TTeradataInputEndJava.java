...
public class TTeradataInputEndJava
{
  ...
  protected final String TEXT_105 = NL + NL + "\t}" + NL + "}finally{" + NL + "\tstmt_";
  ...
  protected final String TEXT_112 = ".setAutoCommit(true);    " + NL + "    try{" + NL + "         conn_";
  protected final String TEXT_113 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");       " + NL + "         conn_";
  protected final String TEXT_114 = ".createStatement().execute(\"END QUERY LOGGING ON ALL\");        " + NL + "     }catch(Exception e){";
  protected final String TEXT_115 = NL + "         System.err.println(e.getMessage());" + NL + "     }";
