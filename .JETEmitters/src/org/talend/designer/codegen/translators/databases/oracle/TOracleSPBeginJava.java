...
public class TOracleSPBeginJava
{
  ...
  protected final String TEXT_47 = ".put(\"password\",decryptedPassword_";
  ...
  protected final String TEXT_55 = NL + "\tjava.sql.Statement stmtNLS_";
  protected final String TEXT_56 = " = connection_";
  protected final String TEXT_57 = ".createStatement();";
  protected final String TEXT_58 = "\t" + NL + "\t\tstmtNLS_";
  protected final String TEXT_59 = ".execute(\"ALTER SESSION SET NLS_LANGUAGE=\" +\"";
  protected final String TEXT_60 = "\" );";
  protected final String TEXT_61 = "\t" + NL + "\t\tstmtNLS_";
  protected final String TEXT_62 = ".execute(\"ALTER SESSION SET NLS_TERRITORY=\" +\"";
  protected final String TEXT_63 = "\" );";
  protected final String TEXT_64 = NL + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_65 = " = connection_";
  protected final String TEXT_66 = ".prepareCall(\"{";
  protected final String TEXT_67 = "call \" + ";
  protected final String TEXT_68 = " + \"(";
  protected final String TEXT_69 = "?";
  protected final String TEXT_70 = ",?";
  protected final String TEXT_71 = ")}\");" + NL + "" + NL + "java.sql.Timestamp tmpDate_";
  protected final String TEXT_72 = ";" + NL + "String tmpString_";
