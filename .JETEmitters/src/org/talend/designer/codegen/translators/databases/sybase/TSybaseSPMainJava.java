...
public class TSybaseSPMainJava
{
  ...
  protected final String TEXT_41 = NL + "\t\t\t// No code generated: IN or INOUT arguments defined, whereas ";
  protected final String TEXT_42 = " has no input" + NL + "\t\t\t";
  protected final String TEXT_43 = NL + "\t\t\t\tif(true){" + NL + "\t\t\t\t\tthrow new RuntimeException(\"Please specify the \\\"return\\\" column in the drop-down list of \\\"Return result in\\\"! You should select \\\"IN\\\" as input parameter type only when \\\"is function\\\" is checked!\");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_44 = NL + "\t\t\t\t\tif (";
  protected final String TEXT_45 = ".";
  protected final String TEXT_46 = " == null) {" + NL + "\t\t\t\t\t\tstatement_";
  protected final String TEXT_47 = ".setNull(";
  protected final String TEXT_48 = ", java.sql.Types.";
  protected final String TEXT_49 = ");" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t";
  protected final String TEXT_50 = NL + "\t\t\t\t\tif (";
  protected final String TEXT_51 = ".";
  protected final String TEXT_52 = " == '\\0') {" + NL + "\t\t\t\t\t\tstatement_";
  protected final String TEXT_53 = ".setString(";
  protected final String TEXT_54 = ", \"\");" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\tstatement_";
  ...
  protected final String TEXT_60 = ".setDate(";
  protected final String TEXT_61 = ", new java.sql.Date(";
  protected final String TEXT_62 = ".";
  protected final String TEXT_63 = ".getTime()));" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_71 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_72 = ".registerOutParameter(";
  protected final String TEXT_73 = ", java.sql.Types.";
  protected final String TEXT_74 = ");" + NL + "\t  \t\t\t";
  protected final String TEXT_75 = NL + "\t";
  protected final String TEXT_76 = NL + "\t\tjava.sql.ResultSet rs_";
  protected final String TEXT_77 = " = statement_";
  protected final String TEXT_78 = ".executeQuery();" + NL + "\t";
  ...
  protected final String TEXT_84 = ".execute();" + NL + "\t";
  ...
  protected final String TEXT_94 = ".getResultSet();";
  protected final String TEXT_95 = NL + "\t\t\t\t\t  \t\t\t\twhile(rs_";
  protected final String TEXT_96 = ".next()){" + NL + "\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_97 = NL + "\t\t\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_98 = " = rs_";
  protected final String TEXT_99 = ".getString(";
  protected final String TEXT_100 = ");" + NL + "\t\t\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_101 = " != null && tmpString_";
  protected final String TEXT_102 = ".length() > 0) {" + NL + "\t\t\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_103 = ".";
  protected final String TEXT_104 = " = tmpString_";
  protected final String TEXT_105 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_106 = NL + "\t\t\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_107 = " = rs_";
  protected final String TEXT_108 = ".getDate(";
  protected final String TEXT_109 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_110 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_111 = ".";
  protected final String TEXT_112 = " = new java.util.Date(tmpDate_";
  ...
  protected final String TEXT_121 = NL + "\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_122 = " = statement_";
  protected final String TEXT_123 = ".getString(";
  protected final String TEXT_124 = ");" + NL + "\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_125 = " != null && tmpString_";
  protected final String TEXT_126 = ".length() > 0) {" + NL + "\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_127 = ".";
  protected final String TEXT_128 = " = tmpString_";
  protected final String TEXT_129 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_130 = NL + "\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_131 = " = statement_";
  protected final String TEXT_132 = ".getDate(";
  protected final String TEXT_133 = ");" + NL + "\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_134 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_135 = ".";
  protected final String TEXT_136 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_137 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_138 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_139 = ".";
  protected final String TEXT_140 = " = statement_";
  protected final String TEXT_141 = ".get";
  protected final String TEXT_142 = "(";
  protected final String TEXT_143 = ");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_144 = NL + "\t\t\t\t\t\t\t\t\tif (statement_";
  protected final String TEXT_145 = ".wasNull()) {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_158 = NL + "\t\t// No code generated: define a schema for ";
