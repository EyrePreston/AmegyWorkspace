...
public class TTeradataFastLoadMainJava
{
  ...
  protected final String TEXT_106 = ",java.sql.Types.BOOLEAN);\t" + NL + "\t";
  ...
  protected final String TEXT_111 = ",java.sql.Types.DOUBLE);\t" + NL + "\t";
  ...
  protected final String TEXT_116 = ",java.sql.Types.FLOAT);\t" + NL + "\t";
  protected final String TEXT_117 = NL + NL + "}else{" + NL + "" + NL + "\t";
  protected final String TEXT_118 = NL + "\t";
  protected final String TEXT_119 = NL + "\tif(";
  protected final String TEXT_120 = ".";
  protected final String TEXT_121 = "==null){" + NL + "\t";
  protected final String TEXT_122 = NL + "\tif((\"null\").equals(String.valueOf(";
  protected final String TEXT_123 = ".";
  protected final String TEXT_124 = ").toLowerCase())){" + NL + "\t";
  protected final String TEXT_125 = NL + "\t\t";
  protected final String TEXT_126 = ".setNull(";
  protected final String TEXT_127 = ",java.sql.Types.CHAR);" + NL + "\t\t" + NL + "\t}else if(";
  protected final String TEXT_128 = ".";
  protected final String TEXT_129 = " == '\\0'){" + NL + "\t" + NL + "\t\t";
  protected final String TEXT_130 = ".setString(";
  protected final String TEXT_131 = ",\"\");" + NL + "\t\t" + NL + "\t}else{" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_132 = ".setString(";
  ...
  protected final String TEXT_138 = "!=null){" + NL + "\t" + NL + "\t\t";
  protected final String TEXT_139 = ".setDate(";
  protected final String TEXT_140 = ",new java.sql.Date(";
  protected final String TEXT_141 = ".";
  protected final String TEXT_142 = ".getTime()));" + NL + "\t\t" + NL + "\t}else{" + NL + "\t" + NL + "\t\t";
  protected final String TEXT_143 = ".setNull(";
  protected final String TEXT_144 = ",java.sql.Types.DATE);" + NL + "\t\t" + NL + "\t}" + NL + "\t";
  protected final String TEXT_145 = NL + "\tif(";
  protected final String TEXT_146 = ".";
  protected final String TEXT_147 = "!=null){" + NL + "\t    " + NL + "\t   ";
  protected final String TEXT_148 = ".setTimestamp(";
  protected final String TEXT_149 = ",new java.sql.Timestamp(";
  protected final String TEXT_150 = ".";
  protected final String TEXT_151 = ".getTime()));" + NL + "\t        " + NL + "\t}else{" + NL + "\t    " + NL + "\t   ";
  protected final String TEXT_152 = ".setNull(";
  protected final String TEXT_153 = ",java.sql.Types.TIMESTAMP);" + NL + "\t        " + NL + "    }" + NL + "\t";
  ...
  protected final String TEXT_162 = ".addBatch();" + NL + "\t\t   }catch(java.lang.Exception e){" + NL + "\t\t            ";
  protected final String TEXT_163 = NL + "\t\t                throw(e);" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_172 = NL + "\t\t                    System.err.print(e.getMessage());" + NL + "\t\t                    ";
  ...
  protected final String TEXT_179 = NL + "\t    commitCounter_";
  protected final String TEXT_180 = "++;";
  protected final String TEXT_181 = NL + "        if(commitEvery_";
  protected final String TEXT_182 = " <= commitCounter_";
  protected final String TEXT_183 = "){" + NL + "\t\t\tint[] resultArr = pstmt_";
  protected final String TEXT_184 = ".executeBatch();" + NL + "\t\t\tpstmt_";
  protected final String TEXT_185 = ".clearBatch();" + NL + "        \tcommitCounter_";
  protected final String TEXT_186 = "=0;" + NL + "        \tint sum = 0;" + NL + "        \tfor(int i : resultArr){" + NL + "  \t\t    \tsum += (i<0 ? 0 : i);" + NL + "        \t}" + NL + "        \tinsertedCount_";
  protected final String TEXT_187 = " += sum;" + NL + "        }" + NL + "\t";
