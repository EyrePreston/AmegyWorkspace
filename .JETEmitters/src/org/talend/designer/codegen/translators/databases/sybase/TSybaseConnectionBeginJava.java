...
public class TSybaseConnectionBeginJava
{
  ...
  protected final String TEXT_88 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\tlog.info(\"";
  ...
  protected final String TEXT_91 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_136 = ");" + NL + "\tglobalMap.put(\"host_";
  protected final String TEXT_137 = "\", ";
  protected final String TEXT_138 = ");" + NL + "\tglobalMap.put(\"port_";
  protected final String TEXT_139 = "\", ";
  protected final String TEXT_140 = ");" + NL + "\tglobalMap.put(\"db_";
  protected final String TEXT_141 = "\", ";
  protected final String TEXT_142 = ");" + NL + "\tglobalMap.put(\"user_";
  protected final String TEXT_143 = "\", ";
  protected final String TEXT_144 = ");" + NL + "\tglobalMap.put(\"pass_";
  protected final String TEXT_145 = "\", dbPwd_";
  protected final String TEXT_146 = ");" + NL + "\tglobalMap.put(\"dbschema_";
