...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_50 = "=0;" + NL + "String dbschema_";
  ...
  protected final String TEXT_54 = " = java.util.Calendar.getInstance();" + NL + "long year1_";
  protected final String TEXT_55 = " = TalendDate.parseDate(\"yyyy-MM-dd\",\"0001-01-01\").getTime();" + NL + "long year2_";
  protected final String TEXT_56 = " = TalendDate.parseDate(\"yyyy-MM-dd\",\"1753-01-01\").getTime();" + NL + "long year10000_";
  protected final String TEXT_57 = " = TalendDate.parseDate(\"yyyy-MM-dd HH:mm:ss\",\"9999-12-31 24:00:00\").getTime();" + NL + "long date_";
  protected final String TEXT_58 = ";" + NL + "" + NL + "java.util.Calendar calendar_datetimeoffset_";
  protected final String TEXT_59 = " = java.util.Calendar.getInstance(java.util.TimeZone.getTimeZone(\"UTC\"));" + NL;
  ...
  protected final String TEXT_69 = NL + "        int insertKeyCount_";
  ...
  protected final String TEXT_84 = " = \"net.sourceforge.jtds.jdbc.Driver\";" + NL + "\t";
  protected final String TEXT_85 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_86 = ");" + NL + "    String port_";
  protected final String TEXT_87 = " = ";
  protected final String TEXT_88 = ";" + NL + "    String dbname_";
  protected final String TEXT_89 = " = ";
  protected final String TEXT_90 = " ;" + NL + "    String url_";
  protected final String TEXT_91 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_92 = " ; " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_93 = ")) {" + NL + "    \turl_";
  protected final String TEXT_94 = " += \":\" + ";
  protected final String TEXT_95 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_96 = ")) {" + NL + "    \turl_";
  protected final String TEXT_97 = " += \"//\" + ";
  protected final String TEXT_98 = "; " + NL + "    }" + NL + "    url_";
  protected final String TEXT_99 = " += \";appName=\" + projectName + \";\" + ";
  ...
  protected final String TEXT_130 = " " + NL + "" + NL + "if(dbschema_";
  ...
  protected final String TEXT_381 = ", true);" + NL + "    " + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_382 = "            ";
  protected final String TEXT_383 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_389 = NL + "            stmtClear_";
  ...
  protected final String TEXT_396 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_397 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_398 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  ...
  protected final String TEXT_402 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_416 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_451 = " = null;    " + NL + "\t\tString keyPsmt_";
  protected final String TEXT_452 = " = conn_";
  protected final String TEXT_453 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_454 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_455 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_456 = ",insert_";
  protected final String TEXT_457 = ",keyPsmt_";
  ...
  protected final String TEXT_465 = ".prepareStatement(update_";
  protected final String TEXT_466 = ");";
  protected final String TEXT_467 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_468 = " = conn_";
  protected final String TEXT_469 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  ...
  protected final String TEXT_502 = " = \"DELETE FROM [\" + tableName_";
  ...
  protected final String TEXT_506 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_520 = NL + "    \t" + NL + "    class BufferLine_";
  ...
  protected final String TEXT_534 = "   \t                " + NL + "        }" + NL + "    }" + NL + "    " + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_535 = "> sInsertColValueList";
  protected final String TEXT_536 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_537 = " sInsertColValue";
  protected final String TEXT_538 = " = null; " + NL + "    " + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_539 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_540 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_541 = ".append(\"(";
  protected final String TEXT_542 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_543 = "-1) extendInsertValueStmt_";
  protected final String TEXT_544 = ".append(\",\");" + NL + "    }" + NL + "   " + NL + "\tString insert_";
  protected final String TEXT_545 = " = \"INSERT INTO \"+";
  protected final String TEXT_546 = "+\" (";
  protected final String TEXT_547 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_548 = ".toString();" + NL + "\t" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_549 = " =  conn_";
  protected final String TEXT_550 = ".prepareStatement(insert_";
  protected final String TEXT_551 = ");" + NL + "      " + NL + "    String insertColName";
  protected final String TEXT_552 = " = \"";
  protected final String TEXT_553 = "\";" + NL + "    String insertColValue";
  ...
  protected final String TEXT_587 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_588 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_589 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_590 = "\") == true;";
  protected final String TEXT_591 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_592 = " = conn_";
  protected final String TEXT_593 = ".createStatement();";
  protected final String TEXT_594 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_595 = " ) {" + NL + "\t        \tstmt_";
  protected final String TEXT_596 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_597 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_598 = NL + "     \t\tstmt_";
  protected final String TEXT_599 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_600 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_601 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_602 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_603 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_604 = " =null;" + NL + "\t";
  protected final String TEXT_605 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_609 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_610 = " =  null;";
  protected final String TEXT_611 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_612 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_616 = NL + "\t\t\tString[] replaceSQLSplits_";
