...
public class TTeradataConnectionBeginJava
{
  ...
  protected final String TEXT_74 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_75 = " + \"/DATABASE=\" + ";
  protected final String TEXT_76 = ";" + NL + "\t\t} else {" + NL + "\t\t    url_";
  protected final String TEXT_77 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_78 = " + \"/DATABASE=\" + ";
  ...
  protected final String TEXT_86 = NL + "\t\tString dbPwd_";
  ...
  protected final String TEXT_101 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  protected final String TEXT_102 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_103 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_104 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_105 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_106 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_107 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_112 = " - Written records count: \" + nb_line_";
  protected final String TEXT_113 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_114 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_115 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_116 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_117 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_118 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_119 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_120 = " - Writing the record \" + nb_line_";
  protected final String TEXT_121 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_123 = " - Processing the record \" + nb_line_";
  protected final String TEXT_124 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_125 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_126 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_127 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_129 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_130 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_131 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_132 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_133 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_140 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_141 = NL + "\t\t\tconn_";
  protected final String TEXT_142 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_143 = NL + "\t\t\tconn_";
  protected final String TEXT_144 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_145 = NL + "\t\t\t\tconn_";
  protected final String TEXT_146 = ".setAutoCommit(";
  protected final String TEXT_147 = ");" + NL + "\t\t\t";
  protected final String TEXT_148 = NL + "\t\t\t\tlog.";
  protected final String TEXT_149 = "(\"";
  protected final String TEXT_150 = " - \" + ";
  protected final String TEXT_151 = ".getMessage());" + NL + "\t\t\t";
  ...
  protected final String TEXT_165 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_178 = ");" + NL + "\tglobalMap.put(\"host_";
  protected final String TEXT_179 = "\", ";
  protected final String TEXT_180 = ");" + NL + "\tglobalMap.put(\"dbname_";
  protected final String TEXT_181 = "\", ";
  protected final String TEXT_182 = ");" + NL + "\tglobalMap.put(\"username_";
  protected final String TEXT_183 = "\", dbUser_";
  protected final String TEXT_184 = ");" + NL + "\tglobalMap.put(\"password_";
  protected final String TEXT_185 = "\", dbPwd_";
  protected final String TEXT_186 = ");" + NL + "\tglobalMap.put(\"url_";
  protected final String TEXT_187 = "\", url_";
  ...
  protected final String TEXT_194 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
