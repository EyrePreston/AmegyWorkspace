...
public class TOracleOutputMainJava {
  ...
  protected final String TEXT_5 = "Enabled())" + NL + "\t\t\t";
  ...
  protected final String TEXT_13 = " = new StringBuilder();" + NL + "    \t   \t";
  protected final String TEXT_14 = ".append(\"Parameters:\");" + NL + "    \t   \t";
  protected final String TEXT_15 = NL + "                    ";
  protected final String TEXT_16 = ".append(\"";
  protected final String TEXT_17 = "\" + \" = \" + String.valueOf(";
  protected final String TEXT_18 = ").substring(0, 4) + \"...\");\t\t" + NL + "       \t\t\t";
  ...
  protected final String TEXT_26 = " = new StringBuilder();\t" + NL + "        \t";
  ...
  protected final String TEXT_34 = ".append(\"<null>\");" + NL + "    \t\t\t\t}else{" + NL + "        \t\t\t\t";
  ...
  protected final String TEXT_48 = NL + NL + "    \t\tif(dbschema_";
  protected final String TEXT_49 = " == null || dbschema_";
  ...
  protected final String TEXT_56 = NL + "  \ttableName_";
  ...
  protected final String TEXT_71 = ".createStatement();" + NL + "\t\t\t";
  ...
  protected final String TEXT_109 = NL + "\t\t    \t\tString keyCheckTable_";
  protected final String TEXT_110 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_121 = NL + "\t\t    " + NL + "\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_122 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_123 = ")) {" + NL + "\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_124 = ")== null){" + NL + "\t\t\t";
  protected final String TEXT_125 = "              " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_126 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_127 = " = conn_";
  protected final String TEXT_128 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_129 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_133 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_138 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_139 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_140 = " = tableNameForSearch_";
  protected final String TEXT_141 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_142 = " = tableNameForSearch_";
  protected final String TEXT_143 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_151 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_205 = " = false;" + NL + "                \t            String defaultSchema_";
  protected final String TEXT_206 = " = \"public\";" + NL + "                \t            if(dbschema_";
  protected final String TEXT_207 = " == null || dbschema_";
  protected final String TEXT_208 = ".trim().length() == 0) {" + NL + "                \t            \tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_215 = ".getString(\"current_schema\");" + NL + "                \t            \t}" + NL + "                \t            \trsSchema_";
  protected final String TEXT_216 = ".close();" + NL + "                \t            \tstmtSchema_";
  protected final String TEXT_217 = ".close();" + NL + "                \t            }" + NL + "                \t            while(rsTable_";
  ...
  protected final String TEXT_232 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_233 = ".equals";
  protected final String TEXT_234 = "IgnoreCase";
  protected final String TEXT_235 = "(schema_";
  ...
  protected final String TEXT_248 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_259 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_260 = ".";
  protected final String TEXT_261 = ", \"";
  protected final String TEXT_262 = "\")";
  protected final String TEXT_263 = ".toUpperCase()";
  ...
  protected final String TEXT_271 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_302 = ", true);" + NL + "    " + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_332 = NL + "                if(!conn_";
  ...
  protected final String TEXT_425 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_433 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_434 = " = new StringBuffer(update_";
  protected final String TEXT_435 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_436 = ".insert(update_";
  protected final String TEXT_437 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_438 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_439 = " =updateStringBuffer_";
  ...
  protected final String TEXT_447 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_545 = ".toUpperCase()";
  ...
  protected final String TEXT_554 = ".toUpperCase()";
  ...
  protected final String TEXT_566 = NL + "    \t\t\t\tpstmtUpdate_";
  ...
  protected final String TEXT_578 = "    " + NL + "    \t\t\t\tpstmtInsert_";
  ...
  protected final String TEXT_599 = NL + "\t\t \tinsertSQLSplits_";
  ...
  protected final String TEXT_621 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_622 = " = insertIgnore_";
  protected final String TEXT_623 = ".split(\"\\\\?\");";
  protected final String TEXT_624 = NL + "\t\t \tinsertSQLSplits_";
  ...
  protected final String TEXT_630 = " = new StringBuffer(\"\");" + NL + "\t";
  protected final String TEXT_631 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_632 = " = buffersSize_";
  protected final String TEXT_633 = ";" + NL + "\t\t\t";
  protected final String TEXT_634 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_635 = " = buffersSize_";
  ...
  protected final String TEXT_660 = ".getBytes());" + NL + "" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_699 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_700 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_701 = " = true;";
  protected final String TEXT_702 = NL + "                        throw(e_";
  ...
  protected final String TEXT_714 = " + 1;" + NL + "                        \t";
  protected final String TEXT_715 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_716 = ").getSQLState();" + NL + "                        \t";
  ...
  protected final String TEXT_731 = ",updateSQLSplits_";
  protected final String TEXT_732 = ");" + NL + "            \t    ";
  protected final String TEXT_733 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_734 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_762 = NL + "        \t\tpstmt_";
  protected final String TEXT_763 = ".addBatch();" + NL + "        \t\tnb_line_";
  protected final String TEXT_764 = "++;" + NL + "    \t\t\t";
  protected final String TEXT_765 = NL + "    \t\t\t\tbatchSizeCounter_";
  protected final String TEXT_766 = "++;" + NL + "    \t\t\t";
  protected final String TEXT_767 = NL + "\t\t\t\ttry {" + NL + "                \tnb_line_";
  protected final String TEXT_768 = "++;" + NL + "            \t    updatedCount_";
  protected final String TEXT_769 = " = updatedCount_";
  protected final String TEXT_770 = " + pstmt_";
  protected final String TEXT_771 = ".executeUpdate();" + NL + "            \t    ";
  protected final String TEXT_772 = NL + "            \t} catch(java.lang.Exception e_";
  protected final String TEXT_773 = ") {" + NL + "                \twhetherReject_";
  protected final String TEXT_774 = " = true;" + NL + "                \t";
  protected final String TEXT_775 = NL + "                    \tthrow(e_";
  protected final String TEXT_776 = ");" + NL + "                \t";
  protected final String TEXT_777 = NL + "                            ";
  protected final String TEXT_778 = " = new ";
  protected final String TEXT_779 = "Struct();";
  protected final String TEXT_780 = NL + "                                ";
  protected final String TEXT_781 = ".";
  protected final String TEXT_782 = " = ";
  protected final String TEXT_783 = ".";
  protected final String TEXT_784 = ";";
  protected final String TEXT_785 = NL + "                            rejectedCount_";
  protected final String TEXT_786 = " = rejectedCount_";
  protected final String TEXT_787 = " + 1;";
  protected final String TEXT_788 = NL + "                            ";
  protected final String TEXT_789 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_790 = ").getSQLState();";
  ...
  protected final String TEXT_796 = ".getMessage());";
  ...
  protected final String TEXT_801 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_802 = " = pstmt_";
  protected final String TEXT_803 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_804 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_805 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_806 = " = rs_";
  protected final String TEXT_807 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_851 = NL + "                } catch(java.lang.Exception e_";
  ...
  protected final String TEXT_870 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_871 = ").getSQLState();";
  protected final String TEXT_872 = NL + "                            ";
  protected final String TEXT_873 = ".errorMessage = e_";
  protected final String TEXT_874 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_875 = ";";
  protected final String TEXT_876 = NL + "                            System.err.print(e_";
  protected final String TEXT_877 = ".getMessage());";
  protected final String TEXT_878 = NL + "                }" + NL + "    \t\t} else {";
  ...
  protected final String TEXT_898 = NL + "                try {" + NL + "                    insertedCount_";
  ...
  protected final String TEXT_903 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_904 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_905 = " = true;";
  protected final String TEXT_906 = NL + "                        throw(e_";
  ...
  protected final String TEXT_922 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_923 = ").getSQLState();";
  protected final String TEXT_924 = NL + "                            ";
  protected final String TEXT_925 = ".errorMessage = e_";
  protected final String TEXT_926 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_927 = ";";
  protected final String TEXT_928 = NL + "                            System.err.print(e_";
  protected final String TEXT_929 = ".getMessage());";
  protected final String TEXT_930 = NL + "                }" + NL + "    \t\t}" + NL + "\t\t";
  protected final String TEXT_931 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_941 = ",updateSQLSplits_";
  ...
  protected final String TEXT_971 = NL + "    " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_972 = " = pstmtUpdate_";
  protected final String TEXT_973 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_974 = " = updatedCount_";
  protected final String TEXT_975 = "+updateFlag_";
  protected final String TEXT_976 = ";" + NL + "                if(updateFlag_";
  protected final String TEXT_977 = " == 0) {" + NL + "    \t\t\t\t";
  ...
  protected final String TEXT_984 = NL + "    \t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_985 = ",";
  protected final String TEXT_986 = ".";
  protected final String TEXT_987 = ", ";
  protected final String TEXT_988 = ",insertSQLSplits_";
  protected final String TEXT_989 = ");" + NL + "                \t\t\t";
  protected final String TEXT_990 = NL + "    \t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_991 = ".";
  protected final String TEXT_992 = ", pstmtInsert_";
  protected final String TEXT_993 = ", ";
  protected final String TEXT_994 = ", \"";
  protected final String TEXT_995 = "\");" + NL + "    \t\t\t\t\t";
  protected final String TEXT_996 = NL + "                        globalMap.put(\"";
  protected final String TEXT_997 = "_QUERY\", query_";
  protected final String TEXT_998 = ".toString().trim());";
  protected final String TEXT_999 = NL + "                    insertedCount_";
  protected final String TEXT_1000 = " = insertedCount_";
  protected final String TEXT_1001 = " + pstmtInsert_";
  protected final String TEXT_1002 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1003 = "++;";
  protected final String TEXT_1004 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_1005 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_1006 = NL + "    \t\t\t}" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_1007 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_1008 = " = true;";
  protected final String TEXT_1009 = NL + "                    throw(e_";
  ...
  protected final String TEXT_1025 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_1026 = ").getSQLState();";
  protected final String TEXT_1027 = NL + "                        ";
  protected final String TEXT_1028 = ".errorMessage = e_";
  protected final String TEXT_1029 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1030 = ";" + NL + "                \t";
  protected final String TEXT_1031 = NL + "                        System.err.print(e_";
  ...
  protected final String TEXT_1051 = NL + "    \t        try {" + NL + "                    deletedCount_";
  protected final String TEXT_1052 = " = deletedCount_";
  protected final String TEXT_1053 = " + pstmt_";
  protected final String TEXT_1054 = ".executeUpdate();" + NL + "    \t        \tnb_line_";
  protected final String TEXT_1055 = "++;";
  protected final String TEXT_1056 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_1057 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_1058 = " = true;";
  protected final String TEXT_1059 = NL + "                        throw(e_";
  ...
  protected final String TEXT_1075 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_1076 = ").getSQLState();";
  protected final String TEXT_1077 = NL + "                            ";
  protected final String TEXT_1078 = ".errorMessage = e_";
  protected final String TEXT_1079 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1080 = ";";
  protected final String TEXT_1081 = NL + "                            System.err.print(e_";
  protected final String TEXT_1082 = ".getMessage());";
  protected final String TEXT_1083 = NL + "                }    \t\t    \t\t" + NL + "    \t\t";
  ...
  protected final String TEXT_1096 = " <= batchSizeCounter_";
  protected final String TEXT_1097 = ") {                " + NL + "                    \ttry {" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_1098 = NL + "    \t\t\t\t\t\tpstmt_";
  protected final String TEXT_1099 = ".executeBatch();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_1100 = NL + "                    \t}catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1101 = "){" + NL + "                        \t";
  protected final String TEXT_1102 = NL + "                        \t\tthrow(e_";
  protected final String TEXT_1103 = ");" + NL + "                        \t";
  protected final String TEXT_1104 = NL + "                        \t\tSystem.err.println(e_";
  protected final String TEXT_1105 = ".getMessage());" + NL + "                        \t";
  protected final String TEXT_1106 = NL + "                \t\t}" + NL + "    \t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_1107 = " = pstmt_";
  protected final String TEXT_1108 = ".getUpdateCount();                \t" + NL + "        \t    \t\t";
  protected final String TEXT_1109 = NL + "        \t    \t\t\tinsertedCount_";
  protected final String TEXT_1110 = NL + "            \t    \t";
  protected final String TEXT_1111 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1112 = NL + "            \t    \t";
  protected final String TEXT_1113 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1114 = NL + "            \t    \t";
  protected final String TEXT_1115 = "      " + NL + "        \t    \t\t+= (tmp_batchUpdateCount_";
  protected final String TEXT_1116 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1117 = ":0);                   \t    \t" + NL + "        \t    \t\tbatchSizeCounter_";
  protected final String TEXT_1118 = " = 0;             \t                \t                \t" + NL + "    \t\t\t\t}" + NL + "        \t\t";
  ...
  protected final String TEXT_1123 = NL + "    \t                try {" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_1124 = NL + "                    \t\tpstmt_";
  protected final String TEXT_1125 = ".executeBatch();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_1126 = NL + "    \t                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1127 = "){" + NL + "    \t                \t";
  protected final String TEXT_1128 = NL + "    \t\t\t\t\t\t\tthrow(e_";
  protected final String TEXT_1129 = ");" + NL + "    \t                \t";
  protected final String TEXT_1130 = NL + "    \t                        System.err.println(e_";
  protected final String TEXT_1131 = ".getMessage());" + NL + "    \t                \t";
  protected final String TEXT_1132 = NL + "    \t                }            \t                              " + NL + "    \t        \t\ttmp_batchUpdateCount_";
  protected final String TEXT_1133 = " = pstmt_";
  protected final String TEXT_1134 = ".getUpdateCount();" + NL + "    \t    \t    \t";
  protected final String TEXT_1135 = NL + "    \t    \t    \t\tinsertedCount_";
  protected final String TEXT_1136 = NL + "    \t    \t    \t";
  protected final String TEXT_1137 = "            \t    \t\t" + NL + "    \t    \t    \t\tupdatedCount_";
  protected final String TEXT_1138 = NL + "    \t    \t    \t";
  protected final String TEXT_1139 = NL + "    \t    \t    \t    deletedCount_";
  protected final String TEXT_1140 = NL + "    \t    \t    \t";
  protected final String TEXT_1141 = "     " + NL + "    \t    \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_1142 = "!=-1?tmp_batchUpdateCount_";
