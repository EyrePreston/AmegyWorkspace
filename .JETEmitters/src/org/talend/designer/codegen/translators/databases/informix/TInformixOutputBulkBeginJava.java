...
public class TInformixOutputBulkBeginJava
{
  ...
  protected final String TEXT_40 = " = 0;" + NL + "\t\tchar rowSeparator_";
  protected final String TEXT_41 = " = ";
  protected final String TEXT_42 = ";" + NL + "\t\tchar fieldSeparator_";
  protected final String TEXT_43 = " = ";
  protected final String TEXT_44 = ";" + NL + "\t\t" + NL + "\t\tjava.io.File file_";
  protected final String TEXT_45 = " = new java.io.File(";
  protected final String TEXT_46 = ");\t\t" + NL + "\t\t";
  protected final String TEXT_47 = NL + "        java.io.File parentFile_";
  protected final String TEXT_48 = " = file_";
  protected final String TEXT_49 = ".getParentFile();" + NL + "        if(parentFile_";
  protected final String TEXT_50 = " != null && !parentFile_";
  protected final String TEXT_51 = ".exists()){" + NL + "            String absolutePath_";
  protected final String TEXT_52 = " = parentFile_";
  protected final String TEXT_53 = ".getAbsolutePath();";
  protected final String TEXT_54 = NL + "            if(parentFile_";
  protected final String TEXT_55 = ".mkdirs()){";
  protected final String TEXT_56 = NL + "                System.out.println(\"The directory '\"+absolutePath_";
  protected final String TEXT_57 = "+\"' has been created successfully.\");" + NL + "            }else{";
  protected final String TEXT_58 = NL + "                System.err.println(\"Fail to create directory '\"+absolutePath_";
  protected final String TEXT_59 = "+\"'.\");" + NL + "            }" + NL + "        }" + NL + "\t\t";
  protected final String TEXT_60 = NL + "\t\t\t\t" + NL + "\t\tcom.talend.csv.CSVWriter csvWriter_";
  protected final String TEXT_61 = " = new com.talend.csv.CSVWriter(new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "        new java.io.FileOutputStream(file_";
  protected final String TEXT_62 = ", ";
  protected final String TEXT_63 = "), ";
  protected final String TEXT_64 = ")));" + NL + "        resourceMap.put(\"csvWriter_";
  protected final String TEXT_65 = "\", csvWriter_";
  protected final String TEXT_66 = "); " + NL + "        csvWriter_";
  protected final String TEXT_67 = ".setSeparator(fieldSeparator_";
  protected final String TEXT_68 = ");" + NL + "        " + NL + "        csvWriter_";
  protected final String TEXT_69 = ".setLineEnd(\"\"+rowSeparator_";
  protected final String TEXT_70 = ");" + NL + "        csvWriter_";
  protected final String TEXT_71 = ".setEscapeChar('\\\\');" + NL + "      \tcsvWriter_";
  protected final String TEXT_72 = ".setQuoteStatus(com.talend.csv.CSVWriter.QuoteStatus.NO);  ";
