...
public class TEXistDeleteBeginJava
{
  ...
  protected final String TEXT_67 = " = 0;" + NL + "\torg.xmldb.api.modules.CollectionManagementService mgtService_";
  protected final String TEXT_68 = " = (org.xmldb.api.modules.CollectionManagementService) col_";
  protected final String TEXT_69 = ".getService(\"CollectionManagementService\",\"1.0\");" + NL + "    java.util.List<java.util.Map<String,String>> list_";
  protected final String TEXT_70 = " = new java.util.ArrayList<java.util.Map<String,String>>();";
  ...
  protected final String TEXT_77 = ");\t\t" + NL + " \t\tlist_";
  protected final String TEXT_78 = ".add(map_";
  protected final String TEXT_79 = "_";
  protected final String TEXT_80 = ");";
  protected final String TEXT_81 = NL + NL + "\t\tfor(java.util.Map<String, String> map_";
