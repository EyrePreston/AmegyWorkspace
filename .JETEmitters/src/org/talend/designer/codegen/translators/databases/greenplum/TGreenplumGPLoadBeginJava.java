...
public class TGreenplumGPLoadBeginJava {
  ...
  protected final String TEXT_66 = NL + "\tint deletedCount_";
  protected final String TEXT_67 = " = 0;" + NL + "\tint insertedCount_";
  protected final String TEXT_68 = " = 0;";
  protected final String TEXT_69 = NL + "\t\tboolean missConfiguration_";
  protected final String TEXT_70 = " = true;" + NL + "\t\tString missConfigurationMsg_";
  protected final String TEXT_71 = " = \"";
  protected final String TEXT_72 = "\";" + NL + "\t\tif (missConfiguration_";
  protected final String TEXT_73 = ") {" + NL + "\t\t\tthrow new java.lang.Exception(missConfigurationMsg_";
  ...
  protected final String TEXT_79 = ";" + NL + "\tString tableName4Load_";
  protected final String TEXT_80 = " = \"\\\"\" + tableName_";
  protected final String TEXT_81 = " + \"\\\"\";" + NL + "\tif(dbschema_";
  protected final String TEXT_82 = " != null && dbschema_";
  protected final String TEXT_83 = ".trim().length() > 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_84 = " = dbschema_";
  protected final String TEXT_85 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_86 = ";" + NL + "\t\ttableName4Load_";
  protected final String TEXT_87 = " = \"\\\"\"+dbschema_";
  protected final String TEXT_88 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_89 = "+\"\\\"\";" + NL + "\t}";
  protected final String TEXT_90 = NL + NL + "\t\tString driverClass_";
  protected final String TEXT_91 = " = \"org.postgresql.Driver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_114 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_120 = " - Drop table '\" + tableName_";
  protected final String TEXT_121 = " + \"' has succeeded.\" );" + NL + "\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_123 = " =  null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_133 = " - Create table '\" + tableName_";
  protected final String TEXT_134 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_135 = NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_136 = "){" + NL + "\t\t\t\t\tthrow new RuntimeException (\"Table '\" + tableName4Load_";
  protected final String TEXT_137 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_138 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_139 = " - Table '\" + tableName4Load_";
  protected final String TEXT_140 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_141 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_142 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_143 = " = null; " + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_147 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_153 = " - Create table '\" + tableName_";
  protected final String TEXT_154 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_155 = NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_156 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Table '\" + tableName4Load_";
  protected final String TEXT_157 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_159 = " - Table '\" + tableName4Load_";
  protected final String TEXT_160 = " + \"' already exists. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_161 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  ...
  protected final String TEXT_186 = ") && (schema_";
  protected final String TEXT_187 = ".equals(dbschema_";
  protected final String TEXT_188 = ") || ((dbschema_";
  protected final String TEXT_189 = "==null || dbschema_";
  protected final String TEXT_190 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_191 = ".equals(schema_";
  protected final String TEXT_192 = ")))) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_193 = " = true;" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_194 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_195 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_196 = " = null;" + NL + "\t\t\t\t\ttry{" + NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_197 = " = conn_";
  protected final String TEXT_198 = ".createStatement();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_199 = NL + "\t\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_200 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_206 = " - Create table '\" + tableName_";
  protected final String TEXT_207 = " + \"' has succeeded.\" );" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_208 = " " + NL + "\t\t\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_209 = "){" + NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName4Load_";
  protected final String TEXT_210 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_211 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_212 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_213 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_214 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}                ";
  protected final String TEXT_215 = NL + "                if(whetherExist_";
  protected final String TEXT_216 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_217 = " = null;" + NL + "                    try{" + NL + "                    \tstmtDrop_";
  ...
  protected final String TEXT_221 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_229 = NL + "                    }catch(java.sql.SQLException e){" + NL + "                    \tif(";
  protected final String TEXT_230 = "){" + NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to drop table '\" + tableName4Load_";
  protected final String TEXT_231 = "  + \"'. process terminated.\");" + NL + "                    \t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_232 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_233 = " - Failure to drop table '\" + tableName4Load_";
  protected final String TEXT_234 = " + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_235 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "                    \t}" + NL + "                    }" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_236 = " = null;" + NL + "                try{" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_248 = "           " + NL + "                }catch(java.sql.SQLException e){" + NL + "                \tif(";
  protected final String TEXT_249 = "){" + NL + "\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName4Load_";
  protected final String TEXT_250 = "  + \"'. process terminated.\");" + NL + "                \t}else{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_251 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_252 = " - Failure to create table '\" + tableName4Load_";
  protected final String TEXT_253 = " + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_254 = NL + "\t\t\t\t\t\t e.printStackTrace();" + NL + "                \t}" + NL + "                }";
  protected final String TEXT_255 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_256 = " = conn_";
  protected final String TEXT_257 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_258 = " = stmtClearCount_";
  ...
  protected final String TEXT_264 = " - Truncating table '\" + tableName_";
  ...
  protected final String TEXT_270 = " - Truncate table '\" + tableName_";
  protected final String TEXT_271 = " + \"' has succeeded.\" );" + NL + "\t\t\t";
  protected final String TEXT_272 = NL + "            while(rsClearCount_";
  protected final String TEXT_273 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_274 = " = rsClearCount_";
  protected final String TEXT_275 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_276 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_277 = " = null;" + NL + "            try{" + NL + "            \tstmtClear_";
  ...
  protected final String TEXT_281 = " - Clearing table '\" + tableName_";
  protected final String TEXT_282 = " + \"'.\");" + NL + "\t\t\t\t";
  protected final String TEXT_283 = NL + "            \tdeletedCount_";
  protected final String TEXT_284 = " = stmtClear_";
  protected final String TEXT_285 = ".executeUpdate(\"";
  protected final String TEXT_286 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_287 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_288 = "- Clear table '\" + tableName_";
  protected final String TEXT_289 = " +  \"' has succeeded.\" );" + NL + "\t\t\t\t";
  protected final String TEXT_290 = NL + "            \tstmtClear_";
  protected final String TEXT_291 = ".close();" + NL + "            }catch(java.sql.SQLException e){" + NL + "            \tif(";
  protected final String TEXT_292 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Failure to clear table '\" + tableName4Load_";
  protected final String TEXT_293 = "  + \"'. process terminated.\");" + NL + "            \t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_294 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_295 = " - Failure to clear table '\" + tableName4Load_";
  protected final String TEXT_296 = " + \"'. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_297 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "            \t}" + NL + "            }";
  protected final String TEXT_298 = NL;
  protected final String TEXT_299 = NL + "\t\tString delim_";
  protected final String TEXT_300 = " = ";
  protected final String TEXT_301 = ";" + NL + "\t\tString escape_";
  protected final String TEXT_302 = " = ";
  protected final String TEXT_303 = ";" + NL + "\t\tString quote_";
  protected final String TEXT_304 = " = ";
  protected final String TEXT_305 = ";" + NL + "\t\tdelim_";
  protected final String TEXT_306 = " = \"\\t\".equals(delim_";
  protected final String TEXT_307 = ") ? \"\\\\t\" : delim_";
  protected final String TEXT_308 = ";" + NL + "\t\t" + NL + "\t\tjava.io.PrintWriter gpctrl_";
  protected final String TEXT_309 = " = new java.io.PrintWriter(new java.io.FileOutputStream(";
  protected final String TEXT_310 = ", false), true);" + NL + "\t\tgpctrl_";
  protected final String TEXT_311 = ".println(\"---\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_312 = ".println(\"VERSION: 1.0.0.1\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_313 = ".println(\"DATABASE: \" + ";
  protected final String TEXT_314 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_315 = ".println(\"USER: \" + ";
  protected final String TEXT_316 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_317 = ".println(\"HOST: \" + ";
  protected final String TEXT_318 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_319 = ".println(\"PORT: \" + ";
  protected final String TEXT_320 = ");" + NL + "\t\tgpctrl_";
  protected final String TEXT_321 = ".println(\"GPLOAD:\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_322 = ".println(\"  INPUT:\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_323 = ".println(\"    - SOURCE:\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_324 = ".println(\"        FILE:\");" + NL + "\t\t";
  protected final String TEXT_325 = NL + "\t\tgpctrl_";
  protected final String TEXT_326 = ".println(\"          - \" + (new com.infobright.io.NamedPipeFactory()).getNativePipeName(";
  protected final String TEXT_327 = "));" + NL + "\t\t";
  protected final String TEXT_328 = NL + "\t\tgpctrl_";
  protected final String TEXT_329 = ".println(\"          - \" + ";
  protected final String TEXT_330 = ");" + NL + "\t\t";
  protected final String TEXT_331 = NL + "\t\tgpctrl_";
  protected final String TEXT_332 = ".println(\"    - DELIMITER: '\" + delim_";
  protected final String TEXT_333 = " + \"'\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_334 = ".println(\"    - ESCAPE: '\" + escape_";
  protected final String TEXT_335 = " + \"'\");" + NL + "\t\t";
  protected final String TEXT_336 = NL + "\t\tgpctrl_";
  protected final String TEXT_337 = ".println(\"    - FORMAT: csv\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_338 = ".println(\"    - QUOTE: '\" + quote_";
  protected final String TEXT_339 = " + \"'\");" + NL + "\t\t";
  protected final String TEXT_340 = NL + "\t\tgpctrl_";
  protected final String TEXT_341 = ".println(\"    - FORMAT: text\");" + NL + "\t\t";
  protected final String TEXT_342 = NL + "\t\t";
  protected final String TEXT_343 = NL + "\t\tgpctrl_";
  protected final String TEXT_344 = ".println(\"    - HEADER: true\");" + NL + "\t\t";
  protected final String TEXT_345 = NL + "\t\tgpctrl_";
  protected final String TEXT_346 = ".println(\"    - ENCODING: \" + ";
  protected final String TEXT_347 = ");" + NL + "\t\t";
  protected final String TEXT_348 = NL + "\t\t\t\tgpctrl_";
  protected final String TEXT_349 = ".println(\"    - ";
  protected final String TEXT_350 = ": \" + ";
  protected final String TEXT_351 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_352 = NL + "\t\tgpctrl_";
  protected final String TEXT_353 = ".println(\"  OUTPUT: \");" + NL + "\t\tgpctrl_";
  protected final String TEXT_354 = ".println(\"    - TABLE: '\" + tableName4Load_";
  protected final String TEXT_355 = "+\"'\");" + NL + "\t\tgpctrl_";
  protected final String TEXT_356 = ".println(\"    - MODE: ";
  protected final String TEXT_357 = "\");" + NL + "\t\t";
  protected final String TEXT_358 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_359 = ".println(\"    - MATCH_COLUMNS:\");" + NL + "\t\t\t";
  protected final String TEXT_360 = NL + "\t\t\t\t\tgpctrl_";
  protected final String TEXT_361 = ".println(\"      - ";
  protected final String TEXT_362 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_363 = NL + "\t\t\tgpctrl_";
  protected final String TEXT_364 = ".println(\"    - UPDATE_COLUMNS:\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_369 = ".println(\"    - UPDATE_CONDITION: \" + ";
  protected final String TEXT_370 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_371 = NL + "\t\tgpctrl_";
  protected final String TEXT_372 = ".close();" + NL + "\t\t";
  protected final String TEXT_373 = NL + NL + "\tfinal StringBuilder gploadOutput_";
  protected final String TEXT_374 = " = new StringBuilder(200);" + NL + "\tThread gploadThread_";
  protected final String TEXT_375 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tString[] envp = null;" + NL + "\t\t\t\tString[] cmds = new String[] {";
  protected final String TEXT_376 = ",";
  protected final String TEXT_377 = "};" + NL + "\t\t\t\tRuntime rt = Runtime.getRuntime();" + NL + "\t\t\t\tfinal Process ps = rt.exec(cmds, envp);" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getInputStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\twhile ((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tgploadOutput_";
  protected final String TEXT_378 = ".append(line);" + NL + "\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tcatch (java.lang.Exception e) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_379 = "_GPLOAD_ERROR\",e.getMessage());" + NL + "\t\t\t\tthrow new RuntimeException(e.getMessage(),e.getCause());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL;
  protected final String TEXT_380 = NL + "\t\tStringBuffer command_";
  protected final String TEXT_381 = " = new StringBuffer(";
  protected final String TEXT_382 = ");" + NL + "\t\t";
  protected final String TEXT_383 = NL + "\t\t\tcommand_";
  protected final String TEXT_384 = ".append(";
  protected final String TEXT_385 = " +\" \");" + NL + "\t\t";
  protected final String TEXT_386 = NL + "\t";
  protected final String TEXT_387 = NL + "\t\t\tcom.infobright.io.NamedPipe outputStream_";
  protected final String TEXT_388 = " = (new com.infobright.io.NamedPipeFactory()).createServer(";
  protected final String TEXT_389 = ", true, true, 1024000, 10000);" + NL + "\t\t\tgploadThread_";
  protected final String TEXT_390 = ".start();" + NL + "\t\t\t// in Windows wait for named pipe to get opened by gpload.exe" + NL + "\t\t\tif ((new com.infobright.io.NamedPipeFactory()).isWindowsMode()) { " + NL + "\t\t\t\tThread.sleep(10000);" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_391 = NL + "\t\t\tjava.io.BufferedOutputStream outputStream_";
  protected final String TEXT_392 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(";
  protected final String TEXT_393 = ",false), 1024000);" + NL + "\t\t";
  protected final String TEXT_394 = NL + "\t\t";
  protected final String TEXT_395 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_396 = " - Executing '\"+command_";
  protected final String TEXT_397 = ".toString()+\"'.\");" + NL + "\t\t";
  protected final String TEXT_398 = NL + "\tgploadThread_";
  protected final String TEXT_399 = ".start();" + NL + "\tgploadThread_";
  protected final String TEXT_400 = ".join(0);" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_401 = "_GPLOAD_OUTPUT\", gploadOutput_";
  protected final String TEXT_402 = ".toString());" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_403 = "_NB_LINE\", insertedCount_";
  protected final String TEXT_404 = ");" + NL + "\t\t";
  protected final String TEXT_405 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_406 = " - Execute '\"+command_";
  protected final String TEXT_407 = ".toString()+\"' has finished.\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_408 = " - Loaded records count:\" + insertedCount_";
