...
public class TSybaseOutputMainJava {
  ...
  protected final String TEXT_553 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_613 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_614 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_615 = NL + "    \t\t  batchSizeCounter_";
  ...
  protected final String TEXT_806 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  ...
  protected final String TEXT_811 = ";" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_841 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_876 = NL + "    \t\tpstmt_";
  protected final String TEXT_877 = ".addBatch();" + NL + "    \t\t\tnb_line_";
  ...
  protected final String TEXT_922 = " <= batchSizeCounter_";
  ...
  protected final String TEXT_960 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_961 = NL + "                }";
  protected final String TEXT_962 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  ...
  protected final String TEXT_968 = NL + "\t\t\t\t\t\tif ( batchSizeCounter_";
  ...
  protected final String TEXT_989 = NL + "\t                \tbatchSizeCounter_";
  protected final String TEXT_990 = " = 0;  " + NL + "\t                \t";
  ...
  protected final String TEXT_995 = NL + "\t                \tint countSum_";
  protected final String TEXT_996 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_997 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1010 = " " + NL + "                        System.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1011 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_1012 = NL + "                \t";
  protected final String TEXT_1013 = NL + "    \t        \tconn_";
  protected final String TEXT_1014 = ".commit();" + NL + "    \t\t\t\t";
  protected final String TEXT_1015 = "                " + NL + "                \tcommitCounter_";
  protected final String TEXT_1016 = "=0;" + NL + "                }\t";
