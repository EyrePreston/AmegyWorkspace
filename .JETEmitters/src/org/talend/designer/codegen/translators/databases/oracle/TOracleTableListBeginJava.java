...
public class TOracleTableListBeginJava
{
  ...
  protected final String TEXT_68 = NL + NL + "String whereClause_";
  protected final String TEXT_69 = " = ";
  protected final String TEXT_70 = ";" + NL + "" + NL + "String query_";
  protected final String TEXT_71 = " = \"\";" + NL + "" + NL + "if(whereClause_";
  protected final String TEXT_72 = " != null && whereClause_";
  protected final String TEXT_73 = ".length() > 0){" + NL + "" + NL + "\tquery_";
  protected final String TEXT_74 = " = \"SELECT tname FROM tab WHERE tabtype='TABLE' AND (\" + whereClause_";
  protected final String TEXT_75 = " + \") ORDER BY tname ASC\";" + NL + "" + NL + "}else{" + NL + "" + NL + "\tquery_";
  protected final String TEXT_76 = " = \"SELECT tname FROM tab WHERE tabtype='TABLE' ORDER BY tname ASC\";" + NL + "" + NL + "}";
  protected final String TEXT_77 = NL + "    log.info(\"";
  protected final String TEXT_78 = " - Query:'\"+query_";
  protected final String TEXT_79 = "+\"'.\");";
  protected final String TEXT_80 = NL + NL + "int nb_table_";
  protected final String TEXT_81 = " = 0;" + NL + "" + NL + "java.sql.Statement stmt2_";
  protected final String TEXT_82 = " = conn_";
  protected final String TEXT_83 = ".createStatement();" + NL + "" + NL + "java.sql.ResultSet rs_";
  protected final String TEXT_84 = " = stmt2_";
  protected final String TEXT_85 = ".executeQuery(query_";
  protected final String TEXT_86 = ");" + NL + "" + NL + "while (rs_";
  protected final String TEXT_87 = ".next()) {" + NL + "" + NL + "\tString currentTableName_";
  protected final String TEXT_88 = " = rs_";
  protected final String TEXT_89 = ".getString(1); " + NL + "" + NL + "\tnb_table_";
  protected final String TEXT_90 = "++;" + NL + "        " + NL + "\t";
  protected final String TEXT_91 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_92 = " - Retrieving the table \"+nb_table_";
  protected final String TEXT_93 = "+\".\");" + NL + "\t\tlog.trace(\"";
  protected final String TEXT_94 = " - Name of table \"+nb_table_";
  protected final String TEXT_95 = "+\":\"+currentTableName_";
  protected final String TEXT_96 = "+\".\");" + NL + "\t";
  protected final String TEXT_97 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_98 = "_CURRENT_TABLE\", currentTableName_";
