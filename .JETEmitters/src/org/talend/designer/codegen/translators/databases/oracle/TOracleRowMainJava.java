...
public class TOracleRowMainJava
{
  ...
  protected final String TEXT_67 = NL + "query_";
  protected final String TEXT_68 = " = ";
  protected final String TEXT_69 = ";" + NL + "whetherReject_";
  protected final String TEXT_70 = " = false;";
  protected final String TEXT_71 = NL + "globalMap.put(\"";
  protected final String TEXT_72 = "_QUERY\",query_";
  ...
  protected final String TEXT_80 = ", java.sql.Types.TIMESTAMP);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\telse{" + NL + "\t\t\t\t\tpstmt_";
  protected final String TEXT_81 = ".setTimestamp(";
  protected final String TEXT_82 = ",new java.sql.Timestamp(";
  protected final String TEXT_83 = ".getTime()));" + NL + "\t\t\t\t\t}";
  ...
  protected final String TEXT_91 = ".executeQuery();";
  ...
  protected final String TEXT_131 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t";
  protected final String TEXT_132 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_133 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_134 = NL + "\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_135 = NL + "\t}" + NL + "\t";
  protected final String TEXT_136 = NL + "\tif(!whetherReject_";
  protected final String TEXT_137 = ") {" + NL + "\t\t";
  protected final String TEXT_138 = NL + "\t\t\t\t\t";
  protected final String TEXT_139 = " = new ";
  protected final String TEXT_140 = "Struct();" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_151 = NL + "\t\tcommitCounter_";
  protected final String TEXT_152 = "++;" + NL + "\t\tif(commitEvery_";
  protected final String TEXT_153 = " <= commitCounter_";
  protected final String TEXT_154 = ") {" + NL + "\t\t\t";
  protected final String TEXT_155 = NL + "\t\t\tcommitCounter_";
  protected final String TEXT_156 = "=0;" + NL + "\t\t}" + NL + "\t\t";
