...
public class TDB2OutputMainJava {
  ...
  protected final String TEXT_374 = NL + "\t\t\t\tString update_";
  protected final String TEXT_375 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_376 = " + \"\\\" SET ";
  protected final String TEXT_377 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_386 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_442 = "\");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_443 = " = conn_";
  protected final String TEXT_444 = ".prepareStatement(insert_";
  protected final String TEXT_445 = ");" + NL + "\t    pstmtUpdate_";
  ...
  protected final String TEXT_505 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_506 = " = insert_";
  protected final String TEXT_507 = ".split(\"\\\\?\");";
  protected final String TEXT_508 = NL + "\t\t\tupdate_";
  protected final String TEXT_509 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_510 = " = update_";
  protected final String TEXT_511 = ".split(\"\\\\?\");";
  protected final String TEXT_512 = NL + "\t\t\tupdate_";
  protected final String TEXT_513 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_514 = " = update_";
  protected final String TEXT_515 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_516 = " = insert_";
  protected final String TEXT_517 = ".split(\"\\\\?\");";
  protected final String TEXT_518 = NL + "\t\t\tdelete_";
  protected final String TEXT_519 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_520 = " = delete_";
  protected final String TEXT_521 = ".split(\"\\\\?\");";
  protected final String TEXT_522 = NL + "\t\t\treplace_";
  protected final String TEXT_523 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_524 = " = replace_";
  protected final String TEXT_525 = ".split(\"\\\\?\");";
  protected final String TEXT_526 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_527 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_528 = " = insertIgnore_";
  ...
  protected final String TEXT_546 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_547 = ",";
  protected final String TEXT_548 = ".";
  protected final String TEXT_549 = ", ";
  protected final String TEXT_550 = ",insertSQLSplits_";
  ...
  protected final String TEXT_563 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_564 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  \t";
  protected final String TEXT_565 = NL + "\t\t  \t\t\tbatchSizeCounter_";
  protected final String TEXT_566 = "++;" + NL + "    \t\t  \t";
  protected final String TEXT_567 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_568 = NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_572 = ".executeUpdate();";
  protected final String TEXT_573 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_598 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_599 = ",";
  protected final String TEXT_600 = ".";
  protected final String TEXT_601 = ", ";
  protected final String TEXT_602 = ",updateSQLSplits_";
  protected final String TEXT_603 = ");";
  protected final String TEXT_604 = NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_639 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_640 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_641 = " = updatedCount_";
  protected final String TEXT_642 = " + pstmt_";
  protected final String TEXT_643 = ".executeUpdate();";
  protected final String TEXT_644 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_645 = " = true;";
  protected final String TEXT_646 = NL + "                    throw(e);";
  protected final String TEXT_647 = NL + "                        ";
  protected final String TEXT_648 = " = new ";
  protected final String TEXT_649 = "Struct();";
  protected final String TEXT_650 = NL + "                            ";
  protected final String TEXT_651 = ".";
  protected final String TEXT_652 = " = ";
  protected final String TEXT_653 = ".";
  protected final String TEXT_654 = ";";
  protected final String TEXT_655 = NL + "                        rejectedCount_";
  protected final String TEXT_656 = " = rejectedCount_";
  protected final String TEXT_657 = " + 1;";
  protected final String TEXT_658 = NL + "                        ";
  protected final String TEXT_659 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_660 = NL + "                        ";
  protected final String TEXT_661 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_662 = ";";
  protected final String TEXT_663 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_668 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_669 = " = pstmt_";
  protected final String TEXT_670 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_671 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_672 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_673 = " = rs_";
  protected final String TEXT_674 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_686 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  ...
  protected final String TEXT_713 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_714 = " = updatedCount_";
  protected final String TEXT_715 = " + pstmtUpdate_";
  protected final String TEXT_716 = ".executeUpdate(); " + NL + "                    nb_line_";
  protected final String TEXT_717 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_718 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_735 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_736 = NL + "                            ";
  protected final String TEXT_737 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_738 = ";";
  protected final String TEXT_739 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_745 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_746 = ",";
  protected final String TEXT_747 = ".";
  protected final String TEXT_748 = ", ";
  protected final String TEXT_749 = ",insertSQLSplits_";
  protected final String TEXT_750 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_751 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_752 = ".";
  protected final String TEXT_753 = ", pstmtInsert_";
  ...
  protected final String TEXT_760 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_761 = " = insertedCount_";
  protected final String TEXT_762 = " + pstmtInsert_";
  protected final String TEXT_763 = ".executeUpdate();" + NL + "                    nb_line_";
  ...
  protected final String TEXT_787 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_788 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_828 = NL + "    \t" + NL + "            try {" + NL + "                updateFlag_";
  ...
  protected final String TEXT_833 = ";" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_841 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_842 = ",";
  protected final String TEXT_843 = ".";
  protected final String TEXT_844 = ", ";
  protected final String TEXT_845 = ",insertSQLSplits_";
  ...
  protected final String TEXT_853 = NL + "                    globalMap.put(\"";
  protected final String TEXT_854 = "_QUERY\", query_";
  protected final String TEXT_855 = ".toString().trim());";
  protected final String TEXT_856 = NL + "                    insertedCount_";
  protected final String TEXT_857 = " = insertedCount_";
  protected final String TEXT_858 = " + pstmtInsert_";
  protected final String TEXT_859 = ".executeUpdate();" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_860 = "++;";
  protected final String TEXT_861 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_862 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_863 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_900 = NL + "        \t\tpstmt_";
  protected final String TEXT_901 = ".addBatch();" + NL + "    \t\t\tnb_line_";
  protected final String TEXT_902 = "++;" + NL + "    \t\t\t";
  protected final String TEXT_903 = NL + "        \t\t\tbatchSizeCounter_";
  protected final String TEXT_904 = "++;" + NL + "        \t\t";
  protected final String TEXT_905 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_906 = NL + "            try {" + NL + "            \tdeletedCount_";
  protected final String TEXT_907 = " = deletedCount_";
  ...
  protected final String TEXT_935 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_946 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_947 = " <= batchSizeCounter_";
  protected final String TEXT_948 = ") {                ";
  protected final String TEXT_949 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  ...
  protected final String TEXT_968 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_969 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_970 = NL + "                \tint countSum_";
  protected final String TEXT_971 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_972 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_985 = " " + NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_986 = NL + "                }";
  protected final String TEXT_987 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_988 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_989 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_990 = " <= commitCounter_";
  protected final String TEXT_991 = ") {" + NL + "                ";
  protected final String TEXT_992 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_993 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_994 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_995 = ": pstmt_";
  protected final String TEXT_996 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1010 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1011 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1012 = NL + "                \t\tint countSum_";
  protected final String TEXT_1013 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1014 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1027 = NL + "                        System.err.println(e.getMessage());" + NL + "                \t";
