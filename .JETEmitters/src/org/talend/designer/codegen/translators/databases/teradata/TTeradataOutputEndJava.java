...
public class TTeradataOutputEndJava
{
  ...
  protected final String TEXT_55 = NL + "\t\t\t\t\t\tif ( batchSizeCounter_";
  protected final String TEXT_56 = " > 0 ) { // do not commit empty batch, this is a jdbc error" + NL + "\t\t\t\t\t";
  protected final String TEXT_57 = NL + "\t\t\t\t\t\tif ( commitCounter_";
  protected final String TEXT_58 = " > 0 ) { // do not commit empty batch, this is a jdbc error" + NL + "\t\t\t\t\t";
  protected final String TEXT_59 = NL + "\t\t\t\t\t\tif (pstmt_";
  protected final String TEXT_60 = " !=null) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_61 = NL + "            \t    \tint countSum_";
  ...
  protected final String TEXT_79 = NL + "            \t    \t" + NL + "\t\t\t\t\t\t}" + NL + "                //}catch (java.sql.BatchUpdateException e){" + NL + "\t\t\t\t}catch (java.sql.SQLException e){" + NL + "\t\t\t\t\t";
  protected final String TEXT_80 = NL + "\t\t\t\t\tjava.sql.SQLException e2 = e;" + NL + "\t\t\t\t\twhile (e2 != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_81 = NL + "\t\t\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t\t\t\te2 = e2.getNextException();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_82 = NL + "\t\t\tjava.sql.SQLException e3 = e;" + NL + "                \tboolean isFailure = false;" + NL + "                \tint errorCode = 0;" + NL + "\t\t\tString sqlState = \"\";" + NL + "\t\t\tString message = \"\";" + NL + "\t\t\twhile(e != null){" + NL + "\t\t\t\tif(e.getErrorCode() == -2801){" + NL + "\t\t\t\t\tSystem.out.println(\"[Message]: \" + e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_83 = NL + "\t\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t\tSystem.out.println();" + NL + "\t\t\t\t}" + NL + "\t\t\t\telse if(e.getErrorCode() == 1339){" + NL + "\t\t\t\t\tisFailure = true;" + NL + "\t\t\t\t} else{" + NL + "\t\t\t\t\tSystem.out.println(\"[Message]: \" + e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_84 = NL + "\t\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t\te = e.getNextException();" + NL + "\t\t\t}" + NL + "\t\t\tif(isFailure && e != null){" + NL + "\t\t\t\tSystem.out.println(\"[Message]: \" + e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_85 = NL + "\t\t\t\te.printStackTrace();" + NL + "\t\t\t}" + NL + "                \t";
  protected final String TEXT_86 = NL + "\t\t\t\tthrow(e3);" + NL + "                \t";
  protected final String TEXT_87 = NL + "\t\t\t\tSystem.err.println(e3.getMessage());" + NL + "                \t";
  ...
  protected final String TEXT_101 = ".setAutoCommit(true);    " + NL + "    try{" + NL + "         conn_";
  protected final String TEXT_102 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");       " + NL + "         conn_";
  protected final String TEXT_103 = ".createStatement().execute(\"END QUERY LOGGING ON ALL\");        " + NL + "     }catch(Exception e){";
  protected final String TEXT_104 = NL + "         System.err.println(e.getMessage());" + NL + "     }";
  protected final String TEXT_105 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_106 = NL + "\t    conn_";
  protected final String TEXT_107 = ".close();" + NL + "\t    ";
  protected final String TEXT_108 = NL + "\t    " + NL + "\t\tresourceMap.put(\"finish_";
