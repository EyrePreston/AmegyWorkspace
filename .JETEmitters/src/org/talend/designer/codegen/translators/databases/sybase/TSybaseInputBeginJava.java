...
public class TSybaseInputBeginJava
{
  ...
  protected final String TEXT_180 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_210 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_211 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  ...
  protected final String TEXT_252 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_264 = ".getColumnTypeName(i));";
  protected final String TEXT_265 = NL + "                \tdcm_";
  protected final String TEXT_266 = ".setFormat(";
  protected final String TEXT_267 = ");";
  protected final String TEXT_268 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_269 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_270 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_271 = ".setLength(rsmd_";
  protected final String TEXT_272 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_273 = ".setLength(rsmd_";
  protected final String TEXT_274 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_275 = NL + "\t\t\tdcm_";
  protected final String TEXT_276 = ".setLength(rsmd_";
  protected final String TEXT_277 = ".getPrecision(i));";
  protected final String TEXT_278 = NL + "                \tdcm_";
  protected final String TEXT_279 = ".setPrecision(rsmd_";
  protected final String TEXT_280 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_281 = ".setNullable(rsmd_";
  protected final String TEXT_282 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_283 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_284 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_285 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_286 = ".metadatas.add(dcm_";
  protected final String TEXT_287 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_288 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_289 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_290 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_291 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_292 = NL + "\t\t    ";
  protected final String TEXT_293 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_294 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_295 = NL + "\t\t    while (rs_";
  protected final String TEXT_296 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_297 = "++;" + NL + "\t\t        ";
  protected final String TEXT_298 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_299 = " = ";
  protected final String TEXT_300 = " + dcg_";
  protected final String TEXT_301 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_302 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_303 = " = ";
  protected final String TEXT_304 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_305 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_306 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_318 = " = (List)rs_";
  protected final String TEXT_319 = ".getObject(";
  ...
  protected final String TEXT_345 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_346 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_368 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_369 = ".";
  protected final String TEXT_370 = ", rs_";
  protected final String TEXT_371 = ", fixedColumnCount_";
  protected final String TEXT_372 = ");";
  protected final String TEXT_373 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_374 = ".";
  protected final String TEXT_375 = ", rs_";
  protected final String TEXT_376 = ", fixedColumnCount_";
  protected final String TEXT_377 = ");";
  protected final String TEXT_378 = NL + "                                  Object geom = rs_";
  protected final String TEXT_379 = ".getObject(";
  protected final String TEXT_380 = "column_index_";
  protected final String TEXT_381 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o = " + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_382 = ".";
  protected final String TEXT_383 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_390 = " - Retrieving the record \" + nb_line_";
