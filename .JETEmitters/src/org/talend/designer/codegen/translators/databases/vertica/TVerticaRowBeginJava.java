...
public class TVerticaRowBeginJava
{
  ...
  protected final String TEXT_117 = " = \"jdbc:vertica://\"+";
  ...
  protected final String TEXT_127 = NL + "\t\t\t\tint nb_line_inserted_";
  protected final String TEXT_128 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_129 = NL + "\t\t\t\tint nb_line_update_";
  protected final String TEXT_130 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_131 = NL + "\t\t\t\tint nb_line_deleted_";
