...
public class TCreateTableMainJava
{
  ...
  protected final String TEXT_68 = NL + "            java.sql.Statement stmt_";
  ...
  protected final String TEXT_72 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_78 = " - Create table '\" + tableName_";
  protected final String TEXT_79 = " + \"' has succeeded.\");";
  protected final String TEXT_80 = NL + "            ";
  protected final String TEXT_81 = NL + "            boolean whetherExist_";
  ...
  protected final String TEXT_86 = ".getMetaData();" + NL + "\t            if(tableNameForSearch_";
  protected final String TEXT_87 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_88 = " = tableNameForSearch_";
  protected final String TEXT_89 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableNameForSearch_";
  protected final String TEXT_90 = " = tableNameForSearch_";
  protected final String TEXT_91 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_95 = ", new String[]{\"TABLE\"});" + NL + "\t            if(rsTable_";
  ...
  protected final String TEXT_100 = ".getMetaData();" + NL + "                java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_119 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }";
  ...
  protected final String TEXT_124 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                String defaultSchema_";
  protected final String TEXT_125 = " = \"public\";" + NL + "                if(dbSchema_";
  protected final String TEXT_126 = " == null || dbSchema_";
  protected final String TEXT_127 = ".trim().length() == 0) {" + NL + "                \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_128 = " = conn_";
  protected final String TEXT_129 = ".createStatement();" + NL + "                \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_130 = " = stmtSchema_";
  protected final String TEXT_131 = ".executeQuery(\"select current_schema() \");" + NL + "                \twhile(rsSchema_";
  protected final String TEXT_132 = ".next()){" + NL + "                                defaultSchema_";
  protected final String TEXT_133 = " = rsSchema_";
  protected final String TEXT_134 = ".getString(\"current_schema\");" + NL + "                \t}" + NL + "                \trsSchema_";
  protected final String TEXT_135 = ".close();" + NL + "                \tstmtSchema_";
  protected final String TEXT_136 = ".close();" + NL + "                }" + NL + "                while(rsTable_";
  ...
  protected final String TEXT_154 = "(schema_";
  protected final String TEXT_155 = ")))) {" + NL + "                        whetherExist_";
  protected final String TEXT_156 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }";
  protected final String TEXT_157 = NL + "                java.sql.Statement rsTable_";
  protected final String TEXT_158 = " = conn_";
  protected final String TEXT_159 = ".createStatement();" + NL + "                try {" + NL + "                    rsTable_";
  protected final String TEXT_160 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_161 = " + \"]\" );" + NL + "                    whetherExist_";
  protected final String TEXT_162 = " = true;" + NL + "                } catch (Exception e){" + NL + "                    whetherExist_";
  ...
  protected final String TEXT_196 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }     ";
  protected final String TEXT_197 = NL + "            rsTable_";
  protected final String TEXT_198 = ".close();";
  protected final String TEXT_199 = NL + "                if(!whetherExist_";
  protected final String TEXT_200 = ") {" + NL + "                    java.sql.Statement stmt_";
  ...
  protected final String TEXT_211 = " + \"' has succeeded.\");";
  ...
  protected final String TEXT_219 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_225 = " - Drop table '\" + tableName_";
  protected final String TEXT_226 = " + \"' has succeeded.\");";
  protected final String TEXT_227 = NL + "                }" + NL + "                java.sql.Statement stmt_";
  ...
  protected final String TEXT_231 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_237 = " - Create table '\" + tableName_";
  protected final String TEXT_238 = " + \"' has succeeded.\");";
  protected final String TEXT_239 = NL + "\t            ";
  protected final String TEXT_240 = NL + "        ";
  protected final String TEXT_241 = NL + "        globalMap.put(\"";
  protected final String TEXT_242 = "_QUERY\", \"";
  protected final String TEXT_243 = "\");        " + NL + "    } catch(java.lang.Exception e) {" + NL + "        globalMap.put(\"";
  protected final String TEXT_244 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "        throw new RuntimeException(\"Creating table failed\", e);" + NL + "    }";
