...
public class TGreenplumBulkExecBeginJava {
  ...
  protected final String TEXT_69 = " = (String)globalMap.get(\"schema_\" + \"";
  protected final String TEXT_70 = "\");";
  protected final String TEXT_71 = NL + "\tdbschema_";
  protected final String TEXT_72 = " = ";
  protected final String TEXT_73 = ";";
  protected final String TEXT_74 = NL + "if(dbschema_";
  ...
  protected final String TEXT_82 = NL + "    String tmpTableName_";
  protected final String TEXT_83 = " = \"tmp_";
  protected final String TEXT_84 = "_\" + pid + Thread.currentThread().getId();";
  protected final String TEXT_85 = NL + "String bulkSQL_";
  protected final String TEXT_86 = " = \"COPY \\\"\" + ";
  protected final String TEXT_87 = "tmpTableName_";
  protected final String TEXT_88 = "tableName_";
  protected final String TEXT_89 = " ";
  protected final String TEXT_90 = " + \"\\\" ";
  protected final String TEXT_91 = "FROM '\" + ";
  protected final String TEXT_92 = " + \"' WITH \";";
  protected final String TEXT_93 = NL + "    bulkSQL_";
  protected final String TEXT_94 = " += \"BINARY ";
  protected final String TEXT_95 = "\";";
  protected final String TEXT_96 = NL + "    Character field_separator_";
  protected final String TEXT_97 = " = (";
  protected final String TEXT_98 = ").charAt(0);" + NL + "    bulkSQL_";
  protected final String TEXT_99 = " += \"";
  protected final String TEXT_100 = " \" + \"DELIMITER AS '\" + field_separator_";
  protected final String TEXT_101 = " + \"' \";" + NL + "    bulkSQL_";
  protected final String TEXT_102 = " += \"NULL AS '\" + ";
  protected final String TEXT_103 = " + \"' \";";
  protected final String TEXT_104 = NL + "        Character text_enclosure_";
  protected final String TEXT_105 = " = (";
  protected final String TEXT_106 = ").charAt(0);" + NL + "        bulkSQL_";
  protected final String TEXT_107 = " += \"CSV ";
  protected final String TEXT_108 = " QUOTE AS '\" + text_enclosure_";
  protected final String TEXT_109 = ".toString().replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "        bulkSQL_";
  protected final String TEXT_110 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_111 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "        bulkSQL_";
  ...
  protected final String TEXT_119 = NL + "\tString driverClass_";
  protected final String TEXT_120 = " = \"org.postgresql.Driver\";" + NL + "\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_121 = ").newInstance();" + NL + "\tString url_";
  ...
  protected final String TEXT_143 = " - Droping table ";
  ...
  protected final String TEXT_151 = " - Drop table ";
  ...
  protected final String TEXT_156 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_160 = " - Creating table ";
  ...
  protected final String TEXT_168 = " - Create table ";
  ...
  protected final String TEXT_178 = " - Creating table ";
  ...
  protected final String TEXT_187 = "\" + tableName_";
  ...
  protected final String TEXT_195 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_196 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_197 = " = tableNameForSearch_";
  protected final String TEXT_198 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_199 = " = tableNameForSearch_";
  protected final String TEXT_200 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_201 = " = dbMetaData_";
  protected final String TEXT_202 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_203 = ", tableNameForSearch_";
  protected final String TEXT_204 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_205 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_206 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_207 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_220 = ".equalsIgnoreCase(";
  protected final String TEXT_221 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_222 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_235 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_239 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_240 = ".equals(schema_";
  protected final String TEXT_241 = ") || (schema_";
  protected final String TEXT_242 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_243 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_408 = ";" + NL + "\t        if(keyCount_";
  protected final String TEXT_409 = " == 0) {" + NL + "\t            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "\t        }" + NL + "\t        tmpTableName_";
  protected final String TEXT_410 = " = tableName_";
  protected final String TEXT_411 = ";" + NL + "\t        tableName_";
  protected final String TEXT_412 = " = \"tmp_";
  protected final String TEXT_413 = "_\" + pid + Thread.currentThread().getId();" + NL + "\t        java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_417 = " - Creating temp table ";
  protected final String TEXT_418 = "\" + tableName_";
  protected final String TEXT_419 = " + \"";
  protected final String TEXT_420 = ".\" );" + NL + "\t\t\t";
  protected final String TEXT_421 = NL + "\t        stmtCreateTmp_";
  protected final String TEXT_422 = ".execute(\"";
  protected final String TEXT_423 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_424 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_425 = " - Create temp table ";
  protected final String TEXT_426 = "\" + tableName_";
  protected final String TEXT_427 = " + \"";
  protected final String TEXT_428 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_429 = NL + "\t        stmtCreateTmp_";
  protected final String TEXT_430 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_431 = NL + "\t\t\t";
  protected final String TEXT_432 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_433 = " - Bulk inserting data into ";
  protected final String TEXT_434 = "\" + tableName_";
  protected final String TEXT_435 = " + \"";
  protected final String TEXT_436 = ".\" );" + NL + "\t\t\t";
  protected final String TEXT_437 = NL + "\t        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_438 = " = conn_";
  protected final String TEXT_439 = ".createStatement();" + NL + "\t        stmtTmpBulk_";
  protected final String TEXT_440 = ".execute(bulkSQL_";
  protected final String TEXT_441 = ");" + NL + "\t        stmtTmpBulk_";
  protected final String TEXT_442 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_443 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_444 = " - Bulk insert data into ";
  protected final String TEXT_445 = "\" + tableName_";
  protected final String TEXT_446 = " + \"";
  protected final String TEXT_447 = " has finished.\");" + NL + "\t\t\t";
  protected final String TEXT_448 = NL + "\t        tableName_";
  protected final String TEXT_449 = " = tmpTableName_";
  protected final String TEXT_450 = ";" + NL + "\t        tmpTableName_";
  protected final String TEXT_451 = " = \"tmp_";
  protected final String TEXT_452 = "_\" + pid + Thread.currentThread().getId();" + NL + "\t        java.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_456 = " - Updating ";
  protected final String TEXT_457 = "\" + tableName_";
  protected final String TEXT_458 = " + \"";
  protected final String TEXT_459 = " from ";
  protected final String TEXT_460 = "\"+tmpTableName_";
  protected final String TEXT_461 = "+\"";
  protected final String TEXT_462 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_463 = NL + "\t        stmtUpdateBulk_";
  protected final String TEXT_464 = ".executeUpdate(\"";
  protected final String TEXT_465 = "\");" + NL + "\t\t\t";
  protected final String TEXT_466 = NL + "\t        stmtUpdateBulk_";
  protected final String TEXT_467 = ".close();" + NL + "\t        tableName_";
  protected final String TEXT_468 = " = tmpTableName_";
  protected final String TEXT_469 = ";" + NL + "\t        java.sql.Statement stmtTmpDrop_";
