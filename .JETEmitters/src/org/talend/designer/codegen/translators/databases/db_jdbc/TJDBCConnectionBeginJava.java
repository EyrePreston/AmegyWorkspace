...
public class TJDBCConnectionBeginJava
{
  ...
  protected final String TEXT_103 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\tlog.info(\"";
  ...
  protected final String TEXT_106 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_138 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_151 = ");" + NL + "\tglobalMap.put(\"url_";
  protected final String TEXT_152 = "\", url_";
  protected final String TEXT_153 = ");" + NL + "\t//globalMap.put(\"user_";
  protected final String TEXT_154 = "\", dbUser_";
  protected final String TEXT_155 = ");" + NL + "\t//globalMap.put(\"pass_";
