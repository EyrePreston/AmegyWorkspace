...
public class TSasOutputMainJava {
  ...
  protected final String TEXT_56 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_57 = " = insertedCount_";
  ...
  protected final String TEXT_72 = NL + "                        nb_line_rejected_";
  protected final String TEXT_73 = "++;";
  protected final String TEXT_74 = NL + "                        ";
  protected final String TEXT_75 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_76 = NL + "                        ";
  protected final String TEXT_77 = ".errorMessage = e.getMessage();";
  ...
  protected final String TEXT_89 = "_QUERY\", query_";
  protected final String TEXT_90 = ".toString().trim());";
  protected final String TEXT_91 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_92 = " = updatedCount_";
  protected final String TEXT_93 = " + pstmt_";
  protected final String TEXT_94 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_95 = "++;" + NL + "        \t    ";
  protected final String TEXT_96 = "                " + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_112 = ".errorMessage = e.getMessage();";
  ...
  protected final String TEXT_118 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_119 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_120 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_121 = " = rs_";
  protected final String TEXT_122 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_135 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_136 = " = updatedCount_";
  protected final String TEXT_137 = " + pstmtUpdate_";
  protected final String TEXT_138 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_139 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_140 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_156 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_157 = NL + "                            ";
  protected final String TEXT_158 = ".errorMessage = e.getMessage();";
  protected final String TEXT_159 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_160 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_168 = NL + "                try {" + NL + "                    insertedCount_";
  ...
  protected final String TEXT_191 = ".errorMessage = e.getMessage();";
  ...
  protected final String TEXT_207 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_208 = " = pstmtUpdate_";
  protected final String TEXT_209 = ".executeUpdate();" + NL + "                if(updateFlag_";
  protected final String TEXT_210 = " != 0) {" + NL + "            \t\tnb_line_";
  protected final String TEXT_211 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_212 = NL + "                }" + NL + "                updatedCount_";
  protected final String TEXT_213 = " = updatedCount_";
  protected final String TEXT_214 = " + updateFlag_";
  protected final String TEXT_215 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_226 = NL + "                        nb_line_rejected_";
  protected final String TEXT_227 = "++;";
  protected final String TEXT_228 = NL + "                        ";
  protected final String TEXT_229 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_230 = NL + "                        ";
  protected final String TEXT_231 = ".errorMessage = e.getMessage();";
  protected final String TEXT_232 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_233 = NL + "            }" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_244 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_245 = " = insertedCount_";
  protected final String TEXT_246 = " + pstmtInsert_";
  protected final String TEXT_247 = ".executeUpdate();" + NL + "                    nb_line_";
  ...
  protected final String TEXT_252 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_262 = NL + "                            nb_line_rejected_";
  protected final String TEXT_263 = "++;";
  protected final String TEXT_264 = NL + "                            ";
  protected final String TEXT_265 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_266 = NL + "                            ";
  protected final String TEXT_267 = ".errorMessage = e.getMessage();";
  ...
  protected final String TEXT_300 = ".errorMessage = e.getMessage();";
  protected final String TEXT_301 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_302 = NL + "            }";
  protected final String TEXT_303 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_314 = NL + "                commitCounter_";
  protected final String TEXT_315 = "++;            " + NL + "                if (commitEvery_";
  protected final String TEXT_316 = " <= commitCounter_";
  protected final String TEXT_317 = ") {" + NL + "    \t\t\t\t";
  protected final String TEXT_318 = NL + "                    connection_";
  protected final String TEXT_319 = ".commit();";
