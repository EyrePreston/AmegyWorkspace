...
public class TGreenplumOutputMainJava {
  ...
  protected final String TEXT_48 = NL + "        whetherReject_";
  protected final String TEXT_49 = " = false;";
  protected final String TEXT_50 = NL + "                    ";
  protected final String TEXT_51 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_52 = " = insertedCount_";
  protected final String TEXT_53 = " + pstmt_";
  protected final String TEXT_54 = ".executeUpdate();" + NL + "                nb_line_";
  ...
  protected final String TEXT_101 = NL + "                        rejectedCount_";
  ...
  protected final String TEXT_133 = " + pstmtUpdate_";
  protected final String TEXT_134 = ".executeUpdate();" + NL + "                    nb_line_";
  ...
  protected final String TEXT_138 = NL + "                        throw(e);";
  ...
  protected final String TEXT_149 = NL + "                            rejectedCount_";
  protected final String TEXT_150 = " =  rejectedCount_";
  protected final String TEXT_151 = " + 1;";
  protected final String TEXT_152 = NL + "                            ";
  protected final String TEXT_153 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_154 = NL + "                            ";
  protected final String TEXT_155 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_156 = ";";
  protected final String TEXT_157 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_188 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_198 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_199 = "=pstmtUpdate_";
  protected final String TEXT_200 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_201 = " = updatedCount_";
  protected final String TEXT_202 = "+updateFlag_";
  protected final String TEXT_203 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_204 = " == 0) {";
  protected final String TEXT_205 = NL + "                        ";
  protected final String TEXT_206 = NL + "                    insertedCount_";
  ...
  protected final String TEXT_211 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_212 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_213 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_245 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_246 = "++;";
  protected final String TEXT_247 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_270 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_281 = NL + "                commitCounter_";
  protected final String TEXT_282 = "++;" + NL + "        " + NL + "                if(commitEvery_";
  protected final String TEXT_283 = "<=commitCounter_";
  protected final String TEXT_284 = ") {" + NL + "                \t";
  protected final String TEXT_285 = NL + "\t\t        \tconn_";
  protected final String TEXT_286 = ".commit();" + NL + "\t\t        \t";
  protected final String TEXT_287 = "                " + NL + "                    commitCounter_";
