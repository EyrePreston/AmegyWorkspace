...
public class TJavaDBInputBeginJava
{
  ...
  protected final String TEXT_178 = NL + "\t\t\t\t//set the root path of the database" + NL + "\t\t\t\tSystem.setProperty(\"derby.system.home\", ";
  protected final String TEXT_179 = ");";
  protected final String TEXT_180 = NL + "        \t\t\torg.apache.derby.drda.NetworkServerControl serverControl_";
  protected final String TEXT_181 = ";" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_182 = " = new org.apache.derby.drda.NetworkServerControl(java.net.InetAddress.getByName(";
  protected final String TEXT_183 = "),Integer.parseInt(";
  protected final String TEXT_184 = "));" + NL + "        \t\t\t//start server" + NL + "        \t\t\tserverControl_";
  protected final String TEXT_185 = ".start(new java.io.PrintWriter(System.out,true));" + NL + "        \t\t\tboolean isServerUp_";
  protected final String TEXT_186 = " = false;" + NL + "        \t\t\tint timeOut_";
  protected final String TEXT_187 = " = 5;" + NL + "        \t\t\twhile(!isServerUp_";
  protected final String TEXT_188 = " && timeOut_";
  protected final String TEXT_189 = " > 0) {" + NL + "        \t\t\t\ttry {" + NL + "            \t\t\t\ttimeOut_";
  protected final String TEXT_190 = "--;" + NL + "            \t\t\t\t/*" + NL + "    \t\t\t\t\t\t* testing for connection to see if the network server is up and running." + NL + "    \t\t\t\t\t\t* if server is not ready yet, this method will throw an exception.\t\t" + NL + "    \t\t\t\t\t\t*/" + NL + "            \t\t\t\tserverControl_";
  protected final String TEXT_191 = ".ping();" + NL + "            \t\t\t\tisServerUp_";
  protected final String TEXT_192 = " = true;" + NL + "        \t\t\t\t} catch(java.lang.Exception e) {" + NL + "    \t\t\t\t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\t\t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t\t\t\t}    \t\t\t\t" + NL + "        \t\t\t}" + NL + "        \t\t\tif(!isServerUp_";
  protected final String TEXT_193 = ") {" + NL + "        \t\t\t\t/*" + NL + "    \t\t\t\t\t * can not obtain a connection to network server." + NL + "    \t\t\t\t\t */ \t " + NL + "        \t\t\t\tthrow new java.lang.Exception(\"Can not obtain a connection to network server\");" + NL + "        \t\t\t}" + NL + "        \t\t\t//derby network server started.";
  protected final String TEXT_194 = NL + "\t\t\t\tString url_";
  protected final String TEXT_195 = " = \"jdbc:derby:\" + ";
  protected final String TEXT_196 = ";";
  protected final String TEXT_197 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_198 = " = \"jdbc:derby:net://\" + ";
  protected final String TEXT_199 = " + \":\" + ";
  protected final String TEXT_200 = " + \"/\" + ";
  protected final String TEXT_201 = ";";
  protected final String TEXT_202 = NL + "    \t\t\t\tString url_";
  protected final String TEXT_203 = " = \"jdbc:derby://\" + ";
  protected final String TEXT_204 = " + \":\" + ";
  protected final String TEXT_205 = " + \"/\" + ";
  protected final String TEXT_206 = ";";
  protected final String TEXT_207 = NL + "\t\t\t    String driverClass_";
  protected final String TEXT_208 = " = \"";
  protected final String TEXT_209 = "\";" + NL + "\t\t\t    java.lang.Class.forName(driverClass_";
  protected final String TEXT_210 = ").newInstance();" + NL + "\t\t\t\t";
  protected final String TEXT_211 = NL + "\t\t        String dbUser_";
  ...
  protected final String TEXT_221 = NL + NL + "\t\t        String dbPwd_";
  protected final String TEXT_222 = " = decryptedPassword_";
  ...
  protected final String TEXT_244 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_245 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
