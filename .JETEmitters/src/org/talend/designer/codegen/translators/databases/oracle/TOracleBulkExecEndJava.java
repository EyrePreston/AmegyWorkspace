...
public class TOracleBulkExecEndJava {
  ...
  protected final String TEXT_65 = NL + "        tableName_";
  protected final String TEXT_66 = " = tmpTableName_";
  protected final String TEXT_67 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_68 = " = \"t_";
  protected final String TEXT_69 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        java.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_73 = " - Updating ";
  protected final String TEXT_74 = "\" + tableName_";
  protected final String TEXT_75 = " + \"";
  protected final String TEXT_76 = " from ";
  protected final String TEXT_77 = "\"+tmpTableName_";
  protected final String TEXT_78 = "+\"";
  protected final String TEXT_79 = ".\");";
  protected final String TEXT_80 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_81 = ".executeUpdate(\"";
  protected final String TEXT_82 = "\");";
  protected final String TEXT_83 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_84 = ".close();" + NL + "    }finally{" + NL + "        tableName_";
  protected final String TEXT_85 = " = \"t_";
  protected final String TEXT_86 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        java.sql.Statement stmtTmpDrop_";
  ...
  protected final String TEXT_90 = " - Droping table ";
  protected final String TEXT_91 = "\" + tableName_";
  protected final String TEXT_92 = " + \"";
  protected final String TEXT_93 = ".\");";
  protected final String TEXT_94 = NL + "        stmtTmpDrop_";
  protected final String TEXT_95 = ".execute(\"";
  protected final String TEXT_96 = "\");";
  protected final String TEXT_97 = NL + "            log.info(\"";
  protected final String TEXT_98 = " - Drop table ";
  protected final String TEXT_99 = "\" + tableName_";
  protected final String TEXT_100 = " + \"";
  protected final String TEXT_101 = " has succeeded.\");";
  protected final String TEXT_102 = NL + "        stmtTmpDrop_";
  protected final String TEXT_103 = ".close();         " + NL + "    }";
  protected final String TEXT_104 = NL;
  protected final String TEXT_105 = NL + "    if(conn_";
  protected final String TEXT_106 = " != null && !conn_";
  protected final String TEXT_107 = ".isClosed()) {";
