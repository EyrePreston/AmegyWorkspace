...
public class TInterbaseInputBeginJava
{
  ...
  protected final String TEXT_179 = " = \"jdbc:interbase://\" + ";
  ...
  protected final String TEXT_202 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_203 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  ...
  protected final String TEXT_244 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_245 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_246 = ".setName(rsmd_";
  protected final String TEXT_247 = ".getColumnName(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_256 = ".getColumnTypeName(i));";
  protected final String TEXT_257 = NL + "                \tdcm_";
  protected final String TEXT_258 = ".setFormat(";
  protected final String TEXT_259 = ");";
  protected final String TEXT_260 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_261 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_262 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_263 = ".setLength(rsmd_";
  protected final String TEXT_264 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_265 = ".setLength(rsmd_";
  protected final String TEXT_266 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_267 = NL + "\t\t\tdcm_";
  protected final String TEXT_268 = ".setLength(rsmd_";
  protected final String TEXT_269 = ".getPrecision(i));";
  protected final String TEXT_270 = NL + "                \tdcm_";
  protected final String TEXT_271 = ".setPrecision(rsmd_";
  protected final String TEXT_272 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_273 = ".setNullable(rsmd_";
  protected final String TEXT_274 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_275 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_276 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_277 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_278 = ".metadatas.add(dcm_";
  protected final String TEXT_279 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_280 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_281 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_282 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_283 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_284 = NL + "\t\t    ";
  protected final String TEXT_285 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_286 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_287 = NL + "\t\t    while (rs_";
  protected final String TEXT_288 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_289 = "++;" + NL + "\t\t        ";
  protected final String TEXT_290 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_291 = " = ";
  protected final String TEXT_292 = " + dcg_";
  protected final String TEXT_293 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_294 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_295 = " = ";
  protected final String TEXT_296 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_297 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_298 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_310 = " = (List)rs_";
  protected final String TEXT_311 = ".getObject(";
  protected final String TEXT_312 = "column_index_";
  protected final String TEXT_313 = ");";
  protected final String TEXT_314 = NL + "\t\t                         ";
  protected final String TEXT_315 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_316 = ".getObject(";
  protected final String TEXT_317 = "column_index_";
  protected final String TEXT_318 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_319 = NL + "                                    ";
  protected final String TEXT_320 = ".";
  protected final String TEXT_321 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_330 = ".setEPSG(";
  ...
  protected final String TEXT_337 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_338 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_339 = " = ";
  protected final String TEXT_340 = "; i_";
  protected final String TEXT_341 = "  <= rsmd_";
  protected final String TEXT_342 = ".getColumnCount(); i_";
  protected final String TEXT_343 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_344 = ".getColumnTypeName(i_";
  protected final String TEXT_345 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_346 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_347 = ".getClob(i_";
  protected final String TEXT_348 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_349 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_350 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_351 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_352 = ".add(tNTextImpl_";
  protected final String TEXT_353 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_354 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_355 = ".";
  protected final String TEXT_356 = ", rs_";
  protected final String TEXT_357 = ", fixedColumnCount_";
  protected final String TEXT_358 = ",list_";
  protected final String TEXT_359 = ");";
  protected final String TEXT_360 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_361 = ".";
  protected final String TEXT_362 = ", rs_";
  protected final String TEXT_363 = ", fixedColumnCount_";
  ...
  protected final String TEXT_370 = NL + "                                  Object geom = rs_";
  protected final String TEXT_371 = ".getObject(";
  protected final String TEXT_372 = "column_index_";
  protected final String TEXT_373 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o = " + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_374 = ".";
  protected final String TEXT_375 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_382 = " - Retrieving the record \" + nb_line_";
