...
public class TFirebirdInputBeginJava
{
  ...
  protected final String TEXT_179 = " =\"jdbc:firebirdsql:\" + ";
  ...
  protected final String TEXT_205 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_206 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  ...
  protected final String TEXT_247 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_259 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_318 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_319 = ".getObject(";
  protected final String TEXT_320 = "column_index_";
  protected final String TEXT_321 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_322 = NL + "                                    ";
  protected final String TEXT_323 = ".";
  protected final String TEXT_324 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_333 = ".setEPSG(";
  ...
  protected final String TEXT_340 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_341 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_342 = " = ";
  protected final String TEXT_343 = "; i_";
  protected final String TEXT_344 = "  <= rsmd_";
  protected final String TEXT_345 = ".getColumnCount(); i_";
  protected final String TEXT_346 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_347 = ".getColumnTypeName(i_";
  protected final String TEXT_348 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_349 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_350 = ".getClob(i_";
  protected final String TEXT_351 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_352 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_353 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_354 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_355 = ".add(tNTextImpl_";
  protected final String TEXT_356 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_357 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_358 = ".";
  protected final String TEXT_359 = ", rs_";
  protected final String TEXT_360 = ", fixedColumnCount_";
  protected final String TEXT_361 = ",list_";
  protected final String TEXT_362 = ");";
  protected final String TEXT_363 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_364 = ".";
  protected final String TEXT_365 = ", rs_";
  protected final String TEXT_366 = ", fixedColumnCount_";
  protected final String TEXT_367 = ");";
  protected final String TEXT_368 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_369 = ".";
  protected final String TEXT_370 = ", rs_";
  protected final String TEXT_371 = ", fixedColumnCount_";
  protected final String TEXT_372 = ");";
  protected final String TEXT_373 = NL + "                                  Object geom = rs_";
  protected final String TEXT_374 = ".getObject(";
  protected final String TEXT_375 = "column_index_";
  protected final String TEXT_376 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o = " + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_377 = ".";
  protected final String TEXT_378 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_385 = " - Retrieving the record \" + nb_line_";
