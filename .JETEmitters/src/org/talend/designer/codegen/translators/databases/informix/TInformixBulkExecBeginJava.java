...
public class TInformixBulkExecBeginJava {
  ...
  protected final String TEXT_65 = NL + "\tString dbschema_";
  protected final String TEXT_66 = " = dbschema_";
  protected final String TEXT_67 = " = (String)globalMap.get(\"dbschema_";
  protected final String TEXT_68 = "\");" + NL + "\tString dbName_";
  protected final String TEXT_69 = " =  (String)globalMap.get(\"dbname_";
  protected final String TEXT_70 = "\");" + NL + "\tString dbServer_";
  protected final String TEXT_71 = " = (String)globalMap.get(\"dbserver_";
  ...
  protected final String TEXT_76 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_77 = " + \":\" + ";
  protected final String TEXT_78 = " + \"/\" + ";
  protected final String TEXT_79 = " + \":informixserver=\" + ";
  protected final String TEXT_80 = ";";
  protected final String TEXT_81 = NL + "    String url_";
  protected final String TEXT_82 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_83 = " + \":\" + ";
  protected final String TEXT_84 = " + \"/\" + ";
  protected final String TEXT_85 = " + \":informixserver=\" + ";
  protected final String TEXT_86 = " + \";\" + ";
  protected final String TEXT_87 = ";";
  protected final String TEXT_88 = NL + "\tString driverClass_";
  protected final String TEXT_89 = " = \"com.informix.jdbc.IfxDriver\";" + NL + "\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_90 = ");" + NL + "\tString dbschema_";
  protected final String TEXT_91 = " = ";
  protected final String TEXT_92 = ";" + NL + "\tString dbName_";
  protected final String TEXT_93 = " = ";
  protected final String TEXT_94 = ";" + NL + "\tString dbServer_";
  ...
  protected final String TEXT_110 = NL + "\t\tString tableName_";
  protected final String TEXT_111 = " = null;" + NL + "\t\tif(dbschema_";
  ...
  protected final String TEXT_286 = " - Creating table ";
  protected final String TEXT_287 = "\" + tableName_";
  ...
  protected final String TEXT_294 = " - Create table ";
  protected final String TEXT_295 = "\" + tableName_";
  protected final String TEXT_296 = " + \"";
  protected final String TEXT_297 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_298 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_299 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_305 = " - Droping table ";
  ...
  protected final String TEXT_313 = " - Drop table ";
  ...
  protected final String TEXT_322 = " - Creating table ";
  ...
  protected final String TEXT_330 = " - Create table ";
  ...
  protected final String TEXT_340 = " - Clearing table ";
  ...
  protected final String TEXT_348 = "- Clear table ";
  ...
  protected final String TEXT_363 = " - Trancating table ";
  ...
  protected final String TEXT_371 = " - Truncate table ";
  ...
  protected final String TEXT_382 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_383 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_384 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_385 = NL + NL + "\t\tString fileName_";
  protected final String TEXT_386 = " = ";
  protected final String TEXT_387 = ";" + NL + "\t\tString cmdFile_";
  protected final String TEXT_388 = " = fileName_";
  protected final String TEXT_389 = " + \".cmd\";" + NL + "\t\tString logFile_";
  protected final String TEXT_390 = " = fileName_";
  protected final String TEXT_391 = " + \".log\";" + NL + "\t\tCharacter field_separator_";
  protected final String TEXT_392 = " = (";
  protected final String TEXT_393 = ").charAt(0);" + NL + " \t\tjava.io.BufferedWriter bw_";
  protected final String TEXT_394 = " = new java.io.BufferedWriter(new java.io.FileWriter(cmdFile_";
  protected final String TEXT_395 = "));" + NL + "    \tjava.io.PrintWriter pw_";
  protected final String TEXT_396 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_397 = " ,false) ;" + NL + "    \t//file \"c:\\informix_bulk.txt\" delimiter \"|\" 7 ;insert into feature9999;" + NL + "    \tpw_";
  protected final String TEXT_398 = ".print(\"FILE \\\"\" + ";
  protected final String TEXT_399 = " + \"\\\"\" );" + NL + "    \tpw_";
  protected final String TEXT_400 = ".print(\" DELIMITER \\\"\" + field_separator_";
  ...
  protected final String TEXT_405 = ".println(\"INSERT INTO \" + tableName_";
  protected final String TEXT_406 = " + \"(";
  protected final String TEXT_407 = ");\" );";
  protected final String TEXT_408 = NL + "\tbw_";
  protected final String TEXT_409 = ".close();" + NL + "\tpw_";
  protected final String TEXT_410 = ".close();" + NL + "\t//-----------------------dbload command" + NL + "\tStringBuilder command_";
  protected final String TEXT_411 = " =  new StringBuilder();" + NL + "\t//-------------------------1. add dbload cmd";
  protected final String TEXT_412 = NL + "\tcommand_";
  protected final String TEXT_413 = ".append(\"dbload \");";
  protected final String TEXT_414 = NL + "\tcommand_";
  protected final String TEXT_415 = ".append(\"./dbload \");";
  protected final String TEXT_416 = NL + "\t//-------------------------2.add database name" + NL + "\tcommand_";
  protected final String TEXT_417 = ".append(\"-d \" + dbName_";
  protected final String TEXT_418 = " + \" \");" + NL + "\t//-------------------------3.add command file" + NL + "\tcommand_";
  protected final String TEXT_419 = ".append(\"-c \" + cmdFile_";
  protected final String TEXT_420 = " + \" \");" + NL + "\t//-------------------------4.add  error log file" + NL + "\tcommand_";
  protected final String TEXT_421 = ".append(\"-l \" + logFile_";
  protected final String TEXT_422 = " + \" \");" + NL + "\t//-------------------------5.add  bad rows before abort" + NL + "\tcommand_";
  protected final String TEXT_423 = ".append(\"-e \" + ";
  protected final String TEXT_424 = " + \" \");" + NL + "\t//-------------------------6.add commit interval" + NL + "\tcommand_";
  protected final String TEXT_425 = ".append(\"-n \" + ";
  protected final String TEXT_426 = " + \";\"); " + NL + "\t" + NL + "\t//----------------get envionment variables";
  protected final String TEXT_427 = NL + "\tProcess ev_";
  protected final String TEXT_428 = " = Runtime.getRuntime().exec(\"cmd /c set\");" + NL + "\tjava.io.BufferedReader evReader_";
  protected final String TEXT_429 = " = new java.io.BufferedReader(new java.io.InputStreamReader(ev_";
  protected final String TEXT_430 = ".getInputStream()));";
  protected final String TEXT_431 = NL + NL + "\tProcess ev_";
  protected final String TEXT_432 = " = Runtime.getRuntime().exec(\"env\");" + NL + "\tjava.io.BufferedReader evReader_";
  protected final String TEXT_433 = " = new java.io.BufferedReader(new java.io.InputStreamReader(ev_";
  protected final String TEXT_434 = ".getInputStream()));";
  protected final String TEXT_435 = NL + "\tjava.util.List<String> evPara_";
  protected final String TEXT_436 = " = new java.util.ArrayList();" + NL + "\tString line_";
  protected final String TEXT_437 = " = null;" + NL + "\twhile((line_";
  protected final String TEXT_438 = " = evReader_";
  protected final String TEXT_439 = ".readLine()) != null) {" + NL + "\t   evPara_";
  protected final String TEXT_440 = ".add(line_";
  protected final String TEXT_441 = ");" + NL + "\t}" + NL + "\tevReader_";
  protected final String TEXT_442 = ".close();" + NL + "" + NL + "\tevPara_";
  protected final String TEXT_443 = ".add(\"INFORMIXDIR=\" + ";
  protected final String TEXT_444 = ");" + NL + "\tevPara_";
  protected final String TEXT_445 = ".add(\"INFORMIXSERVER=\" + dbServer_";
  protected final String TEXT_446 = ");" + NL + "\tevPara_";
  protected final String TEXT_447 = ".add(\"DBDATE=\" + \"";
  protected final String TEXT_448 = "\");" + NL + "\t";
  protected final String TEXT_449 = NL + "\tevPara_";
  protected final String TEXT_450 = ".add(\"DBMONEY=\" + ";
  protected final String TEXT_451 = ");";
  protected final String TEXT_452 = NL + "\t//----------------get envionment variables end" + NL + "\t" + NL + "\t//------------------get dbload directory" + NL + "\tjava.io.File dbLoadDirectory_";
  protected final String TEXT_453 = " = new java.io.File (";
  protected final String TEXT_454 = "+\"/bin\");" + NL + "\tboolean dbloadExist_";
  protected final String TEXT_455 = " = dbLoadDirectory_";
  protected final String TEXT_456 = ".exists();" + NL + "\tif(!dbloadExist_";
  protected final String TEXT_457 = "){" + NL + "\t\tthrow new RuntimeException(dbLoadDirectory_";
  protected final String TEXT_458 = "+\"' is not exist!\");" + NL + "\t}" + NL + "\t";
  protected final String TEXT_459 = NL + "\t\tlog.info(\"";
  protected final String TEXT_460 = " - Executing '\"+command_";
  protected final String TEXT_461 = ".toString()+\"'.\");" + NL + "\t";
  protected final String TEXT_462 = NL + " \tRuntime runtime_";
  protected final String TEXT_463 = " = Runtime.getRuntime();";
  protected final String TEXT_464 = NL + "\tfinal Process ps_";
  protected final String TEXT_465 = " = runtime_";
  protected final String TEXT_466 = ".exec(new String[]{\"cmd.exe\",\"/c\",command_";
  protected final String TEXT_467 = ".toString()}," + NL + "\t\t\t\t\t\t\t\tevPara_";
  protected final String TEXT_468 = ".toArray(new String[]{}),dbLoadDirectory_";
  protected final String TEXT_469 = ");";
  protected final String TEXT_470 = NL + "\tfinal Process ps_";
  protected final String TEXT_471 = " = runtime_";
  protected final String TEXT_472 = ".exec(command_";
  protected final String TEXT_473 = ".toString()," + NL + "\t\t\t\t\t\t\t\tevPara_";
  protected final String TEXT_474 = ".toArray(new String[]{}),dbLoadDirectory_";
  protected final String TEXT_475 = ");";
  protected final String TEXT_476 = NL;
  protected final String TEXT_477 = NL + NL + "Thread normal_";
  protected final String TEXT_478 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_479 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_480 = NL + "\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_481 = NL + "\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_482 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_483 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t        ";
  protected final String TEXT_484 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_485 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_486 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_487 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_488 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  protected final String TEXT_489 = NL + "\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t        ";
  ...
  protected final String TEXT_493 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_494 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_495 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_496 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_497 = ".interrupt();" + NL + "error_";
  protected final String TEXT_498 = ".interrupt();";
  protected final String TEXT_499 = NL + "        log.info(\"";
  protected final String TEXT_500 = " - Execute '\"+command_";
  protected final String TEXT_501 = ".toString()+\"' has finished。\");";
  protected final String TEXT_502 = NL + NL + NL + NL;
