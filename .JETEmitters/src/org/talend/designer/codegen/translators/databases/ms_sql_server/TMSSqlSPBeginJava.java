...
public class TMSSqlSPBeginJava
{
  ...
  protected final String TEXT_41 = NL + "String dbschema_";
  ...
  protected final String TEXT_52 = ";" + NL + "    String driverClass_";
  protected final String TEXT_53 = " = \"net.sourceforge.jtds.jdbc.Driver\";" + NL + "\t";
  protected final String TEXT_54 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_55 = ");" + NL + "    String port_";
  protected final String TEXT_56 = " = ";
  protected final String TEXT_57 = ";" + NL + "    String dbname_";
  protected final String TEXT_58 = " = ";
  protected final String TEXT_59 = " ;" + NL + "    String url_";
  protected final String TEXT_60 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_61 = " ; " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_62 = ")) {" + NL + "    \turl_";
  protected final String TEXT_63 = " += \":\" + ";
  protected final String TEXT_64 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_65 = ")) {" + NL + "    \turl_";
  protected final String TEXT_66 = " += \"//\" + ";
  protected final String TEXT_67 = "; " + NL + "    }" + NL + "    url_";
  protected final String TEXT_68 = " += \";appName=\" + projectName + \";\" + ";
  ...
  protected final String TEXT_84 = ",dbUser_";
  protected final String TEXT_85 = ",dbPwd_";
  protected final String TEXT_86 = ");";
  protected final String TEXT_87 = NL + "//java.sql.Statement stmt_";
  protected final String TEXT_88 = " = conn_";
  protected final String TEXT_89 = ".createStatement();" + NL + "" + NL + "//stmt_";
  protected final String TEXT_90 = ".execute(\"SET NOCOUNT ON\");" + NL + "" + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_91 = " = conn_";
  protected final String TEXT_92 = ".prepareCall(\"{";
  protected final String TEXT_93 = "call \" + ";
  protected final String TEXT_94 = " + \"(";
  protected final String TEXT_95 = ")}\"";
  protected final String TEXT_96 = NL + "\t,java.sql.ResultSet.TYPE_SCROLL_INSENSITIVE, java.sql.ResultSet.CONCUR_READ_ONLY";
  protected final String TEXT_97 = NL + ");" + NL + "" + NL + "java.sql.Timestamp tmpDate_";
  protected final String TEXT_98 = ";" + NL + "String tmpString_";
