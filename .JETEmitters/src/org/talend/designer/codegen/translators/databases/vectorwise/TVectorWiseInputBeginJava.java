...
public class TVectorWiseInputBeginJava
{
  ...
  protected final String TEXT_179 = " = \"jdbc:ingres://\" + ";
  ...
  protected final String TEXT_203 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_204 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  ...
  protected final String TEXT_217 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_245 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_246 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_247 = ".setName(rsmd_";
  protected final String TEXT_248 = ".getColumnName(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_257 = ".getColumnTypeName(i));";
  protected final String TEXT_258 = NL + "                \tdcm_";
  protected final String TEXT_259 = ".setFormat(";
  protected final String TEXT_260 = ");";
  protected final String TEXT_261 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_262 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_263 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_264 = ".setLength(rsmd_";
  protected final String TEXT_265 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_266 = ".setLength(rsmd_";
  protected final String TEXT_267 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_268 = NL + "\t\t\tdcm_";
  protected final String TEXT_269 = ".setLength(rsmd_";
  protected final String TEXT_270 = ".getPrecision(i));";
  protected final String TEXT_271 = NL + "                \tdcm_";
  protected final String TEXT_272 = ".setPrecision(rsmd_";
  protected final String TEXT_273 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_274 = ".setNullable(rsmd_";
  protected final String TEXT_275 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_276 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_277 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_278 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_279 = ".metadatas.add(dcm_";
  protected final String TEXT_280 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_281 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_282 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_283 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_284 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_285 = NL + "\t\t    ";
  protected final String TEXT_286 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_287 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_288 = NL + "\t\t    while (rs_";
  protected final String TEXT_289 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_290 = "++;" + NL + "\t\t        ";
  protected final String TEXT_291 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_292 = " = ";
  protected final String TEXT_293 = " + dcg_";
  protected final String TEXT_294 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_295 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_296 = " = ";
  protected final String TEXT_297 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_298 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_299 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_311 = " = (List)rs_";
  protected final String TEXT_312 = ".getObject(";
  protected final String TEXT_313 = "column_index_";
  protected final String TEXT_314 = ");";
  protected final String TEXT_315 = NL + "\t\t                         ";
  protected final String TEXT_316 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_317 = ".getObject(";
  protected final String TEXT_318 = "column_index_";
  protected final String TEXT_319 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_320 = NL + "                                    ";
  protected final String TEXT_321 = ".";
  protected final String TEXT_322 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_331 = ".setEPSG(";
  ...
  protected final String TEXT_338 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_339 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_340 = " = ";
  protected final String TEXT_341 = "; i_";
  protected final String TEXT_342 = "  <= rsmd_";
  protected final String TEXT_343 = ".getColumnCount(); i_";
  protected final String TEXT_344 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_345 = ".getColumnTypeName(i_";
  protected final String TEXT_346 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_347 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_348 = ".getClob(i_";
  protected final String TEXT_349 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_350 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_351 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_352 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_353 = ".add(tNTextImpl_";
  protected final String TEXT_354 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_355 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_356 = ".";
  protected final String TEXT_357 = ", rs_";
  protected final String TEXT_358 = ", fixedColumnCount_";
  protected final String TEXT_359 = ",list_";
  protected final String TEXT_360 = ");";
  protected final String TEXT_361 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_362 = ".";
  protected final String TEXT_363 = ", rs_";
  protected final String TEXT_364 = ", fixedColumnCount_";
  protected final String TEXT_365 = ");";
  protected final String TEXT_366 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_367 = ".";
  protected final String TEXT_368 = ", rs_";
  protected final String TEXT_369 = ", fixedColumnCount_";
  protected final String TEXT_370 = ");";
  protected final String TEXT_371 = NL + "                                  Object geom = rs_";
  protected final String TEXT_372 = ".getObject(";
  protected final String TEXT_373 = "column_index_";
  protected final String TEXT_374 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o = " + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_375 = ".";
  protected final String TEXT_376 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_377 = ".";
  protected final String TEXT_378 = " = null;" + NL + "                                  }";
  protected final String TEXT_379 = NL + "\t\t                          ";
  protected final String TEXT_380 = NL + "\t\t                    }";
  protected final String TEXT_381 = NL + "\t\t\t\t\t";
  protected final String TEXT_382 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_383 = " - Retrieving the record \" + nb_line_";
