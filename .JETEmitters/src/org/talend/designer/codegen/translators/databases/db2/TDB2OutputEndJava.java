...
public class TDB2OutputEndJava
{
  ...
  protected final String TEXT_53 = "                " + NL + "    try {" + NL + "\t\t\tint countSum_";
  protected final String TEXT_54 = " = 0;" + NL + "\t\t\tif (pstmt_";
  protected final String TEXT_55 = " != null) {" + NL + "\t\t\t\t";
  protected final String TEXT_56 = NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_57 = ": pstmt_";
  protected final String TEXT_58 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_59 = " += (countEach_";
  protected final String TEXT_60 = " < 0 ? 0 : countEach_";
  protected final String TEXT_61 = ");" + NL + "\t\t\t\t} " + NL + "\t\t\t\t";
  protected final String TEXT_62 = NL + "\t\t\t}" + NL + "\t    \t";
  protected final String TEXT_63 = NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_64 = " += countSum_";
  protected final String TEXT_65 = "; " + NL + "\t    \t";
  protected final String TEXT_66 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_67 = " += countSum_";
  protected final String TEXT_68 = ";" + NL + "\t    \t";
  protected final String TEXT_69 = NL + "\t    \t    deletedCount_";
  ...
  protected final String TEXT_80 = NL + "    \t\tinsertedCount_";
  protected final String TEXT_81 = " += countSum_";
  protected final String TEXT_82 = "; " + NL + "    \t";
  protected final String TEXT_83 = NL + "    \t\tupdatedCount_";
  protected final String TEXT_84 = " += countSum_";
  protected final String TEXT_85 = ";" + NL + "    \t";
  protected final String TEXT_86 = NL + "    \t    deletedCount_";
  protected final String TEXT_87 = " += countSum_";
  protected final String TEXT_88 = ";" + NL + "    \t";
  protected final String TEXT_89 = " " + NL + "    \tSystem.err.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_90 = "                \t" + NL + "\t}                                  ";
  protected final String TEXT_91 = "   " + NL + "                " + NL + "        if(pstmt_";
  protected final String TEXT_92 = " != null) {" + NL + "" + NL + "            pstmt_";
  ...
  protected final String TEXT_101 = NL + "        resourceMap.put(\"finish_";
  protected final String TEXT_102 = "\", true);";
  protected final String TEXT_103 = NL + "    ";
  protected final String TEXT_104 = NL + "\tnb_line_deleted_";
  protected final String TEXT_105 = "=nb_line_deleted_";
  protected final String TEXT_106 = "+ deletedCount_";
  protected final String TEXT_107 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_108 = "=nb_line_update_";
  protected final String TEXT_109 = " + updatedCount_";
  protected final String TEXT_110 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_111 = "=nb_line_inserted_";
  protected final String TEXT_112 = " + insertedCount_";
  protected final String TEXT_113 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_114 = "=nb_line_rejected_";
  protected final String TEXT_115 = " + rejectedCount_";
  protected final String TEXT_116 = ";" + NL + "\t";
  protected final String TEXT_117 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_118 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_119 = "_NB_LINE\",nb_line_";
  protected final String TEXT_120 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_121 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_122 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_123 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_124 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_125 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_126 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_127 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_128 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_129 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_130 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_133 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_136 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_137 = "_NB_LINE_DELETED\",nb_line_deleted_";
  ...
  protected final String TEXT_142 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_143 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_144 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_145 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
