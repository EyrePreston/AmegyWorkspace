...
public class TInterbaseOutputMainJava {
  ...
  protected final String TEXT_233 = "_QUERY\", query_";
  protected final String TEXT_234 = ".toString().trim());";
  protected final String TEXT_235 = "  " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_236 = "=pstmtUpdate_";
  protected final String TEXT_237 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_238 = " = updatedCount_";
  protected final String TEXT_239 = "+updateFlag_";
  protected final String TEXT_240 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_241 = " == 0) {" + NL + "            \t";
  protected final String TEXT_242 = NL + "\t\t\t\tquery_";
  protected final String TEXT_243 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_252 = " = insertedCount_";
  protected final String TEXT_253 = " + pstmtInsert_";
  protected final String TEXT_254 = ".executeUpdate();  " + NL + "             \t\tnb_line_";
  protected final String TEXT_255 = "++;";
  protected final String TEXT_256 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_257 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_258 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_283 = NL + "\t                        query_";
  ...
  protected final String TEXT_291 = "_QUERY\", query_";
  protected final String TEXT_292 = ".toString().trim());";
  protected final String TEXT_293 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_294 = " = deletedCount_";
  protected final String TEXT_295 = " + pstmt_";
  protected final String TEXT_296 = ".executeUpdate();" + NL + "                nb_line_";
  ...
  protected final String TEXT_311 = NL + "                        rejectedCount_";
  protected final String TEXT_312 = " = rejectedCount_";
  protected final String TEXT_313 = " + 1;";
  protected final String TEXT_314 = NL + "                        ";
  protected final String TEXT_315 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_316 = NL + "                        ";
  protected final String TEXT_317 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_318 = ";";
  protected final String TEXT_319 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_320 = NL + "            }";
  protected final String TEXT_321 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_332 = NL + "                commitCounter_";
  protected final String TEXT_333 = "++;" + NL + "                " + NL + "                if(commitEvery_";
  protected final String TEXT_334 = " <= commitCounter_";
  protected final String TEXT_335 = ") {" + NL + "                \t";
  protected final String TEXT_336 = NL + "                    conn_";
  protected final String TEXT_337 = ".commit();";
  protected final String TEXT_338 = "    " + NL + "                    commitCounter_";
  protected final String TEXT_339 = "=0;" + NL + "                " + NL + "                }   " + NL + "            ";
