...
public class TTeradataRowEndJava
{
  ...
  protected final String TEXT_106 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_107 = " +\" OFF\");" + NL + "\t";
  ...
  protected final String TEXT_113 = NL + "\t\tif(commitEvery_";
  protected final String TEXT_114 = ">commitCounter_";
  protected final String TEXT_115 = "){" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_116 = NL + NL + "\t\t\tcommitCounter_";
  ...
  protected final String TEXT_122 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");       " + NL + "         conn_";
  protected final String TEXT_123 = ".createStatement().execute(\"END QUERY LOGGING ON ALL\");        " + NL + "     }catch(Exception e){";
  protected final String TEXT_124 = NL + "         System.err.println(e.getMessage());" + NL + "     }";
