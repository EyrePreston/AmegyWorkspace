...
public class TMaxDBOutputEndJava
{
  ...
  protected final String TEXT_63 = NL + "    " + NL + "    resourceMap.put(\"finish_";
  protected final String TEXT_64 = "\", true);" + NL + "" + NL + "\tint rejectedCount_";
  protected final String TEXT_65 = " = 0;" + NL + "\t";
  protected final String TEXT_66 = NL + "\tnb_line_deleted_";
  ...
  protected final String TEXT_80 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_81 = "_NB_LINE\",nb_line_";
  protected final String TEXT_82 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_83 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_84 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_85 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_86 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_87 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_88 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_89 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_90 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_91 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_92 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_95 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_96 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_97 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_98 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_99 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_100 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_101 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_102 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_103 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_104 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_105 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_106 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_107 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
