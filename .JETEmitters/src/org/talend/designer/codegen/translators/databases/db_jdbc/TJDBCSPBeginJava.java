...
public class TJDBCSPBeginJava
{
  ...
  protected final String TEXT_44 = " " + NL + "\t\tif (null == connection_";
  protected final String TEXT_45 = ") {" + NL + "\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_46 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES); " + NL + "\t\t\tconnection_";
  protected final String TEXT_47 = " = dataSources_";
  protected final String TEXT_48 = ".get(";
  protected final String TEXT_49 = ").getConnection();" + NL + "\t\t}";
  ...
  protected final String TEXT_55 = " = dataSources_";
  protected final String TEXT_56 = ".get(";
  protected final String TEXT_57 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_58 = NL + "\t\t\tjava.lang.Class.forName(";
  ...
  protected final String TEXT_72 = " = java.sql.DriverManager.getConnection(connectionString_";
  ...
  protected final String TEXT_85 = ")}\");" + NL + "" + NL + "java.sql.Date tmpDate_";
