...
public class TMSSqlTableListBeginJava
{
  ...
  protected final String TEXT_68 = NL + "String dbSchema_";
  ...
  protected final String TEXT_73 = " = \"\";" + NL + "" + NL + "if(dbSchema_";
  protected final String TEXT_74 = " != null && dbSchema_";
  protected final String TEXT_75 = ".length() > 0){" + NL + "\t" + NL + "\tquery_";
  protected final String TEXT_76 = " = \"SELECT table_name FROM information_schema.tables WHERE table_type='BASE TABLE' AND table_schema='\" + dbSchema_";
  protected final String TEXT_77 = " + \"'\";" + NL + "\t" + NL + "}else{" + NL + "\t" + NL + "\tquery_";
  protected final String TEXT_78 = " = \"SELECT table_name FROM information_schema.tables WHERE table_type='BASE TABLE'\";" + NL + "\t" + NL + "}" + NL + "if(whereClause_";
  protected final String TEXT_79 = " != null && whereClause_";
  protected final String TEXT_80 = ".length() > 0){" + NL + "" + NL + "\tquery_";
  protected final String TEXT_81 = " = query_";
  ...
  protected final String TEXT_84 = " = query_";
