...
public class TRedshiftOutputEndJava {
  ...
  protected final String TEXT_41 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_42 = ".";
  protected final String TEXT_43 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_44 = ".setNull(count";
  protected final String TEXT_45 = ",java.sql.Types.CHAR);" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_50 = ",java.sql.Types.DATE);" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_55 = ",java.sql.Types.ARRAY);         " + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_60 = ",java.sql.Types.INTEGER);" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_65 = ",java.sql.Types.VARCHAR);" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_70 = ",java.sql.Types.OTHER);" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_75 = ",java.sql.Types.BOOLEAN);   " + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_80 = ",java.sql.Types.DOUBLE);    " + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_85 = ",java.sql.Types.FLOAT); " + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_91 = NL + "\t\t\t\t\tif((\"null\").equals(String.valueOf(bufferL";
  protected final String TEXT_92 = ".";
  protected final String TEXT_93 = ").toLowerCase())){" + NL + "\t\t\t\t";
  protected final String TEXT_94 = NL + "\t\t\t\t";
  protected final String TEXT_95 = ".setNull(count";
  protected final String TEXT_96 = ",java.sql.Types.CHAR);" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t} else if(bufferL";
  protected final String TEXT_97 = ".";
  protected final String TEXT_98 = " == '\\0') {" + NL + "\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_99 = ".setString(count";
  protected final String TEXT_100 = ",\"\");" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_101 = ".setString(count";
  protected final String TEXT_102 = ",String.valueOf(bufferL";
  protected final String TEXT_103 = ".";
  protected final String TEXT_104 = "));" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_105 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_106 = ".";
  protected final String TEXT_107 = "!=null){" + NL + "\t\t\t\t\t\t// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t\t\t\t\tdate_";
  protected final String TEXT_108 = " = bufferL";
  protected final String TEXT_109 = ".";
  protected final String TEXT_110 = ".getTime();" + NL + "\t\t\t\t\t\tif (date_";
  protected final String TEXT_111 = " < year1_";
  protected final String TEXT_112 = " || date_";
  protected final String TEXT_113 = " >= year10000_";
  protected final String TEXT_114 = ") {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_115 = ".setString(count";
  protected final String TEXT_116 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_117 = ".setTimestamp(count";
  protected final String TEXT_118 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_119 = "));" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_120 = ".setNull(count";
  protected final String TEXT_121 = ",java.sql.Types.DATE);" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\t\t";
  protected final String TEXT_123 = ".set";
  protected final String TEXT_124 = "(count";
  protected final String TEXT_125 = ",bufferL";
  protected final String TEXT_126 = ".";
  protected final String TEXT_127 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_129 = NL + "\t  " + NL + "\t" + NL + "\t    if(rowCount";
  protected final String TEXT_130 = "!=0){" + NL + "\t" + NL + "\t        StringBuilder extendInsertValueStmt = new StringBuilder();" + NL + "\t        for(int i=0 ; i < rowCount";
  protected final String TEXT_131 = " ; i++){" + NL + "\t             extendInsertValueStmt.append(\"(";
  protected final String TEXT_132 = ")\");" + NL + "\t             if (i != rowCount";
  protected final String TEXT_133 = " - 1) extendInsertValueStmt.append(\",\");" + NL + "\t        }" + NL + "\t        " + NL + "\t" + NL + "\t\t\tinsert_";
  protected final String TEXT_134 = " = \"INSERT INTO \"+";
  protected final String TEXT_135 = "+\" (";
  protected final String TEXT_136 = ") VALUES \"+extendInsertValueStmt.toString();" + NL + "\t\t\tpstmt_";
  protected final String TEXT_137 = " = conn_";
  protected final String TEXT_138 = ".prepareStatement(insert_";
  protected final String TEXT_139 = ");" + NL + "\t        " + NL + "\t        int row2Count";
  protected final String TEXT_140 = " = 0;" + NL + "\t\t\tint count";
  protected final String TEXT_141 = " = 0;" + NL + "        " + NL + "\t        for(BufferLine_";
  protected final String TEXT_142 = " bufferL";
  protected final String TEXT_143 = " : exInsertColValueList";
  protected final String TEXT_144 = "){            " + NL + "\t\t\t\tcount";
  protected final String TEXT_145 = " = row2Count";
  protected final String TEXT_146 = "*";
  protected final String TEXT_147 = "+1;         \t          " + NL + "\t";
  protected final String TEXT_148 = NL + "\t                    count";
  protected final String TEXT_149 = "++;" + NL + "\t                    ";
  protected final String TEXT_150 = NL + "\t    " + NL + "\t            row2Count";
  protected final String TEXT_151 = "++;" + NL + "\t        }        " + NL + "\t        insertedCount_";
  protected final String TEXT_152 = " = insertedCount_";
  protected final String TEXT_153 = " + pstmt_";
  protected final String TEXT_154 = ".executeUpdate();" + NL + "\t    }" + NL + "\t";
  protected final String TEXT_155 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_156 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_157 = ".close();" + NL + "            " + NL + "        } " + NL + "        if(pstmtInsert_";
  protected final String TEXT_158 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_159 = ".close();" + NL + "            " + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_160 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_161 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_162 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_163 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_164 = ".close();" + NL + "            " + NL + "        } " + NL + "        if(pstmtInsert_";
  protected final String TEXT_165 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_166 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_167 = NL + "        if(pstmt_";
  protected final String TEXT_168 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_169 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_170 = NL;
  protected final String TEXT_171 = NL + "\t\tif (commitCounter_";
  protected final String TEXT_172 = " > 0) {" + NL + "\t\t\t";
  protected final String TEXT_173 = NL + "\t\t\tconn_";
  protected final String TEXT_174 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_175 = NL + "\t\t}\t\t\t";
  protected final String TEXT_176 = "\t" + NL + "\t\t";
  protected final String TEXT_177 = "\t\t" + NL + "    \tconn_";
  protected final String TEXT_178 = " .close();" + NL + "\t\t";
  protected final String TEXT_179 = "    \t" + NL + "    \tresourceMap.put(\"finish_";
  protected final String TEXT_180 = "\", true);" + NL + "    \t";
  protected final String TEXT_181 = NL + "\tnb_line_deleted_";
  protected final String TEXT_182 = "=nb_line_deleted_";
  protected final String TEXT_183 = "+ deletedCount_";
  protected final String TEXT_184 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_185 = "=nb_line_update_";
  protected final String TEXT_186 = " + updatedCount_";
  ...
  protected final String TEXT_190 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_191 = "=nb_line_rejected_";
  protected final String TEXT_192 = " + rejectedCount_";
  protected final String TEXT_193 = ";" + NL + "\t";
  protected final String TEXT_194 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_195 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_196 = "_NB_LINE\",nb_line_";
  protected final String TEXT_197 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_198 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_199 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_200 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_201 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_202 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_203 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_204 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_205 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_206 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_207 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_208 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_209 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_210 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_211 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_212 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_213 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_214 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_215 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_216 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_217 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_218 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_219 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_222 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_232 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_233 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_234 = "_NB_LINE_REJECTED\", nb_line_rejected_";
