...
public class TSasInputBeginJava
{
  ...
  protected final String TEXT_179 = " = \"jdbc:sasiom://\"+";
  ...
  protected final String TEXT_185 = ");" + NL + "\t\t\t" + NL + "\t\t\tString dbUser_";
  ...
  protected final String TEXT_197 = ";" + NL + "" + NL + "\t\t\tjava.util.Properties property_";
  protected final String TEXT_198 = " = new java.util.Properties();" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_199 = NL + "\t\t\t\tString librefs_";
  protected final String TEXT_200 = " = ";
  protected final String TEXT_201 = ";" + NL + "\t\t\t\tproperty_";
  protected final String TEXT_202 = ".setProperty(\"librefs\", librefs_";
  protected final String TEXT_203 = ");" + NL + "\t\t\t";
  protected final String TEXT_204 = NL + "\t\t\tproperty_";
  protected final String TEXT_205 = ".setProperty(\"username\", dbUser_";
  protected final String TEXT_206 = ");" + NL + "\t\t\tproperty_";
  protected final String TEXT_207 = ".setProperty(\"password\", dbPwd_";
  protected final String TEXT_208 = ");" + NL + "\t\t\t";
  protected final String TEXT_209 = NL + "\t\t\t\t\tproperty_";
  protected final String TEXT_210 = ".setProperty(String.valueOf(";
  ...
  protected final String TEXT_217 = ", property_";
  ...
  protected final String TEXT_230 = ").charAt(0);" + NL + "\t\t\t}else{\t\t\t  \t";
  ...
  protected final String TEXT_236 = "=null;" + NL + "\t\t\t  \t\t}else{" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_237 = ".";
  protected final String TEXT_238 = "='\\0';" + NL + "\t\t\t  \t\t}";
  protected final String TEXT_239 = NL + "\t\t\t  \t\t" + NL + "\t\t\t  \t\tif((rs_";
  protected final String TEXT_240 = ".getString(";
  protected final String TEXT_241 = "column_index_";
  protected final String TEXT_242 = ")).equals(\"\")){" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_243 = ".";
  protected final String TEXT_244 = " = '\\0';" + NL + "\t\t\t  \t\t}else{" + NL + "\t\t\t  \t\t\tthrow new RuntimeException(" + NL + "\t\t\t\t\t\t\t\"Value is empty for column : '";
  protected final String TEXT_245 = "', value is invalid or this column should be nullable or have a default value.\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t  \t\t";
  ...
  protected final String TEXT_267 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_268 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  ...
  protected final String TEXT_347 = NL + "\t\t    \tint column_index_";
  ...
  protected final String TEXT_363 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_375 = " = (List)rs_";
  protected final String TEXT_376 = ".getObject(";
  protected final String TEXT_377 = "column_index_";
  protected final String TEXT_378 = ");";
  protected final String TEXT_379 = NL + "\t\t                         ";
  protected final String TEXT_380 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_381 = ".getObject(";
  protected final String TEXT_382 = "column_index_";
  protected final String TEXT_383 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_384 = NL + "                                    ";
  protected final String TEXT_385 = ".";
  protected final String TEXT_386 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_395 = ".setEPSG(";
  protected final String TEXT_396 = ");" + NL + "                                        }";
  protected final String TEXT_397 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_398 = NL + "                                  ";
  protected final String TEXT_399 = ".";
  protected final String TEXT_400 = "=dcg_";
  protected final String TEXT_401 = ";";
  protected final String TEXT_402 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_403 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_404 = " = ";
  protected final String TEXT_405 = "; i_";
  protected final String TEXT_406 = "  <= rsmd_";
  protected final String TEXT_407 = ".getColumnCount(); i_";
  protected final String TEXT_408 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_409 = ".getColumnTypeName(i_";
  protected final String TEXT_410 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_411 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_412 = ".getClob(i_";
  protected final String TEXT_413 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_414 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_415 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_416 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_417 = ".add(tNTextImpl_";
  protected final String TEXT_418 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_419 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_430 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
