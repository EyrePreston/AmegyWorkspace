...
public class TSybaseBulkExecBeginJava {
  ...
  protected final String TEXT_66 = "=0;" + NL + "String dbschema_";
  protected final String TEXT_67 = "= ";
  protected final String TEXT_68 = "; " + NL + "String tableName_";
  protected final String TEXT_69 = " = ";
  protected final String TEXT_70 = ";";
  protected final String TEXT_71 = NL + "        int keyCount_";
  protected final String TEXT_72 = " = ";
  protected final String TEXT_73 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_74 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }";
  protected final String TEXT_75 = NL + "    String host_";
  protected final String TEXT_76 = " = (String)globalMap.get(\"host_";
  protected final String TEXT_77 = "\");" + NL + "    String port_";
  protected final String TEXT_78 = " = (String)globalMap.get(\"port_";
  protected final String TEXT_79 = "\");" + NL + "    String db_";
  protected final String TEXT_80 = " = (String)globalMap.get(\"db_";
  protected final String TEXT_81 = "\");" + NL + "    String dbUser_";
  protected final String TEXT_82 = " = (String)globalMap.get(\"user_";
  protected final String TEXT_83 = "\");" + NL + "    String dbPwd_";
  protected final String TEXT_84 = " = (String)globalMap.get(\"pass_";
  protected final String TEXT_85 = "\");" + NL + "    dbschema_";
  ...
  protected final String TEXT_104 = ";" + NL + "    String host_";
  ...
  protected final String TEXT_111 = " = \"jdbc:sybase:Tds:\" + host_";
  protected final String TEXT_112 = " + \":\" + port_";
  protected final String TEXT_113 = " + \"/\" + db_";
  ...
  protected final String TEXT_121 = NL + "   \t \tString driverClass_";
  protected final String TEXT_122 = " = \"com.sybase.jdbc3.jdbc.SybDriver\";" + NL + "   \t \tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_123 = ");" + NL + "    \tjava.sql.Connection conn_";
  protected final String TEXT_124 = " = null;" + NL + "    \t" + NL + "\t\t";
  ...
  protected final String TEXT_398 = NL + NL + "StringBuilder command_";
  protected final String TEXT_399 = " =  new StringBuilder();" + NL + "command_";
  protected final String TEXT_400 = ".append(";
  protected final String TEXT_401 = " + \" \");";
  protected final String TEXT_402 = NL + "    String tmpTableName_";
  protected final String TEXT_403 = " = tableName_";
  protected final String TEXT_404 = ";" + NL + "    tableName_";
  protected final String TEXT_405 = " = \"tmp_";
  protected final String TEXT_406 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    if(dbschema_";
  protected final String TEXT_407 = " != null && dbschema_";
  protected final String TEXT_408 = ".trim().length() != 0) {" + NL + "    \ttableName_";
  protected final String TEXT_409 = "=dbschema_";
  protected final String TEXT_410 = " + \".\" + tableName_";
  protected final String TEXT_411 = ";" + NL + "    }";
  protected final String TEXT_412 = NL + "if(dbschema_";
  protected final String TEXT_413 = " != null && dbschema_";
  protected final String TEXT_414 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_415 = ".append(db_";
  protected final String TEXT_416 = " + \".\" + tableName_";
  protected final String TEXT_417 = ");" + NL + "} else {" + NL + "    command_";
  protected final String TEXT_418 = ".append(db_";
  protected final String TEXT_419 = " + \"..\" + tableName_";
  protected final String TEXT_420 = ");" + NL + "}" + NL + "command_";
  protected final String TEXT_421 = ".append(\" in \" + ";
  protected final String TEXT_422 = ");" + NL + "String headRow_";
  protected final String TEXT_423 = " = ";
  protected final String TEXT_424 = ";" + NL + "if(headRow_";
  protected final String TEXT_425 = " != null && headRow_";
  protected final String TEXT_426 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_427 = ".append(\" -F \" + headRow_";
  protected final String TEXT_428 = ");" + NL + "}" + NL;
  protected final String TEXT_429 = NL + "\tcommand_";
  protected final String TEXT_430 = ".append(\" -b \" + ";
  protected final String TEXT_431 = ");";
  protected final String TEXT_432 = NL + NL + "command_";
  protected final String TEXT_433 = ".append(\" -t \" + ";
  protected final String TEXT_434 = ");" + NL + "command_";
  protected final String TEXT_435 = ".append(\" -r \" + ";
  protected final String TEXT_436 = ");" + NL + "command_";
  protected final String TEXT_437 = ".append(\" -c -U \" + dbUser_";
  protected final String TEXT_438 = " + \" -P \" + dbPwd_";
  protected final String TEXT_439 = ");";
  protected final String TEXT_440 = NL + "command_";
  protected final String TEXT_441 = ".append(\" -I \" + ";
  protected final String TEXT_442 = ");";
  protected final String TEXT_443 = NL + "    command_";
  protected final String TEXT_444 = ".append(\" -S \" + ";
  protected final String TEXT_445 = ");";
  protected final String TEXT_446 = NL + "\tcommand_";
  protected final String TEXT_447 = ".append(\" -S \" + host_";
  protected final String TEXT_448 = ");";
  protected final String TEXT_449 = NL + "String encoding_";
  protected final String TEXT_450 = " = ";
  protected final String TEXT_451 = ";" + NL + "if(encoding_";
  protected final String TEXT_452 = " != null && encoding_";
  protected final String TEXT_453 = ".trim().length() > 0) {" + NL + "    command_";
  protected final String TEXT_454 = ".append(\" -J \" + encoding_";
  protected final String TEXT_455 = ");" + NL + "}" + NL;
  protected final String TEXT_456 = NL + "\tlog.info(\"";
  protected final String TEXT_457 = " - Executing command:'\" + command_";
  protected final String TEXT_458 = " + \"'.\");";
  protected final String TEXT_459 = NL + "    Runtime runtime_";
  protected final String TEXT_460 = " = Runtime.getRuntime();" + NL + "    final Process ps_";
  protected final String TEXT_461 = " = runtime_";
  protected final String TEXT_462 = ".exec(command_";
  protected final String TEXT_463 = ".toString());";
  protected final String TEXT_464 = NL + "        java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_468 = " - Creating temp table ";
  protected final String TEXT_469 = "\" + tableName_";
  protected final String TEXT_470 = " + \"";
  protected final String TEXT_471 = ".\" );" + NL + "\t\t";
  protected final String TEXT_472 = NL + "        stmtCreateTmp_";
  protected final String TEXT_473 = ".execute(\"";
  protected final String TEXT_474 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_475 = ".close();            ";
  protected final String TEXT_476 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_477 = " - Create temp table ";
  protected final String TEXT_478 = "\" + tableName_";
  protected final String TEXT_479 = " + \"";
  protected final String TEXT_480 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_481 = NL + "        Runtime runtime_";
  protected final String TEXT_482 = " = Runtime.getRuntime();" + NL + "        final Process ps_";
  protected final String TEXT_483 = " = runtime_";
  protected final String TEXT_484 = ".exec(command_";
  ...
  protected final String TEXT_494 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "normal_";
  protected final String TEXT_495 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_496 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_497 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t    ";
  ...
  protected final String TEXT_502 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_503 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_504 = ".start();" + NL + "" + NL + "ps_";
  protected final String TEXT_505 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_506 = ".interrupt();" + NL + "error_";
  protected final String TEXT_507 = ".interrupt();";
  protected final String TEXT_508 = NL + "\tlog.info(\"";
  protected final String TEXT_509 = " - Excute command: '\" + command_";
  protected final String TEXT_510 = " + \"' has finished.\");";
