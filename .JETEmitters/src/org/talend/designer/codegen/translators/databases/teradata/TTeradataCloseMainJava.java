...
public class TTeradataCloseMainJava
{
  ...
  protected final String TEXT_107 = "\");" + NL + "\tif(conn_";
  protected final String TEXT_108 = " != null && !conn_";
  protected final String TEXT_109 = ".isClosed())" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_110 = NL + "            //add query band support for teradata12+" + NL + "            // end query band for session" + NL + "            conn_";
  protected final String TEXT_111 = ".setAutoCommit(true);            " + NL + "            try{" + NL + "                 conn_";
  protected final String TEXT_112 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");               " + NL + "                 conn_";
  protected final String TEXT_113 = ".createStatement().execute(\"END QUERY LOGGING ON ALL\");                 " + NL + "             }catch(Exception e){";
  protected final String TEXT_114 = NL + "                 System.err.println(e.getMessage());" + NL + "             }" + NL;
