...
public class TMysqlTableListBeginJava
{
  ...
  protected final String TEXT_70 = "\");" + NL + "" + NL + "String whereClause_";
  protected final String TEXT_71 = " = ";
  protected final String TEXT_72 = ";" + NL + "" + NL + "String query_";
  protected final String TEXT_73 = " = \"\";" + NL + "" + NL + "if(whereClause_";
  protected final String TEXT_74 = " != null && whereClause_";
  protected final String TEXT_75 = ".length() > 0){" + NL + "" + NL + "\tquery_";
  protected final String TEXT_76 = " = \"SELECT table_name FROM information_schema.tables WHERE table_type<>'VIEW' AND table_schema='\" + db_";
  protected final String TEXT_77 = " + \"' AND (\" + whereClause_";
  protected final String TEXT_78 = " + \") ORDER BY table_name ASC\";" + NL + "" + NL + "}else{" + NL + "" + NL + "\tquery_";
  protected final String TEXT_79 = " = \"SELECT table_name FROM information_schema.tables WHERE table_type<>'VIEW' AND table_schema='\" + db_";
  protected final String TEXT_80 = " + \"' ORDER BY table_name ASC\";" + NL + "" + NL + "}";
  protected final String TEXT_81 = NL + "    log.info(\"";
  protected final String TEXT_82 = " - Query:'\"+query_";
  protected final String TEXT_83 = "+\"'.\");";
  protected final String TEXT_84 = NL + NL + "int nb_table_";
  ...
  protected final String TEXT_91 = ".next()) {" + NL + "" + NL + "\tString currentTableName_";
  protected final String TEXT_92 = " = rs_";
  protected final String TEXT_93 = ".getString(1); " + NL + "" + NL + "\tnb_table_";
  protected final String TEXT_94 = "++;" + NL + "        " + NL + "\t";
  protected final String TEXT_95 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_96 = " - Retrieving the table \"+nb_table_";
  protected final String TEXT_97 = "+\".\");" + NL + "\t\tlog.trace(\"";
  protected final String TEXT_98 = " - Name of table \"+nb_table_";
  protected final String TEXT_99 = "+\":\"+currentTableName_";
  protected final String TEXT_100 = "+\".\");" + NL + "\t";
  protected final String TEXT_101 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_102 = "_CURRENT_TABLE\", currentTableName_";
