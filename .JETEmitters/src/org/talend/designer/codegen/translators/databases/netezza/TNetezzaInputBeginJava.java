...
public class TNetezzaInputBeginJava
{
  ...
  protected final String TEXT_179 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_186 = NL + "\t\t\tif(rs_";
  ...
  protected final String TEXT_192 = " = new java.util.Date(rs_";
  protected final String TEXT_193 = ".get";
  protected final String TEXT_194 = "(";
  protected final String TEXT_195 = "column_index_";
  protected final String TEXT_196 = ").getTime());" + NL + "\t\t\t} else {" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_206 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_207 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_208 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_209 = " = dataSources_";
  protected final String TEXT_210 = ".get(";
  protected final String TEXT_211 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_219 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_220 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  ...
  protected final String TEXT_261 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_273 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_387 = NL + "                                  Object geom = rs_";
  protected final String TEXT_388 = ".getObject(";
  protected final String TEXT_389 = "column_index_";
  protected final String TEXT_390 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o = " + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_391 = ".";
  protected final String TEXT_392 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
