...
public class TDB2ConnectionBeginJava
{
  ...
  protected final String TEXT_92 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\tlog.info(\"";
  ...
  protected final String TEXT_95 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_140 = ");" + NL + "\tglobalMap.put(\"host_";
  protected final String TEXT_141 = "\", ";
  protected final String TEXT_142 = ");" + NL + "\tglobalMap.put(\"dbname_";
  protected final String TEXT_143 = "\", ";
  protected final String TEXT_144 = ");" + NL + "\tglobalMap.put(\"port_";
  protected final String TEXT_145 = "\", ";
  protected final String TEXT_146 = ");" + NL + "\tglobalMap.put(\"username_";
  protected final String TEXT_147 = "\", dbUser_";
  protected final String TEXT_148 = ");" + NL + "\tglobalMap.put(\"password_";
