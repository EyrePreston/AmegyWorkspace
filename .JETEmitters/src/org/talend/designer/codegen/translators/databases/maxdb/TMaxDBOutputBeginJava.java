...
public class TMaxDBOutputBeginJava {
  ...
  protected final String TEXT_44 = NL + "        int updateKeyCount_";
  protected final String TEXT_45 = " = ";
  protected final String TEXT_46 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_47 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_48 = NL + "        int deleteKeyCount_";
  protected final String TEXT_49 = " = ";
  protected final String TEXT_50 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_51 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  ...
  protected final String TEXT_63 = " = false;" + NL + "java.lang.Class.forName(\"com.sap.dbtech.jdbc.DriverSapDB\");";
  protected final String TEXT_64 = NL + "String url_";
  protected final String TEXT_65 = " = \"jdbc:sapdb://\" + ";
  ...
  protected final String TEXT_86 = NL + NL + "resourceMap.put(\"conn_";
  ...
  protected final String TEXT_94 = ".createStatement();" + NL + "            \t";
  ...
  protected final String TEXT_99 = ".close();" + NL + "            " + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_109 = ".createStatement();" + NL + "            \t";
  ...
  protected final String TEXT_161 = NL + "            stmtClear_";
  protected final String TEXT_162 = ".close();";
  protected final String TEXT_163 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_164 = " = conn_";
  protected final String TEXT_165 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_166 = " = stmtTruncCount_";
  protected final String TEXT_167 = ".executeQuery(\"";
  protected final String TEXT_168 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_169 = " = conn_";
  protected final String TEXT_170 = ".createStatement();" + NL + "            \t";
  protected final String TEXT_171 = NL + "            stmtTrunc_";
  protected final String TEXT_172 = ".executeUpdate(\"";
  protected final String TEXT_173 = "\");" + NL + "            \t";
  protected final String TEXT_174 = NL + "            while(rsTruncCount_";
  protected final String TEXT_175 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_176 = " += rsTruncCount_";
  protected final String TEXT_177 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_178 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_179 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_199 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_200 = " + \" WHERE ";
  protected final String TEXT_201 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_202 = " = \"INSERT INTO \" + ";
  protected final String TEXT_203 = " + \" (";
  protected final String TEXT_204 = ") VALUES (";
  protected final String TEXT_205 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_206 = " = conn_";
  protected final String TEXT_207 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_238 = NL + "        StringBuffer query_";
  protected final String TEXT_239 = " = null;" + NL + "       \t";
  protected final String TEXT_240 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_241 = " = insert_";
  ...
  protected final String TEXT_250 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_251 = " = insert_";
  protected final String TEXT_252 = ".split(\"\\\\?\");";
  protected final String TEXT_253 = NL + "\t\t\tdelete_";
  protected final String TEXT_254 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_255 = " = delete_";
  protected final String TEXT_256 = ".split(\"\\\\?\");";
  protected final String TEXT_257 = NL + "\t\t\treplace_";
  protected final String TEXT_258 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_259 = " = replace_";
  protected final String TEXT_260 = ".split(\"\\\\?\");";
  protected final String TEXT_261 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_262 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_263 = " = insertIgnore_";
  ...
  protected final String TEXT_268 = NL + "        int commitEvery_";
  protected final String TEXT_269 = " = ";
  protected final String TEXT_270 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_271 = " = 0;";
