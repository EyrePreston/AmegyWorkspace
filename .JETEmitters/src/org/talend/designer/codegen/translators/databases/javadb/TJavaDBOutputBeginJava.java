...
public class TJavaDBOutputBeginJava {
  ...
  protected final String TEXT_51 = " " + NL + "" + NL + "String jdbcDriver_";
  protected final String TEXT_52 = " = null;" + NL + "String url_";
  protected final String TEXT_53 = " = null;";
  protected final String TEXT_54 = NL + "\tjdbcDriver_";
  protected final String TEXT_55 = " = \"org.apache.derby.jdbc.EmbeddedDriver\";" + NL + "\turl_";
  protected final String TEXT_56 = " = \"jdbc:derby:\" + ";
  protected final String TEXT_57 = ";" + NL + "\t//set the root path of the database" + NL + "\tSystem.setProperty(\"derby.system.home\",";
  protected final String TEXT_58 = ");" + NL + "\t";
  protected final String TEXT_59 = NL + "\t\tjdbcDriver_";
  protected final String TEXT_60 = " = \"com.ibm.db2.jcc.DB2Driver\";" + NL + "\t\turl_";
  protected final String TEXT_61 = " = \"jdbc:derby:net://\" + ";
  protected final String TEXT_62 = " + \":\" + ";
  protected final String TEXT_63 = " + \"/\" + ";
  protected final String TEXT_64 = ";" + NL + "\t\t";
  protected final String TEXT_65 = NL + "\t\tjdbcDriver_";
  protected final String TEXT_66 = " = \"org.apache.derby.jdbc.ClientDriver\";" + NL + "\t\turl_";
  protected final String TEXT_67 = " = \"jdbc:derby://\" + ";
  protected final String TEXT_68 = " + \":\" + ";
  protected final String TEXT_69 = " + \"/\" + ";
  protected final String TEXT_70 = ";" + NL + "\t\t";
  protected final String TEXT_71 = NL + "\t";
  protected final String TEXT_72 = NL + "    \torg.apache.derby.drda.NetworkServerControl serverControl_";
  protected final String TEXT_73 = ";" + NL + "    \tserverControl_";
  protected final String TEXT_74 = " = new org.apache.derby.drda.NetworkServerControl(java.net.InetAddress.getByName(";
  protected final String TEXT_75 = "),Integer.parseInt(";
  protected final String TEXT_76 = "));" + NL + "    \t//start server" + NL + "    \tserverControl_";
  protected final String TEXT_77 = ".start(new java.io.PrintWriter(System.out,true));" + NL + "    \tboolean isServerUp_";
  protected final String TEXT_78 = " = false;" + NL + "    \tint timeOut_";
  protected final String TEXT_79 = " = 5;" + NL + "    \twhile(!isServerUp_";
  protected final String TEXT_80 = " && timeOut_";
  protected final String TEXT_81 = " > 0) {" + NL + "    \t\ttry {" + NL + "    \t\t\ttimeOut_";
  protected final String TEXT_82 = "--;" + NL + "    \t\t\t/*" + NL + "    \t\t\t* testing for connection to see if the network server is up and running." + NL + "    \t\t\t* if server is not ready yet, this method will throw an exception.\t\t" + NL + "    \t\t\t*/" + NL + "    \t\t\tserverControl_";
  protected final String TEXT_83 = ".ping();" + NL + "    \t\t\tisServerUp_";
  protected final String TEXT_84 = " = true;" + NL + "    \t\t} catch(java.lang.Exception e) {" + NL + "    \t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t}    \t\t\t\t" + NL + "    \t}" + NL + "    \tif(!isServerUp_";
  protected final String TEXT_85 = ") {" + NL + "    \t\t/*" + NL + "    \t\t * can not obtain a connection to network server." + NL + "    \t\t */ \t " + NL + "    \t\tthrow new java.lang.Exception(\"Can not obtain a connection to network server\");" + NL + "    \t}" + NL + "    \t//derby network server started." + NL + "\t";
  protected final String TEXT_86 = NL + NL + "int nb_line_";
  protected final String TEXT_87 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_88 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_89 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_90 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_91 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_92 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_93 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_94 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_95 = " = ";
  protected final String TEXT_96 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_97 = " = false;" + NL + "" + NL + "Class.forName(jdbcDriver_";
  protected final String TEXT_98 = ").newInstance();";
  protected final String TEXT_99 = NL + "java.util.Properties properties_";
  protected final String TEXT_100 = " = new java.util.Properties();" + NL + "properties_";
  protected final String TEXT_101 = ".put(\"user\",";
  ...
  protected final String TEXT_110 = NL + "  " + NL + "" + NL + "properties_";
  protected final String TEXT_111 = ".put(\"password\",decryptedPassword_";
  ...
  protected final String TEXT_115 = ",properties_";
  ...
  protected final String TEXT_150 = ".equalsIgnoreCase(";
  protected final String TEXT_151 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_152 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_178 = NL + "            deletedCount_";
  protected final String TEXT_179 = " = deletedCount_";
  protected final String TEXT_180 = " + stmtClear_";
  ...
  protected final String TEXT_270 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_271 = " = ";
  protected final String TEXT_272 = ";" + NL + "        " + NL + "        int commitCounter_";
