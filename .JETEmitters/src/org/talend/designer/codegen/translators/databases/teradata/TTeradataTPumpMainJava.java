...
public class TTeradataTPumpMainJava
{
  ...
  protected final String TEXT_75 = NL + "try{" + NL + "java.io.FileWriter fw_";
  protected final String TEXT_76 = " = new java.io.FileWriter(file_";
  protected final String TEXT_77 = ");" + NL + "StringBuilder script_";
  protected final String TEXT_78 = " = new StringBuilder();";
  protected final String TEXT_79 = NL + "\tfw_";
  protected final String TEXT_80 = ".write(\".LOGTABLE \"+";
  protected final String TEXT_81 = "+\".\"+";
  protected final String TEXT_82 = "+\"_lt;\"+\"";
  ...
  protected final String TEXT_96 = NL + NL + "fw_";
  protected final String TEXT_97 = ".write(\".LOGON \"+";
  protected final String TEXT_98 = "+\"/\"+";
  protected final String TEXT_99 = "+\",\"+decryptedPassword_";
  protected final String TEXT_100 = "+\";\"+\"";
  protected final String TEXT_101 = "\");" + NL;
  protected final String TEXT_102 = NL + "fw_";
  protected final String TEXT_103 = ".write(\".BEGIN LOAD \"+ ";
  protected final String TEXT_104 = " + \";\"+\"";
  protected final String TEXT_105 = "\");" + NL + "fw_";
  protected final String TEXT_106 = ".write(\".LAYOUT customer_layout;\"+\"";
  protected final String TEXT_107 = "\");";
  protected final String TEXT_108 = NL + "fw_";
  protected final String TEXT_109 = ".write(\".FIELD \"+\"";
  protected final String TEXT_110 = "\"+\" * VARCHAR(";
  protected final String TEXT_111 = ");\"+\"";
  protected final String TEXT_112 = "\");";
  protected final String TEXT_113 = NL + "fw_";
  protected final String TEXT_114 = ".write(\".DML LABEL DML_LABEL;\"+\"";
  protected final String TEXT_115 = "\");" + NL;
  protected final String TEXT_116 = NL + "fw_";
  protected final String TEXT_117 = ".write(\"UPDATE \"+tableFullName_";
  protected final String TEXT_118 = "+\" SET \"+\"";
  protected final String TEXT_119 = "\"" + NL + "\t+\" WHERE \"+\"";
  protected final String TEXT_120 = "\"+\";\"+\"";
  protected final String TEXT_121 = "\");";
  protected final String TEXT_122 = NL + "  ";
  protected final String TEXT_123 = NL + "\t\tfw_";
  protected final String TEXT_124 = ".write(\"UPDATE \"+tableFullName_";
  protected final String TEXT_125 = "+\" SET ";
  protected final String TEXT_126 = " WHERE (";
  protected final String TEXT_127 = ") ELSE INSERT INTO \"+tableFullName_";
  ...
  protected final String TEXT_134 = ".write(\"INSERT INTO \"+tableFullName_";
  protected final String TEXT_135 = "+\"(\"" + NL + "\t+\"";
  protected final String TEXT_136 = "\"+\") VAlUES(\"+\"";
  protected final String TEXT_137 = "\"+\");\"+\"";
  protected final String TEXT_138 = "\");";
  protected final String TEXT_139 = NL + "fw_";
  protected final String TEXT_140 = ".write(\"DELETE FROM \"+tableFullName_";
  protected final String TEXT_141 = "+\" \"+";
  protected final String TEXT_142 = "+\" ;\"+\"";
  protected final String TEXT_143 = "\");";
  protected final String TEXT_144 = NL;
  protected final String TEXT_145 = NL + "fw_";
  protected final String TEXT_146 = ".write(\".IMPORT INFILE \\\"\"+";
  protected final String TEXT_147 = " +\"\\\"\");" + NL + "fw_";
  protected final String TEXT_148 = ".write(\" FROM 1 FORMAT VARText '\"+";
  protected final String TEXT_149 = "+\"' LAYOUT customer_layout APPLY DML_LABEL;\"+\"";
  protected final String TEXT_150 = "\");" + NL + "fw_";
  protected final String TEXT_151 = ".write(\".END LOAD;\"+\"";
  protected final String TEXT_152 = "\");" + NL + "fw_";
  protected final String TEXT_153 = ".write(\".LOGOFF;\"+\"";
  protected final String TEXT_154 = "\");" + NL;
  protected final String TEXT_155 = NL + "fw_";
  protected final String TEXT_156 = ".close();" + NL;
  protected final String TEXT_157 = NL + "\t\t\tString[] sb_";
  protected final String TEXT_158 = "= {\"cmd\",\"/c\",\"tpump -c \"+";
  protected final String TEXT_159 = "+\" < \\\"\"+";
  protected final String TEXT_160 = "+";
  protected final String TEXT_161 = "+\".script\\\" > \\\"\"+";
  protected final String TEXT_162 = "+\"\\\" 2>&1\"};" + NL + "\t\t";
  protected final String TEXT_163 = NL + "\t\t\tString[] sb_";
  protected final String TEXT_164 = "= {\"sh\",\"-c\",\"tpump -c \"+";
  protected final String TEXT_165 = "+\" < \\\"\"+";
  protected final String TEXT_166 = "+";
  protected final String TEXT_167 = "+\".scr\\\" > \\\"\"+";
  protected final String TEXT_168 = "+\"\\\" 2>&1\"};" + NL + "\t\t";
  protected final String TEXT_169 = NL + "\t\tString[] sb_";
  protected final String TEXT_170 = "= {\"cmd\",\"/c\",\"tpump < \\\"\"+";
  ...
  protected final String TEXT_175 = "= {\"sh\",\"-c\",\"tpump < \\\"\"+";
  protected final String TEXT_176 = "+";
  protected final String TEXT_177 = "+\".scr\\\" > \\\"\"+";
  protected final String TEXT_178 = "+\"\\\" 2>&1\"};" + NL + "\t";
  protected final String TEXT_179 = NL + "\tString cmdStr_";
  protected final String TEXT_180 = " = java.util.Arrays.toString(sb_";
  protected final String TEXT_181 = ");" + NL + "    log.info(\"";
  protected final String TEXT_182 = " - Executing command: '\" + cmdStr_";
  protected final String TEXT_183 = " + \"'.\");";
  protected final String TEXT_184 = NL + "final Process process_";
  protected final String TEXT_185 = " = Runtime.getRuntime().exec(sb_";
  protected final String TEXT_186 = "); " + NL + "Thread normal_";
  ...
  protected final String TEXT_188 = ".getInputStream()));" + NL + "    \t\tString line = \"\";" + NL + "    \t\ttry {" + NL + "    \t\t\twhile((line = reader.readLine()) != null) {" + NL + "    \t\t\t   System.out.println(line);" + NL + "    \t        }" + NL + "    \t    } finally {" + NL + "    \t         reader.close();" + NL + "    \t    }" + NL + "        }catch(java.io.IOException ioe) {";
  protected final String TEXT_189 = NL + "    \t\tioe.printStackTrace();" + NL + "    \t}" + NL + "    }" + NL + "};" + NL + "normal_";
  protected final String TEXT_190 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_191 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_192 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tSystem.err.println(line);" + NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {";
  protected final String TEXT_193 = NL + "\t\t   ioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_194 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_195 = ".waitFor();" + NL + "" + NL + "normal_";
  protected final String TEXT_196 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_197 = ".interrupt();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_198 = "_EXIT_VALUE\", process_";
  protected final String TEXT_199 = ".exitValue());" + NL;
  protected final String TEXT_200 = NL + "\tif(process_";
  protected final String TEXT_201 = ".exitValue()>=";
  protected final String TEXT_202 = ") {" + NL + "\t\tthrow new RuntimeException(\"TPump returned exit code \"+process_";
  protected final String TEXT_203 = ".exitValue());" + NL + "\t}";
  protected final String TEXT_204 = NL + "    log.info(\"";
  protected final String TEXT_205 = " - Excute command:'\" + cmdStr_";
  protected final String TEXT_206 = " + \"' has finished.\");";
  protected final String TEXT_207 = NL + "}finally{" + NL + "\ttry{" + NL + "\t\tfile_";
  protected final String TEXT_208 = ".delete();" + NL + "\t}catch(Exception e_";
