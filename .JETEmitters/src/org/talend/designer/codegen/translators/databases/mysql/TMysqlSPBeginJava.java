...
public class TMysqlSPBeginJava
{
  ...
  protected final String TEXT_42 = NL + "    java.sql.Connection connection_";
  protected final String TEXT_43 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_44 = "\");";
  protected final String TEXT_45 = NL + "    String dbProperties_";
  protected final String TEXT_46 = " = ";
  protected final String TEXT_47 = ";" + NL + "    String connectionString_";
  protected final String TEXT_48 = " = null;" + NL + "    if(dbProperties_";
  protected final String TEXT_49 = " == null || dbProperties_";
  protected final String TEXT_50 = ".trim().length() == 0) {" + NL + "        connectionString_";
  protected final String TEXT_51 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_52 = " + \":\" + ";
  protected final String TEXT_53 = " + \"/\" + ";
  protected final String TEXT_54 = ";" + NL + "    } else {" + NL + "        connectionString_";
  protected final String TEXT_55 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_56 = " + \":\" + ";
  protected final String TEXT_57 = " + \"/\" + ";
  protected final String TEXT_58 = " + \"?\" + dbProperties_";
  protected final String TEXT_59 = ";" + NL + "    }" + NL + "    String dbUser_";
  ...
  protected final String TEXT_69 = NL + NL + "    String dbPwd_";
  protected final String TEXT_70 = " = decryptedPassword_";
  protected final String TEXT_71 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"org.gjt.mm.mysql.Driver\");";
  protected final String TEXT_72 = NL + "    java.sql.Connection connection_";
  protected final String TEXT_73 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_74 = ", dbUser_";
  protected final String TEXT_75 = ", dbPwd_";
  ...
  protected final String TEXT_84 = ")}\");" + NL + "" + NL + "java.sql.Date tmpDate_";
...
if(useExistingConn) {
    ...
    dbLog.conn().logJDBCDriver(dbLog.str("org.gjt.mm.mysql.Driver"));
