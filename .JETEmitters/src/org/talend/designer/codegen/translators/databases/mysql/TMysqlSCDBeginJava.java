...
public class TMysqlSCDBeginJava {
  ...
  protected final String TEXT_13 = NL + "        java.lang.Class.forName(\"org.gjt.mm.mysql.Driver\");";
  protected final String TEXT_14 = NL + "            String connectionString_";
  protected final String TEXT_15 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_16 = " + \":\" + ";
  protected final String TEXT_17 = " + \"/\" + ";
  protected final String TEXT_18 = ";";
  protected final String TEXT_19 = NL + "            String connectionString_";
  protected final String TEXT_20 = " = \"jdbc:mysql://\" + ";
  ...
  protected final String TEXT_47 = ".getMetaData();";
  protected final String TEXT_48 = "   " + NL + "\t\t\t\tString dbschemaForSearch_";
  protected final String TEXT_49 = " = null;" + NL + "\t\t\t\tif (schema_";
  protected final String TEXT_50 = " == null" + NL + "\t\t\t\t\t\t|| schema_";
  protected final String TEXT_51 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_52 = " = ((String)";
  protected final String TEXT_53 = ").toUpperCase();" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_54 = " = schema_";
  protected final String TEXT_55 = ".toUpperCase();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tString tableName4Search_";
  protected final String TEXT_56 = " = ";
  protected final String TEXT_57 = ";" + NL + "            \tif(tableName4Search_";
  protected final String TEXT_58 = ".indexOf(\"\\\"\")==-1){" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_59 = " = tableName4Search_";
  protected final String TEXT_60 = ".toUpperCase();" + NL + "            \t}else{" + NL + "            \t\ttableName4Search_";
  protected final String TEXT_61 = " = tableName4Search_";
  protected final String TEXT_62 = ".replaceAll(\"\\\"\",\"\");" + NL + "            \t}" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_63 = " = dbMetaData_";
  protected final String TEXT_64 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_65 = ", tableName4Search_";
  protected final String TEXT_66 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_67 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_68 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_69 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_70 = ".close();" + NL + "\t            ";
  protected final String TEXT_71 = NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_80 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }";
  protected final String TEXT_81 = "            " + NL + "            if(!whetherExist_";
  ...
  protected final String TEXT_88 = NL + "        " + NL + "    java.util.Calendar calendar_";
  protected final String TEXT_89 = " = java.util.Calendar.getInstance();" + NL + "    java.util.Calendar calendarYear0_";
  protected final String TEXT_90 = " = java.util.Calendar.getInstance();" + NL + "    " + NL + "    calendar_";
  protected final String TEXT_91 = ".set(1, 0, 1, 0, 0, 0);" + NL + "    calendarYear0_";
  protected final String TEXT_92 = ".set(0,0,0,0,0,0);" + NL + "    " + NL + "    final java.util.Date dateYear0_";
  protected final String TEXT_93 = " = calendarYear0_";
  protected final String TEXT_94 = ".getTime();" + NL + "    final long year1_";
  protected final String TEXT_95 = " = calendar_";
  protected final String TEXT_96 = ".getTime().getTime();" + NL + "    " + NL + "    " + NL + "    calendar_";
  protected final String TEXT_97 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "    final long year10000_";
  protected final String TEXT_98 = " = calendar_";
  protected final String TEXT_99 = ".getTime().getTime();" + NL + "    long date_";
  protected final String TEXT_100 = " = 0;    " + NL + "    String dateStr_";
  ...
  protected final String TEXT_156 = NL + "                    dateStr_";
  protected final String TEXT_157 = " = resultSet_";
  protected final String TEXT_158 = ".getString(";
  protected final String TEXT_159 = ");" + NL + "                    if(dateStr_";
  protected final String TEXT_160 = " != null) {" + NL + "                        if(!(\"0000-00-00\").equals(dateStr_";
  protected final String TEXT_161 = ") && !(\"0000-00-00 00:00:00\").equals(dateStr_";
  protected final String TEXT_162 = ")) {";
  protected final String TEXT_163 = NL + "                            ";
  protected final String TEXT_164 = ".";
  protected final String TEXT_165 = " = new java.util.Date(resultSet_";
  protected final String TEXT_166 = ".getTimestamp(";
  protected final String TEXT_167 = ").getTime());" + NL + "                        } else {";
  protected final String TEXT_168 = NL + "                            ";
  protected final String TEXT_169 = ".";
  protected final String TEXT_170 = " = (java.util.Date) dateYear0_";
  protected final String TEXT_171 = ".clone();" + NL + "                        }" + NL + "                    } else {";
  protected final String TEXT_172 = NL + "                        ";
  protected final String TEXT_173 = ".";
  protected final String TEXT_174 = " = null;" + NL + "                    }";
  protected final String TEXT_175 = NL + "                    if(resultSet_";
  protected final String TEXT_176 = ".getObject(";
  protected final String TEXT_177 = ") != null) {";
  protected final String TEXT_178 = NL + "                        ";
  protected final String TEXT_179 = ".";
  protected final String TEXT_180 = " = resultSet_";
  protected final String TEXT_181 = ".get";
  protected final String TEXT_182 = "(";
  protected final String TEXT_183 = ");" + NL + "                    }";
  protected final String TEXT_184 = NL + "            cache_";
  protected final String TEXT_185 = ".put(sk_";
  protected final String TEXT_186 = ", row_";
  protected final String TEXT_187 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_188 = ".close();" + NL + "        statement_";
  protected final String TEXT_189 = ".close();";
  protected final String TEXT_190 = NL + "            System.out.println(\"[";
  protected final String TEXT_191 = "] comparison cache loaded\");";
  protected final String TEXT_192 = NL + "        ";
  protected final String TEXT_193 = " nextSurrogateKey_";
  protected final String TEXT_194 = " = 1;";
  protected final String TEXT_195 = NL + "            if(cache_";
  protected final String TEXT_196 = ".size() > 0) {";
  protected final String TEXT_197 = NL + "        String tmpQuery_";
  protected final String TEXT_198 = " = \"SELECT MAX(`";
  protected final String TEXT_199 = "`) FROM `\" + tableName_";
  protected final String TEXT_200 = " + \"`\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_201 = " = connection_";
  protected final String TEXT_202 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_203 = " = tmpStmt_";
  protected final String TEXT_204 = ".executeQuery(tmpQuery_";
  protected final String TEXT_205 = ");";
  protected final String TEXT_206 = NL + "        if(tmpRS_";
  protected final String TEXT_207 = ".next() && tmpRS_";
  protected final String TEXT_208 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_209 = " = tmpRS_";
  protected final String TEXT_210 = ".get";
  protected final String TEXT_211 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_212 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_213 = ".close();";
  protected final String TEXT_214 = NL + "            }            ";
  protected final String TEXT_215 = NL + "    String insertionSQL_";
  protected final String TEXT_216 = " = \"";
  protected final String TEXT_217 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_218 = " = connection_";
  protected final String TEXT_219 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_220 = ");";
  protected final String TEXT_221 = NL + "            insertionStatement_";
  protected final String TEXT_222 = ".setTimestamp(";
  protected final String TEXT_223 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_224 = "\")));";
  protected final String TEXT_225 = NL + "            insertionStatement_";
  protected final String TEXT_226 = ".setNull(";
  protected final String TEXT_227 = ", java.sql.Types.DATE);";
  protected final String TEXT_228 = NL + "            String endDateTimeDetail_";
  protected final String TEXT_229 = " = ";
  protected final String TEXT_230 = ";" + NL + "            String datePattern_";
  protected final String TEXT_231 = " = \"yyyy-MM-dd\";" + NL + "            if(endDateTimeDetail_";
  protected final String TEXT_232 = ".length()>0){" + NL + "            \tendDateTimeDetail_";
  protected final String TEXT_233 = " = \" \"+endDateTimeDetail_";
  protected final String TEXT_234 = ";" + NL + "            \tdatePattern_";
  protected final String TEXT_235 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "            }" + NL + "            insertionStatement_";
  protected final String TEXT_236 = ".setTimestamp(";
  protected final String TEXT_237 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(datePattern_";
  protected final String TEXT_238 = ").parse(";
  protected final String TEXT_239 = " + \"-01-01\"+endDateTimeDetail_";
  protected final String TEXT_240 = ").getTime()));";
  protected final String TEXT_241 = NL + "        String updateSQLForType1_";
  protected final String TEXT_242 = " = \"";
  protected final String TEXT_243 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_244 = " = connection_";
  protected final String TEXT_245 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_246 = ");        ";
  protected final String TEXT_247 = NL + "        String updateSQLForType2_";
  protected final String TEXT_248 = " = \"";
  protected final String TEXT_249 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_250 = " = connection_";
  protected final String TEXT_251 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_252 = ");";
  protected final String TEXT_253 = NL + "            updateForType2_";
  protected final String TEXT_254 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_255 = "\")));";
  protected final String TEXT_256 = NL + "        String updateSQLForType3_";
  protected final String TEXT_257 = " = \"";
  protected final String TEXT_258 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_259 = " = connection_";
  protected final String TEXT_260 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_261 = ");";
  protected final String TEXT_262 = NL + "    ";
  protected final String TEXT_263 = NL + "        SCDSK_";
  protected final String TEXT_264 = " lookUpKey_";
  protected final String TEXT_265 = " = null;        ";
  protected final String TEXT_266 = NL + "    SCDStruct_";
