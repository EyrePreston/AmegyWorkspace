...
public class TMSSqlInputBeginJava
{
  ...
  protected final String TEXT_178 = NL + "\t\t\torg.talend.designer.components.util.mssql.MSSqlGenerateTimestampUtil mssqlGTU_";
  protected final String TEXT_179 = " = org.talend.designer.components.util.mssql.MSSqlUtilFactory.getMSSqlGenerateTimestampUtil();" + NL + "\t\t\t" + NL + "\t\t\tjava.util.List<String> talendToDBList_";
  protected final String TEXT_180 = " = new java.util.ArrayList();" + NL + "\t\t\tString[] talendToDBArray_";
  protected final String TEXT_181 = "  = new String[]{\"FLOAT\",\"NUMERIC\",\"NUMERIC IDENTITY\",\"DECIMAL\",\"DECIMAL IDENTITY\",\"REAL\"}; " + NL + "\t\t\tjava.util.Collections.addAll(talendToDBList_";
  protected final String TEXT_182 = ", talendToDBArray_";
  protected final String TEXT_183 = "); ";
  protected final String TEXT_184 = NL + "\t\t\tString dbschema_";
  protected final String TEXT_185 = " = (String)globalMap.get(\"";
  protected final String TEXT_186 = "\");";
  protected final String TEXT_187 = NL + "\t\t    String port_";
  protected final String TEXT_188 = " = ";
  protected final String TEXT_189 = ";" + NL + "\t\t    String dbname_";
  protected final String TEXT_190 = " = ";
  protected final String TEXT_191 = " ;" + NL + "\t\t    String url_";
  protected final String TEXT_192 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_193 = " ; " + NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_194 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_195 = " += \":\" + ";
  protected final String TEXT_196 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  protected final String TEXT_197 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_198 = " += \"//\" + ";
  protected final String TEXT_199 = "; " + NL + "\t\t    }" + NL + "\t\t    url_";
  protected final String TEXT_200 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_201 = ";" + NL + "\t\t    String dbschema_";
  protected final String TEXT_202 = " = ";
  protected final String TEXT_203 = ";";
  protected final String TEXT_204 = NL + "\t\t\t";
  protected final String TEXT_205 = ".";
  protected final String TEXT_206 = " = mssqlGTU_";
  protected final String TEXT_207 = ".getDate(rsmd_";
  protected final String TEXT_208 = ", rs_";
  protected final String TEXT_209 = ", ";
  protected final String TEXT_210 = "column_index_";
  protected final String TEXT_211 = ");" + NL + "\t\t\t";
  protected final String TEXT_212 = NL + "\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_213 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_214 = ".getClob(";
  ...
  protected final String TEXT_219 = " = tNTextImpl_";
  protected final String TEXT_220 = ".getValue();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_221 = " = null;\t\t\t\t" + NL + "\t\t\t\t}";
  protected final String TEXT_222 = NL + "           \t\ttmpContent_";
  ...
  protected final String TEXT_227 = NL + "            if(tmpContent_";
  protected final String TEXT_228 = " != null) {" + NL + "            \tif (talendToDBList_";
  protected final String TEXT_229 = " .contains(rsmd_";
  protected final String TEXT_230 = ".getColumnTypeName(";
  protected final String TEXT_231 = "column_index_";
  protected final String TEXT_232 = ").toUpperCase(java.util.Locale.ENGLISH))) {" + NL + "            \t\t";
  protected final String TEXT_233 = ".";
  protected final String TEXT_234 = " = FormatterUtils.formatUnwithE(tmpContent_";
  protected final String TEXT_235 = ");" + NL + "            \t} else {" + NL + "                \t";
  protected final String TEXT_236 = ".";
  protected final String TEXT_237 = " = tmpContent_";
  protected final String TEXT_238 = ";" + NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_259 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_260 = " =  conn_";
  protected final String TEXT_261 = ".getAutoCommit();          " + NL + "             conn_";
  protected final String TEXT_262 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_263 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  ...
  protected final String TEXT_342 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_343 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_344 = NL + "\t\t    ";
  protected final String TEXT_345 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_346 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_347 = NL + "\t\t    while (rs_";
  protected final String TEXT_348 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_349 = "++;" + NL + "\t\t        ";
  protected final String TEXT_350 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  ...
  protected final String TEXT_397 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_398 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_414 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_415 = ".";
  protected final String TEXT_416 = ", rs_";
  protected final String TEXT_417 = ", fixedColumnCount_";
  protected final String TEXT_418 = ",list_";
  ...
  protected final String TEXT_449 = NL + NL + NL + NL + NL;
