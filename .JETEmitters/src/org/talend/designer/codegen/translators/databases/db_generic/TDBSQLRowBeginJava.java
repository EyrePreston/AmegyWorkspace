...
public class TDBSQLRowBeginJava
{
  ...
  protected final String TEXT_68 = "\";" + NL + "\t\t    java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_118 = " = \"jdbc:odbc:\"+";
  ...
  protected final String TEXT_131 = ";" + NL + "" + NL + "\t\t\tString driverClass_";
  protected final String TEXT_132 = " = \"";
  protected final String TEXT_133 = "\";" + NL + "\t\t\tString dbProperties_";
  protected final String TEXT_134 = " = ";
  protected final String TEXT_135 = ";" + NL + "\t\t\t";
  protected final String TEXT_136 = NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_137 = " == null || dbProperties_";
  protected final String TEXT_138 = ".trim().length() == 0) {" + NL + "\t\t\t\tconn_";
  ...
  protected final String TEXT_142 = ");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tdbProperties_";
  protected final String TEXT_143 = " = dbProperties_";
  protected final String TEXT_144 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\t\tjava.util.Properties atnParamsPrope_";
  ...
  protected final String TEXT_150 = ".load(new java.io.ByteArrayInputStream(dbProperties_";
  ...
  protected final String TEXT_153 = ", atnParamsPrope_";
  protected final String TEXT_154 = ");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_155 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_156 = " = null;" + NL + "\tString query_";
