...
public class TSQLiteRowBeginJava
{
  ...
  protected final String TEXT_117 = " = \"jdbc:sqlite:\" + \"/\" + ";
  protected final String TEXT_118 = ";" + NL + "\t\t";
  protected final String TEXT_119 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_120 = " = null;" + NL + "\tString query_";
  protected final String TEXT_121 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_122 = " = false;";
  protected final String TEXT_123 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_124 = " = conn_";
  protected final String TEXT_125 = ".prepareStatement(";
  protected final String TEXT_126 = ");\t" + NL + "\t";
  protected final String TEXT_127 = NL + "\t\tjava.sql.Statement stmt_";
