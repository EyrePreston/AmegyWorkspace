...
public class TNetezzaOutputMainJava {
  ...
  protected final String TEXT_106 = ".executeUpdate();" + NL + "    \t    \t";
  ...
  protected final String TEXT_133 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_134 = " = pstmt_";
  protected final String TEXT_135 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_136 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_137 = ".next())" + NL + "    \t\t{" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_138 = " = rs_";
  protected final String TEXT_139 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_150 = NL + "                try{" + NL + "                    updatedCount_";
  protected final String TEXT_151 = " = updatedCount_";
  protected final String TEXT_152 = " + pstmtUpdate_";
  protected final String TEXT_153 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_154 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_155 = NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_177 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\telse" + NL + "    \t\t{" + NL + "    \t\t\t";
  ...
  protected final String TEXT_183 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_184 = "++;";
  protected final String TEXT_185 = NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_208 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_221 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_222 = " = updatedCount_";
  protected final String TEXT_223 = "+updateFlag_";
  protected final String TEXT_224 = ";" + NL + "                " + NL + "            if(updateFlag_";
  protected final String TEXT_225 = " == 0) {" + NL + "        \t\t";
  protected final String TEXT_226 = NL + "        \t\t\t    ";
  protected final String TEXT_227 = NL + "        \t\t\t    ";
  protected final String TEXT_228 = NL + "                    insertedCount_";
  protected final String TEXT_229 = " = insertedCount_";
  protected final String TEXT_230 = " + pstmtInsert_";
  protected final String TEXT_231 = ".executeUpdate();" + NL + "         \t\t\tnb_line_";
  protected final String TEXT_232 = "++;";
  protected final String TEXT_233 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_234 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_235 = NL + "    \t\t\t}" + NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  protected final String TEXT_236 = " = true;";
  protected final String TEXT_237 = NL + "                        throw(e);";
  protected final String TEXT_238 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_267 = ".addBatch();" + NL + "    \t\t\tnb_line_";
  protected final String TEXT_268 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_269 = NL + "    \t\t  \t\tbatchSizeCounter_";
  protected final String TEXT_270 = "++;" + NL + "    \t\t  \t";
  protected final String TEXT_271 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_272 = NL + "        try{" + NL + "    \t    deletedCount_";
  protected final String TEXT_273 = " = deletedCount_";
  protected final String TEXT_274 = " + pstmt_";
  protected final String TEXT_275 = ".executeUpdate();" + NL + "    \t    nb_line_";
  protected final String TEXT_276 = "++;";
  protected final String TEXT_277 = NL + "        }catch(java.lang.Exception e)" + NL + "        {" + NL + "            whetherReject_";
  ...
  protected final String TEXT_312 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_313 = " <= batchSizeCounter_";
  protected final String TEXT_314 = ") {                ";
  protected final String TEXT_315 = "                                                " + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  ...
  protected final String TEXT_320 = ".clearBatch();" + NL + "            \t    \t";
  protected final String TEXT_321 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_322 = " += pstmt_";
  protected final String TEXT_323 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_324 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_325 = " += pstmt_";
  protected final String TEXT_326 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_327 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_328 = " += pstmt_";
  protected final String TEXT_329 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_330 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_331 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_332 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_333 = NL + "                " + NL + "                }catch (java.sql.SQLException e){" + NL + "                \t";
  ...
  protected final String TEXT_343 = " >0){" + NL + "\t\t\t\t\t\tbatchSizeCounter_";
  protected final String TEXT_344 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_345 = NL + "                \t\tpstmt_";
  protected final String TEXT_346 = ".executeBatch();" + NL + "                \t\t";
  protected final String TEXT_347 = NL + "                \t\tpstmt_";
  protected final String TEXT_348 = ".clearBatch();" + NL + "            \t\t}" + NL + "            \t    \t";
  protected final String TEXT_349 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_350 = " += pstmt_";
  protected final String TEXT_351 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_352 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_353 = " += pstmt_";
  protected final String TEXT_354 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_355 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_356 = " += pstmt_";
  protected final String TEXT_357 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_358 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_359 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_360 = NL + "                        System.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_361 = NL + "                " + NL + "                }catch (java.sql.SQLException e){" + NL + "                \t";
  protected final String TEXT_362 = NL + "                \t\tthrow(e);" + NL + "                \t";
  ...
  protected final String TEXT_367 = ".commit();" + NL + "                \t";
  protected final String TEXT_368 = "      " + NL + "                \tcommitCounter_";
  protected final String TEXT_369 = "=0;" + NL + "                " + NL + "                }\t" + NL + "    " + NL + "    \t";
