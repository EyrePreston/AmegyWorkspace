...
public class TOleDbOutputEndJava
{
  ...
  protected final String TEXT_43 = ".invoke(\"Close\");" + NL + "\t";
  protected final String TEXT_44 = NL + "\t";
  protected final String TEXT_45 = NL + "\tnb_line_deleted_";
  protected final String TEXT_46 = "=nb_line_deleted_";
  protected final String TEXT_47 = "+ deletedCount_";
  protected final String TEXT_48 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_49 = "=nb_line_update_";
  protected final String TEXT_50 = " + updatedCount_";
  protected final String TEXT_51 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_52 = "=nb_line_inserted_";
  protected final String TEXT_53 = " + insertedCount_";
  protected final String TEXT_54 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_55 = "=nb_line_rejected_";
  protected final String TEXT_56 = " + rejectedCount_";
  protected final String TEXT_57 = ";" + NL + "\t";
  protected final String TEXT_58 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_59 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_60 = "_NB_LINE\",nb_line_";
  protected final String TEXT_61 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_62 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_63 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_64 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_65 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_66 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_67 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_68 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_69 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_70 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_71 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_74 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_75 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_76 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_77 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_78 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_79 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_80 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_81 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_82 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_83 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_84 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_85 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_86 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
