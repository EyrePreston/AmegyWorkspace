...
public class TSQLiteOutputEndJava {
  ...
  protected final String TEXT_42 = " != null) {    " + NL + "                pstmtUpdate_";
  protected final String TEXT_43 = ".close();                " + NL + "            } " + NL + "            if(pstmtInsert_";
  protected final String TEXT_44 = " != null) {    " + NL + "                pstmtInsert_";
  protected final String TEXT_45 = ".close();                " + NL + "            }" + NL + "            if(pstmt_";
  ...
  protected final String TEXT_49 = " != null) {    " + NL + "                pstmtUpdate_";
  protected final String TEXT_50 = ".close();                " + NL + "            } " + NL + "            if(pstmtInsert_";
  protected final String TEXT_51 = " != null) {    " + NL + "                pstmtInsert_";
  protected final String TEXT_52 = ".close();                " + NL + "            }        ";
  protected final String TEXT_53 = NL + "            if(pstmt_";
  protected final String TEXT_54 = " != null) {    " + NL + "                pstmt_";
  ...
  protected final String TEXT_67 = NL + NL + "\tint rejectedCount_";
