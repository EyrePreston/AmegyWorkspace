...
public class TTeradataCommitMainJava
{
  ...
  protected final String TEXT_109 = ".isClosed())" + NL + "{";
  protected final String TEXT_110 = NL + "\ttry{";
  protected final String TEXT_111 = NL + "\t\t";
  protected final String TEXT_112 = NL + "\t}finally{";
  protected final String TEXT_113 = NL + "            //add query band support for teradata12+" + NL + "            // end query band for session" + NL + "            conn_";
  protected final String TEXT_114 = ".setAutoCommit(true);          " + NL + "            try{" + NL + "                 conn_";
  protected final String TEXT_115 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");               " + NL + "                 conn_";
  protected final String TEXT_116 = ".createStatement().execute(\"END QUERY LOGGING ON ALL\");                 " + NL + "             }catch(Exception e){";
  protected final String TEXT_117 = NL + "                    System.err.println(e.getMessage());" + NL + "             }" + NL;
