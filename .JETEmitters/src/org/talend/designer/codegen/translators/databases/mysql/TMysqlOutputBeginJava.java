...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_76 = " " + NL + "\t\tif (null == conn_";
  protected final String TEXT_77 = ") {" + NL + "\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_78 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES); " + NL + "\t\t\tconn_";
  protected final String TEXT_79 = " = dataSources_";
  protected final String TEXT_80 = ".get(";
  protected final String TEXT_81 = ").getConnection();" + NL + "\t\t\tif (conn_";
  protected final String TEXT_82 = " != null) { " + NL + "\t\t\t\tconn_";
  protected final String TEXT_83 = ".setAutoCommit(";
  ...
  protected final String TEXT_101 = " + \"?\" + \"rewriteBatchedStatements=true\";" + NL + "\t\t} else {" + NL + "\t\t\tString properties_";
  protected final String TEXT_102 = " = ";
  protected final String TEXT_103 = ";" + NL + "\t\t\tif (!properties_";
  protected final String TEXT_104 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\t\tproperties_";
  protected final String TEXT_105 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\turl_";
  protected final String TEXT_106 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_107 = " + \":\" + ";
  protected final String TEXT_108 = " + \"/\" + ";
  protected final String TEXT_109 = " + \"?\" + properties_";
  protected final String TEXT_110 = ";" + NL + "\t\t}" + NL + "\t\tString driverClass_";
  protected final String TEXT_111 = " = \"org.gjt.mm.mysql.Driver\";" + NL + "\t\t";
  ...
  protected final String TEXT_124 = ";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_137 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_138 = " = ";
  protected final String TEXT_139 = ";" + NL + "        int commitCounter_";
  ...
  protected final String TEXT_182 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_239 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_390 = ", true);" + NL + "    " + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_405 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_406 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_407 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  protected final String TEXT_408 = " = rsTruncCount_";
  protected final String TEXT_409 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_410 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_411 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_420 = NL + "                if(!conn_";
  ...
  protected final String TEXT_449 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_450 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");\t" + NL + "\t\t\t\t";
  protected final String TEXT_451 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_452 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_453 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_454 = ".append (\"`\" +  ";
  protected final String TEXT_455 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_456 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_466 = " += \tduplidateClause_";
  protected final String TEXT_467 = ".toString();";
  protected final String TEXT_468 = NL + "\t\t\t\t";
  protected final String TEXT_469 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_470 = " = new StringBuffer(insert_";
  protected final String TEXT_471 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_472 = ".insert(insert_";
  protected final String TEXT_473 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_474 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_475 = " =insertStringBuffer_";
  protected final String TEXT_476 = ".toString(); ";
  ...
  protected final String TEXT_484 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_485 = " = conn_";
  protected final String TEXT_486 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_487 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_488 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_489 = ",insert_";
  protected final String TEXT_490 = ",keyPsmt_";
  protected final String TEXT_491 = ");";
  protected final String TEXT_492 = NL + "\t        \t        ";
  protected final String TEXT_493 = "\t            " + NL + "\t            class BufferLine_";
  protected final String TEXT_494 = " {" + NL + "    \t            ";
  protected final String TEXT_495 = NL + "                            ";
  protected final String TEXT_496 = " ";
  protected final String TEXT_497 = ";                ";
  protected final String TEXT_498 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  ...
  protected final String TEXT_507 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "\t            " + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_508 = "> exInsertColValueList";
  protected final String TEXT_509 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_510 = " exInsertColValue";
  protected final String TEXT_511 = " = null; " + NL + "\t            " + NL + "\t            " + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_512 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_513 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_514 = ".append(\"(";
  protected final String TEXT_515 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_516 = "-1) extendInsertValueStmt_";
  protected final String TEXT_517 = ".append(\",\");" + NL + "                }" + NL + "               " + NL + "" + NL + "\t\t\t\tString insert_";
  ...
  protected final String TEXT_537 = ");" + NL + "\t            " + NL + "\t            String insertColName";
  protected final String TEXT_538 = " = \"";
  protected final String TEXT_539 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_540 = " =  \"";
  protected final String TEXT_541 = "\"; " + NL + "\t            int rowCount";
  ...
  protected final String TEXT_549 = " += \tduplidateClause_";
  protected final String TEXT_550 = ".toString();";
  protected final String TEXT_551 = NL + "\t\t        int batchSize_";
  protected final String TEXT_552 = " = ";
  protected final String TEXT_553 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  ...
  protected final String TEXT_568 = " = \"UPDATE `\" + ";
  protected final String TEXT_569 = " + \"` SET ";
  protected final String TEXT_570 = " WHERE ";
  protected final String TEXT_571 = "\";" + NL + "\t    ";
  protected final String TEXT_572 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_573 = " = new StringBuffer(update_";
  protected final String TEXT_574 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_575 = ".insert(update_";
  protected final String TEXT_576 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_577 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_578 = " =updateStringBuffer_";
  ...
  protected final String TEXT_586 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  ...
  protected final String TEXT_591 = ") VALUES (";
  ...
  protected final String TEXT_601 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_605 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_622 = " = \"UPDATE `\" + ";
  protected final String TEXT_623 = " + \"` SET ";
  protected final String TEXT_624 = " WHERE ";
  protected final String TEXT_625 = "\";" + NL + "\t    ";
  protected final String TEXT_626 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_627 = " = new StringBuffer(update_";
  protected final String TEXT_628 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_629 = ".insert(update_";
  protected final String TEXT_630 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_631 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_632 = " =updateStringBuffer_";
  protected final String TEXT_633 = ".toString(); ";
  protected final String TEXT_634 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_635 = " = conn_";
  protected final String TEXT_636 = ".prepareStatement(update_";
  protected final String TEXT_637 = ");" + NL + "\t    String insert_";
  protected final String TEXT_638 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_650 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_674 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_683 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_728 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_734 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_735 = " {" + NL + "    \t            ";
  protected final String TEXT_736 = NL + "                            ";
  protected final String TEXT_737 = " ";
  protected final String TEXT_738 = ";                ";
  protected final String TEXT_739 = NL + "\t\t\t\tDynamic ";
  protected final String TEXT_740 = ";" + NL + "\t\t\t";
  protected final String TEXT_741 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_742 = "(";
  protected final String TEXT_743 = NL + "                                ,";
  protected final String TEXT_744 = NL + "                            ";
  protected final String TEXT_745 = " ";
  protected final String TEXT_746 = NL + "\t\t\t\t, Dynamic ";
  protected final String TEXT_747 = NL + "\t\t\t";
  protected final String TEXT_748 = " " + NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_749 = NL + "                                this.";
  protected final String TEXT_750 = " = ";
  protected final String TEXT_751 = ";              ";
  protected final String TEXT_752 = NL + "\t\t\t\tthis.";
  protected final String TEXT_753 = "=";
  protected final String TEXT_754 = ";" + NL + "\t\t\t";
  protected final String TEXT_755 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_756 = "> exInsertColValueList";
  protected final String TEXT_757 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_758 = " exInsertColValue";
  protected final String TEXT_759 = " = null; " + NL + "\t\t    String insert_";
  protected final String TEXT_760 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_761 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_762 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_763 = "=1;";
  protected final String TEXT_764 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_765 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_766 = "=0;";
  protected final String TEXT_767 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_768 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_769 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_770 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_771 = "=0;" + NL + "\t";
  protected final String TEXT_772 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_776 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_777 = " =  null;";
  protected final String TEXT_778 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_779 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_780 = " = null;";
  protected final String TEXT_781 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_782 = " = null;";
  protected final String TEXT_783 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_784 = " = null;";
  protected final String TEXT_785 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
