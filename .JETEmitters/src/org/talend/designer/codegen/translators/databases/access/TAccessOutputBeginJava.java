...
public class TAccessOutputBeginJava {
  ...
  protected final String TEXT_59 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_60 = " = ";
  protected final String TEXT_61 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_62 = " = false;" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_68 = "\t" + NL + "java.lang.Class.forName(\"sun.jdbc.odbc.JdbcOdbcDriver\");";
  protected final String TEXT_69 = NL + "\tString url_";
  protected final String TEXT_70 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=\" + ";
  protected final String TEXT_71 = ";";
  protected final String TEXT_72 = NL + "\tString url_";
  protected final String TEXT_73 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=\" + ";
  ...
  protected final String TEXT_94 = NL + "\tString atnParams_";
  protected final String TEXT_95 = " = ";
  protected final String TEXT_96 = ";" + NL + "\tatnParams_";
  protected final String TEXT_97 = " = atnParams_";
  protected final String TEXT_98 = ".replaceAll(\"&\", \"\\n\");" + NL + "\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_99 = " = new java.util.Properties();" + NL + "\tatnParamsPrope_";
  protected final String TEXT_100 = ".put(\"user\",dbUser_";
  protected final String TEXT_101 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_102 = ".put(\"password\",dbPwd_";
  protected final String TEXT_103 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_104 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_105 = ".getBytes()));" + NL + "  " + NL + "\tconn_";
  protected final String TEXT_106 = " =  java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_107 = ", atnParamsPrope_";
  ...
  protected final String TEXT_113 = ".setAutoCommit(false);\t" + NL + "\t    int commitEvery_";
  protected final String TEXT_114 = " = ";
  protected final String TEXT_115 = ";" + NL + "" + NL + "\t    int commitCounter_";
  protected final String TEXT_116 = " = 0;" + NL + "" + NL + "\t    ";
