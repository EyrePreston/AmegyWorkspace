...
public class TMysqlBulkExecBeginJava {
  ...
  protected final String TEXT_65 = NL + "String charset_";
  protected final String TEXT_66 = " = ";
  protected final String TEXT_67 = ";" + NL + "String tableName_";
  protected final String TEXT_68 = " = ";
  protected final String TEXT_69 = ";" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_70 = "=0;" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_76 = " = \"com.mysql.jdbc.Driver\";" + NL + "\t\tClass.forName(driverClass_";
  protected final String TEXT_77 = ").newInstance();" + NL + "\t\t";
  protected final String TEXT_78 = NL + "\t\t\tString url_";
  protected final String TEXT_79 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_80 = " + \":\" + ";
  protected final String TEXT_81 = " + \"/\" + ";
  protected final String TEXT_82 = ";" + NL + "\t\t";
  protected final String TEXT_83 = NL + "\t\t\tString url_";
  protected final String TEXT_84 = " = \"jdbc:mysql://\" + ";
  ...
  protected final String TEXT_104 = ".createStatement();" + NL + "\t\t\t";
  ...
  protected final String TEXT_123 = " - Creating table ";
  ...
  protected final String TEXT_131 = " - Create table ";
  ...
  protected final String TEXT_185 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_198 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_202 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_203 = ".equals(schema_";
  protected final String TEXT_204 = ") || (schema_";
  protected final String TEXT_205 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_206 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_215 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_216 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_217 = " == null || dbschema_";
  protected final String TEXT_218 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_219 = " = conn_";
  protected final String TEXT_220 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_221 = " = stmtSchema_";
  protected final String TEXT_222 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_223 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_224 = " = rsSchema_";
  protected final String TEXT_225 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_226 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_227 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_269 = " - Creating table ";
  protected final String TEXT_270 = "\" + tableName_";
  ...
  protected final String TEXT_277 = " - Create table ";
  ...
  protected final String TEXT_288 = " - Droping table ";
  protected final String TEXT_289 = "\" + tableName_";
  ...
  protected final String TEXT_296 = " - Drop table ";
  ...
  protected final String TEXT_305 = " - Creating table ";
  ...
  protected final String TEXT_313 = " - Create table ";
  ...
  protected final String TEXT_323 = " - Clearing table ";
  ...
  protected final String TEXT_331 = "- Clear table ";
  ...
  protected final String TEXT_337 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_338 = " = conn_";
  protected final String TEXT_339 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_340 = " = stmtTruncCount_";
  protected final String TEXT_341 = ".executeQuery(\"";
  protected final String TEXT_342 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_346 = " - Trancating table ";
  ...
  protected final String TEXT_354 = " - Truncate table ";
  ...
  protected final String TEXT_365 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_366 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_367 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_368 = NL + "String lines_separator_";
  protected final String TEXT_369 = " = ";
  protected final String TEXT_370 = ";" + NL + "String field_separator_";
  protected final String TEXT_371 = " = ";
  protected final String TEXT_372 = ";" + NL + "String escaped_str_";
  protected final String TEXT_373 = " = ";
  protected final String TEXT_374 = ";" + NL + "String enclosed_str_";
  protected final String TEXT_375 = " = ";
  protected final String TEXT_376 = ";" + NL + "String file_";
  protected final String TEXT_377 = " = ";
  protected final String TEXT_378 = ";" + NL + "file_";
  protected final String TEXT_379 = " = file_";
  protected final String TEXT_380 = ".replaceAll(\"\\\\\\\\\", \"/\");" + NL + "String replace_";
  protected final String TEXT_381 = " = null;";
  protected final String TEXT_382 = NL + "\t\tint keyCount_";
  protected final String TEXT_383 = " = ";
  protected final String TEXT_384 = ";" + NL + "\t\tif(keyCount_";
  protected final String TEXT_385 = " == 0) {" + NL + "\t\t\tthrow new RuntimeException(\"For bulk update, Schema must have a key at least.\");" + NL + "\t\t}" + NL + "\t\ttableName_";
  protected final String TEXT_386 = " = \"tmp_";
  protected final String TEXT_387 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\tjava.sql.Statement stmtTmpCreate_";
  ...
  protected final String TEXT_391 = " - Creating temp table \" + tableName_";
  protected final String TEXT_392 = " + \".\" );" + NL + "\t\t";
  protected final String TEXT_393 = NL + "\t\tstmtTmpCreate_";
  protected final String TEXT_394 = ".execute(\"";
  protected final String TEXT_395 = ")\");" + NL + "\t\tstmtTmpCreate_";
  protected final String TEXT_396 = ".close();" + NL + "" + NL + "\t\tjava.sql.Statement stmtTmpBulk_";
  ...
  protected final String TEXT_400 = " - Create temp table \" + tableName_";
  protected final String TEXT_401 = " + \" has succeeded.\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_402 = " - Bulk inserting data into \" + tableName_";
  protected final String TEXT_403 = " + \".\" );" + NL + "\t\t";
  protected final String TEXT_404 = NL + "\t\tstmtTmpBulk_";
  protected final String TEXT_405 = ".execute(\"SET character_set_database=\" + charset_";
  protected final String TEXT_406 = ");" + NL + "\t\tstmtTmpBulk_";
  protected final String TEXT_407 = ".execute(" + NL + "\t\t\t\"LOAD DATA LOCAL INFILE '\" + file_";
  protected final String TEXT_408 = " + \"' \"" + NL + "\t\t\t+ \" INTO TABLE \" + tableName_";
  protected final String TEXT_409 = NL + "\t\t\t+ \" FIELDS TERMINATED BY '\" + field_separator_";
  protected final String TEXT_410 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t\t+ \" ENCLOSED BY '\"+(\"'\".equals(enclosed_str_";
  protected final String TEXT_411 = ")?\"\\\\\":\"\")+ enclosed_str_";
  protected final String TEXT_412 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t\t+ \" ESCAPED BY '\" +(\"'\".equals(escaped_str_";
  protected final String TEXT_413 = ")?\"\\\\\":\"\")+ escaped_str_";
  protected final String TEXT_414 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\")+ \"'\"" + NL + "\t\t\t+ \" LINES TERMINATED BY '\" + lines_separator_";
  protected final String TEXT_415 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' ";
  protected final String TEXT_416 = "\"";
  protected final String TEXT_417 = NL + "\t\t\t+ \" SET\"";
  protected final String TEXT_418 = NL + "\t\t\t+ \" ";
  protected final String TEXT_419 = "=CAST(@";
  protected final String TEXT_420 = "_";
  protected final String TEXT_421 = " AS UNSIGNED)\"";
  protected final String TEXT_422 = NL + "\t\t\t+ \",\"";
  protected final String TEXT_423 = NL + "\t\t);" + NL + "\t\t";
  protected final String TEXT_424 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_425 = " - Bulk insert data into \" + tableName_";
  protected final String TEXT_426 = " + \" has finished.\");" + NL + "\t\t";
  protected final String TEXT_427 = NL + "\t\ttableName_";
  protected final String TEXT_428 = " = ";
  protected final String TEXT_429 = ";" + NL + "\t\tString tmpTableName_";
  protected final String TEXT_430 = " = \"tmp_";
  protected final String TEXT_431 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\tjava.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_435 = " - Updating \" + tableName_";
  protected final String TEXT_436 = " + \" from \"+tmpTableName_";
  protected final String TEXT_437 = "+\".\");" + NL + "\t\t";
  protected final String TEXT_438 = NL + "\t\tstmtUpdateBulk_";
  protected final String TEXT_439 = ".executeUpdate(\"";
  protected final String TEXT_440 = "\");" + NL + "\t\t";
  protected final String TEXT_441 = NL + "\t\tstmtUpdateBulk_";
  protected final String TEXT_442 = ".close();" + NL + "\t\ttableName_";
  protected final String TEXT_443 = " = tmpTableName_";
  protected final String TEXT_444 = ";" + NL + "\t\tjava.sql.Statement stmtTmpDrop_";
  ...
  protected final String TEXT_448 = " - Droping temp table \" + tableName_";
  protected final String TEXT_449 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_450 = NL + "\t\tstmtTmpDrop_";
  protected final String TEXT_451 = ".execute(\"";
  protected final String TEXT_452 = "\");" + NL + "\t\tstmtTmpDrop_";
  protected final String TEXT_453 = ".close();" + NL + "\t\t";
  protected final String TEXT_454 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_455 = " - Drop temp table \" + tableName_";
  protected final String TEXT_456 = "+ \" has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_457 = NL + "\t\t";
  protected final String TEXT_458 = NL + "\t\treplace_";
  protected final String TEXT_459 = " = \"REPLACE\";" + NL + "\t\t";
  protected final String TEXT_460 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_461 = " - Replacing records in table \" + tableName_";
  protected final String TEXT_462 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_463 = NL + "\t\treplace_";
  protected final String TEXT_464 = " = \"IGNORE\";" + NL + "\t\t";
  protected final String TEXT_465 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_466 = " - Loading data ignore records in table \" + tableName_";
  protected final String TEXT_467 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_468 = NL + "\t\treplace_";
  protected final String TEXT_469 = " = \"\";" + NL + "\t\t";
  protected final String TEXT_470 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_471 = " - Inserting records in table \" + tableName_";
  protected final String TEXT_472 = " + \".\");" + NL + "\t\t";
  protected final String TEXT_473 = NL + "\tString bulkSQL_";
  protected final String TEXT_474 = " = \"LOAD DATA LOCAL INFILE '\" + file_";
  protected final String TEXT_475 = " + \"' \"" + NL + "\t\t+ replace_";
  protected final String TEXT_476 = NL + "\t\t+ \" INTO TABLE \" + tableName_";
  protected final String TEXT_477 = NL + "\t\t+ \" FIELDS TERMINATED BY '\" + field_separator_";
  protected final String TEXT_478 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t+ \" ENCLOSED BY '\"+(\"'\".equals(enclosed_str_";
  protected final String TEXT_479 = ")?\"\\\\\":\"\") + enclosed_str_";
  protected final String TEXT_480 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t+ \" ESCAPED BY '\" + (\"'\".equals(escaped_str_";
  protected final String TEXT_481 = ")?\"\\\\\":\"\")+ escaped_str_";
  protected final String TEXT_482 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"'\"" + NL + "\t\t+ \" LINES TERMINATED BY '\" + lines_separator_";
  protected final String TEXT_483 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' ";
  protected final String TEXT_484 = "\"";
  protected final String TEXT_485 = NL + "\t\t+ \" SET\"";
  protected final String TEXT_486 = NL + "\t\t+ \" ";
  protected final String TEXT_487 = "=CAST(@";
  protected final String TEXT_488 = "_";
  protected final String TEXT_489 = " AS UNSIGNED)\"";
  protected final String TEXT_490 = NL + "\t\t+ \",\"";
  protected final String TEXT_491 = ";" + NL + "\t";
  protected final String TEXT_492 = NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_493 = "=conn_";
  protected final String TEXT_494 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_495 = ".execute(\"SET character_set_database=\" + charset_";
  protected final String TEXT_496 = ");" + NL + "\t" + NL + "\tstmt_";
  protected final String TEXT_497 = ".execute(bulkSQL_";
  protected final String TEXT_498 = ");" + NL + "\t";
  protected final String TEXT_499 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_500 = " - Replace records in table \" + tableName_";
  protected final String TEXT_501 = " + \" has finished.\");" + NL + "\t\t";
  protected final String TEXT_502 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_503 = " - Load data ignore records in table \" + tableName_";
  protected final String TEXT_504 = " + \" has finished.\");" + NL + "\t\t";
  protected final String TEXT_505 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_506 = " - Insert records in table \" + tableName_";
  protected final String TEXT_507 = " + \" has finished.\");" + NL + "\t\t";
