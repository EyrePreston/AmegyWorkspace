...
public class TVerticaOutputMainJava {
  ...
  protected final String TEXT_44 = " = new StringBuffer(\"\");";
  protected final String TEXT_45 = NL + "\t\t\t\tjava.sql.Statement stmtCreateProjection_";
  protected final String TEXT_46 = " = conn_";
  protected final String TEXT_47 = ".createStatement();" + NL + "\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_48 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_49 = " + \"_proj (";
  protected final String TEXT_50 = ") AS SELECT ";
  protected final String TEXT_51 = " FROM \" + tableName_";
  protected final String TEXT_52 = ");" + NL + "\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_53 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_54 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_55 = ") {" + NL + "\t\t\t\t";
  protected final String TEXT_56 = NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_57 = NL + "\t\t\t\tstmtBuilder_";
  protected final String TEXT_58 = " = new StringBuilder();" + NL + "\t\t\t\tstmt_";
  protected final String TEXT_59 = " = conn_";
  protected final String TEXT_60 = ".createStatement();" + NL + "\t\t\t\ttemplate_";
  protected final String TEXT_61 = " = \"COPY \" + tableName_";
  protected final String TEXT_62 = " +\" (";
  protected final String TEXT_63 = ")\" + \" FROM STDIN UNCOMPRESSED WITH DELIMITER ';' RECORD TERMINATOR '\\n' ENCLOSED BY '|' NULL AS '' ";
  protected final String TEXT_64 = "DIRECT";
  protected final String TEXT_65 = "\";" + NL + "\t\t\t";
  protected final String TEXT_66 = NL + "\t\t\t\t\t    for(int i_";
  protected final String TEXT_67 = " = 0; i_";
  protected final String TEXT_68 = " < ";
  protected final String TEXT_69 = ".";
  protected final String TEXT_70 = ".getColumnCount(); i_";
  protected final String TEXT_71 = "++) {" + NL + "\t\t\t\t\t    \tObject currentValue_";
  protected final String TEXT_72 = " = ";
  protected final String TEXT_73 = ".";
  protected final String TEXT_74 = ".getColumnValue(i_";
  protected final String TEXT_75 = ");" + NL + "\t\t\t\t\t    \tif(currentValue_";
  protected final String TEXT_76 = " == null) {" + NL + "\t\t\t\t\t    \t\tstmtBuilder_";
  protected final String TEXT_77 = ".append(\"\");" + NL + "\t\t\t\t\t    \t} else {" + NL + "\t\t\t\t\t\t    \tstmtBuilder_";
  protected final String TEXT_78 = ".append(\"|\");" + NL + "\t\t\t\t\t\t    \troutines.system.DynamicMetadata metadata_";
  protected final String TEXT_79 = " = ";
  protected final String TEXT_80 = ".";
  protected final String TEXT_81 = ".getColumnMetadata(i_";
  protected final String TEXT_82 = ");" + NL + "\t\t\t\t\t\t    \tif(\"id_String\".equals(metadata_";
  protected final String TEXT_83 = ".getType())) {" + NL + "\t\t\t\t\t\t    \t\tstmtBuilder_";
  protected final String TEXT_84 = ".append(String.valueOf(currentValue_";
  protected final String TEXT_85 = ").replaceAll(\"\\\\|\",\"\\\\\\\\|\"));" + NL + "\t\t\t\t\t\t    \t} else if(\"id_Date\".equals(metadata_";
  protected final String TEXT_86 = ".getType())) {" + NL + "\t\t\t\t\t\t    \t\tstmtBuilder_";
  protected final String TEXT_87 = ".append(FormatterUtils.format_Date((java.util.Date)currentValue_";
  protected final String TEXT_88 = ", ";
  protected final String TEXT_89 = "));" + NL + "\t\t\t\t\t\t    \t} else if(\"id_Byte\".equals(metadata_";
  protected final String TEXT_90 = ".getType()) " + NL + "\t\t\t\t\t\t    \t\t|| \"id_Short\".equals(metadata_";
  protected final String TEXT_91 = ".getType()) " + NL + "\t\t\t\t\t\t    \t\t|| \"id_Integer\".equals(metadata_";
  protected final String TEXT_92 = ".getType()) " + NL + "\t\t\t\t\t\t    \t\t|| \"id_Long\".equals(metadata_";
  protected final String TEXT_93 = ".getType())" + NL + "\t\t\t\t\t\t    \t) {" + NL + "\t\t\t\t\t\t    \t\tstmtBuilder_";
  protected final String TEXT_94 = ".append(FormatterUtils.format_Number(String.valueOf(currentValue_";
  protected final String TEXT_95 = "), null, '.'));" + NL + "\t\t\t\t\t\t    \t} else if(\"id_BigDecimal\".equals(metadata_";
  protected final String TEXT_96 = ".getType())) {" + NL + "\t\t\t\t\t\t    \t\tBigDecimal decimal_";
  protected final String TEXT_97 = " = (BigDecimal)currentValue_";
  protected final String TEXT_98 = ";" + NL + "\t\t\t\t\t\t    \t\tstmtBuilder_";
  protected final String TEXT_99 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_100 = "), null, '.'));" + NL + "\t\t\t\t\t\t    \t} else if(\"id_Float\".equals(metadata_";
  protected final String TEXT_101 = ".getType())) {" + NL + "\t\t\t\t\t\t    \t\tBigDecimal decimal_";
  protected final String TEXT_102 = " = new BigDecimal((Float)currentValue_";
  protected final String TEXT_103 = ");" + NL + "\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_104 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_105 = "), null, '.'));" + NL + "\t\t\t\t\t\t    \t} else if(\"id_Double\".equals(metadata_";
  protected final String TEXT_106 = ".getType())) {" + NL + "\t\t\t\t\t\t    \t\tBigDecimal decimal_";
  protected final String TEXT_107 = " = new BigDecimal((Double)currentValue_";
  protected final String TEXT_108 = ");" + NL + "\t\t\t\t\t\t    \t\tstmtBuilder_";
  protected final String TEXT_109 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_110 = "), null, '.'));" + NL + "\t\t\t\t\t\t    \t} else if(\"id_byte[]\".equals(metadata_";
  protected final String TEXT_111 = ".getType())) {" + NL + "\t\t\t\t\t\t    \t\tstmtBuilder_";
  protected final String TEXT_112 = ".append(java.nio.charset.Charset.defaultCharset().decode(java.nio.ByteBuffer.wrap((byte[])currentValue_";
  protected final String TEXT_113 = ")).toString());" + NL + "\t\t\t\t\t\t    \t} else {" + NL + "\t\t\t\t\t\t    \t\tstmtBuilder_";
  protected final String TEXT_114 = ".append(String.valueOf(currentValue_";
  protected final String TEXT_115 = "));" + NL + "\t\t\t\t\t\t    \t}" + NL + "\t\t\t\t\t\t    \tstmtBuilder_";
  protected final String TEXT_116 = ".append(\"|\");" + NL + "\t\t\t\t\t\t    }" + NL + "" + NL + "\t\t\t\t\t    \tif(i_";
  protected final String TEXT_117 = " < (";
  protected final String TEXT_118 = ".";
  protected final String TEXT_119 = ".getColumnCount() - 1)) {" + NL + "\t\t\t\t\t    \t\tstmtBuilder_";
  protected final String TEXT_120 = ".append(\";\");" + NL + "\t\t\t\t\t    \t}" + NL + "\t\t\t\t\t    }" + NL + "\t\t\t\t\t";
  protected final String TEXT_121 = NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_122 = ".append(\"|\");" + NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_123 = ".append(String.valueOf(";
  protected final String TEXT_124 = ".";
  protected final String TEXT_125 = "));" + NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_126 = ".append(\"|\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_127 = NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_128 = ".";
  protected final String TEXT_129 = " == null){" + NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_130 = ".append(\"\");" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_131 = ".append(\"|\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_132 = NL + "\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_133 = ".append(";
  protected final String TEXT_134 = ".";
  protected final String TEXT_135 = ".replaceAll(\"\\\\|\",\"\\\\\\\\|\"));" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_136 = NL + "\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_137 = ".append(FormatterUtils.format_Date(";
  protected final String TEXT_138 = ".";
  protected final String TEXT_139 = ", ";
  protected final String TEXT_140 = "));" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_141 = NL + "\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_142 = ".append(java.nio.charset.Charset.defaultCharset().decode(java.nio.ByteBuffer.wrap(";
  protected final String TEXT_143 = ".";
  protected final String TEXT_144 = ")).toString());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_145 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_147 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_148 = "), null, '.'));" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_149 = NL + "\t\t\t\t\t\t\t\t\tif (";
  protected final String TEXT_150 = ".";
  protected final String TEXT_151 = " != null) {" + NL + "\t\t\t\t\t\t\t\t\t\tBigDecimal decimal_";
  protected final String TEXT_152 = " = new BigDecimal(";
  protected final String TEXT_153 = ".";
  protected final String TEXT_154 = ");" + NL + "\t\t\t\t\t\t\t\t\t\tstmtBuilder_";
  ...
  protected final String TEXT_157 = NL + "\t\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_158 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_159 = ".";
  protected final String TEXT_160 = "), null, '.'));" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_161 = NL + "\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_162 = ".append(String.valueOf(";
  protected final String TEXT_163 = "));" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_164 = NL + "\t\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_165 = ".append(String.valueOf(";
  protected final String TEXT_166 = ".";
  protected final String TEXT_167 = "));" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_168 = NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_169 = ".append(\"|\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_170 = NL + "\t\t\t\t\tstmtBuilder_";
  ...
  protected final String TEXT_177 = NL + "\t\tif(nb_line_";
  ...
  protected final String TEXT_389 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_420 = ", true);" + NL + "    " + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_432 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_557 = "\");" + NL + "\t    pstmtInsert_";
  ...
  protected final String TEXT_600 = ");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_601 = " = conn_";
  protected final String TEXT_602 = ".prepareStatement(insert_";
  protected final String TEXT_603 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_604 = NL + "\t    String delete_";
  protected final String TEXT_605 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_606 = " + \" WHERE ";
  protected final String TEXT_607 = "\";" + NL + "\t    pstmt_";
  protected final String TEXT_608 = " = conn_";
  protected final String TEXT_609 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_691 = " + 1;" + NL + "\t\t\t\t";
  protected final String TEXT_692 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t";
  protected final String TEXT_693 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_694 = ";";
  protected final String TEXT_695 = NL + "\t\t\t\t\tSystem.err.print(e.getMessage());";
  ...
  protected final String TEXT_708 = NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_736 = ".toString().trim());" + NL + "\t\t\t\t";
  protected final String TEXT_737 = NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_738 = NL + "\t\t\tpstmt_";
  protected final String TEXT_739 = ".addBatch();" + NL + "\t\t\tnb_line_";
  protected final String TEXT_740 = "++;" + NL + "\t\t\t";
  protected final String TEXT_741 = NL + "\t\t\tbatchSizeCounter_";
  ...
  protected final String TEXT_762 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_763 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_764 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_765 = NL + "\t\t\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_773 = NL + "\t" + NL + "\t\t\tjava.sql.ResultSet rs_";
  protected final String TEXT_774 = " = pstmt_";
  protected final String TEXT_775 = ".executeQuery();" + NL + "\t\t\tint checkCount_";
  protected final String TEXT_776 = " = -1;" + NL + "\t\t\twhile(rs_";
  protected final String TEXT_777 = ".next()) {" + NL + "\t\t\t\tcheckCount_";
  protected final String TEXT_778 = " = rs_";
  protected final String TEXT_779 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\tif(checkCount_";
  ...
  protected final String TEXT_818 = NL + "\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_819 = "_QUERY\", query_";
  protected final String TEXT_820 = ".toString().trim());" + NL + "\t\t\t\t\t";
  protected final String TEXT_821 = NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tupdatedCount_";
  ...
  protected final String TEXT_826 = NL + "\t\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\t\twhetherReject_";
  protected final String TEXT_827 = " = true;" + NL + "\t\t\t\t\t";
  protected final String TEXT_828 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_833 = "Struct();" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_841 = " + 1;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_842 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_843 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_844 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_845 = NL + "\t\t\t\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_866 = ".toString().trim());" + NL + "\t\t\t\t\t";
  protected final String TEXT_867 = NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tinsertedCount_";
  ...
  protected final String TEXT_872 = NL + "\t\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\t\twhetherReject_";
  protected final String TEXT_873 = " = true;" + NL + "\t\t\t\t\t";
  protected final String TEXT_874 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_879 = "Struct();" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_887 = " + 1;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_888 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_889 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_890 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_891 = NL + "\t\t\t\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_965 = " = insertedCount_";
  protected final String TEXT_966 = " + pstmtInsert_";
  protected final String TEXT_967 = ".executeUpdate(); " + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_968 = "++;";
  protected final String TEXT_969 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_970 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_971 = NL + "    \t\t\t}" + NL + "\t\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\t\twhetherReject_";
  protected final String TEXT_972 = " = true;" + NL + "\t\t\t\t\t";
  protected final String TEXT_973 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_974 = NL + "\t\t\t\t\t\tnb_line_";
  ...
  protected final String TEXT_986 = " + 1;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_987 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_988 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_989 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_990 = NL + "\t\t\t\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_1005 = ".toString().trim());" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_1013 = NL + "\t\t\ttry {" + NL + "\t\t\t\tdeletedCount_";
  ...
  protected final String TEXT_1018 = NL + "\t\t\t} catch(java.lang.Exception e) {" + NL + "\t\t\t\twhetherReject_";
  protected final String TEXT_1019 = " = true;" + NL + "\t\t\t\t";
  protected final String TEXT_1020 = NL + "\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_1021 = NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_1022 = "++;" + NL + "\t\t\t\t\t";
  protected final String TEXT_1023 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_1024 = " = new ";
  protected final String TEXT_1025 = "Struct();" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_1051 = NL + "\t\t\t\tif ( batchSize_";
  protected final String TEXT_1052 = " <= batchSizeCounter_";
  protected final String TEXT_1053 = ") {" + NL + "\t\t\t\t";
  protected final String TEXT_1054 = NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1055 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_1056 = NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_1057 = ".executeBatch();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1058 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_1059 = NL + "\t\t\t\t\t\tjava.io.ByteArrayInputStream bais_";
  protected final String TEXT_1060 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_1061 = ".toString().getBytes());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1062 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_1063 = NL + "    \t\t\t\t\t\tcom.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_1064 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_1065 = ",template_";
  protected final String TEXT_1066 = ");" + NL + "    \t\t\t\t\t\tvcs_";
  protected final String TEXT_1067 = ".start();" + NL + "    \t\t\t\t\t\tvcs_";
  protected final String TEXT_1068 = ".addStream(bais_";
  protected final String TEXT_1069 = ");" + NL + "    \t\t\t\t\t\tvcs_";
  protected final String TEXT_1070 = ".execute();" + NL + "    \t\t\t\t\t\tvcs_";
  protected final String TEXT_1071 = ".finish();" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_1072 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_1073 = NL + "    \t\t\t\t\t\t";
  protected final String TEXT_1074 = NL + "    \t\t\t\t\t\t((com.vertica.PGStatement)stmt_";
  protected final String TEXT_1075 = ").executeCopyIn(template_";
  protected final String TEXT_1076 = ", bais_";
  protected final String TEXT_1077 = ");" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_1078 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_1079 = NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_1080 = " = null;" + NL + "\t\t\t\t\t\tif (bais_";
  protected final String TEXT_1081 = " != null) {" + NL + "\t\t\t\t\t\t\tbais_";
  protected final String TEXT_1082 = ".close();" + NL + "\t\t\t\t\t\t\tbais_";
  protected final String TEXT_1083 = " = null;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_1084 = " = new StringBuilder();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1085 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_1086 = NL + "\t\t\t\t\t\t\tinsertedCount_";
  protected final String TEXT_1087 = " += pstmt_";
  protected final String TEXT_1088 = ". getUpdateCount();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1089 = NL + "\t\t\t\t\t\t\tupdatedCount_";
  protected final String TEXT_1090 = " += pstmt_";
  protected final String TEXT_1091 = ". getUpdateCount();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1092 = NL + "\t\t\t\t\t\t\tdeletedCount_";
  protected final String TEXT_1093 = " += pstmt_";
  protected final String TEXT_1094 = ". getUpdateCount();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1095 = NL + "\t\t\t\t\t\t\t\tcopiedCount_";
  protected final String TEXT_1096 = " += vcs_";
  protected final String TEXT_1097 = ".getRowCount();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1098 = NL + "\t\t\t\t\t\t\t\tcopiedCount_";
  protected final String TEXT_1099 = " += stmt_";
  protected final String TEXT_1100 = ".getUpdateCount();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1101 = NL + "\t\t\t\t\t\tbatchSizeCounter_";
  protected final String TEXT_1102 = " = 0; \t\t\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t}catch (java.sql.SQLException e){" + NL + "\t\t\t\t\t";
  protected final String TEXT_1103 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_1104 = NL + "\t\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_1105 = NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_1106 = NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_1107 = NL + "\t\t\t\tcommitCounter_";
  protected final String TEXT_1108 = "++;" + NL + "\t\t\t\tif(commitEvery_";
  protected final String TEXT_1109 = " <= commitCounter_";
  protected final String TEXT_1110 = ") {" + NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_1111 = NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\t";
  protected final String TEXT_1112 = NL + "\t\t\t\t\t\t\tboolean isCountResult_";
  protected final String TEXT_1113 = " = false;" + NL + "\t\t\t\t\t\t\tif(batchSizeCounter_";
  protected final String TEXT_1114 = " > 0){" + NL + "                \t\t\t\t";
  protected final String TEXT_1115 = NL + "\t\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_1116 = ".executeBatch();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_1117 = NL + "\t\t\t\t\t\t\t\tisCountResult_";
  protected final String TEXT_1118 = " = true;" + NL + "\t\t\t\t\t\t\t\tbatchSizeCounter_";
  protected final String TEXT_1119 = " = 0;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_1124 = NL + "\t\t\t\t\t\tif(isCountResult_";
  ...
  protected final String TEXT_1131 = ".getUpdateCount();" + NL + "\t\t\t\t\t";
  protected final String TEXT_1132 = NL + "\t\t\t\t\t\tdeletedCount_";
  protected final String TEXT_1133 = " += pstmt_";
  protected final String TEXT_1134 = ".getUpdateCount();" + NL + "\t\t\t\t\t";
  protected final String TEXT_1135 = NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1136 = NL + "\t\t\t\t\t\tif (stmtBuilder_";
  protected final String TEXT_1137 = " != null && stmtBuilder_";
  protected final String TEXT_1138 = ".length() != 0 ) { // stmtBuilder_";
  protected final String TEXT_1139 = " start" + NL + "\t\t\t\t\t\t\tjava.io.ByteArrayInputStream bais_";
  protected final String TEXT_1140 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_1141 = ".toString().getBytes());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_1142 = NL + "\t\t\t\t\t\t\t((com.vertica.PGStatement)stmt_";
  protected final String TEXT_1143 = ").executeCopyIn(template_";
  protected final String TEXT_1144 = ", bais_";
  protected final String TEXT_1145 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_1146 = NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_1147 = " = null;" + NL + "\t\t\t\t\t\t\tif (bais_";
  protected final String TEXT_1148 = " != null) {" + NL + "\t\t\t\t\t\t\t\tbais_";
  protected final String TEXT_1149 = ".close();" + NL + "\t\t\t\t\t\t\t\tbais_";
  protected final String TEXT_1150 = " = null;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_1151 = " = new StringBuilder();" + NL + "\t\t\t\t\t\t\tcopiedCount_";
  protected final String TEXT_1152 = " += stmt_";
  protected final String TEXT_1153 = ".getUpdateCount();" + NL + "\t\t\t\t\t\t} // stmtBuilder_";
  protected final String TEXT_1154 = " end" + NL + "\t\t\t\t\t";
  protected final String TEXT_1155 = NL + "\t\t\t\t}catch (java.sql.SQLException e){" + NL + "\t\t\t\t\t";
  protected final String TEXT_1156 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_1157 = NL + "\t\t\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_1158 = NL + "\t\t\t\t" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_1163 = "=0;" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
