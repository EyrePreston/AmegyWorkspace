...
public class TInformixOutputBeginJava {
  ...
  protected final String TEXT_50 = "=0;" + NL + "" + NL + "String dbschema_";
  protected final String TEXT_51 = " = null;" + NL + "String tableName_";
  protected final String TEXT_52 = " = null;" + NL + "boolean whetherReject_";
  protected final String TEXT_53 = " = false;";
  protected final String TEXT_54 = NL + "   int batchSize_";
  protected final String TEXT_55 = " = ";
  protected final String TEXT_56 = ";" + NL + "   int batchSizeCounter_";
  ...
  protected final String TEXT_69 = " = (String)globalMap.get(\"dbschema_";
  ...
  protected final String TEXT_74 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_75 = " + \":\" + ";
  protected final String TEXT_76 = " + \"/\" + ";
  protected final String TEXT_77 = " + \":informixserver=\" + ";
  protected final String TEXT_78 = ";";
  protected final String TEXT_79 = NL + "    String url_";
  protected final String TEXT_80 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_81 = " + \":\" + ";
  protected final String TEXT_82 = " + \"/\" + ";
  protected final String TEXT_83 = " + \":informixserver=\" + ";
  protected final String TEXT_84 = " + \";\" + ";
  protected final String TEXT_85 = ";";
  protected final String TEXT_86 = NL + "\turl_";
  protected final String TEXT_87 = " +=\";IFX_USEPUT=1\";";
  protected final String TEXT_88 = NL + "\tjava.lang.Class.forName(\"com.informix.jdbc.IfxDriver\");" + NL + "\t";
  protected final String TEXT_89 = NL + "\tdbschema_";
  ...
  protected final String TEXT_114 = ".getAutoCommit()) {" + NL + "\t    conn_";
  protected final String TEXT_115 = ".setAutoCommit(false);" + NL + "\t}";
  protected final String TEXT_116 = NL + "\tif(!conn_";
  protected final String TEXT_117 = ".getAutoCommit()) {" + NL + "\t    conn_";
  protected final String TEXT_118 = ".setAutoCommit(true);" + NL + "\t}" + NL + "\t";
  protected final String TEXT_119 = NL + "if(dbschema_";
  protected final String TEXT_120 = " == null || dbschema_";
  protected final String TEXT_121 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_122 = " = ";
  protected final String TEXT_123 = ";" + NL + "} else {" + NL + "    tableName_";
  ...
  protected final String TEXT_143 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_144 = ".";
  protected final String TEXT_145 = ", \"";
  protected final String TEXT_146 = "\")";
  protected final String TEXT_147 = ".toUpperCase()";
  ...
  protected final String TEXT_200 = " = true;" + NL + "                \t\t\t\t} catch (java.lang.Exception e){" + NL + "                \t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_206 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_207 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_208 = " = tableNameForSearch_";
  protected final String TEXT_209 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_210 = " = tableNameForSearch_";
  protected final String TEXT_211 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_263 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_264 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_273 = " = false;" + NL + "                \t            String defaultSchema_";
  protected final String TEXT_274 = " = \"public\";" + NL + "                \t            if(dbschema_";
  protected final String TEXT_275 = " == null || dbschema_";
  protected final String TEXT_276 = ".trim().length() == 0) {" + NL + "                \t            \tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_283 = ".getString(\"current_schema\");" + NL + "                \t            \t}" + NL + "                \t            \trsSchema_";
  protected final String TEXT_284 = ".close();" + NL + "                \t            \tstmtSchema_";
  protected final String TEXT_285 = ".close();" + NL + "                \t            }" + NL + "                \t            while(rsTable_";
  protected final String TEXT_286 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_287 = " = rsTable_";
  protected final String TEXT_288 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_289 = " = rsTable_";
  protected final String TEXT_290 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  ...
  protected final String TEXT_300 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_301 = ".equals";
  protected final String TEXT_302 = "IgnoreCase";
  protected final String TEXT_303 = "(schema_";
  ...
  protected final String TEXT_315 = ".getString(\"TABLE_NAME\");" + NL + "                \t                if(table_";
  protected final String TEXT_316 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_321 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_339 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_349 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_369 = NL + "    \t\t\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_370 = ", true);" + NL + "    " + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_385 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_386 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_387 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  ...
  protected final String TEXT_391 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_405 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_422 = NL + "            while(rsTruncCount_";
  protected final String TEXT_423 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_424 = " += rsTruncCount_";
  protected final String TEXT_425 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_426 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_427 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_447 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_453 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_454 = " = conn_";
  protected final String TEXT_455 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_460 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_468 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_475 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_479 = NL + "\t    String delete_";
  protected final String TEXT_480 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_486 = NL + "        StringBuffer query_";
  protected final String TEXT_487 = " = null;" + NL + "       \t";
  protected final String TEXT_488 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_498 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_499 = " = insert_";
  protected final String TEXT_500 = ".split(\"\\\\?\");";
  protected final String TEXT_501 = NL + "\t\t\tdelete_";
  protected final String TEXT_502 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_503 = " = delete_";
  protected final String TEXT_504 = ".split(\"\\\\?\");";
  protected final String TEXT_505 = NL + "\t\t\treplace_";
  protected final String TEXT_506 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_507 = " = replace_";
  protected final String TEXT_508 = ".split(\"\\\\?\");";
  protected final String TEXT_509 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_510 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_511 = " = insertIgnore_";
  protected final String TEXT_512 = ".split(\"\\\\?\");";
  protected final String TEXT_513 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_514 = " = insert_";
  protected final String TEXT_515 = ".split(\"\\\\?\");";
  protected final String TEXT_516 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_517 = " = ";
  protected final String TEXT_518 = ";" + NL + "        " + NL + "        int commitCounter_";
  protected final String TEXT_519 = " = 0;" + NL + "        ";
  protected final String TEXT_520 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_521 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_522 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_531 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_535 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_536 = " = null;";
  protected final String TEXT_537 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
