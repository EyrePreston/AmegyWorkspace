...
public class TNetezzaBulkExecBeginJava {
  ...
  protected final String TEXT_65 = NL + "\tString bulkSQL_";
  protected final String TEXT_66 = "=\"\";";
  protected final String TEXT_67 = NL + "\tCharacter OUT_DELIM_";
  protected final String TEXT_68 = " = (";
  protected final String TEXT_69 = ").charAt(0); " + NL + "\tbulkSQL_";
  protected final String TEXT_70 = " += \"INSERT INTO \" + ";
  protected final String TEXT_71 = " + \" \"  " + NL + "            + \" SELECT * FROM EXTERNAL '\"+ ";
  protected final String TEXT_72 = " + \"'\"" + NL + "            + \" USING (DELIM '\"+OUT_DELIM_";
  protected final String TEXT_73 = "+\"' REMOTESOURCE 'JDBC' \"" + NL + "\t\t\t+ \" DATESTYLE '\"+";
  protected final String TEXT_74 = "+\"' DATEDELIM '\"+";
  protected final String TEXT_75 = "+\"' \"" + NL + "\t\t\t+ \" TIMESTYLE '";
  protected final String TEXT_76 = "' TIMEDELIM '\"+";
  protected final String TEXT_77 = "+\"' \"" + NL + "\t\t\t";
  protected final String TEXT_78 = NL + "\t\t\t+ \" ESCAPECHAR '\"+";
  protected final String TEXT_79 = "+\"' \"" + NL + "\t\t\t";
  protected final String TEXT_80 = NL + "\t\t\t+ \"\tMAXERRORS ";
  protected final String TEXT_81 = " SKIPROWS ";
  protected final String TEXT_82 = " LOGDIR '' ";
  ...
  protected final String TEXT_89 = ").newInstance();" + NL + "\t\tString url_";
  ...
  protected final String TEXT_109 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_110 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_111 = " - Bulk inserting data into \" + ";
  protected final String TEXT_112 = " + \".\" );" + NL + "\t";
  protected final String TEXT_113 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_114 = " = conn_";
  protected final String TEXT_115 = ".createStatement();" + NL + "    stmtBulk_";
  protected final String TEXT_116 = ".execute(bulkSQL_";
  protected final String TEXT_117 = ");" + NL + "    stmtBulk_";
  ...
  protected final String TEXT_121 = " + \" has finished.\");" + NL + "\t";
