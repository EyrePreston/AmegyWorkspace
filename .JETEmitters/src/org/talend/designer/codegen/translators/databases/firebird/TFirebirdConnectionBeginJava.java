...
public class TFirebirdConnectionBeginJava
{
  ...
  protected final String TEXT_85 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\tlog.info(\"";
  ...
  protected final String TEXT_88 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_101 = ".setAutoCommit(";
  ...
  protected final String TEXT_111 = ".executeBatch();" + NL + "\t\t\t";
  ...
  protected final String TEXT_115 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_116 = " += (countEach_";
  protected final String TEXT_117 = " < 0 ? 0 : ";
  protected final String TEXT_118 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_119 = NL + "\t";
  protected final String TEXT_120 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
