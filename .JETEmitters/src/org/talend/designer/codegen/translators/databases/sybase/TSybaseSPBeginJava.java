...
public class TSybaseSPBeginJava
{
  ...
  protected final String TEXT_47 = NL + "    java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");";
  protected final String TEXT_48 = NL + "\t\t String connectionString_";
  protected final String TEXT_49 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_50 = " + \":\" + ";
  protected final String TEXT_51 = " + \"/\" + ";
  protected final String TEXT_52 = ";";
  protected final String TEXT_53 = NL + "\t\t String connectionString_";
  protected final String TEXT_54 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_68 = NL + "    java.sql.Connection connection_";
  protected final String TEXT_69 = " = java.sql.DriverManager.getConnection(connectionString_";
  ...
  protected final String TEXT_76 = NL + "String spName_";
  protected final String TEXT_77 = " = ";
  protected final String TEXT_78 = ";" + NL + "if(dbschema_";
  protected final String TEXT_79 = " != null && dbschema_";
  protected final String TEXT_80 = ".trim().length() != 0) {" + NL + "\tspName_";
  protected final String TEXT_81 = " = dbschema_";
  protected final String TEXT_82 = " + \".\" + spName_";
  protected final String TEXT_83 = ";" + NL + "} ";
  protected final String TEXT_84 = NL + "java.sql.PreparedStatement statement_";
  protected final String TEXT_85 = " = connection_";
  protected final String TEXT_86 = ".prepareStatement(\"select \" + spName_";
  protected final String TEXT_87 = " + \"(";
  protected final String TEXT_88 = NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_89 = " = connection_";
  protected final String TEXT_90 = ".prepareCall(\"{call \" + ";
  ...
  protected final String TEXT_97 = NL + "    statement_";
  protected final String TEXT_98 = ".setQueryTimeout(";
  protected final String TEXT_99 = ");";
  protected final String TEXT_100 = NL + NL + "java.sql.Date tmpDate_";
  protected final String TEXT_101 = ";" + NL + "String tmpString_";
