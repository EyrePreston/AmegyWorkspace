...
public class TInformixOutputMainJava {
  ...
  protected final String TEXT_623 = ".executeUpdate();" + NL + "        \t    ";
  protected final String TEXT_624 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_635 = NL + "                        rejectedCount_";
  protected final String TEXT_636 = " = rejectedCount_";
  protected final String TEXT_637 = " + 1;";
  protected final String TEXT_638 = NL + "                        ";
  protected final String TEXT_639 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_640 = NL + "                        ";
  protected final String TEXT_641 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_642 = ";";
  protected final String TEXT_643 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_648 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_649 = " = pstmt_";
  protected final String TEXT_650 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_651 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_652 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_653 = " = rs_";
  protected final String TEXT_654 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_655 = " > 0) {";
  protected final String TEXT_656 = NL + "                        ";
  protected final String TEXT_657 = NL + "                            query_";
  protected final String TEXT_658 = " = ";
  protected final String TEXT_659 = ";";
  protected final String TEXT_660 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_661 = ",";
  protected final String TEXT_662 = ".";
  protected final String TEXT_663 = ", ";
  protected final String TEXT_664 = ",updateSQLSplits_";
  ...
  protected final String TEXT_693 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_694 = " = updatedCount_";
  protected final String TEXT_695 = " + pstmtUpdate_";
  protected final String TEXT_696 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_697 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_698 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_699 = " = true;";
  protected final String TEXT_700 = NL + "                        throw(e);";
  protected final String TEXT_701 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_715 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_720 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_721 = NL + "                        ";
  protected final String TEXT_722 = NL + "                            query_";
  protected final String TEXT_723 = " = ";
  protected final String TEXT_724 = ";";
  protected final String TEXT_725 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_726 = ",";
  protected final String TEXT_727 = ".";
  protected final String TEXT_728 = ", ";
  protected final String TEXT_729 = ",insertSQLSplits_";
  protected final String TEXT_730 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_731 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_778 = ",updateSQLSplits_";
  ...
  protected final String TEXT_783 = ", pstmtUpdate_";
  ...
  protected final String TEXT_808 = "  " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_809 = "=pstmtUpdate_";
  protected final String TEXT_810 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_811 = " = updatedCount_";
  protected final String TEXT_812 = " + updateFlag_";
  protected final String TEXT_813 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_814 = " == 0) {" + NL + "            \t";
  protected final String TEXT_815 = NL + "\t\t\t\tquery_";
  protected final String TEXT_816 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_827 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_828 = ".";
  protected final String TEXT_829 = ", pstmtInsert_";
  protected final String TEXT_830 = ", ";
  protected final String TEXT_831 = ", \"";
  protected final String TEXT_832 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_833 = NL + "                    globalMap.put(\"";
  protected final String TEXT_834 = "_QUERY\", query_";
  protected final String TEXT_835 = ".toString().trim());";
  protected final String TEXT_836 = NL + "                    insertedCount_";
  protected final String TEXT_837 = " = insertedCount_";
  protected final String TEXT_838 = " + pstmtInsert_";
  protected final String TEXT_839 = ".executeUpdate();" + NL + "             \t\tnb_line_";
  protected final String TEXT_840 = "++;";
  protected final String TEXT_841 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_842 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_843 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_880 = ".addBatch();" + NL + "\t\t\t" + NL + "\t\t\t\tnb_line_";
  ...
  protected final String TEXT_889 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_926 = "                                                " + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_927 = " = 0;             \t                \t                \t" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_928 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_929 = NL + "\t\t\t\t\t\tfor(int countEach_";
  ...
  protected final String TEXT_945 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_946 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_947 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_948 = NL + "                }";
  protected final String TEXT_949 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_950 = NL + "            commitCounter_";
  protected final String TEXT_951 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_952 = "<=commitCounter_";
  protected final String TEXT_953 = ") {" + NL + "            \t";
  protected final String TEXT_954 = NL + "                conn_";
  protected final String TEXT_955 = ".commit();";
  protected final String TEXT_956 = " " + NL + "                commitCounter_";
  protected final String TEXT_957 = " = 0;" + NL + "            " + NL + "            }" + NL + "        ";
