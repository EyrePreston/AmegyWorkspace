...
public class TAccessOutputBulkBeginJava
{
  ...
  protected final String TEXT_39 = NL + "\t\tString fileName_";
  protected final String TEXT_40 = " = (new java.io.File(";
  protected final String TEXT_41 = ")).getAbsolutePath().replace(\"\\\\\",\"/\");";
  protected final String TEXT_42 = NL + "\t\tString directory_";
  protected final String TEXT_43 = " = null;" + NL + "\t\tif((fileName_";
  protected final String TEXT_44 = ".indexOf(\"/\") != -1)) {     " + NL + "\t\t    directory_";
  protected final String TEXT_45 = " = fileName_";
  protected final String TEXT_46 = ".substring(0, fileName_";
  protected final String TEXT_47 = ".lastIndexOf(\"/\"));            " + NL + "\t\t} else {" + NL + "\t\t    directory_";
  protected final String TEXT_48 = " = \"\";" + NL + "\t\t}" + NL + "" + NL + "\t\tif(directory_";
  protected final String TEXT_49 = " != null && directory_";
  protected final String TEXT_50 = ".trim().length() != 0) {" + NL + " \t\t\tjava.io.File dir_";
  protected final String TEXT_51 = " = new java.io.File(directory_";
  protected final String TEXT_52 = ");" + NL + "\t\t\tif(!dir_";
  protected final String TEXT_53 = ".exists()) {";
  protected final String TEXT_54 = NL + "                if(dir_";
  protected final String TEXT_55 = ".mkdirs()){";
  protected final String TEXT_56 = NL + "                    System.out.println(\"The directory '\"+directory_";
  protected final String TEXT_57 = "+\"' has been created successfully.\");" + NL + "                }else{";
  protected final String TEXT_58 = NL + "                    System.err.println(\"Fail to create directory '\"+directory_";
  protected final String TEXT_59 = "+\"'.\");" + NL + "                }" + NL + "" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_60 = NL + NL + "\t\tint nb_line_";
  protected final String TEXT_61 = " = 0;" + NL + "\t\t" + NL + "\t\tfinal String OUT_DELIM_";
  protected final String TEXT_62 = " = \",\";" + NL + "\t\t" + NL + "\t\tfinal String OUT_DELIM_ROWSEP_";
  protected final String TEXT_63 = " = \"\\n\";" + NL + "\t\t";
  protected final String TEXT_64 = "\t\t\t\t" + NL + "\t\tfinal String OUT_FIELDS_ENCLOSURE_";
  protected final String TEXT_65 = " = ";
  protected final String TEXT_66 = ";" + NL + "\t\t";
  protected final String TEXT_67 = "\t\t" + NL + "\t\t" + NL + "\t\tjava.io.File file_";
  protected final String TEXT_68 = "=new java.io.File(";
  protected final String TEXT_69 = ");" + NL + "\t\tfinal java.io.BufferedWriter out";
  protected final String TEXT_70 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "        \t\tnew java.io.FileOutputStream(file_";
  protected final String TEXT_71 = ", ";
  protected final String TEXT_72 = "),";
  protected final String TEXT_73 = "));" + NL + "       \tresourceMap.put(\"out";
  protected final String TEXT_74 = "\", out";
  protected final String TEXT_75 = ");";
  protected final String TEXT_76 = NL + "\t\tif(file_";
  protected final String TEXT_77 = ".length()==0){";
  protected final String TEXT_78 = NL + "    \t\t\tout";
  protected final String TEXT_79 = ".write(\"";
  protected final String TEXT_80 = "\");" + NL + "    \t\t";
  protected final String TEXT_81 = "out";
  protected final String TEXT_82 = ".write(OUT_DELIM_";
  protected final String TEXT_83 = ");";
  protected final String TEXT_84 = NL + "    \t\tout";
  protected final String TEXT_85 = ".write(OUT_DELIM_ROWSEP_";
  protected final String TEXT_86 = ");" + NL + "    \t\tout";
  protected final String TEXT_87 = ".flush();" + NL + "    \t}";
