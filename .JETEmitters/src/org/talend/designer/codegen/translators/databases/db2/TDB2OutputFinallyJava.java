...
public class TDB2OutputFinallyJava
{
  ...
  protected final String TEXT_42 = NL + "\t\tif(resourceMap.get(\"finish_";
  protected final String TEXT_43 = "\")==null){" + NL + "\t\t\tif(resourceMap.get(\"conn_";
  protected final String TEXT_44 = "\")!=null){" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\t";
  protected final String TEXT_45 = NL + "\t\t\t\t\t((java.sql.Connection)resourceMap.get(\"conn_";
  protected final String TEXT_46 = "\")).close();" + NL + "\t\t\t\t\t";
  protected final String TEXT_47 = NL + "\t\t\t\t} catch (java.sql.SQLException sqlEx_";
  protected final String TEXT_48 = ") {" + NL + "\t\t\t\t\tString errorMessage_";
  protected final String TEXT_49 = " = \"failed to close the connection in ";
  protected final String TEXT_50 = " :\" + sqlEx_";
  protected final String TEXT_51 = ".getMessage();" + NL + "\t\t\t\t\t";
  protected final String TEXT_52 = NL + "\t\t\t\t\tSystem.err.println(errorMessage_";
