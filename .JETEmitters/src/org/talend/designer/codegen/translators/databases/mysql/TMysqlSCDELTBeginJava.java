...
public class TMysqlSCDELTBeginJava {
  ...
  protected final String TEXT_37 = NL + "    String tableName_";
  protected final String TEXT_38 = " = ";
  protected final String TEXT_39 = ";" + NL + "    String sourceTable_";
  protected final String TEXT_40 = " = ";
  protected final String TEXT_41 = ";";
  protected final String TEXT_42 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_43 = " = conn_";
  protected final String TEXT_44 = ".createStatement();" + NL + "            stmtDrop_";
  protected final String TEXT_45 = ".execute(\"";
  protected final String TEXT_46 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_47 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_53 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_54 = " = conn_";
  protected final String TEXT_55 = ".createStatement();" + NL + "            stmtCreate_";
  ...
  protected final String TEXT_85 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_91 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_92 = " = conn_";
  protected final String TEXT_93 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_94 = ".executeUpdate(\"";
  protected final String TEXT_95 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_96 = ".close();";
  protected final String TEXT_97 = NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_98 = " = conn_";
  protected final String TEXT_99 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_100 = ".executeUpdate(\"";
  protected final String TEXT_101 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_102 = ".close();";
  protected final String TEXT_103 = NL + "        System.out.println(\"[";
  protected final String TEXT_104 = "] table action ";
  protected final String TEXT_105 = " done\\n\");";
  protected final String TEXT_106 = NL + "    ";
  protected final String TEXT_107 = NL + "        String updateForType1_";
  protected final String TEXT_108 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_109 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_110 = " + \"` t SET ";
  protected final String TEXT_111 = " WHERE ";
  protected final String TEXT_112 = " AND (";
  protected final String TEXT_113 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_114 = " = conn_";
  protected final String TEXT_115 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_116 = ".executeUpdate(updateForType1_";
  protected final String TEXT_117 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_118 = ".close();";
  protected final String TEXT_119 = NL + "            System.out.println(\"[";
  protected final String TEXT_120 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_121 = " + \"\\ndone\");";
  protected final String TEXT_122 = "        " + NL + "        String changeDateTime_";
  protected final String TEXT_123 = " = (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_124 = "\"))).toString();" + NL + "\t";
  protected final String TEXT_125 = NL + "        String changeDateTime_";
  protected final String TEXT_126 = "_begin = changeDateTime_";
  protected final String TEXT_127 = ";" + NL + "        String changeDateTime_";
  protected final String TEXT_128 = "_end = changeDateTime_";
  protected final String TEXT_129 = ";" + NL + "        ";
  protected final String TEXT_130 = NL + "\t\t        changeDateTime_";
  protected final String TEXT_131 = "_begin = routines.system.DBDateParser.getDBDateParser(\"";
  protected final String TEXT_132 = "\").getDateString(\"";
  protected final String TEXT_133 = "\",\"";
  protected final String TEXT_134 = "\",(Long)start_Hash.get(\"";
  protected final String TEXT_135 = "\"),";
  protected final String TEXT_136 = ");" + NL + "\t\t";
  protected final String TEXT_137 = NL + "        \t\tchangeDateTime_";
  protected final String TEXT_138 = "_end = routines.system.DBDateParser.getDBDateParser(\"";
  protected final String TEXT_139 = "\").getDateString(\"";
  protected final String TEXT_140 = "\",\"";
  protected final String TEXT_141 = "\",(Long)start_Hash.get(\"";
  protected final String TEXT_142 = "\"),";
  protected final String TEXT_143 = ");";
  protected final String TEXT_144 = NL + "        String updateForType2_";
  protected final String TEXT_145 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_146 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_147 = " + \"` t SET `";
  protected final String TEXT_148 = "` = '\" + (changeDateTime_";
  ...
  protected final String TEXT_161 = NL + "        \tString updateForType2_";
  protected final String TEXT_162 = "_debug = \"UPDATE `\" + tableName_";
  protected final String TEXT_163 = " + \"` d, `\" + sourceTable_";
  protected final String TEXT_164 = " + \"` t SET `";
  protected final String TEXT_165 = "` = '\" + (changeDateTime_";
  protected final String TEXT_166 = "_end) + \"'";
  protected final String TEXT_167 = ", `";
  protected final String TEXT_168 = "` = 0";
  protected final String TEXT_169 = " WHERE ";
  protected final String TEXT_170 = " AND (";
  protected final String TEXT_171 = ") AND d.`";
  protected final String TEXT_172 = "` IS NULL\"; " + NL + "            System.out.println(\"[";
  protected final String TEXT_173 = "] type2 update sql\\n\" + updateForType2_";
  protected final String TEXT_174 = "_debug + \"\\ndone\");";
  protected final String TEXT_175 = NL + "        String insertForType2_";
  protected final String TEXT_176 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_177 = " + \"`(";
  protected final String TEXT_178 = ") SELECT t.";
  protected final String TEXT_179 = ", '\" + " + NL + "        (changeDateTime_";
  protected final String TEXT_180 = ") + \"', NULL";
  protected final String TEXT_181 = ", 1";
  protected final String TEXT_182 = ", d.`";
  protected final String TEXT_183 = "` + 1";
  protected final String TEXT_184 = " FROM `\" + " + NL + "        sourceTable_";
  protected final String TEXT_185 = " + \"` t, `\" + tableName_";
  protected final String TEXT_186 = " + \"` d WHERE ";
  protected final String TEXT_187 = " AND (";
  protected final String TEXT_188 = ") AND d.`";
  protected final String TEXT_189 = "` = '\" + (changeDateTime_";
  protected final String TEXT_190 = ") + \"'\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_191 = " = conn_";
  protected final String TEXT_192 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_193 = ".executeUpdate(insertForType2_";
  protected final String TEXT_194 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_195 = ".close();";
  protected final String TEXT_196 = NL + "\t\t\tString insertForType2_";
  protected final String TEXT_197 = "_debug = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_198 = " + \"`(";
  protected final String TEXT_199 = ") SELECT t.";
  protected final String TEXT_200 = ", '\" + (changeDateTime_";
  protected final String TEXT_201 = "_begin) + \"', NULL";
  protected final String TEXT_202 = ", 1";
  protected final String TEXT_203 = ", d.`";
  protected final String TEXT_204 = "` + 1";
  protected final String TEXT_205 = " FROM `\" + sourceTable_";
  protected final String TEXT_206 = " + \"` t, `\" + tableName_";
  protected final String TEXT_207 = " + \"` d WHERE ";
  protected final String TEXT_208 = " AND (";
  protected final String TEXT_209 = ") AND d.`";
  protected final String TEXT_210 = "` = '\" + (changeDateTime_";
  protected final String TEXT_211 = "_end) + \"'\";" + NL + "            System.out.println(\"[";
  protected final String TEXT_212 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_213 = "_debug + \"\\ndone\");";
  protected final String TEXT_214 = NL + "    String insert_";
  protected final String TEXT_215 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_216 = " + \"`(";
  protected final String TEXT_217 = ") SELECT t.";
  protected final String TEXT_218 = "\"";
  protected final String TEXT_219 = " + \", '\" + (changeDateTime_";
  protected final String TEXT_220 = ") + \"', NULL\"";
  protected final String TEXT_221 = NL + "    + \"";
  protected final String TEXT_222 = ", 1";
  protected final String TEXT_223 = ", 1";
  protected final String TEXT_224 = " FROM `\" + " + NL + "    sourceTable_";
  protected final String TEXT_225 = " + \"` t LEFT JOIN `\" + tableName_";
  protected final String TEXT_226 = " + \"` d ON ";
  protected final String TEXT_227 = " WHERE (";
  protected final String TEXT_228 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_229 = " = conn_";
  protected final String TEXT_230 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_231 = ".executeUpdate(insert_";
  protected final String TEXT_232 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_233 = ".close();";
  protected final String TEXT_234 = NL + "    \tString insert_";
  protected final String TEXT_235 = "_debug = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_236 = " + \"`(";
  protected final String TEXT_237 = ") SELECT t.";
  protected final String TEXT_238 = "\"";
  protected final String TEXT_239 = " + \", '\" + (changeDateTime_";
  protected final String TEXT_240 = "_begin) + \"', NULL\"";
  protected final String TEXT_241 = " + \"";
  protected final String TEXT_242 = ", 1";
  protected final String TEXT_243 = ", 1";
  protected final String TEXT_244 = " FROM `\" + sourceTable_";
  protected final String TEXT_245 = " + \"` t LEFT JOIN `\" + tableName_";
  protected final String TEXT_246 = " + \"` d ON ";
  protected final String TEXT_247 = " WHERE (";
  protected final String TEXT_248 = ")\";" + NL + "        System.out.println(\"[";
  protected final String TEXT_249 = "] new rows sql\\n\" + insert_";
  protected final String TEXT_250 = "_debug + \"\\ndone\");";
