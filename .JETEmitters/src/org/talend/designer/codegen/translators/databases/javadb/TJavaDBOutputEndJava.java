...
public class TJavaDBOutputEndJava
{
  ...
  protected final String TEXT_63 = NL + "    \ttry" + NL + "    \t{" + NL + "    \t\tjava.sql.DriverManager.getConnection(\"jdbc:derby:;shutdown=true\");" + NL + "    \t}" + NL + "    \tcatch(java.sql.SQLException se)" + NL + "    \t{" + NL + "            /*" + NL + "               In embedded mode, an application should shut down Derby." + NL + "               If the application fails to shut down Derby explicitly," + NL + "               the Derby does not perform a checkpoint when the JVM shuts down, which means" + NL + "               that the next connection will be slower." + NL + "               Explicitly shutting down Derby with the URL is preferred." + NL + "               This style of shutdown will always throw an \"exception\"." + NL + "             */" + NL + "    \t}\t";
  protected final String TEXT_64 = NL + "    \tserverControl_";
  protected final String TEXT_65 = ".shutdown();" + NL + "    \t";
  protected final String TEXT_66 = NL + "\tresourceMap.put(\"finish_";
  protected final String TEXT_67 = "\", true);" + NL + "\t" + NL + "\tint rejectedCount_";
  protected final String TEXT_68 = " = 0;" + NL + "\t";
  protected final String TEXT_69 = NL + "\tnb_line_deleted_";
