...
public class TSasOutputBeginJava {
  ...
  protected final String TEXT_54 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_55 = " = 0;" + NL + "int updatedCount_";
  protected final String TEXT_56 = " = 0;" + NL + "int insertedCount_";
  protected final String TEXT_57 = " = 0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_58 = " = false;" + NL;
  protected final String TEXT_59 = NL + "\tjava.sql.Connection connection_";
  ...
  protected final String TEXT_77 = NL + "      " + NL + "    String dbPwd_";
  protected final String TEXT_78 = " = decryptedPassword_";
  protected final String TEXT_79 = ";" + NL + "\tjava.util.Properties property_";
  protected final String TEXT_80 = " = new java.util.Properties();" + NL + "\t" + NL + "\t";
  protected final String TEXT_81 = NL + "\t\tString librefs_";
  protected final String TEXT_82 = " = ";
  protected final String TEXT_83 = ";" + NL + "\t\tproperty_";
  protected final String TEXT_84 = ".setProperty(\"librefs\", librefs_";
  protected final String TEXT_85 = ");" + NL + "\t";
  protected final String TEXT_86 = NL + "\tproperty_";
  protected final String TEXT_87 = ".setProperty(\"username\", dbUser_";
  protected final String TEXT_88 = ");" + NL + "\tproperty_";
  protected final String TEXT_89 = ".setProperty(\"password\", dbPwd_";
  protected final String TEXT_90 = ");" + NL + "\t";
  protected final String TEXT_91 = NL + "\t\t\tproperty_";
  protected final String TEXT_92 = ".setProperty(String.valueOf(";
  protected final String TEXT_93 = "), String.valueOf(";
  protected final String TEXT_94 = "));" + NL + "\t\t";
  protected final String TEXT_95 = "\t" + NL + "    java.sql.Connection connection_";
  protected final String TEXT_96 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_97 = ", property_";
  protected final String TEXT_98 = ");" + NL + "\t";
  protected final String TEXT_99 = "    " + NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_100 = "\", connection_";
  protected final String TEXT_101 = ");";
  protected final String TEXT_102 = NL + "//        connection_";
  protected final String TEXT_103 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_104 = " = ";
  protected final String TEXT_105 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_106 = " = 0;         ";
  protected final String TEXT_107 = NL + "\tjava.sql.Statement statementClear_";
  ...
  protected final String TEXT_111 = " + statementClear_";
  protected final String TEXT_112 = ".executeUpdate(\"delete from \" + ";
  ...
  protected final String TEXT_131 = " = connection_";
  ...
  protected final String TEXT_139 = " = connection_";
