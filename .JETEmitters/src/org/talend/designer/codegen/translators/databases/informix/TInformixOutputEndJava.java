...
public class TInformixOutputEndJava
{
  ...
  protected final String TEXT_53 = "                " + NL + "\t\t\ttry {" + NL + "\t\t\t\t// when PreparedStatement execute \"executeBatch\" if have no any data to update that will throw \"java.sql.SQLException: Method can be called only once.\"" + NL + "\t\t\t\tif (pstmt_";
  protected final String TEXT_54 = " != null && batchSizeCounter_";
  protected final String TEXT_55 = " > 0) {" + NL + "\t\t\t\t\tint countSum_";
  ...
  protected final String TEXT_59 = ".executeBatch()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_60 = " += (countEach_";
  protected final String TEXT_61 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_73 = NL + "    \t    \t}" + NL + "            }catch (java.sql.BatchUpdateException e){" + NL + "            \t";
  protected final String TEXT_74 = NL + "            \t\tthrow(e);" + NL + "            \t";
  protected final String TEXT_75 = NL + "            \tSystem.err.println(e.getMessage());" + NL + "            \t";
  protected final String TEXT_76 = "                \t" + NL + "        \t}                                  ";
  protected final String TEXT_77 = " " + NL + "        if(pstmt_";
  protected final String TEXT_78 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_79 = ".close();" + NL + "            " + NL + "        }" + NL + " ";
  ...
  protected final String TEXT_112 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_113 = "_NB_LINE_UPDATED\") + nb_line_update_";
  ...
  protected final String TEXT_118 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_121 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_124 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_125 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_126 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_127 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_130 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
