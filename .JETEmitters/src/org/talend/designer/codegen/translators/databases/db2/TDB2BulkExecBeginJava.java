...
public class TDB2BulkExecBeginJava {
  ...
  protected final String TEXT_67 = "\");" + NL + "\t\tString schema_";
  ...
  protected final String TEXT_73 = " = \"jdbc:db2://\" + ";
  ...
  protected final String TEXT_84 = " = \"com.ibm.db2.jcc.DB2Driver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_97 = ";" + NL + "\t\tString schema_";
  ...
  protected final String TEXT_102 = " = null;" + NL + "\t\tif(schema_";
  protected final String TEXT_103 = " == null || schema_";
  ...
  protected final String TEXT_109 = ";" + NL + "\t\t}" + NL + "" + NL + "\t\tString fileName_";
  protected final String TEXT_110 = " = ";
  protected final String TEXT_111 = ";" + NL;
  protected final String TEXT_112 = NL + "\t\tString sqlLoadPending_";
  protected final String TEXT_113 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "\t\tjava.sql.CallableStatement callStmtLoadPending_";
  protected final String TEXT_114 = " = conn_";
  protected final String TEXT_115 = ".prepareCall(sqlLoadPending_";
  protected final String TEXT_116 = ");" + NL + "\t\tcallStmtLoadPending_";
  protected final String TEXT_117 = ".setString(1, \"load from  /dev/null  of del terminate into \\\"\" + tableName_";
  protected final String TEXT_118 = " + \"\\\"\");" + NL + "\t\ttry {" + NL + "\t\t\tcallStmtLoadPending_";
  protected final String TEXT_119 = ".execute();" + NL + "\t\t} catch (java.sql.SQLException e) {" + NL + "\t\t\t//when table not in load pending mode will throw exception." + NL + "\t\t\t//and do nothing." + NL + "\t\t\t";
  protected final String TEXT_120 = NL + "\t\t}" + NL + "\t\tcallStmtLoadPending_";
  ...
  protected final String TEXT_127 = " - Droping table ";
  ...
  protected final String TEXT_135 = " - Drop table ";
  ...
  protected final String TEXT_144 = " - Creating table ";
  ...
  protected final String TEXT_152 = " - Create table ";
  ...
  protected final String TEXT_162 = " - Creating table ";
  ...
  protected final String TEXT_170 = " - Create table ";
  ...
  protected final String TEXT_206 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_219 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_223 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_224 = ".equals(schema_";
  protected final String TEXT_225 = ") || (schema_";
  protected final String TEXT_226 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_227 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_290 = " - Creating table ";
  ...
  protected final String TEXT_298 = " - Create table ";
  ...
  protected final String TEXT_303 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_309 = " - Droping table ";
  ...
  protected final String TEXT_317 = " - Drop table ";
  ...
  protected final String TEXT_322 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_326 = " - Creating table ";
  ...
  protected final String TEXT_334 = " - Create table ";
  ...
  protected final String TEXT_344 = " - Clearing table ";
  ...
  protected final String TEXT_352 = "- Clear table ";
  ...
  protected final String TEXT_358 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_367 = " - Trancating table ";
  ...
  protected final String TEXT_375 = " - Truncate table ";
  protected final String TEXT_376 = "\" + tableName_";
  protected final String TEXT_377 = " + \"";
  protected final String TEXT_378 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_379 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_380 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_381 = " += rsTruncCount_";
  protected final String TEXT_382 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_383 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_384 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_385 = ".close();" + NL + "\t\t";
  protected final String TEXT_386 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_387 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_388 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_389 = NL;
  protected final String TEXT_390 = NL + "Character field_separator_";
  protected final String TEXT_391 = " = (";
  protected final String TEXT_392 = ").charAt(0);";
  protected final String TEXT_393 = NL + "\t\tString action_";
  protected final String TEXT_394 = " = \"";
  protected final String TEXT_395 = "\";" + NL + "\t\tjava.sql.CallableStatement callStmt_";
  protected final String TEXT_396 = " = null;" + NL + "\t\tString sql_";
  protected final String TEXT_397 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "\t\tString param_";
  protected final String TEXT_398 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_399 = " + \"\\\" OF ";
  protected final String TEXT_400 = " DEL MODIFIED BY COLDEL\"+ field_separator_";
  protected final String TEXT_401 = " +" + NL + "\t\t\t\t\t\t\" dateformat=\\\"\"+ ";
  protected final String TEXT_402 = "+ \"\\\" timeformat=\\\"\" + ";
  protected final String TEXT_403 = "+ \"\\\" timestampformat=\\\"\"+";
  protected final String TEXT_404 = " +\"\\\" ";
  protected final String TEXT_405 = " \" +" + NL + "\t\t\t\t\t\t action_";
  protected final String TEXT_406 = " +\" INTO \\\"\"  + tableName_";
  protected final String TEXT_407 = " + \"\\\" ";
  protected final String TEXT_408 = "\";" + NL + "\t\t";
  protected final String TEXT_409 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_410 = " - Bulk SQL:CALL SYSPROC.ADMIN_CMD(\"+param_";
  protected final String TEXT_411 = "+\").\");" + NL + "\t\t\t";
  protected final String TEXT_412 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_413 = " - Bulk inserting data into ";
  protected final String TEXT_414 = "\" + tableName_";
  protected final String TEXT_415 = " + \"";
  protected final String TEXT_416 = ".\" );" + NL + "\t\t\t";
  protected final String TEXT_417 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_418 = " - Bulk replacing data into ";
  protected final String TEXT_419 = "\" + tableName_";
  protected final String TEXT_420 = " + \"";
  protected final String TEXT_421 = ".\" );" + NL + "\t\t\t";
  protected final String TEXT_422 = NL + "\t\tcallStmt_";
  protected final String TEXT_423 = " = conn_";
  protected final String TEXT_424 = ".prepareCall(sql_";
  protected final String TEXT_425 = ");" + NL + "\t\tcallStmt_";
  protected final String TEXT_426 = ".setString(1, param_";
  protected final String TEXT_427 = ");" + NL + "\t\tcallStmt_";
  protected final String TEXT_428 = ".execute();" + NL + "\t\tcallStmt_";
  protected final String TEXT_429 = ".close();" + NL + "\t\t";
  protected final String TEXT_430 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_431 = " - Bulk insert data into ";
  ...
  protected final String TEXT_436 = " - Bulk replace data into ";
  protected final String TEXT_437 = "\" + tableName_";
  protected final String TEXT_438 = " + \"";
  protected final String TEXT_439 = " has finished.\");" + NL + "\t\t\t\t";
  protected final String TEXT_440 = NL + "\t\t\tint keyCount_";
  protected final String TEXT_441 = " = ";
  protected final String TEXT_442 = ";" + NL + "\t\t\tif(keyCount_";
  protected final String TEXT_443 = " == 0) {" + NL + "\t\t\t\tthrow new RuntimeException(\"For bulk update, Schema must have a key at least.\");" + NL + "\t\t\t}" + NL + "\t\t\tString tmpTableName_";
  protected final String TEXT_444 = " = tableName_";
  protected final String TEXT_445 = ";" + NL + "\t\t\ttableName_";
  protected final String TEXT_446 = " = \"tmp_";
  protected final String TEXT_447 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\t\tjava.sql.Statement stmtCreateTmp_";
  protected final String TEXT_448 = " = conn_";
  protected final String TEXT_449 = ".createStatement();" + NL + "" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_450 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_451 = " - Creating temp table ";
  ...
  protected final String TEXT_457 = ")\");" + NL + "\t\t\tstmtCreateTmp_";
  protected final String TEXT_458 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_459 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_460 = " - Create temp table ";
  protected final String TEXT_461 = "\" + tableName_";
  protected final String TEXT_462 = " + \"";
  protected final String TEXT_463 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_464 = NL + "\t\t\tjava.sql.CallableStatement callStmt_";
  protected final String TEXT_465 = " = null;" + NL + "\t\t\tString sql_";
  protected final String TEXT_466 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "\t\t\tString param_";
  protected final String TEXT_467 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_468 = ".replace(\"\\\\\",\"/\") + \"\\\" OF ";
  protected final String TEXT_469 = " DEL MODIFIED BY COLDEL\" + field_separator_";
  protected final String TEXT_470 = " +" + NL + "\t\t\t\t\t\t\t\t\t\" dateformat=\\\"\"+";
  protected final String TEXT_471 = "+\"\\\" timeformat=\\\"\" +";
  protected final String TEXT_472 = "+ \"\\\" timestampformat=\\\"\" + ";
  ...
  protected final String TEXT_477 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_478 = " - Bulk SQL:CALL SYSPROC.ADMIN_CMD(\"+param_";
  protected final String TEXT_479 = "+\").\");" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_480 = " - Bulk inserting data into ";
  protected final String TEXT_481 = "\" + tableName_";
  protected final String TEXT_482 = " + \"";
  protected final String TEXT_483 = ".\" );" + NL + "\t\t\t";
  protected final String TEXT_484 = NL + "\t\t\tcallStmt_";
  protected final String TEXT_485 = " = conn_";
  protected final String TEXT_486 = ".prepareCall(sql_";
  protected final String TEXT_487 = ");" + NL + "\t\t\tcallStmt_";
  protected final String TEXT_488 = ".setString(1, param_";
  protected final String TEXT_489 = ");" + NL + "\t\t\tcallStmt_";
  protected final String TEXT_490 = ".execute();" + NL + "\t\t\tcallStmt_";
  protected final String TEXT_491 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_492 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_493 = " - Bulk insert data into ";
  protected final String TEXT_494 = "\" + tableName_";
  protected final String TEXT_495 = " + \"";
  protected final String TEXT_496 = " has finished.\");" + NL + "\t\t\t";
  protected final String TEXT_497 = NL + "\t\t\ttableName_";
  protected final String TEXT_498 = " = tmpTableName_";
  protected final String TEXT_499 = ";" + NL + "\t\t\ttmpTableName_";
  protected final String TEXT_500 = " = \"tmp_";
  protected final String TEXT_501 = "\"+ \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\t\tjava.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_505 = " - Updating ";
  protected final String TEXT_506 = "\" + tableName_";
  protected final String TEXT_507 = " + \"";
  protected final String TEXT_508 = " from ";
  protected final String TEXT_509 = "\"+tmpTableName_";
  ...
  protected final String TEXT_515 = NL + "\t\t\tstmtUpdateBulk_";
  protected final String TEXT_516 = ".close();" + NL + "\t\t\ttableName_";
  protected final String TEXT_517 = " = \"tmp_";
  protected final String TEXT_518 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "\t\t\tjava.sql.Statement stmtTmpDrop_";
  ...
  protected final String TEXT_522 = " - Droping temp table ";
  protected final String TEXT_523 = "\" + tableName_";
  protected final String TEXT_524 = " + \"";
  protected final String TEXT_525 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_526 = NL + "\t\t\tstmtTmpDrop_";
  ...
  protected final String TEXT_534 = NL + "\t\t\tstmtTmpDrop_";
  protected final String TEXT_535 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_536 = NL + NL + NL + NL + NL + NL;
