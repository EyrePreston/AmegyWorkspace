...
public class TPostgresqlConnectionBeginJava
{
  ...
  protected final String TEXT_82 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\tlog.info(\"";
  ...
  protected final String TEXT_85 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_98 = ".setAutoCommit(";
  protected final String TEXT_99 = ");" + NL + "\t\t\t";
  protected final String TEXT_100 = NL + "\t\t\t\tlog.";
  protected final String TEXT_101 = "(\"";
  protected final String TEXT_102 = " - \" + ";
  protected final String TEXT_103 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_104 = NL + "\t    \t\tlog.";
  ...
  protected final String TEXT_117 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
