...
public class TOleDbRowMainJava
{
  ...
  protected final String TEXT_44 = ";" + NL + "whetherReject_";
  protected final String TEXT_45 = " = false;";
  protected final String TEXT_46 = NL + "    globalMap.put(\"";
  protected final String TEXT_47 = "_QUERY\",query_";
  protected final String TEXT_48 = ");";
  protected final String TEXT_49 = NL + "\torg.talend.net.Object rs_";
  protected final String TEXT_50 = " = null;";
  protected final String TEXT_51 = NL + "    try {";
  protected final String TEXT_52 = NL + "\torg.talend.net.Object param_";
  protected final String TEXT_53 = ";" + NL + "\tObject val_";
  protected final String TEXT_54 = ";" + NL + "\t";
  protected final String TEXT_55 = NL + "\t\t\t\t    param_";
  protected final String TEXT_56 = " = cmd_";
  protected final String TEXT_57 = ".invoke(\"CreateParameter\");" + NL + "                    val_";
  protected final String TEXT_58 = " = ";
  protected final String TEXT_59 = ";" + NL + "                    param_";
  protected final String TEXT_60 = ".mutateProperty(\"Value\",val_";
  protected final String TEXT_61 = ");" + NL + "                    cmd_";
  protected final String TEXT_62 = ".accessProperty(\"Parameters\",";
  protected final String TEXT_63 = ")" + NL + "                    \t.invoke(\"Add\",new java.lang.Object[] {";
  protected final String TEXT_64 = ", param_";
  protected final String TEXT_65 = " });" + NL + "\t\t\t\t";
  protected final String TEXT_66 = NL + "\t\t\trs_";
  protected final String TEXT_67 = " = cmd_";
  protected final String TEXT_68 = ".invoke(\"ExecuteReader\");" + NL + "\t\t\tcmd_";
  protected final String TEXT_69 = ".accessProperty(\"Parameters\",";
  protected final String TEXT_70 = ")" + NL + "                    \t.invoke(\"Clear\");";
  protected final String TEXT_71 = NL + "    \t\tcmd_";
  protected final String TEXT_72 = ".invoke(\"ExecuteNonQuery\");" + NL + "    \t\tcmd_";
  protected final String TEXT_73 = ".accessProperty(\"Parameters\",";
  protected final String TEXT_74 = ")" + NL + "                    \t.invoke(\"Clear\");";
  protected final String TEXT_75 = NL + "\t\t\tcmd_";
  protected final String TEXT_76 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_77 = ", \"System.Data.OleDb.OleDbCommand\", new java.lang.Object[] { query_";
  protected final String TEXT_78 = ",conn_";
  protected final String TEXT_79 = " });" + NL + "\t\t\trs_";
  protected final String TEXT_80 = " = cmd_";
  protected final String TEXT_81 = ".invoke(\"ExecuteReader\");";
  protected final String TEXT_82 = NL + "\t\t\tcmd_";
  protected final String TEXT_83 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_84 = ", \"System.Data.OleDb.OleDbCommand\", new java.lang.Object[] { query_";
  protected final String TEXT_85 = ",conn_";
  protected final String TEXT_86 = " });" + NL + "    \t\tcmd_";
  protected final String TEXT_87 = ".invoke(\"ExecuteNonQuery\");";
  protected final String TEXT_88 = NL + "    } catch (java.lang.Exception e) {        " + NL + "\t\twhetherReject_";
  ...
  protected final String TEXT_100 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_101 = ";";
  protected final String TEXT_102 = NL + "\t\t\t";
  protected final String TEXT_103 = NL + "         \tSystem.err.print(e.getMessage());";
  protected final String TEXT_104 = NL + "    }" + NL + "\t";
  protected final String TEXT_105 = NL + "        if(!whetherReject_";
