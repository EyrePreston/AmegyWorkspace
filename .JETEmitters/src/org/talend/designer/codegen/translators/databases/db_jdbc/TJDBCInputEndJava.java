...
public class TJDBCInputEndJava
{
  ...
  protected final String TEXT_66 = NL + "\t}" + NL + "}finally{" + NL + "\tif(rs_";
  protected final String TEXT_67 = " !=null){" + NL + "\t\trs_";
  protected final String TEXT_68 = ".close();" + NL + "\t}" + NL + "\tstmt_";
  protected final String TEXT_69 = ".close();" + NL;
  protected final String TEXT_70 = NL + "if(conn_";
  protected final String TEXT_71 = " != null && !conn_";
  protected final String TEXT_72 = ".isClosed()) {" + NL + "\t";
