...
public class TAccessConnectionBeginJava
{
  ...
  protected final String TEXT_30 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=\" + ";
  protected final String TEXT_31 = ";";
  protected final String TEXT_32 = NL + "\t            String url_";
  protected final String TEXT_33 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=\" + ";
  ...
  protected final String TEXT_42 = ";" + NL + "\t\t\tatnParams_";
  protected final String TEXT_43 = " = atnParams_";
  protected final String TEXT_44 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_45 = " = new java.util.Properties();" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_46 = ".put(\"user\",dbUser_";
  protected final String TEXT_47 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_48 = ".put(\"password\",dbPwd_";
  protected final String TEXT_49 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_50 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_51 = ".getBytes()));" + NL + "\t\t\tconn_";
  protected final String TEXT_52 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_53 = ", atnParamsPrope_";
  protected final String TEXT_54 = ");";
  protected final String TEXT_55 = NL + NL + "\t";
  protected final String TEXT_56 = NL + NL + "\tString dbUser_";
  ...
  protected final String TEXT_69 = NL + "\t\tString dbPwd_";
  ...
  protected final String TEXT_75 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_80 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_81 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_82 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_83 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_84 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_85 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_86 = " - Written records count: \" + nb_line_";
  protected final String TEXT_87 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_88 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_89 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_90 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_91 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_92 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_94 = " - Writing the record \" + nb_line_";
  protected final String TEXT_95 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_96 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_97 = " - Processing the record \" + nb_line_";
  protected final String TEXT_98 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_99 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_100 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_101 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_102 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_103 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_104 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_105 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_106 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_107 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
