...
public class TIngresOutputMainJava {
  ...
  protected final String TEXT_239 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_240 = " = updatedCount_";
  protected final String TEXT_241 = " + updateFlag_";
  protected final String TEXT_242 = ";" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_253 = NL + "                    insertedCount_";
  ...
  protected final String TEXT_258 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_259 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_260 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_261 = " = true;";
  protected final String TEXT_262 = NL + "                        throw(e);";
  protected final String TEXT_263 = NL + "                    \tnb_line_";
  protected final String TEXT_264 = "++;" + NL + "                    \t";
  protected final String TEXT_265 = NL + "                            ";
  protected final String TEXT_266 = " = new ";
  protected final String TEXT_267 = "Struct();";
  protected final String TEXT_268 = NL + "                                ";
  protected final String TEXT_269 = ".";
  protected final String TEXT_270 = " = ";
  protected final String TEXT_271 = ".";
  protected final String TEXT_272 = ";";
  protected final String TEXT_273 = NL + "                            rejectedCount_";
  protected final String TEXT_274 = " = rejectedCount_";
  ...
  protected final String TEXT_313 = NL + "                        rejectedCount_";
  protected final String TEXT_314 = " = rejectedCount_";
  protected final String TEXT_315 = " + 1;";
  protected final String TEXT_316 = NL + "                        ";
  protected final String TEXT_317 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_318 = NL + "                        ";
  protected final String TEXT_319 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_341 = "=0;" + NL + "\t            " + NL + "\t            }" + NL + "\t        " + NL + "\t        ";
