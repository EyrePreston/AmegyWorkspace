...
public class TDBInputBeginJava
{
  ...
  protected final String TEXT_179 = " = \"jdbc:odbc:\"+";
  protected final String TEXT_180 = ";";
  protected final String TEXT_181 = NL + "\t\t        String url_";
  protected final String TEXT_182 = " = \"jdbc:odbc:\"+";
  ...
  protected final String TEXT_190 = " = \"jdbc:postgresql://\"+";
  protected final String TEXT_191 = "+\":\"+";
  protected final String TEXT_192 = "+\"/\"+";
  protected final String TEXT_193 = ";";
  protected final String TEXT_194 = NL + "\t\t        String url_";
  protected final String TEXT_195 = " = \"jdbc:mysql://\" + ";
  ...
  protected final String TEXT_215 = ";" + NL + "" + NL + "\t\t\tString dbProperties_";
  protected final String TEXT_216 = " = ";
  protected final String TEXT_217 = ";" + NL + "\t\t\t";
  protected final String TEXT_218 = NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_219 = " == null || dbProperties_";
  protected final String TEXT_220 = ".trim().length() == 0) {" + NL + "\t\t\t\tconn_";
  ...
  protected final String TEXT_224 = ");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tdbProperties_";
  protected final String TEXT_225 = " = dbProperties_";
  ...
  protected final String TEXT_232 = ".load(new java.io.ByteArrayInputStream(dbProperties_";
  ...
  protected final String TEXT_237 = NL + "            java.sql.Timestamp timestamp_";
  protected final String TEXT_238 = " = rs_";
  protected final String TEXT_239 = ".getTimestamp(";
  protected final String TEXT_240 = "column_index_";
  protected final String TEXT_241 = ");" + NL + "            if(timestamp_";
  protected final String TEXT_242 = " != null) {";
  protected final String TEXT_243 = NL + "                ";
  protected final String TEXT_244 = ".";
  protected final String TEXT_245 = " = new java.util.Date(timestamp_";
  protected final String TEXT_246 = ".getTime());" + NL + "            } else {";
  protected final String TEXT_247 = NL + "                ";
  protected final String TEXT_248 = ".";
  protected final String TEXT_249 = " =  null;" + NL + "            }";
  protected final String TEXT_250 = NL + "\t\t\tObject value_";
  protected final String TEXT_251 = " = rs_";
  protected final String TEXT_252 = ".get";
  protected final String TEXT_253 = "(";
  protected final String TEXT_254 = "column_index_";
  protected final String TEXT_255 = ");" + NL + "\t\t\tif(value_";
  ...
  protected final String TEXT_279 = NL + "\t\t\ttry {" + NL + "            \ttmpContent_";
  protected final String TEXT_280 = " = rs_";
  protected final String TEXT_281 = ".getString(";
  protected final String TEXT_282 = "column_index_";
  protected final String TEXT_283 = ");" + NL + "\t\t\t} catch (java.sql.SQLException e) {" + NL + "\t\t\t\tif (\"No data found\".equals(e.getMessage())) {" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_284 = " = \"\";" + NL + "\t\t\t\t}else {" + NL + "\t\t\t\t\tthrow e;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "            if(tmpContent_";
  protected final String TEXT_285 = " != null) {";
  protected final String TEXT_286 = NL + "                ";
  protected final String TEXT_287 = ".";
  protected final String TEXT_288 = " = tmpContent_";
  ...
  protected final String TEXT_294 = NL + "\t\t    int nb_line_";
  protected final String TEXT_295 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_296 = " = null;";
  protected final String TEXT_297 = NL + "\t\t        conn_";
  protected final String TEXT_298 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_299 = "\");";
  protected final String TEXT_300 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_301 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_302 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_303 = " = dataSources_";
  protected final String TEXT_304 = ".get(";
  protected final String TEXT_305 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  protected final String TEXT_306 = "\", conn_";
  protected final String TEXT_307 = ");" + NL + "\t\t        \t}" + NL + "\t\t        ";
  protected final String TEXT_308 = NL + "\t\t\t\t";
  protected final String TEXT_309 = NL + "\t\t\t\t";
  protected final String TEXT_310 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_311 = " =  conn_";
  protected final String TEXT_312 = ".getAutoCommit();          " + NL + "             conn_";
  protected final String TEXT_313 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_314 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  protected final String TEXT_315 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" + ";
  protected final String TEXT_316 = NL + "               ";
  protected final String TEXT_317 = " + \"=\" + ";
  protected final String TEXT_318 = " + \";\" +";
  protected final String TEXT_319 = " \"' FOR SESSION\"" + NL + "           );           " + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());              " + NL + "      }" + NL + "      conn_";
  protected final String TEXT_320 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_321 = ");";
  protected final String TEXT_322 = NL + "\t\t    ";
  protected final String TEXT_323 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_324 = " = ";
  protected final String TEXT_325 = ";" + NL + "\t\t\t";
  protected final String TEXT_326 = NL + "                log.info(\"";
  protected final String TEXT_327 = " - Executing the query: '\"+dbquery_";
  ...
  protected final String TEXT_355 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_356 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_357 = ".setName(rsmd_";
  protected final String TEXT_358 = ".getColumnName(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_367 = ".getColumnTypeName(i));";
  protected final String TEXT_368 = NL + "                \tdcm_";
  protected final String TEXT_369 = ".setFormat(";
  protected final String TEXT_370 = ");";
  protected final String TEXT_371 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_372 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_373 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_374 = ".setLength(rsmd_";
  protected final String TEXT_375 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_376 = ".setLength(rsmd_";
  protected final String TEXT_377 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_378 = NL + "\t\t\tdcm_";
  protected final String TEXT_379 = ".setLength(rsmd_";
  protected final String TEXT_380 = ".getPrecision(i));";
  protected final String TEXT_381 = NL + "                \tdcm_";
  protected final String TEXT_382 = ".setPrecision(rsmd_";
  protected final String TEXT_383 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_384 = ".setNullable(rsmd_";
  protected final String TEXT_385 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_386 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_387 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_388 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_389 = ".metadatas.add(dcm_";
  protected final String TEXT_390 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_391 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_392 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_393 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_394 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_395 = NL + "\t\t    ";
  protected final String TEXT_396 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_397 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_398 = NL + "\t\t    while (rs_";
  protected final String TEXT_399 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_400 = "++;" + NL + "\t\t        ";
  protected final String TEXT_401 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_402 = " = ";
  protected final String TEXT_403 = " + dcg_";
  protected final String TEXT_404 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_405 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_406 = " = ";
  protected final String TEXT_407 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_408 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_409 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_410 = " < ";
  protected final String TEXT_411 = "column_index_";
  protected final String TEXT_412 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_413 = ".";
  protected final String TEXT_414 = " = ";
  protected final String TEXT_415 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  protected final String TEXT_416 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_417 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_418 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_419 = NL + "\t\t                            ";
  protected final String TEXT_420 = ".";
  protected final String TEXT_421 = " = (List)rs_";
  protected final String TEXT_422 = ".getObject(";
  protected final String TEXT_423 = "column_index_";
  protected final String TEXT_424 = ");";
  protected final String TEXT_425 = NL + "\t\t                         ";
  protected final String TEXT_426 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_427 = ".getObject(";
  protected final String TEXT_428 = "column_index_";
  protected final String TEXT_429 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_430 = NL + "                                    ";
  protected final String TEXT_431 = ".";
  protected final String TEXT_432 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_441 = ".setEPSG(";
  protected final String TEXT_442 = ");" + NL + "                                        }";
  protected final String TEXT_443 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_444 = NL + "                                  ";
  protected final String TEXT_445 = ".";
  protected final String TEXT_446 = "=dcg_";
  protected final String TEXT_447 = ";";
  protected final String TEXT_448 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_449 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_450 = " = ";
  protected final String TEXT_451 = "; i_";
  protected final String TEXT_452 = "  <= rsmd_";
  protected final String TEXT_453 = ".getColumnCount(); i_";
  protected final String TEXT_454 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_455 = ".getColumnTypeName(i_";
  protected final String TEXT_456 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_457 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_458 = ".getClob(i_";
  protected final String TEXT_459 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_460 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_461 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_462 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_463 = ".add(tNTextImpl_";
  protected final String TEXT_464 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_465 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_466 = ".";
  protected final String TEXT_467 = ", rs_";
  protected final String TEXT_468 = ", fixedColumnCount_";
  protected final String TEXT_469 = ",list_";
  protected final String TEXT_470 = ");";
  protected final String TEXT_471 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_472 = ".";
  protected final String TEXT_473 = ", rs_";
  protected final String TEXT_474 = ", fixedColumnCount_";
  protected final String TEXT_475 = ");";
  protected final String TEXT_476 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_477 = ".";
  protected final String TEXT_478 = ", rs_";
  protected final String TEXT_479 = ", fixedColumnCount_";
  protected final String TEXT_480 = ");";
  protected final String TEXT_481 = NL + "                                  Object geom = rs_";
  protected final String TEXT_482 = ".getObject(";
  protected final String TEXT_483 = "column_index_";
  protected final String TEXT_484 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o = " + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_485 = ".";
  protected final String TEXT_486 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_493 = " - Retrieving the record \" + nb_line_";
