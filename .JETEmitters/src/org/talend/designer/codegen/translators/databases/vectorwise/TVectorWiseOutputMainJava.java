...
public class TVectorWiseOutputMainJava {
  ...
  protected final String TEXT_104 = "_QUERY\", query_";
  protected final String TEXT_105 = ".toString().trim());";
  protected final String TEXT_106 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_107 = " = updatedCount_";
  protected final String TEXT_108 = " + pstmt_";
  protected final String TEXT_109 = ".executeUpdate();" + NL + "                nb_line_";
  ...
  protected final String TEXT_125 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_158 = ".toString().trim());";
  protected final String TEXT_159 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_160 = " = updatedCount_";
  protected final String TEXT_161 = " + pstmtUpdate_";
  protected final String TEXT_162 = ".executeUpdate();" + NL + "                    nb_line_";
  ...
  protected final String TEXT_177 = NL + "                            nb_line_rejected_";
  ...
  protected final String TEXT_196 = ".executeUpdate();" + NL + "                    nb_line_";
  ...
  protected final String TEXT_239 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_240 = "=pstmtUpdate_";
  protected final String TEXT_241 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_242 = " = updatedCount_";
  protected final String TEXT_243 = " + updateFlag_";
  protected final String TEXT_244 = ";" + NL + "                if(updateFlag_";
  protected final String TEXT_245 = " != 0){" + NL + "            \t\tnb_line_";
  ...
  protected final String TEXT_258 = NL + "                        nb_line_rejected_";
  ...
  protected final String TEXT_266 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_267 = " == 0) {" + NL + "            \t";
  protected final String TEXT_268 = NL + "\t\t\t\tquery_";
  protected final String TEXT_269 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_277 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_278 = " = insertedCount_";
  protected final String TEXT_279 = " + pstmtInsert_";
  ...
  protected final String TEXT_314 = "_QUERY\", query_";
  protected final String TEXT_315 = ".toString().trim());";
  ...
  protected final String TEXT_334 = NL + "                        nb_line_rejected_";
  ...
  protected final String TEXT_357 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_358 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_359 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_360 = ": pstmt_";
  protected final String TEXT_361 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_362 = " == -2 || countEach_";
  protected final String TEXT_363 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_368 = ";" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_369 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_370 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_371 = NL + "                \tint countSum_";
  protected final String TEXT_372 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  ...
  protected final String TEXT_376 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "    \t    \t\tinsertedCount_";
  ...
  protected final String TEXT_382 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_383 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_384 = " <= commitCounter_";
  protected final String TEXT_385 = ") {" + NL + "                ";
  protected final String TEXT_386 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_387 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_388 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_389 = ": pstmt_";
  protected final String TEXT_390 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_391 = " == -2 || countEach_";
  protected final String TEXT_392 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_393 = " += countEach_";
  ...
  protected final String TEXT_397 = ";" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_398 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_399 = NL + "                \tint countSum_";
  protected final String TEXT_400 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_401 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_402 = " += (countEach_";
  protected final String TEXT_403 = " < 0 ? 0 : countEach_";
  protected final String TEXT_404 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "    \t    \t\tinsertedCount_";
