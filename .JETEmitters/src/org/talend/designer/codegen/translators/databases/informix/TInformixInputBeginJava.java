...
public class TInformixInputBeginJava
{
  ...
  protected final String TEXT_179 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_180 = " + \":\" + ";
  protected final String TEXT_181 = " + \"/\" + ";
  protected final String TEXT_182 = " + \":informixserver=\" + ";
  protected final String TEXT_183 = ";";
  protected final String TEXT_184 = NL + "\t\t        String url_";
  protected final String TEXT_185 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_186 = " + \":\" + ";
  protected final String TEXT_187 = " + \"/\" + ";
  protected final String TEXT_188 = " + \":informixserver=\" + ";
  ...
  protected final String TEXT_211 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_212 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  ...
  protected final String TEXT_253 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_265 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_346 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_347 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_374 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_375 = ".";
  protected final String TEXT_376 = ", rs_";
  protected final String TEXT_377 = ", fixedColumnCount_";
  protected final String TEXT_378 = ");";
  protected final String TEXT_379 = NL + "                                  Object geom = rs_";
  protected final String TEXT_380 = ".getObject(";
  protected final String TEXT_381 = "column_index_";
  protected final String TEXT_382 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o = " + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_383 = ".";
  protected final String TEXT_384 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_385 = ".";
  protected final String TEXT_386 = " = null;" + NL + "                                  }";
  protected final String TEXT_387 = NL + "\t\t                          ";
  protected final String TEXT_388 = NL + "\t\t                    }";
  protected final String TEXT_389 = NL + "\t\t\t\t\t";
  protected final String TEXT_390 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_391 = " - Retrieving the record \" + nb_line_";
