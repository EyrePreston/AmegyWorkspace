...
public class TVerticaBulkExecBeginJava {
  ...
  protected final String TEXT_65 = NL + "String tableName_";
  protected final String TEXT_66 = " = null;" + NL + "String dbschema_";
  protected final String TEXT_67 = " = null;" + NL + "java.io.FileInputStream fis_";
  protected final String TEXT_68 = " = null;" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_76 = " = \"com.vertica.jdbc.Driver\";" + NL + "\t\t";
  protected final String TEXT_77 = NL + "\t \t\tString driverClass_";
  protected final String TEXT_78 = " = \"com.vertica.Driver\";" + NL + "\t\t";
  protected final String TEXT_79 = NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_80 = ").newInstance();" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_81 = NL + "\t\tString url_";
  protected final String TEXT_82 = " = \"jdbc:vertica://\" + ";
  ...
  protected final String TEXT_100 = NL + "\t   \t" + NL + "\t\tdbschema_";
  protected final String TEXT_101 = " = ";
  protected final String TEXT_102 = ";" + NL + "\t\tString dbUser_";
  protected final String TEXT_103 = " = ";
  protected final String TEXT_104 = ";" + NL + "\t\tString dbPwd_";
  protected final String TEXT_105 = " = decryptedPassword_";
  protected final String TEXT_106 = ";" + NL + "\t";
  protected final String TEXT_107 = NL + "\tif(dbschema_";
  ...
  protected final String TEXT_119 = " - Droping table ";
  protected final String TEXT_120 = "\" + tableName_";
  ...
  protected final String TEXT_127 = " - Drop table ";
  protected final String TEXT_128 = "\" + tableName_";
  ...
  protected final String TEXT_136 = " - Creating table ";
  ...
  protected final String TEXT_144 = " - Create table ";
  ...
  protected final String TEXT_152 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_153 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_154 = " - Creating table ";
  ...
  protected final String TEXT_162 = " - Create table ";
  ...
  protected final String TEXT_196 = ".equalsIgnoreCase(";
  protected final String TEXT_197 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_198 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_211 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_215 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_216 = ".equals(schema_";
  protected final String TEXT_217 = ") || (schema_";
  protected final String TEXT_218 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_219 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_282 = " - Creating table ";
  ...
  protected final String TEXT_290 = " - Create table ";
  protected final String TEXT_291 = "\" + tableName_";
  protected final String TEXT_292 = " + \"";
  protected final String TEXT_293 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_294 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_295 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_301 = " - Droping table ";
  protected final String TEXT_302 = "\" + tableName_";
  ...
  protected final String TEXT_309 = " - Drop table ";
  protected final String TEXT_310 = "\" + tableName_";
  ...
  protected final String TEXT_336 = " - Clearing table ";
  ...
  protected final String TEXT_344 = "- Clear table ";
  ...
  protected final String TEXT_359 = " - Trancating table ";
  ...
  protected final String TEXT_378 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_379 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_380 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_381 = NL + "try{";
  ...
  protected final String TEXT_387 = "\" + pid + Thread.currentThread().getId();" + NL + "        if(dbschema_";
  protected final String TEXT_388 = " != null && dbschema_";
  protected final String TEXT_389 = ".trim().length() != 0) {" + NL + "\t    \ttableName_";
  protected final String TEXT_390 = " = dbschema_";
  protected final String TEXT_391 = " + \".\" + tableName_";
  protected final String TEXT_392 = ";" + NL + "\t\t}" + NL + "        java.sql.Statement stmtCreateTmp_";
  ...
  protected final String TEXT_396 = " - Creating temp table ";
  protected final String TEXT_397 = "\" + tableName_";
  protected final String TEXT_398 = " + \"";
  protected final String TEXT_399 = ".\" );" + NL + "\t\t";
  protected final String TEXT_400 = NL + "        stmtCreateTmp_";
  protected final String TEXT_401 = ".execute(\"";
  protected final String TEXT_402 = ")\");";
  protected final String TEXT_403 = NL + "        \tlog.info(\"";
  protected final String TEXT_404 = " - Create temp table ";
  protected final String TEXT_405 = "\" + tableName_";
  protected final String TEXT_406 = " + \"";
  protected final String TEXT_407 = " has succeeded.\");";
  protected final String TEXT_408 = NL + "        stmtCreateTmp_";
  protected final String TEXT_409 = ".close();";
  protected final String TEXT_410 = NL + "\t\tCharacter OUT_DELIM_";
  protected final String TEXT_411 = " = ";
  protected final String TEXT_412 = ".charAt(0);" + NL + "\t\tString sql_";
  protected final String TEXT_413 = " = \"COPY \" + tableName_";
  protected final String TEXT_414 = " + \" FROM STDIN DELIMITER '\" +OUT_DELIM_";
  protected final String TEXT_415 = " + \"'\" " + NL + "\t    ";
  protected final String TEXT_416 = " + \" NULL '\"  + ";
  protected final String TEXT_417 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_418 = NL + "\t\t";
  protected final String TEXT_419 = " + \" DIRECT\"";
  protected final String TEXT_420 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_421 = NL + "\t\t\t+ \" REJECTED DATA '\" + ";
  protected final String TEXT_422 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_423 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_424 = NL + "\t\t\t+ \" EXCEPTIONS '\" + ";
  protected final String TEXT_425 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_426 = NL + "\t\t;" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_427 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_428 = " - Bulk SQL:\"+sql_";
  protected final String TEXT_429 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_430 = " - Bulk inserting data into ";
  protected final String TEXT_431 = "\" + tableName_";
  protected final String TEXT_432 = " + \"";
  protected final String TEXT_433 = ".\" );";
  protected final String TEXT_434 = NL + "    \tfis_";
  protected final String TEXT_435 = " = new java.io.FileInputStream(new java.io.File(";
  protected final String TEXT_436 = "));";
  protected final String TEXT_437 = NL + "\t\tcom.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_438 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_439 = ",sql_";
  protected final String TEXT_440 = ");" + NL + "\t\tvcs_";
  protected final String TEXT_441 = ".start();" + NL + "\t\tvcs_";
  protected final String TEXT_442 = ".addStream(fis_";
  protected final String TEXT_443 = ");" + NL + "\t\tvcs_";
  protected final String TEXT_444 = ".execute();" + NL + "\t\tvcs_";
  protected final String TEXT_445 = ".finish();" + NL + "\t\t";
  protected final String TEXT_446 = NL + "            log.info(\"";
  protected final String TEXT_447 = " - Bulk insert data into ";
  protected final String TEXT_448 = "\" + tableName_";
  protected final String TEXT_449 = " + \"";
  protected final String TEXT_450 = " has finished.\");";
  protected final String TEXT_451 = NL + "\t\tlong copyNumber_";
  protected final String TEXT_452 = " = vcs_";
  protected final String TEXT_453 = ".getRowCount();" + NL + "\t\t" + NL + "\t\t//get rejected and accepted row number" + NL + "\t\tjava.sql.Statement stmt_accept_reject_";
  protected final String TEXT_454 = " = conn_";
  protected final String TEXT_455 = ".createStatement();" + NL + "\t\t" + NL + "\t    java.sql.ResultSet rs_";
  protected final String TEXT_456 = " = stmt_accept_reject_";
  protected final String TEXT_457 = ".executeQuery(\"select get_num_accepted_rows()\");" + NL + "\t    int accetpedRowNumber_";
  protected final String TEXT_458 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_459 = ".next()) {" + NL + "\t    \taccetpedRowNumber_";
  protected final String TEXT_460 = " = rs_";
  protected final String TEXT_461 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t    rs_";
  protected final String TEXT_462 = " = stmt_accept_reject_";
  protected final String TEXT_463 = ".executeQuery(\"select get_num_rejected_rows()\");" + NL + "\t    int rejectedRowNumber_";
  protected final String TEXT_464 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_465 = ".next()) {" + NL + "\t    \trejectedRowNumber_";
  protected final String TEXT_466 = " = rs_";
  protected final String TEXT_467 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tstmt_accept_reject_";
  protected final String TEXT_468 = ".close();" + NL + "\t\t" + NL + "\t\tif(";
  protected final String TEXT_469 = " && copyNumber_";
  protected final String TEXT_470 = " <= 0){" + NL + "\t\t\tthrow new RuntimeException(\"No record was inserted into component ";
  protected final String TEXT_471 = "\");" + NL + "\t\t}else{" + NL + "\t\t\t";
  protected final String TEXT_472 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_473 = " - Number of records inserted into table ";
  protected final String TEXT_474 = "\" + tableName_";
  protected final String TEXT_475 = " + \"";
  protected final String TEXT_476 = " by ";
  protected final String TEXT_477 = ": \" + (copyNumber_";
  protected final String TEXT_478 = ")+\".\");" + NL + "\t\t\t";
  protected final String TEXT_479 = NL + "\t\t\tSystem.out.println(\"Number of records inserted into table ";
  protected final String TEXT_480 = "\" + tableName_";
  protected final String TEXT_481 = " + \"";
  protected final String TEXT_482 = " by ";
  protected final String TEXT_483 = ": \" + (copyNumber_";
  protected final String TEXT_484 = "));" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_485 = "_ACCEPTED_ROW_NUMBER\",accetpedRowNumber_";
  protected final String TEXT_486 = ");" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_487 = "_REJECTED_ROW_NUMBER\",rejectedRowNumber_";
  ...
  protected final String TEXT_541 = NL + "        String tmpTableName_";
  protected final String TEXT_542 = " = \"tmp_";
  protected final String TEXT_543 = "\" + pid + Thread.currentThread().getId();" + NL + "        if(dbschema_";
  protected final String TEXT_544 = " == null || dbschema_";
  protected final String TEXT_545 = ".trim().length() == 0) {" + NL + "\t    \ttableName_";
  protected final String TEXT_546 = " = ";
  protected final String TEXT_547 = ";" + NL + "\t\t} else {" + NL + "\t    \ttableName_";
  protected final String TEXT_548 = " = dbschema_";
  protected final String TEXT_549 = " + \".\" + ";
  protected final String TEXT_550 = ";" + NL + "\t    \ttmpTableName_";
  protected final String TEXT_551 = "=dbschema_";
  protected final String TEXT_552 = " + \".\" + tmpTableName_";
  protected final String TEXT_553 = ";" + NL + "\t\t}" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_554 = " = conn_";
  protected final String TEXT_555 = ".createStatement();" + NL + "\t";
  protected final String TEXT_556 = NL + "\t\tlog.info(\"";
  protected final String TEXT_557 = " - Updating ";
  protected final String TEXT_558 = "\" + tableName_";
  protected final String TEXT_559 = " + \"";
  protected final String TEXT_560 = " from ";
  protected final String TEXT_561 = "\"+tmpTableName_";
  protected final String TEXT_562 = "+\"";
  protected final String TEXT_563 = ".\");" + NL + "\t";
  protected final String TEXT_564 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_565 = ".executeUpdate(\"";
  protected final String TEXT_566 = "\");" + NL + "\t";
  protected final String TEXT_567 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_568 = ".close();" + NL + "        tableName_";
  protected final String TEXT_569 = " = tmpTableName_";
  protected final String TEXT_570 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_571 = " = conn_";
  protected final String TEXT_572 = ".createStatement();" + NL + "\t";
  protected final String TEXT_573 = NL + "\t\tlog.info(\"";
  protected final String TEXT_574 = " - Droping temp table ";
  protected final String TEXT_575 = "\" + tableName_";
  protected final String TEXT_576 = " + \"";
  protected final String TEXT_577 = ".\");" + NL + "\t";
  protected final String TEXT_578 = NL + "        stmtTmpDrop_";
  protected final String TEXT_579 = ".execute(\"";
  protected final String TEXT_580 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_581 = ".close();        " + NL + "\t";
  protected final String TEXT_582 = NL + "\t\tlog.info(\"";
  protected final String TEXT_583 = " - Drop temp table ";
  protected final String TEXT_584 = "\" + tableName_";
  protected final String TEXT_585 = "+ \"";
  protected final String TEXT_586 = " has succeeded.\");" + NL + "\t";
  protected final String TEXT_587 = NL + "}finally{" + NL + "\tif(fis_";
  protected final String TEXT_588 = "!=null)" + NL + "\t\tfis_";
  protected final String TEXT_589 = ".close();";
  protected final String TEXT_590 = NL + "}" + NL + NL + NL + NL + NL + NL + NL;
