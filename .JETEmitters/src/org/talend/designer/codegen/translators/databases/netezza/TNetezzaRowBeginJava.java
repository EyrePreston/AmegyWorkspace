...
public class TNetezzaRowBeginJava
{
  ...
  protected final String TEXT_116 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_117 = " = ";
  protected final String TEXT_118 = ";" + NL + "\t\t\tString url_";
  protected final String TEXT_119 = " = null;" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_120 = " == null || dbProperties_";
  protected final String TEXT_121 = ".trim().length() == 0) {" + NL + "\t\t\t    url_";
  protected final String TEXT_122 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_123 = " + \":\" + ";
  protected final String TEXT_124 = " + \"/\" + ";
  protected final String TEXT_125 = ";" + NL + "\t\t\t} else {" + NL + "\t\t\t    url_";
  protected final String TEXT_126 = " = \"jdbc:netezza://\" + ";
  protected final String TEXT_127 = " + \":\" + ";
  protected final String TEXT_128 = " + \"/\" + ";
  protected final String TEXT_129 = " + \"?\" + ";
  protected final String TEXT_130 = ";" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_131 = NL + "\t\t\tint nb_";
