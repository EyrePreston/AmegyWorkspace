...
public class TAmazonMysqlOutputMainJava {
  ...
  protected final String TEXT_388 = "    " + NL + "" + NL + "                pstmt_";
  protected final String TEXT_389 = " = conn_";
  protected final String TEXT_390 = ".prepareStatement(insert_";
  protected final String TEXT_391 = ");" + NL + "\t        \t        ";
  protected final String TEXT_392 = "\t            " + NL + "\t            ////////////////////////////////////////////////////////////////////////////////////////////" + NL + "\t            " + NL + "\t            " + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_393 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_394 = ";i++){";
  ...
  protected final String TEXT_400 = NL + "\t\t\t\t    extendInsertValueStmt_";
  protected final String TEXT_401 = ".append(\"(";
  protected final String TEXT_402 = ")\");";
  protected final String TEXT_403 = NL + "                if (i!=";
  protected final String TEXT_404 = "-1) extendInsertValueStmt_";
  protected final String TEXT_405 = ".append(\",\");" + NL + "                }";
  protected final String TEXT_406 = NL + "\t\t\t\t\t\tinsert_";
  protected final String TEXT_407 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_419 = "\")+\") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_420 = ".toString();";
  protected final String TEXT_421 = "            " + NL + "\t\t\t\t    insert_";
  protected final String TEXT_422 = " += \tduplidateClause_";
  ...
  protected final String TEXT_457 = NL + "\t            int rowCount";
  ...
  protected final String TEXT_478 = " += \tduplidateClause_";
  protected final String TEXT_479 = ".toString();";
  protected final String TEXT_480 = NL + "\t\t\t\t\t    batchSize_";
  protected final String TEXT_481 = " = ";
  protected final String TEXT_482 = ";" + NL + "\t\t   \t\t\t    batchSizeCounter_";
  protected final String TEXT_483 = "=0;";
  protected final String TEXT_484 = NL + "\t\t\t\t\t    int batchSize_";
  protected final String TEXT_485 = " = ";
  protected final String TEXT_486 = ";" + NL + "\t\t   \t\t\t    int batchSizeCounter_";
  ...
  protected final String TEXT_550 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_557 = " + \"` SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_566 = "\");//String insert_";
  ...
  protected final String TEXT_579 = "    " + NL + "\t    pstmtInsert_";
  ...
  protected final String TEXT_602 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_603 = ".";
  protected final String TEXT_604 = ")+\")\";";
  protected final String TEXT_605 = NL + "\t\t\t\t\tString insert_";
  protected final String TEXT_606 = " = \"INSERT INTO `\" + tableName_";
  protected final String TEXT_607 = " + \"` (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_608 = ".";
  protected final String TEXT_609 = ", \"";
  protected final String TEXT_610 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_616 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_617 = ".";
  protected final String TEXT_618 = ", \"";
  protected final String TEXT_619 = "\")+\" WHERE ";
  protected final String TEXT_620 = "\";";
  protected final String TEXT_621 = NL + "\t\t\t\t\tString update_";
  protected final String TEXT_622 = " = \"UPDATE `\" + tableName_";
  protected final String TEXT_623 = " + \"` SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_641 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_642 = " = new StringBuffer(insert_";
  protected final String TEXT_643 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_644 = ".insert(insert_";
  protected final String TEXT_645 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_646 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_647 = " =insertStringBuffer_";
  protected final String TEXT_648 = ".toString(); ";
  protected final String TEXT_649 = "    " + NL + "\t    pstmtInsert_";
  protected final String TEXT_650 = " = conn_";
  protected final String TEXT_651 = ".prepareStatement(insert_";
  protected final String TEXT_652 = ");\t\t\t\t" + NL + "\t    ";
  protected final String TEXT_653 = NL + "\t    String delete_";
  protected final String TEXT_654 = " = \"DELETE  FROM `\" + ";
  protected final String TEXT_655 = " + \"` WHERE ";
  protected final String TEXT_656 = "\";" + NL + "\t    ";
  protected final String TEXT_657 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_658 = " = new StringBuffer(delete_";
  protected final String TEXT_659 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_660 = ".insert(delete_";
  protected final String TEXT_661 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_662 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_663 = " =deleteStringBuffer_";
  protected final String TEXT_664 = ".toString();  ";
  protected final String TEXT_665 = NL + "\t    pstmt_";
  protected final String TEXT_666 = " = conn_";
  protected final String TEXT_667 = ".prepareStatement(delete_";
  protected final String TEXT_668 = ");" + NL + "\t    ";
  protected final String TEXT_669 = NL + "\t    String replace_";
  protected final String TEXT_670 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_671 = " + \"` (";
  protected final String TEXT_672 = ") VALUES (";
  protected final String TEXT_673 = ")\";" + NL + "\t    pstmt_";
  protected final String TEXT_674 = " = conn_";
  protected final String TEXT_675 = ".prepareStatement(replace_";
  protected final String TEXT_676 = ");" + NL + "\t    ";
  protected final String TEXT_677 = NL + "\t    String insertIgnore_";
  protected final String TEXT_678 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_679 = " + \"` (";
  protected final String TEXT_680 = ") VALUES (";
  protected final String TEXT_681 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_682 = "\";" + NL + "\t    pstmt_";
  protected final String TEXT_683 = " = conn_";
  protected final String TEXT_684 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_685 = ");" + NL + "\t    ";
  protected final String TEXT_686 = NL + "\t    String insert_";
  protected final String TEXT_687 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_688 = " + \"` (";
  protected final String TEXT_689 = ") VALUES (";
  protected final String TEXT_690 = ")\";" + NL + "\t    ";
  protected final String TEXT_691 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_692 = " = new StringBuffer(insert_";
  protected final String TEXT_693 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_694 = ".insert(insert_";
  protected final String TEXT_695 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_696 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_697 = " =insertStringBuffer_";
  protected final String TEXT_698 = ".toString(); ";
  protected final String TEXT_699 = "    " + NL + "\t    pstmt_";
  protected final String TEXT_700 = " = conn_";
  protected final String TEXT_701 = ".prepareStatement(insert_";
  protected final String TEXT_702 = ");" + NL + "\t    ";
  protected final String TEXT_703 = NL + "       \t";
  protected final String TEXT_704 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_705 = " = insert_";
  protected final String TEXT_706 = ".split(\"\\\\?\");";
  protected final String TEXT_707 = NL + "\t\t\tupdate_";
  protected final String TEXT_708 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_709 = " = update_";
  protected final String TEXT_710 = ".split(\"\\\\?\");";
  protected final String TEXT_711 = NL + "\t\t\tupdate_";
  protected final String TEXT_712 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_713 = " = update_";
  protected final String TEXT_714 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_715 = " = insert_";
  protected final String TEXT_716 = ".split(\"\\\\?\");";
  protected final String TEXT_717 = NL + "\t\t\tdelete_";
  protected final String TEXT_718 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_719 = " = delete_";
  protected final String TEXT_720 = ".split(\"\\\\?\");";
  protected final String TEXT_721 = NL + "\t\t\treplace_";
  protected final String TEXT_722 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_723 = " = replace_";
  protected final String TEXT_724 = ".split(\"\\\\?\");";
  protected final String TEXT_725 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_726 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_727 = " = insertIgnore_";
  protected final String TEXT_728 = ".split(\"\\\\?\");";
  protected final String TEXT_729 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_730 = " = insert_";
  ...
  protected final String TEXT_738 = ".setNull(counter";
  protected final String TEXT_739 = ",java.sql.Types.CHAR);";
  protected final String TEXT_740 = NL + "                if(";
  protected final String TEXT_741 = ".";
  protected final String TEXT_742 = "==null){";
  protected final String TEXT_743 = NL + "                    ";
  protected final String TEXT_744 = ".setNull(counter";
  protected final String TEXT_745 = ",java.sql.Types.DATE);";
  protected final String TEXT_746 = NL + "                if(";
  protected final String TEXT_747 = ".";
  protected final String TEXT_748 = "==null){";
  protected final String TEXT_749 = NL + "                    ";
  protected final String TEXT_750 = ".setNull(counter";
  protected final String TEXT_751 = ",java.sql.Types.ARRAY);         ";
  protected final String TEXT_752 = NL + "                if(";
  protected final String TEXT_753 = ".";
  protected final String TEXT_754 = "==null){";
  protected final String TEXT_755 = NL + "                    ";
  protected final String TEXT_756 = ".setNull(counter";
  protected final String TEXT_757 = ",java.sql.Types.INTEGER);";
  protected final String TEXT_758 = NL + "                if(";
  protected final String TEXT_759 = ".";
  protected final String TEXT_760 = "==null){";
  protected final String TEXT_761 = NL + "                    ";
  protected final String TEXT_762 = ".setNull(counter";
  protected final String TEXT_763 = ",java.sql.Types.VARCHAR);";
  protected final String TEXT_764 = NL + "                if(";
  protected final String TEXT_765 = ".";
  protected final String TEXT_766 = "==null){";
  protected final String TEXT_767 = NL + "                    ";
  protected final String TEXT_768 = ".setNull(counter";
  protected final String TEXT_769 = ",java.sql.Types.OTHER);";
  ...
  protected final String TEXT_775 = ",java.sql.Types.BOOLEAN);   ";
  protected final String TEXT_776 = NL + "                if(";
  protected final String TEXT_777 = ".";
  protected final String TEXT_778 = "==null){";
  protected final String TEXT_779 = NL + "                    ";
  protected final String TEXT_780 = ".setNull(counter";
  protected final String TEXT_781 = ",java.sql.Types.DOUBLE);    ";
  protected final String TEXT_782 = NL + "                if(";
  protected final String TEXT_783 = ".";
  protected final String TEXT_784 = "==null){";
  protected final String TEXT_785 = NL + "                    ";
  protected final String TEXT_786 = ".setNull(counter";
  protected final String TEXT_787 = ",java.sql.Types.FLOAT); ";
  protected final String TEXT_788 = NL + "                }else{";
  protected final String TEXT_789 = NL + "                    if(";
  protected final String TEXT_790 = ".";
  protected final String TEXT_791 = "==null){";
  protected final String TEXT_792 = NL + "                    if((\"null\").equals(String.valueOf(";
  protected final String TEXT_793 = ".";
  protected final String TEXT_794 = ").toLowerCase())){";
  protected final String TEXT_795 = NL + "                ";
  protected final String TEXT_796 = ".setNull(counter";
  protected final String TEXT_797 = ",java.sql.Types.CHAR);" + NL + "            " + NL + "                }else if(";
  protected final String TEXT_798 = ".";
  protected final String TEXT_799 = " == '\\0'){" + NL + "        ";
  protected final String TEXT_800 = NL + "                    ";
  protected final String TEXT_801 = ".setString(counter";
  protected final String TEXT_802 = ",\"\");" + NL + "            " + NL + "                }else{" + NL + "            ";
  protected final String TEXT_803 = NL + "                    ";
  protected final String TEXT_804 = ".setString(counter";
  protected final String TEXT_805 = ",String.valueOf(";
  protected final String TEXT_806 = ".";
  protected final String TEXT_807 = "));" + NL + "                }";
  protected final String TEXT_808 = NL + "                if(";
  protected final String TEXT_809 = ".";
  protected final String TEXT_810 = "!=null){" + NL + "                    // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "                    date_";
  protected final String TEXT_811 = " = ";
  protected final String TEXT_812 = ".";
  protected final String TEXT_813 = ".getTime();" + NL + "                    if (date_";
  protected final String TEXT_814 = " < year1_";
  protected final String TEXT_815 = " || date_";
  protected final String TEXT_816 = " >= year10000_";
  protected final String TEXT_817 = ") {";
  protected final String TEXT_818 = NL + "                        ";
  protected final String TEXT_819 = ".setString(counter";
  protected final String TEXT_820 = ", \"0000-00-00 00:00:00\");" + NL + "                    } else {";
  protected final String TEXT_821 = NL + "                        ";
  protected final String TEXT_822 = ".setTimestamp(counter";
  protected final String TEXT_823 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_824 = "));" + NL + "                    }" + NL + "                }else{" + NL + "        ";
  protected final String TEXT_825 = NL + "                    ";
  protected final String TEXT_826 = ".setNull(counter";
  protected final String TEXT_827 = ",java.sql.Types.DATE);" + NL + "            " + NL + "                }";
  protected final String TEXT_828 = NL + "                ";
  protected final String TEXT_829 = ".set";
  protected final String TEXT_830 = "(counter";
  protected final String TEXT_831 = ",";
  protected final String TEXT_832 = ".";
  protected final String TEXT_833 = ");";
  protected final String TEXT_834 = NL + "            " + NL + "                }" + NL + "        ";
  protected final String TEXT_835 = NL + "\t\tquery_";
  protected final String TEXT_836 = " = new StringBuffer(\"\");";
  protected final String TEXT_837 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_838 = " = buffersSize_";
  protected final String TEXT_839 = ";";
  protected final String TEXT_840 = NL + "\t\t\t\t\tbatchSize_";
  protected final String TEXT_841 = " = buffersSize_";
  protected final String TEXT_842 = ";";
  protected final String TEXT_843 = NL + "\t\t";
  protected final String TEXT_844 = NL + "        whetherReject_";
  protected final String TEXT_845 = " = false;";
  protected final String TEXT_846 = "                " + NL + "\t                \tint counter";
  protected final String TEXT_847 = " = rowCount";
  protected final String TEXT_848 = " * ";
  protected final String TEXT_849 = " + 1;" + NL + "\t                ";
  protected final String TEXT_850 = NL + "\t                        counter";
  protected final String TEXT_851 = "++;" + NL + "\t                        ";
  protected final String TEXT_852 = NL + "\t\t\t\t\t\t\tint count_dyn_";
  protected final String TEXT_853 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_854 = ".";
  protected final String TEXT_855 = ", pstmt_";
  protected final String TEXT_856 = ", counter";
  protected final String TEXT_857 = "-1, \"";
  protected final String TEXT_858 = "\");" + NL + "\t\t\t\t\t\t\tcounter";
  protected final String TEXT_859 = "+=count_dyn_";
  protected final String TEXT_860 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_861 = NL + "\t             " + NL + "\t                exInsertColValue";
  protected final String TEXT_862 = " = new BufferLine_";
  ...
  protected final String TEXT_871 = "  " + NL + "\t                ); " + NL + "\t               " + NL + "\t                exInsertColValueList";
  protected final String TEXT_872 = ".add(exInsertColValue";
  protected final String TEXT_873 = ");" + NL + "\t    " + NL + "\t                rowCount";
  protected final String TEXT_874 = "++;";
  protected final String TEXT_875 = NL + "\t\t\t\tnb_line_";
  protected final String TEXT_876 = "++;";
  protected final String TEXT_877 = "\t         " + NL + "\t                if(rowCount";
  ...
  protected final String TEXT_882 = ".executeUpdate();" + NL + "\t                    exInsertColValueList";
  protected final String TEXT_883 = ".clear();" + NL + "\t                    rowCount";
  protected final String TEXT_884 = " = 0;" + NL + "\t\t\t    counter";
  protected final String TEXT_885 = "=1;" + NL + "\t                }    ";
  ...
  protected final String TEXT_905 = ".toString().trim());" + NL + "\t                    ";
  protected final String TEXT_906 = NL + "\t\t\t\t\t";
  protected final String TEXT_907 = NL + "\t\t    \t\tpstmt_";
  protected final String TEXT_908 = ".addBatch();" + NL + "\t\t    \t\tnb_line_";
  ...
  protected final String TEXT_918 = ".executeUpdate();" + NL + "\t                    ";
  protected final String TEXT_919 = NL + "\t                } catch(java.lang.Exception e) {" + NL + "\t                    whetherReject_";
  protected final String TEXT_920 = " = true;" + NL + "\t                    ";
  protected final String TEXT_921 = NL + "\t                        throw(e);" + NL + "\t                        ";
  protected final String TEXT_922 = NL + "\t                            ";
  protected final String TEXT_923 = " = new ";
  protected final String TEXT_924 = "Struct();" + NL + "\t                            ";
  protected final String TEXT_925 = NL + "\t                                ";
  protected final String TEXT_926 = ".";
  protected final String TEXT_927 = " = ";
  protected final String TEXT_928 = ".";
  protected final String TEXT_929 = ";" + NL + "\t                            ";
  protected final String TEXT_930 = NL + "\t                            rejectedCount_";
  protected final String TEXT_931 = " =  rejectedCount_";
  protected final String TEXT_932 = "+ 1;" + NL + "\t                            ";
  protected final String TEXT_933 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t                            ";
  protected final String TEXT_934 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_935 = ";" + NL + "\t                            ";
  protected final String TEXT_936 = NL + "\t                            System.err.print(e.getMessage());" + NL + "\t                            ";
  ...
  protected final String TEXT_957 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_958 = "++;" + NL + "                    insertedCount_";
  protected final String TEXT_959 = " = insertedCount_";
  ...
  protected final String TEXT_973 = NL + "                            rejectedCount_";
  protected final String TEXT_974 = " =  rejectedCount_";
  protected final String TEXT_975 = "+ 1;";
  protected final String TEXT_976 = NL + "                            ";
  protected final String TEXT_977 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_985 = NL + "                        query_";
  protected final String TEXT_986 = " = ";
  protected final String TEXT_987 = ";";
  protected final String TEXT_988 = NL + "\t\t\t\t\t    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_989 = ",";
  protected final String TEXT_990 = ".";
  protected final String TEXT_991 = ", ";
  protected final String TEXT_992 = ",updateSQLSplits_";
  protected final String TEXT_993 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_994 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_995 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_1025 = ".addBatch();" + NL + "    \t\tnb_line_";
  ...
  protected final String TEXT_1031 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_1032 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_1033 = " = updatedCount_";
  protected final String TEXT_1034 = " + pstmt_";
  protected final String TEXT_1035 = ".executeUpdate();";
  protected final String TEXT_1036 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_1061 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_1062 = " = pstmt_";
  protected final String TEXT_1063 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_1064 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_1065 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_1066 = " = rs_";
  protected final String TEXT_1067 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_1105 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1106 = "_QUERY\", query_";
  protected final String TEXT_1107 = ".toString().trim());";
  protected final String TEXT_1108 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_1109 = " = updatedCount_";
  protected final String TEXT_1110 = " + pstmtUpdate_";
  protected final String TEXT_1111 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1112 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_1113 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1114 = " = true;";
  protected final String TEXT_1115 = NL + "                        throw(e);";
  protected final String TEXT_1116 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_1130 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_1141 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1142 = ",";
  protected final String TEXT_1143 = ".";
  protected final String TEXT_1144 = ", ";
  protected final String TEXT_1145 = ",insertSQLSplits_";
  protected final String TEXT_1146 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_1147 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1148 = ".";
  protected final String TEXT_1149 = ", pstmtInsert_";
  protected final String TEXT_1150 = ", ";
  protected final String TEXT_1151 = ", \"";
  protected final String TEXT_1152 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_1153 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1154 = "_QUERY\", query_";
  protected final String TEXT_1155 = ".toString().trim());";
  protected final String TEXT_1156 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_1157 = " = insertedCount_";
  protected final String TEXT_1158 = " + pstmtInsert_";
  protected final String TEXT_1159 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1160 = "++;";
  protected final String TEXT_1161 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1162 = " = true;";
  protected final String TEXT_1163 = NL + "                        throw(e);";
  protected final String TEXT_1164 = NL + "                    \tnb_line_";
  protected final String TEXT_1165 = "++;" + NL + "                    \t";
  protected final String TEXT_1166 = NL + "                        ";
  protected final String TEXT_1167 = " = new ";
  protected final String TEXT_1168 = "Struct();";
  protected final String TEXT_1169 = NL + "                                ";
  protected final String TEXT_1170 = ".";
  protected final String TEXT_1171 = " = ";
  protected final String TEXT_1172 = ".";
  protected final String TEXT_1173 = ";";
  protected final String TEXT_1174 = NL + "                            rejectedCount_";
  protected final String TEXT_1175 = " =  rejectedCount_";
  protected final String TEXT_1176 = "+ 1;";
  protected final String TEXT_1177 = NL + "                            ";
  protected final String TEXT_1178 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1179 = NL + "                            ";
  protected final String TEXT_1180 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1181 = ";";
  protected final String TEXT_1182 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1183 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_1184 = NL + "    \t    int updateFlag_";
  protected final String TEXT_1185 = "=0;" + NL + "    \t    ";
  protected final String TEXT_1186 = NL + "    \t\t\t    ";
  protected final String TEXT_1187 = NL + "    \t\t\t    ";
  protected final String TEXT_1188 = NL + "                        query_";
  protected final String TEXT_1189 = " = ";
  protected final String TEXT_1190 = ";";
  protected final String TEXT_1191 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1192 = ",";
  protected final String TEXT_1193 = ".";
  protected final String TEXT_1194 = ", ";
  protected final String TEXT_1195 = ",updateSQLSplits_";
  protected final String TEXT_1196 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_1197 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_1198 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1199 = ".";
  protected final String TEXT_1200 = ", pstmtUpdate_";
  ...
  protected final String TEXT_1220 = NL + "\t\t\t\t\t\tquery_";
  protected final String TEXT_1221 = " = ";
  protected final String TEXT_1222 = ";" + NL + "\t\t\t\t\t";
  protected final String TEXT_1223 = NL + "                globalMap.put(\"";
  protected final String TEXT_1224 = "_QUERY\", query_";
  protected final String TEXT_1225 = ".toString().trim());";
  protected final String TEXT_1226 = NL + "    \t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_1227 = "=pstmtUpdate_";
  protected final String TEXT_1228 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_1229 = " = updatedCount_";
  protected final String TEXT_1230 = "+updateFlag_";
  protected final String TEXT_1231 = ";" + NL + "                " + NL + "            if(updateFlag_";
  protected final String TEXT_1232 = " == 0) {" + NL + "            " + NL + "            \t";
  protected final String TEXT_1233 = NL + "\t\t\t\tquery_";
  protected final String TEXT_1234 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_1244 = ",insertSQLSplits_";
  protected final String TEXT_1245 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1246 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_1252 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1253 = "_QUERY\", query_";
  protected final String TEXT_1254 = ".toString().trim());";
  protected final String TEXT_1255 = NL + "                    insertedCount_";
  protected final String TEXT_1256 = " = insertedCount_";
  protected final String TEXT_1257 = " + pstmtInsert_";
  protected final String TEXT_1258 = ".executeUpdate();" + NL + "             \t\tnb_line_";
  protected final String TEXT_1259 = "++;";
  protected final String TEXT_1260 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_1261 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_1262 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1263 = " = true;";
  protected final String TEXT_1264 = NL + "                        throw(e);";
  protected final String TEXT_1265 = NL + "                    \tnb_line_";
  protected final String TEXT_1266 = "++;" + NL + "                    \t";
  protected final String TEXT_1267 = NL + "                        ";
  protected final String TEXT_1268 = " = new ";
  protected final String TEXT_1269 = "Struct();";
  ...
  protected final String TEXT_1275 = NL + "                            rejectedCount_";
  protected final String TEXT_1276 = " =  rejectedCount_";
  protected final String TEXT_1277 = "+ 1;";
  protected final String TEXT_1278 = NL + "                            ";
  protected final String TEXT_1279 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1280 = NL + "                            ";
  protected final String TEXT_1281 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1282 = ";";
  protected final String TEXT_1283 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1284 = NL + "                }";
  protected final String TEXT_1285 = NL + "\t\t\t\t\t";
  protected final String TEXT_1286 = NL + "                    \t";
  protected final String TEXT_1287 = NL + "\t                        query_";
  ...
  protected final String TEXT_1295 = NL + "                globalMap.put(\"";
  protected final String TEXT_1296 = "_QUERY\", query_";
  protected final String TEXT_1297 = ".toString().trim());";
  protected final String TEXT_1298 = NL + "        \t";
  protected final String TEXT_1299 = NL + "    \t\tpstmt_";
  protected final String TEXT_1300 = ".addBatch();" + NL + "\t\t\tnb_line_";
  ...
  protected final String TEXT_1306 = NL + "            try {" + NL + "        \t    deletedCount_";
  protected final String TEXT_1307 = " = deletedCount_";
  protected final String TEXT_1308 = " + pstmt_";
  protected final String TEXT_1309 = ".executeUpdate();" + NL + "            \tnb_line_";
  protected final String TEXT_1310 = "++;" + NL + "            \t";
  protected final String TEXT_1311 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_1342 = NL + "            int replaceCount_";
  protected final String TEXT_1343 = " = 0;" + NL + "            try {" + NL + "                replaceCount_";
  protected final String TEXT_1344 = " = pstmt_";
  protected final String TEXT_1345 = ".executeUpdate();";
  ...
  protected final String TEXT_1350 = " = new ";
  protected final String TEXT_1351 = "Struct();";
  ...
  protected final String TEXT_1357 = NL + "                        rejectedCount_";
  protected final String TEXT_1358 = " =  rejectedCount_";
  protected final String TEXT_1359 = "+ 1;";
  protected final String TEXT_1360 = NL + "                        ";
  protected final String TEXT_1361 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1362 = NL + "                        ";
  protected final String TEXT_1363 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1364 = ";";
  protected final String TEXT_1365 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1366 = "                " + NL + "            }" + NL + "            if(replaceCount_";
  protected final String TEXT_1367 = " == 1) {" + NL + "                insertedCount_";
  protected final String TEXT_1368 = " += replaceCount_";
  protected final String TEXT_1369 = ";" + NL + "            } else {" + NL + "                insertedCount_";
  protected final String TEXT_1370 = " += 1;" + NL + "                deletedCount_";
  protected final String TEXT_1371 = " += replaceCount_";
  protected final String TEXT_1372 = " - 1;" + NL + "            }";
  protected final String TEXT_1373 = NL + "                    ";
  protected final String TEXT_1374 = NL + "                        query_";
  protected final String TEXT_1375 = " = ";
  protected final String TEXT_1376 = ";";
  protected final String TEXT_1377 = NL + "                    ";
  protected final String TEXT_1378 = NL + "                        query_";
  protected final String TEXT_1379 = " = ";
  protected final String TEXT_1380 = ";";
  protected final String TEXT_1381 = NL + "                globalMap.put(\"";
  protected final String TEXT_1382 = "_QUERY\", query_";
  protected final String TEXT_1383 = ".toString().trim());";
  protected final String TEXT_1384 = NL + "            int count_on_duplicate_key_";
  protected final String TEXT_1385 = " = 0;" + NL + "            try {" + NL + "                count_on_duplicate_key_";
  protected final String TEXT_1386 = " = pstmt_";
  protected final String TEXT_1387 = ".executeUpdate();";
  protected final String TEXT_1388 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1389 = " = true;";
  protected final String TEXT_1390 = NL + "                    throw(e);";
  protected final String TEXT_1391 = NL + "                        ";
  protected final String TEXT_1392 = " = new ";
  protected final String TEXT_1393 = "Struct();";
  ...
  protected final String TEXT_1399 = NL + "                        rejectedCount_";
  protected final String TEXT_1400 = " =  rejectedCount_";
  protected final String TEXT_1401 = "+ 1;";
  protected final String TEXT_1402 = NL + "                        ";
  protected final String TEXT_1403 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1404 = NL + "                        ";
  protected final String TEXT_1405 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1406 = ";";
  protected final String TEXT_1407 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1408 = "                " + NL + "            }" + NL + "            if(count_on_duplicate_key_";
  protected final String TEXT_1409 = " == 1) {" + NL + "                insertedCount_";
  protected final String TEXT_1410 = " += count_on_duplicate_key_";
  protected final String TEXT_1411 = ";" + NL + "            } else {" + NL + "                insertedCount_";
  protected final String TEXT_1412 = " += 1;" + NL + "                updatedCount_";
  protected final String TEXT_1413 = " += count_on_duplicate_key_";
  protected final String TEXT_1414 = " - 1;" + NL + "            }";
  protected final String TEXT_1415 = NL + "                        ";
  protected final String TEXT_1416 = NL + "                            query_";
  protected final String TEXT_1417 = " = ";
  protected final String TEXT_1418 = ";";
  protected final String TEXT_1419 = NL + "                    globalMap.put(\"";
  protected final String TEXT_1420 = "_QUERY\", query_";
  protected final String TEXT_1421 = ".toString().trim());";
  protected final String TEXT_1422 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_1423 = "++;" + NL + "                    insertedCount_";
  protected final String TEXT_1424 = " = insertedCount_";
  protected final String TEXT_1425 = " + pstmt_";
  protected final String TEXT_1426 = ".executeUpdate();";
  protected final String TEXT_1427 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_1428 = " = true;";
  protected final String TEXT_1429 = NL + "                        throw(e);";
  protected final String TEXT_1430 = NL + "                            ";
  protected final String TEXT_1431 = " = new ";
  protected final String TEXT_1432 = "Struct();";
  ...
  protected final String TEXT_1438 = NL + "                            rejectedCount_";
  protected final String TEXT_1439 = " =  rejectedCount_";
  protected final String TEXT_1440 = "+ 1;";
  protected final String TEXT_1441 = NL + "                            ";
  protected final String TEXT_1442 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1443 = NL + "                            ";
  protected final String TEXT_1444 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1445 = ";";
  protected final String TEXT_1446 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_1447 = NL + "                }";
  protected final String TEXT_1448 = NL + "            if(!whetherReject_";
  protected final String TEXT_1449 = ") {";
  protected final String TEXT_1450 = NL + "                            ";
  protected final String TEXT_1451 = " = new ";
  protected final String TEXT_1452 = "Struct();";
  ...
  protected final String TEXT_1459 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_1460 = " <= batchSizeCounter_";
  protected final String TEXT_1461 = ") {                ";
  protected final String TEXT_1462 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_1463 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_1464 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1465 = ": pstmt_";
  protected final String TEXT_1466 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1467 = " += (countEach_";
  protected final String TEXT_1468 = " < 0 ? 0 : 1);" + NL + "\t\t\t\t\t\t}          " + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_1473 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1474 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1475 = NL + "                \tint countSum_";
  protected final String TEXT_1476 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1477 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1478 = " += (countEach_";
  protected final String TEXT_1479 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1480 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1481 = NL + "            \t    insertedCount_";
  protected final String TEXT_1482 = " += countSum_";
  protected final String TEXT_1483 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_1484 = "  " + NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1485 = NL + "                }";
  protected final String TEXT_1486 = "    " + NL + "                \t\t\t" + NL + "    \t\t\tbatchSizeCounter_";
  protected final String TEXT_1487 = " = 0;" + NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_1488 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_1489 = " <= batchSizeCounter_";
  protected final String TEXT_1490 = ") {                ";
  protected final String TEXT_1491 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_1492 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1493 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1494 = ": pstmt_";
  protected final String TEXT_1495 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1500 = NL + "            \t    \tupdatedCount_";
  protected final String TEXT_1501 = " += countSum_";
  protected final String TEXT_1502 = ";" + NL + "            \t    \t";
  protected final String TEXT_1503 = NL + "            \t    \tdeletedCount_";
  protected final String TEXT_1504 = " += countSum_";
  protected final String TEXT_1505 = ";" + NL + "            \t    \t";
  protected final String TEXT_1506 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_1507 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1508 = NL + "                \t\tthrow(e);" + NL + "                \t";
  ...
  protected final String TEXT_1521 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1522 = NL + "                }";
  protected final String TEXT_1523 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1524 = NL + "        \t    commitCounter_";
  protected final String TEXT_1525 = "++;" + NL + "       " + NL + "                if(commitEvery_";
  protected final String TEXT_1526 = " <= commitCounter_";
  protected final String TEXT_1527 = ") {" + NL + "                ";
  protected final String TEXT_1528 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_1529 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_1530 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1531 = ": pstmt_";
  protected final String TEXT_1532 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1533 = " += (countEach_";
  protected final String TEXT_1534 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_1540 = "            \t    \t\t" + NL + "            \t    \tupdatedCount_";
  protected final String TEXT_1541 = " += countSum_";
  protected final String TEXT_1542 = ";" + NL + "            \t    \t";
  protected final String TEXT_1543 = NL + "            \t    \tdeletedCount_";
  protected final String TEXT_1544 = " += countSum_";
  protected final String TEXT_1545 = ";" + NL + "            \t    \t";
  protected final String TEXT_1546 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1547 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1548 = NL + "                \tint countSum_";
  protected final String TEXT_1549 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1550 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1551 = " += (countEach_";
  protected final String TEXT_1552 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1553 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1554 = NL + "        \t    \tinsertedCount_";
  protected final String TEXT_1555 = " += countSum_";
  protected final String TEXT_1556 = ";" + NL + "        \t    \t";
  protected final String TEXT_1557 = "            \t    \t\t" + NL + "        \t    \tupdatedCount_";
  protected final String TEXT_1558 = " += countSum_";
  protected final String TEXT_1559 = ";" + NL + "        \t    \t";
  protected final String TEXT_1560 = NL + "        \t    \tdeletedCount_";
  protected final String TEXT_1561 = " += countSum_";
  protected final String TEXT_1562 = ";" + NL + "        \t    \t";
  protected final String TEXT_1563 = NL + "                    System.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1564 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_1565 = NL + "                \t";
  protected final String TEXT_1566 = NL + "                \tconn_";
  protected final String TEXT_1567 = ".commit();" + NL + "            \t\t";
