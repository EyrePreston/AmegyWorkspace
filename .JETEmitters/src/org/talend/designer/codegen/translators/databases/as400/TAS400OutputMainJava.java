...
public class TAS400OutputMainJava {
  ...
  protected final String TEXT_545 = NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_549 = ".executeUpdate();";
  ...
  protected final String TEXT_565 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_566 = NL + "                        ";
  protected final String TEXT_567 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_568 = ";";
  protected final String TEXT_569 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  ...
  protected final String TEXT_579 = ",updateSQLSplits_";
  protected final String TEXT_580 = ");";
  protected final String TEXT_581 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_582 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_606 = NL + "                globalMap.put(\"";
  protected final String TEXT_607 = "_QUERY\", query_";
  protected final String TEXT_608 = ".toString().trim());";
  protected final String TEXT_609 = NL + "    \t\t";
  protected final String TEXT_610 = NL + "    \t\tpstmt_";
  protected final String TEXT_611 = ".addBatch();" + NL + "    \t\tnb_line_";
  ...
  protected final String TEXT_621 = ".executeUpdate();";
  protected final String TEXT_622 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_641 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_642 = NL + "            }";
  protected final String TEXT_643 = NL + "                    \t";
  protected final String TEXT_644 = NL + "                    ";
  protected final String TEXT_645 = NL + "    \t\tjava.sql.ResultSet rs_";
  ...
  protected final String TEXT_652 = " > 0) {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_691 = NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_692 = " = updatedCount_";
  protected final String TEXT_693 = " + pstmtUpdate_";
  protected final String TEXT_694 = ".executeUpdate();" + NL + "        \t\t\tnb_line_";
  protected final String TEXT_695 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_696 = NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  protected final String TEXT_697 = " = true;";
  protected final String TEXT_698 = NL + "                        throw(e);";
  protected final String TEXT_699 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_713 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_717 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_718 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  protected final String TEXT_719 = NL + "                        ";
  protected final String TEXT_720 = NL + "                            query_";
  protected final String TEXT_721 = " = ";
  protected final String TEXT_722 = ";";
  protected final String TEXT_723 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_724 = ",";
  protected final String TEXT_725 = ".";
  protected final String TEXT_726 = ", ";
  protected final String TEXT_727 = ",insertSQLSplits_";
  ...
  protected final String TEXT_740 = " + pstmtInsert_";
  ...
  protected final String TEXT_765 = NL + "                }" + NL + "    \t\t}" + NL + "    " + NL + "    \t\t";
  protected final String TEXT_766 = NL + "    \t    int updateFlag_";
  protected final String TEXT_767 = "=0;" + NL + "            try {" + NL + "    \t    ";
  ...
  protected final String TEXT_776 = ",updateSQLSplits_";
  protected final String TEXT_777 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_778 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_779 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_803 = NL + "                globalMap.put(\"";
  protected final String TEXT_804 = "_QUERY\", query_";
  protected final String TEXT_805 = ".toString().trim());";
  protected final String TEXT_806 = "\t" + NL + "                updateFlag_";
  protected final String TEXT_807 = "=pstmtUpdate_";
  protected final String TEXT_808 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_809 = " = updatedCount_";
  protected final String TEXT_810 = "+updateFlag_";
  protected final String TEXT_811 = ";" + NL + "            " + NL + "            if(updateFlag_";
  protected final String TEXT_812 = " == 0) {" + NL + "            " + NL + "\t\t\t\t";
  ...
  protected final String TEXT_837 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_838 = "++;";
  protected final String TEXT_839 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_840 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_841 = NL + "    \t\t\t}" + NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  protected final String TEXT_842 = " = true;";
  protected final String TEXT_843 = NL + "                        throw(e);";
  protected final String TEXT_844 = NL + "                   \t\tnb_line_";
  ...
  protected final String TEXT_862 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  ...
  protected final String TEXT_884 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_885 = " = deletedCount_";
  protected final String TEXT_886 = " + pstmt_";
  protected final String TEXT_887 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_888 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_889 = "                " + NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_910 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_911 = NL + "            }" + NL + "    \t";
  protected final String TEXT_912 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_923 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_924 = " <= batchSizeCounter_";
  protected final String TEXT_925 = ") {" + NL + "    \t\t\t    try {" + NL + "    \t\t\t    \t";
  protected final String TEXT_926 = NL + "                            pstmt_";
  protected final String TEXT_927 = ".executeBatch();";
  protected final String TEXT_928 = NL + "                            int countSum_";
  protected final String TEXT_929 = " = 0;" + NL + "                            for(int countEach_";
  protected final String TEXT_930 = ": pstmt_";
  protected final String TEXT_931 = ".executeBatch()) {" + NL + "                                countSum_";
  protected final String TEXT_932 = " += (countEach_";
  protected final String TEXT_933 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_941 = "                 " + NL + "                    }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_942 = "){";
  protected final String TEXT_943 = NL + "                            throw(e_";
  protected final String TEXT_944 = ");";
  protected final String TEXT_945 = "                          " + NL + "                                int countSum_";
  protected final String TEXT_946 = " = 0;" + NL + "                                for(int countEach_";
  protected final String TEXT_947 = ": e_";
  protected final String TEXT_948 = ".getUpdateCounts()) {" + NL + "                                    countSum_";
  ...
  protected final String TEXT_958 = NL + "                            System.err.println(e_";
  protected final String TEXT_959 = ".getMessage());";
  protected final String TEXT_960 = NL + "                    }                                             ";
  protected final String TEXT_961 = NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_962 = " = pstmt_";
  protected final String TEXT_963 = ".getUpdateCount();" + NL + "                        insertedCount_";
  protected final String TEXT_964 = "+= (tmp_batchUpdateCount_";
  protected final String TEXT_965 = " >0 ? tmp_batchUpdateCount_";
  protected final String TEXT_966 = ":0);";
  protected final String TEXT_967 = " " + NL + "                    batchSizeCounter_";
  protected final String TEXT_968 = " = 0;  " + NL + "\t\t\t\t}" + NL + "" + NL + "\t    \t\t";
  protected final String TEXT_969 = NL + "                    commitCounter_";
  protected final String TEXT_970 = "++;                " + NL + "                    if(commitEvery_";
  protected final String TEXT_971 = " <= commitCounter_";
  protected final String TEXT_972 = ") {                " + NL + "\t                ";
  protected final String TEXT_973 = NL + "\t                if(batchSizeCounter_";
  protected final String TEXT_974 = " > 0){" + NL + "    \t                try {" + NL + "    \t                \t";
  protected final String TEXT_975 = NL + "                                pstmt_";
  protected final String TEXT_976 = ".executeBatch();";
  protected final String TEXT_977 = NL + "                                int countSum_";
  protected final String TEXT_978 = " = 0;" + NL + "                                for(int countEach_";
  protected final String TEXT_979 = ": pstmt_";
  protected final String TEXT_980 = ".executeBatch()) {" + NL + "                                    countSum_";
  protected final String TEXT_981 = " += (countEach_";
  protected final String TEXT_982 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_990 = "                 " + NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_991 = "){";
  protected final String TEXT_992 = NL + "                                throw(e_";
  ...
  protected final String TEXT_996 = ": e_";
  protected final String TEXT_997 = ".getUpdateCounts()) {" + NL + "                                        countSum_";
