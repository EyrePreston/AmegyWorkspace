...
public class THSQLDbOutputBeginJava {
  ...
  protected final String TEXT_44 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_45 = " + \":\" + ";
  protected final String TEXT_46 = " + \"/\" + ";
  protected final String TEXT_47 = ";" + NL + "\t\t\t";
  protected final String TEXT_48 = NL + "\t\t\turl_";
  protected final String TEXT_49 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_50 = " + \":\" + ";
  protected final String TEXT_51 = " + \"/\" + ";
  protected final String TEXT_52 = ";" + NL + "\t\t\t";
  protected final String TEXT_53 = NL + "\t\t\turl_";
  protected final String TEXT_54 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_55 = " + \":\" + ";
  protected final String TEXT_56 = " + \"/\" + ";
  protected final String TEXT_57 = ";" + NL + "\t\t\t";
  protected final String TEXT_58 = NL + "\t\t\turl_";
  protected final String TEXT_59 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_60 = " + \":\" + ";
  protected final String TEXT_61 = " + \"/\" + ";
  protected final String TEXT_62 = ";" + NL + "\t\t\t";
  protected final String TEXT_63 = NL + "\t\turl_";
  protected final String TEXT_64 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_65 = " + \"/\" + ";
  protected final String TEXT_66 = " ;" + NL + "\t\t";
  protected final String TEXT_67 = NL + "\t\turl_";
  protected final String TEXT_68 = " = \"jdbc:hsqldb:mem:\" + ";
  protected final String TEXT_69 = " ;" + NL + "\t\t";
  protected final String TEXT_70 = NL + "\t\turl_";
  protected final String TEXT_71 = " += \";\" + ";
  protected final String TEXT_72 = ";";
  protected final String TEXT_73 = NL + NL + "int nb_line_";
  ...
  protected final String TEXT_82 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_83 = " = ";
  protected final String TEXT_84 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_85 = " = false;";
  ...
  protected final String TEXT_95 = " " + NL + "java.lang.Class.forName(\"org.hsqldb.jdbcDriver\");";
  ...
  protected final String TEXT_117 = ".setAutoCommit(false);";
  ...
  protected final String TEXT_179 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_190 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_198 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_199 = " = \"INSERT INTO \" + ";
  protected final String TEXT_200 = " + \" (";
  protected final String TEXT_201 = ") VALUES (";
  protected final String TEXT_202 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_203 = " = conn_";
  protected final String TEXT_204 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_213 = NL + "\t    String update_";
  protected final String TEXT_214 = " = \"UPDATE \" + ";
  protected final String TEXT_215 = " + \" SET ";
  protected final String TEXT_216 = " WHERE ";
  protected final String TEXT_217 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_218 = " = conn_";
  protected final String TEXT_219 = ".prepareStatement(update_";
  protected final String TEXT_220 = ");" + NL + "\t    String insert_";
  protected final String TEXT_221 = " = \"INSERT INTO \" + ";
  protected final String TEXT_222 = " + \" (";
  protected final String TEXT_223 = ") VALUES (";
  protected final String TEXT_224 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_225 = " = conn_";
  protected final String TEXT_226 = ".prepareStatement(insert_";
  protected final String TEXT_227 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_228 = NL + "\t    String delete_";
  protected final String TEXT_229 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_230 = " + \" WHERE ";
  protected final String TEXT_231 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_232 = " = conn_";
  protected final String TEXT_233 = ".prepareStatement(delete_";
  protected final String TEXT_234 = ");" + NL + "\t    ";
  protected final String TEXT_235 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_244 = NL + "\t\t\tupdate_";
  protected final String TEXT_245 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_246 = " = update_";
  protected final String TEXT_247 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_248 = " = insert_";
  protected final String TEXT_249 = ".split(\"\\\\?\");";
  protected final String TEXT_250 = NL + "\t\t\tdelete_";
  protected final String TEXT_251 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_252 = " = delete_";
  protected final String TEXT_253 = ".split(\"\\\\?\");";
  protected final String TEXT_254 = NL + "\t\t\treplace_";
  protected final String TEXT_255 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_256 = " = replace_";
  protected final String TEXT_257 = ".split(\"\\\\?\");";
  protected final String TEXT_258 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_259 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_260 = " = insertIgnore_";
  protected final String TEXT_261 = ".split(\"\\\\?\");";
  protected final String TEXT_262 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_263 = " = insert_";
  protected final String TEXT_264 = ".split(\"\\\\?\");";
  protected final String TEXT_265 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_266 = " = ";
  protected final String TEXT_267 = ";" + NL + "        " + NL + "        int commitCounter_";
