...
public class TNetezzaNzLoadBeginJava {
  ...
  protected final String TEXT_77 = " = \"org.netezza.Driver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_78 = ");" + NL + "\t\tString url_";
  protected final String TEXT_79 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_94 = ";" + NL + "\t        \t\t" + NL + "\t\tString tableName_";
  ...
  protected final String TEXT_102 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_103 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_104 = " - Droping table '\" + tableName_";
  ...
  protected final String TEXT_110 = " - Drop table '\" + tableName_";
  protected final String TEXT_111 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_112 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_113 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_114 = " =  null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_118 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_124 = " - Create table '\" + tableName_";
  protected final String TEXT_125 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_126 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_127 = ".close();" + NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_128 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Failure on DROP_CREATE action, process terminated.\");" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_129 = NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_130 = " = null; " + NL + "\t\t\ttry{" + NL + "\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_143 = ".close();" + NL + "\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\tif(";
  protected final String TEXT_144 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Table '\" + tableName_";
  protected final String TEXT_145 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_147 = " - Table '\" + tableName_";
  protected final String TEXT_148 = "  + \"' already exists. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_149 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  ...
  protected final String TEXT_164 = " = null;" + NL + "\t\t\t\t\ttry{" + NL + "\t\t\t\t\t\tstmtCreate_";
  ...
  protected final String TEXT_174 = " - Create table \" + tableName_";
  protected final String TEXT_175 = " + \"' has succeeded. \");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_176 = " " + NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_177 = ".close();" + NL + "\t\t\t\t\t}catch(java.sql.SQLException e){" + NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_178 = "){" + NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName_";
  protected final String TEXT_179 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_180 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_181 = " - Failure to create table '\" + tableName_";
  protected final String TEXT_182 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_183 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}                ";
  protected final String TEXT_184 = NL + "                if(whetherExist_";
  protected final String TEXT_185 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_186 = " = null;" + NL + "                    try{" + NL + "                    \tstmtDrop_";
  ...
  protected final String TEXT_199 = ".close();" + NL + "                    }catch(java.sql.SQLException e){" + NL + "                    \tif(";
  protected final String TEXT_200 = "){" + NL + "\t\t\t\t\t\t\t throw new RuntimeException (\"Failure to drop table '\" + tableName_";
  protected final String TEXT_201 = "  + \"'. process terminated.\");" + NL + "                    \t" + NL + "                    \t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_202 = NL + "\t\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_203 = " - Failure to drop table '\" + tableName_";
  protected final String TEXT_204 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_205 = NL + "\t\t\t\t\t\t\t e.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "                    }" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_206 = " = null;" + NL + "                try{" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_210 = " - Creating table '\" + tableName_";
  ...
  protected final String TEXT_216 = " - Drop table '\" + tableName_";
  protected final String TEXT_217 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_218 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_219 = ".close();" + NL + "                }catch(java.sql.SQLException e){" + NL + "                \tif(";
  protected final String TEXT_220 = "){" + NL + "\t\t\t\t\t\t throw new RuntimeException (\"Failure to create table '\" + tableName_";
  protected final String TEXT_221 = "  + \"'. process terminated.\");" + NL + "                \t}else{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_222 = NL + "\t\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_223 = " - Failure to create table '\" + tableName_";
  protected final String TEXT_224 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_225 = NL + "\t\t\t\t\t\t e.printStackTrace();" + NL + "                \t}" + NL + "                }";
  protected final String TEXT_226 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_227 = " = conn_";
  protected final String TEXT_228 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_229 = " = stmtClearCount_";
  protected final String TEXT_230 = ".executeQuery(\"";
  ...
  protected final String TEXT_235 = " - Truncating table '\" + tableName_";
  protected final String TEXT_236 = " + \"'.\");" + NL + "\t\t\t";
  protected final String TEXT_237 = NL + "            stmtClear_";
  protected final String TEXT_238 = ".executeUpdate(\"";
  protected final String TEXT_239 = "\");" + NL + "\t\t\t";
  protected final String TEXT_240 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_241 = " - Truncate table '\" + tableName_";
  protected final String TEXT_242 = " + \"' has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_243 = NL + "            while(rsClearCount_";
  protected final String TEXT_244 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_245 = " = rsClearCount_";
  protected final String TEXT_246 = ".getInt(1);" + NL + "            }" + NL + "            stmtClearCount_";
  protected final String TEXT_247 = ".close();" + NL + "\t\t\tstmtClear_";
  protected final String TEXT_248 = ".close();";
  protected final String TEXT_249 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_250 = " = null;" + NL + "            try{" + NL + "            \tstmtClear_";
  ...
  protected final String TEXT_254 = " - Clearing table '\" + tableName_";
  protected final String TEXT_255 = " + \"'.\");" + NL + "\t\t\t\t";
  protected final String TEXT_256 = NL + "            \tdeletedCount_";
  protected final String TEXT_257 = " = stmtClear_";
  protected final String TEXT_258 = ".executeUpdate(\"";
  protected final String TEXT_259 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_260 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_261 = " - Clear table '\" + tableName_";
  protected final String TEXT_262 = " + \"' has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_263 = NL + "            \tstmtClear_";
  protected final String TEXT_264 = ".close();" + NL + "            }catch(java.sql.SQLException e){" + NL + "            \tif(";
  protected final String TEXT_265 = "){" + NL + "\t\t\t\t\t throw new RuntimeException (\"Failure to clear table '\" + tableName_";
  protected final String TEXT_266 = "  + \"'. process terminated.\");" + NL + "            \t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_267 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_268 = " - Failure to clear table '\" + tableName_";
  protected final String TEXT_269 = "  + \"'. process terminated.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_270 = NL + "\t\t\t\t\t e.printStackTrace();" + NL + "            \t}" + NL + "            }";
  protected final String TEXT_271 = NL;
  protected final String TEXT_272 = NL + "\tfinal StringBuilder nzloadOutput_";
  protected final String TEXT_273 = " = new StringBuilder(200);" + NL + "\t//final " + NL + "\t";
  protected final String TEXT_274 = NL + "    ";
  protected final String TEXT_275 = " " + NL + "    \tfinal String decryptedPwd_";
  protected final String TEXT_276 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_277 = ");";
  protected final String TEXT_278 = NL + "    \tfinal String decryptedPwd_";
  protected final String TEXT_279 = " = ";
  protected final String TEXT_280 = "; ";
  protected final String TEXT_281 = NL + "\t" + NL + "\tThread nzloadThread_";
  protected final String TEXT_282 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tString[] envp = null;" + NL + "\t\t\t\tString[] cmds = new String[] {";
  protected final String TEXT_283 = " ";
  protected final String TEXT_284 = ",";
  protected final String TEXT_285 = "};" + NL + "\t\t\t\t" + NL + "\t\t\t\t// added \"print command\" feature" + NL + "\t\t\t\t";
  protected final String TEXT_286 = NL + "\t\t\t\t    System.out.println(\"INFO: executing nzload command:\");" + NL + "\t\t\t\t    for( String cmd : cmds ) {" + NL + "\t\t\t\t\t       System.out.print(cmd + \" \");" + NL + "\t\t\t\t\t }" + NL + "\t\t\t\t";
  protected final String TEXT_287 = NL + "\t\t\t\t" + NL + "\t\t\t\tRuntime rt = Runtime.getRuntime();" + NL + "\t\t\t\tfinal Process ps = rt.exec(cmds, envp);" + NL + "\t\t\t\t" + NL + "" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getInputStream()));" + NL + "\t\t\t\t// fixed no showing of error messages" + NL + "\t\t\t\tjava.io.BufferedReader errReader = new java.io.BufferedReader(new java.io.InputStreamReader(ps.getErrorStream()));" + NL + "\t\t\t\t" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\tString errLine = \"\";" + NL + "\t\t\t\twhile ((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tif((errLine = errReader.readLine()) != null) {" + NL + "\t\t\t\t\t\tnzloadOutput_";
  protected final String TEXT_288 = ".append(errLine);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_289 = NL + "\t\t\t\t\t\t\t\tSystem.out.println(errLine);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_290 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tnzloadOutput_";
  protected final String TEXT_291 = ".append(line);" + NL + "\t\t\t\t\t";
  protected final String TEXT_292 = NL + "\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t\t";
  protected final String TEXT_293 = NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tcatch (java.lang.Exception e) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_294 = "_NZLOAD_ERROR\",e.getMessage());" + NL + "\t\t\t\tthrow new RuntimeException(e.getMessage(),e.getCause());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\t";
  protected final String TEXT_295 = NL + "\t\tStringBuffer command_";
  protected final String TEXT_296 = " = new StringBuffer(";
  protected final String TEXT_297 = ");" + NL + "\t\t";
  protected final String TEXT_298 = NL + "\t\t\tcommand_";
  protected final String TEXT_299 = ".append(";
  protected final String TEXT_300 = " +\" \");" + NL + "\t\t";
  protected final String TEXT_301 = NL + "\t";
  protected final String TEXT_302 = NL + "\t\t\tcom.infobright.io.NamedPipe outputStream_";
  protected final String TEXT_303 = " = (new com.infobright.io.NamedPipeFactory()).createServer(";
  protected final String TEXT_304 = ", true, true, 1024000, 10000);" + NL + "\t\t\tnzloadThread_";
  protected final String TEXT_305 = ".start();" + NL + "\t\t\t// in Windows wait for named pipe to get opened by nzload.exe" + NL + "\t\t\tif ((new com.infobright.io.NamedPipeFactory()).isWindowsMode()) { " + NL + "\t\t\t\tThread.sleep(10000);" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_306 = NL + "\t\t\tjava.io.BufferedOutputStream outputStream_";
  protected final String TEXT_307 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(";
  protected final String TEXT_308 = ",false), 1024000);" + NL + "\t\t";
  protected final String TEXT_309 = NL + "\t\t";
  protected final String TEXT_310 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_311 = " - Executing '\"+command_";
  protected final String TEXT_312 = ".toString()+\"'.\");" + NL + "\t\t";
  protected final String TEXT_313 = NL + "\t\tnzloadThread_";
  protected final String TEXT_314 = ".start();" + NL + "\t\tnzloadThread_";
  protected final String TEXT_315 = ".join(0);" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_316 = "_NZLOAD_OUTPUT\", nzloadOutput_";
  protected final String TEXT_317 = ".toString());" + NL + "\t\t";
  protected final String TEXT_318 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_319 = " - Execute '\"+command_";
  protected final String TEXT_320 = ".toString()+\"' has finished.\");" + NL + "\t\t";
