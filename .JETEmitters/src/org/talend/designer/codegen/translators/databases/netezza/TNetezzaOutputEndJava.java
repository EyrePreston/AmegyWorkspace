...
public class TNetezzaOutputEndJava {
  ...
  protected final String TEXT_53 = "                " + NL + "    try {" + NL + "    \tif(pstmt_";
  ...
  protected final String TEXT_62 = ".getUpdateCount(); " + NL + "\t    \t";
  protected final String TEXT_63 = NL + "\t    \tupdatedCount_";
  protected final String TEXT_64 = " += pstmt_";
  protected final String TEXT_65 = ".getUpdateCount();" + NL + "\t    \t";
  protected final String TEXT_66 = NL + "\t    \tdeletedCount_";
  protected final String TEXT_67 = " += pstmt_";
  protected final String TEXT_68 = ".getUpdateCount();" + NL + "\t    \t";
  protected final String TEXT_69 = NL + "\t    }\t                \t    " + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  protected final String TEXT_70 = NL + "    \t\tthrow(e);" + NL + "    \t";
  protected final String TEXT_71 = NL + "    \tSystem.err.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_72 = "                \t" + NL + "\t}catch (java.sql.SQLException e){" + NL + "\t\t";
  protected final String TEXT_73 = NL + "\t\t\tthrow(e);" + NL + "\t\t";
  protected final String TEXT_74 = NL + "\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t";
  protected final String TEXT_75 = NL + "\t}                                  ";
  protected final String TEXT_76 = "  " + NL + "    " + NL + "        if(pstmt_";
  protected final String TEXT_77 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_78 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_79 = NL;
  protected final String TEXT_80 = NL + "\t\t\tif(commitCounter_";
  protected final String TEXT_81 = " > 0){" + NL + "\t\t\t\t";
  protected final String TEXT_82 = NL + "\t\t\t\tconn_";
  protected final String TEXT_83 = ".commit();" + NL + "\t\t\t\t";
