...
public class TVerticaOutputBeginJava {
  ...
  protected final String TEXT_46 = " = 0;" + NL + "int nb_line_copied_";
  ...
  protected final String TEXT_51 = "=0;" + NL + "int copiedCount_";
  ...
  protected final String TEXT_77 = " = \"com.vertica.jdbc.Driver\";" + NL + "\t\t\t";
  ...
  protected final String TEXT_84 = " = \"jdbc:vertica://\" + ";
  ...
  protected final String TEXT_94 = NL + "\t\t\t" + NL + "\t\t\t\tString dbUser_";
  ...
  protected final String TEXT_115 = NL + "\t\t\t" + NL + "if(dbschema_";
  ...
  protected final String TEXT_124 = ".setAutoCommit(false);" + NL + "        " + NL + "int commitEvery_";
  protected final String TEXT_125 = " = ";
  protected final String TEXT_126 = ";" + NL + "        " + NL + "int commitCounter_";
  ...
  protected final String TEXT_184 = NL + "\t\t    \t\tString keyCheckTable_";
  protected final String TEXT_185 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_186 = "+\"][\"+";
  protected final String TEXT_187 = "+\"][\"+";
  protected final String TEXT_188 = "+\"][\"+";
  protected final String TEXT_189 = "+\"][\"+";
  protected final String TEXT_190 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_191 = " + \"]\";" + NL + "\t\t    \t";
  protected final String TEXT_192 = NL + "        \t\t    // [%connection%][checktable][tableName]" + NL + "        \t\t    String keyCheckTable_";
  protected final String TEXT_193 = " = conn_";
  protected final String TEXT_194 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_195 = " + \"]\";" + NL + "    \t\t    ";
  protected final String TEXT_196 = NL + "\t\t    " + NL + "\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_197 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_198 = ")) {" + NL + "\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  ...
  protected final String TEXT_334 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_335 = ".";
  protected final String TEXT_336 = ", \"";
  protected final String TEXT_337 = "\")";
  protected final String TEXT_338 = ".toUpperCase()";
  ...
  protected final String TEXT_346 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_347 = NL + "                                if(whetherExist_";
  protected final String TEXT_348 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_376 = NL + "    \t\t\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_377 = ", true);" + NL + "    " + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_412 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_436 = NL + "\t\t\t\tjava.sql.Statement stmtCreateProjection_";
  protected final String TEXT_437 = " = conn_";
  protected final String TEXT_438 = ".createStatement();" + NL + "\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_439 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_440 = " + \"_proj (";
  protected final String TEXT_441 = ") AS SELECT ";
  protected final String TEXT_442 = " FROM \" + tableName_";
  protected final String TEXT_443 = ");" + NL + "\t\t\t\tstmtCreateProjection_";
  ...
  protected final String TEXT_456 = NL + "        int batchCount_";
  ...
  protected final String TEXT_468 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_474 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_489 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_496 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_497 = " = conn_";
  protected final String TEXT_498 = ".prepareStatement(insert_";
  protected final String TEXT_499 = ");        ";
  protected final String TEXT_500 = NL + "        String delete_";
  protected final String TEXT_501 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_507 = NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_508 = " = new StringBuilder();" + NL + "        java.sql.Statement stmt_";
  protected final String TEXT_509 = " = conn_";
  protected final String TEXT_510 = ".createStatement();\t" + NL + "        String template_";
  protected final String TEXT_511 = " = \"COPY \" + tableName_";
  protected final String TEXT_512 = " +\" (";
  protected final String TEXT_513 = ")\"" + NL + "\t\t\t\t\t\t          + \" FROM STDIN UNCOMPRESSED WITH DELIMITER ';' RECORD TERMINATOR '\\n' ENCLOSED BY '|' NULL AS '' ";
  protected final String TEXT_514 = "DIRECT";
  ...
  protected final String TEXT_547 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_548 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_557 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_561 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_562 = " = null;";
  protected final String TEXT_563 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_567 = NL + "\t\tjava.sql.Statement stmt_";
  protected final String TEXT_568 = " = null;" + NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_569 = " = null;" + NL + "\t\tString template_";
