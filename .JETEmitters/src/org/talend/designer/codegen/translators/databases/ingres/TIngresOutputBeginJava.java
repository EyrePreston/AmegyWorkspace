...
public class TIngresOutputBeginJava {
  ...
  protected final String TEXT_95 = ".setAutoCommit(false);" + NL + "\t";
  ...
  protected final String TEXT_141 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_148 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_149 = " = conn_";
  protected final String TEXT_150 = ".createStatement();";
  protected final String TEXT_151 = NL + "            deletedCount_";
  protected final String TEXT_152 = " = deletedCount_";
  protected final String TEXT_153 = " + stmtClear_";
  ...
  protected final String TEXT_174 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  ...
  protected final String TEXT_187 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_195 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_206 = NL + "\t    String delete_";
  protected final String TEXT_207 = " = \"DELETE  FROM \\\"\" + ";
  ...
  protected final String TEXT_211 = ".prepareStatement(delete_";
  protected final String TEXT_212 = ");" + NL + "\t    ";
  protected final String TEXT_213 = NL + "        StringBuffer query_";
  protected final String TEXT_214 = " = null;" + NL + "       \t";
  protected final String TEXT_215 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_216 = " = insert_";
  protected final String TEXT_217 = ".split(\"\\\\?\");";
  protected final String TEXT_218 = NL + "\t\t\tupdate_";
  protected final String TEXT_219 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_220 = " = update_";
  protected final String TEXT_221 = ".split(\"\\\\?\");";
  protected final String TEXT_222 = NL + "\t\t\tupdate_";
  protected final String TEXT_223 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_224 = " = update_";
  protected final String TEXT_225 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_226 = " = insert_";
  protected final String TEXT_227 = ".split(\"\\\\?\");";
  protected final String TEXT_228 = NL + "\t\t\tdelete_";
  protected final String TEXT_229 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_230 = " = delete_";
  protected final String TEXT_231 = ".split(\"\\\\?\");";
  protected final String TEXT_232 = NL + "\t\t\treplace_";
  protected final String TEXT_233 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_234 = " = replace_";
  protected final String TEXT_235 = ".split(\"\\\\?\");";
  protected final String TEXT_236 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_237 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_238 = " = insertIgnore_";
  ...
  protected final String TEXT_243 = NL + "\t    " + NL + "\t        int commitEvery_";
  protected final String TEXT_244 = " = ";
  protected final String TEXT_245 = ";" + NL + "\t        " + NL + "\t        int commitCounter_";
  protected final String TEXT_246 = " = 0;" + NL + "\t        " + NL + "\t    \t";
