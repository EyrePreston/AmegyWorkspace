...
public class THiveConnectionBeginJava
{
  ...
  protected final String TEXT_100 = NL + "\t\t\t\tif(true) {" + NL + "\t\t\t\t\tthrow new java.lang.Exception(\"The Hive version and the connection mode are not compatible together. Please check your component configuration.\");" + NL + "\t\t\t\t}";
  protected final String TEXT_101 = NL + "\t\t\t\t\tSystem.setProperty(";
  protected final String TEXT_102 = " ,";
  protected final String TEXT_103 = ");";
  protected final String TEXT_104 = NL + "\t\t\t\tSystem.setProperty(\"hive.metastore.sasl.enabled\", \"true\");" + NL + "\t\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionDriverName\", ";
  protected final String TEXT_105 = ");" + NL + "\t\t\t\tSystem.setProperty(\"hive.security.authorization.enabled\", \"true\");" + NL + "\t\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionURL\", ";
  protected final String TEXT_106 = ");" + NL + "\t\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionUserName\", ";
  ...
  protected final String TEXT_112 = NL + "            \tString decryptedMetastorePassword_";
  protected final String TEXT_113 = " = ";
  protected final String TEXT_114 = "; " + NL + "    \t\t\t";
  protected final String TEXT_115 = NL + "        \t   \t" + NL + "\t\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionPassword\", decryptedMetastorePassword_";
  protected final String TEXT_116 = ");" + NL + "\t\t\t\tSystem.setProperty(\"hive.metastore.kerberos.principal\", ";
  ...
  protected final String TEXT_153 = " + \";principal=\" + ";
  protected final String TEXT_154 = ";";
  protected final String TEXT_155 = NL + "\t\t\t\t\tString url_";
  protected final String TEXT_156 = " = \"jdbc:";
  ...
  protected final String TEXT_175 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_176 = " = ";
  protected final String TEXT_177 = "; ";
  protected final String TEXT_178 = NL + "\t\tString dbPwd_";
  protected final String TEXT_179 = " = decryptedPassword_";
  protected final String TEXT_180 = ";" + NL + "\t";
  protected final String TEXT_181 = NL + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_182 = " = null;" + NL + "\t";
  protected final String TEXT_183 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_184 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  protected final String TEXT_185 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_186 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_187 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_188 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_189 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_190 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_191 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_192 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_193 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_194 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_195 = " - Written records count: \" + nb_line_";
  protected final String TEXT_196 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_197 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_198 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_199 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_200 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_201 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_202 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_203 = " - Writing the record \" + nb_line_";
  protected final String TEXT_204 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_205 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_206 = " - Processing the record \" + nb_line_";
  protected final String TEXT_207 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_208 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_209 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_210 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_211 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_212 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_213 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_214 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_215 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_216 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_223 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_224 = NL + "\t\t\tconn_";
  protected final String TEXT_225 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_226 = NL + "\t\t\tconn_";
  protected final String TEXT_227 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_228 = NL + "\t\t\t\tconn_";
  protected final String TEXT_229 = ".setAutoCommit(";
  protected final String TEXT_230 = ");" + NL + "\t\t\t";
  protected final String TEXT_231 = NL + "\t\t\t\tlog.";
  protected final String TEXT_232 = "(\"";
  protected final String TEXT_233 = " - \" + ";
  protected final String TEXT_234 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_235 = NL + "\t    \t\tlog.";
  protected final String TEXT_236 = "(\"";
  protected final String TEXT_237 = "\");" + NL + "\t\t\t";
  protected final String TEXT_238 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_239 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_240 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_241 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  ...
  protected final String TEXT_248 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  protected final String TEXT_249 = ")) {";
  protected final String TEXT_250 = NL + "\t\t";
  protected final String TEXT_251 = NL + "\t\t";
  protected final String TEXT_252 = NL + NL + "\t\tglobalMap.put(\"conn_";
  ...
  protected final String TEXT_260 = NL + "\tglobalMap.put(\"current_client_path_separator\", System.getProperty(\"path.separator\"));" + NL + "\tSystem.setProperty(\"path.separator\", ";
  protected final String TEXT_261 = ");" + NL + "\t" + NL + "\tjava.sql.Statement init_";
  ...
  protected final String TEXT_265 = ".execute(\"SET mapred.job.map.memory.mb=\" + ";
  protected final String TEXT_266 = ");" + NL + "\t    init_";
  protected final String TEXT_267 = ".execute(\"SET mapred.job.reduce.memory.mb=\" + ";
  protected final String TEXT_268 = ");";
  protected final String TEXT_269 = NL + "\t\tinit_";
  protected final String TEXT_270 = ".execute(\"SET dfs.namenode.kerberos.principal=\" + ";
  protected final String TEXT_271 = ");";
  protected final String TEXT_272 = NL + "\t\t\tinit_";
  protected final String TEXT_273 = ".execute(\"SET mapreduce.jobtracker.kerberos.principal=\" + ";
  protected final String TEXT_274 = ");";
  protected final String TEXT_275 = NL + "\t\t\tinit_";
  protected final String TEXT_276 = ".execute(\"SET yarn.resourcemanager.principal=\" + ";
  protected final String TEXT_277 = ");";
  protected final String TEXT_278 = NL + "    \t\tinit_";
  protected final String TEXT_279 = ".execute(\"SET mapreduce.framework.name=yarn\");" + NL + "    \t\tinit_";
  protected final String TEXT_280 = ".execute(\"SET yarn.resourcemanager.address=\" + ";
  protected final String TEXT_281 = ");";
  protected final String TEXT_282 = NL + "\t\t\tinit_";
  protected final String TEXT_283 = ".execute(\"SET mapreduce.jobhistory.address=\" + ";
  protected final String TEXT_284 = ");" + NL + "\t\t\t";
  protected final String TEXT_285 = NL + "\t\t\tinit_";
  protected final String TEXT_286 = ".execute(\"SET dfs.client.use.datanode.hostname=true\");";
  protected final String TEXT_287 = NL + "\t\t\tinit_";
  protected final String TEXT_288 = ".execute(\"SET yarn.resourcemanager.scheduler.address=\" + ";
  protected final String TEXT_289 = ");";
  protected final String TEXT_290 = NL + "\t\t\tinit_";
  protected final String TEXT_291 = ".execute(\"SET fs.default.name=\" + ";
  protected final String TEXT_292 = ");";
  protected final String TEXT_293 = NL + "\t\t\tinit_";
  protected final String TEXT_294 = ".execute(\"SET mapreduce.app-submission.cross-platform=true\");";
  protected final String TEXT_295 = NL + "\t\t\tinit_";
  protected final String TEXT_296 = ".execute(\"SET yarn.application.classpath=/etc/hadoop/conf,/usr/lib/hadoop/*,/usr/lib/hadoop/lib/*,/usr/lib/hadoop-hdfs/*,/usr/lib/hadoop-hdfs/lib/*,/usr/lib/hadoop-yarn/*,/usr/lib/hadoop-yarn/lib/*,/usr/lib/hadoop-mapreduce/*,/usr/lib/hadoop-mapreduce/lib/*\");";
  protected final String TEXT_297 = NL + "    \t\t\t//set default yarn classpath with environment variable" + NL + "    \t\t\tinit_";
  protected final String TEXT_298 = ".execute(\"SET yarn.application.classpath=$HADOOP_CONF_DIR,$HADOOP_COMMON_HOME/*,$HADOOP_COMMON_HOME/lib/*,$HADOOP_HDFS_HOME/*,$HADOOP_HDFS_HOME/lib/*,$HADOOP_MAPRED_HOME/*,$HADOOP_MAPRED_HOME/lib/*,$YARN_HOME/*,$YARN_HOME/lib/*,$HADOOP_YARN_HOME/*,$HADOOP_YARN_HOME/lib/*,$HADOOP_COMMON_HOME/share/hadoop/common/*,$HADOOP_COMMON_HOME/share/hadoop/common/lib/*,$HADOOP_HDFS_HOME/share/hadoop/hdfs/*,$HADOOP_HDFS_HOME/share/hadoop/hdfs/lib/*,$HADOOP_YARN_HOME/share/hadoop/yarn/*,$HADOOP_YARN_HOME/share/hadoop/yarn/lib/*\");";
  protected final String TEXT_299 = NL + "    \t\tinit_";
  protected final String TEXT_300 = ".execute(\"SET mapreduce.app-submission.cross-platform=true\");";
  protected final String TEXT_301 = NL + "\t\t\tinit_";
  protected final String TEXT_302 = ".execute(\"SET mapreduce.map.memory.mb=\" + ";
  protected final String TEXT_303 = ");" + NL + "\t\t\tinit_";
  protected final String TEXT_304 = ".execute(\"SET mapreduce.reduce.memory.mb=\" + ";
  protected final String TEXT_305 = ");" + NL + "\t\t\tinit_";
  protected final String TEXT_306 = ".execute(\"SET yarn.app.mapreduce.am.resource.mb=\" + ";
  protected final String TEXT_307 = ");";
  protected final String TEXT_308 = NL + "\t\t\tinit_";
  protected final String TEXT_309 = ".execute(\"SET \"+";
  protected final String TEXT_310 = "+\"=\"+";
  protected final String TEXT_311 = ");";
  protected final String TEXT_312 = NL + "\tinit_";
  protected final String TEXT_313 = ".close();" + NL + "\t" + NL + "\t";
  protected final String TEXT_314 = NL + "\t\tjava.sql.Statement statement_";
  protected final String TEXT_315 = " = conn_";
  protected final String TEXT_316 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_317 = NL + "\t\t\tstatement_";
  protected final String TEXT_318 = ".execute(\"SET hbase.zookeeper.quorum=\"+";
  protected final String TEXT_319 = ");" + NL + "\t\t";
  protected final String TEXT_320 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_321 = NL + "\t\t\tstatement_";
  protected final String TEXT_322 = ".execute(\"SET hbase.zookeeper.property.clientPort=\"+";
  protected final String TEXT_323 = ");" + NL + "\t\t";
  protected final String TEXT_324 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_325 = NL + "\t\t\tstatement_";
  protected final String TEXT_326 = ".execute(\"SET zookeeper.znode.parent=\"+";
  protected final String TEXT_327 = ");" + NL + "\t\t";
  protected final String TEXT_328 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_329 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_330 = ".execute(\"add jar \"+";
  protected final String TEXT_331 = ");" + NL + "\t\t";
  protected final String TEXT_332 = NL + "\t\tstatement_";
  protected final String TEXT_333 = ".close();" + NL + "\t";
  protected final String TEXT_334 = NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_335 = "\",conn_";
  protected final String TEXT_336 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
  protected final String TEXT_337 = "\",";
  protected final String TEXT_338 = ");" + NL + "\t" + NL + "\tString currentClientPathSeparator_";
  protected final String TEXT_339 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "\tif(currentClientPathSeparator_";
  protected final String TEXT_340 = "!=null) {" + NL + "\t\tSystem.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_341 = ");" + NL + "\t\tglobalMap.put(\"current_client_path_separator\", null);" + NL + "\t}" + NL + "\t" + NL + "\tString currentClientUsername_";
  protected final String TEXT_342 = " = (String)globalMap.get(\"current_client_user_name\");" + NL + "\tif(currentClientUsername_";
  protected final String TEXT_343 = "!=null) {" + NL + "\t\tSystem.setProperty(\"user.name\", currentClientUsername_";
  protected final String TEXT_344 = ");" + NL + "\t\tglobalMap.put(\"current_client_user_name\", null);" + NL + "\t}" + NL + "\t" + NL + "\tString originalHadoopUsername_";
  protected final String TEXT_345 = " = (String)globalMap.get(\"HADOOP_USER_NAME_";
  protected final String TEXT_346 = "\");" + NL + "\tif(originalHadoopUsername_";
  protected final String TEXT_347 = "!=null) {" + NL + "\t\tSystem.setProperty(\"HADOOP_USER_NAME\", originalHadoopUsername_";
  protected final String TEXT_348 = ");" + NL + "\t\tglobalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_349 = "\", null);" + NL + "\t} else {" + NL + "\t\tSystem.clearProperty(\"HADOOP_USER_NAME\");" + NL + "\t}";
