...
public class TParAccelBulkExecBeginJava {
  ...
  protected final String TEXT_82 = NL + "\tString xpxSQL_";
  protected final String TEXT_83 = "=\"\";" + NL + "\tString bulkSQL_";
  protected final String TEXT_84 = "=\"\";";
  protected final String TEXT_85 = NL + "\txpxSQL_";
  protected final String TEXT_86 = " += \"xpx 'localize \\\"\" + tableName_";
  protected final String TEXT_87 = " +\"\\\"\" + ";
  protected final String TEXT_88 = " + \" ";
  protected final String TEXT_89 = "'\";" + NL + "\tbulkSQL_";
  protected final String TEXT_90 = " += \"COPY \\\"\" + tableName_";
  protected final String TEXT_91 = " + \"\\\"\" + " + NL + "\t\t\" FROM 'local' WITH PARALLEL ";
  protected final String TEXT_92 = " \";";
  protected final String TEXT_93 = NL + "\tbulkSQL_";
  protected final String TEXT_94 = " += \"COPY \\\"\" + tableName_";
  protected final String TEXT_95 = " + \"\\\"\" + \"";
  protected final String TEXT_96 = "FROM '\" +" + NL + "\t\t";
  protected final String TEXT_97 = " + \"' WITH ";
  protected final String TEXT_98 = " \";";
  protected final String TEXT_99 = NL + "\tbulkSQL_";
  protected final String TEXT_100 = " += \"DELIMITER '\" + (";
  protected final String TEXT_101 = ").charAt(0) + \"' \";";
  protected final String TEXT_102 = NL + "\t\t\tbulkSQL_";
  protected final String TEXT_103 = " += \"FIXEDWIDTH '\" + ";
  protected final String TEXT_104 = " + \"' \";" + NL + "\t\t";
  protected final String TEXT_105 = NL + "\t\tbulkSQL_";
  protected final String TEXT_106 = " += \"FIXEDWIDTH '\";" + NL + "\t\t";
  ...
  protected final String TEXT_115 = NL + "\t\tbulkSQL_";
  protected final String TEXT_116 = " += \"' \";";
  protected final String TEXT_117 = NL + "\tbulkSQL_";
  protected final String TEXT_118 = " += \"REMOVEQUOTES \";";
  protected final String TEXT_119 = NL + "\tbulkSQL_";
  protected final String TEXT_120 = " += \"EXPLICIT_IDS \";";
  protected final String TEXT_121 = NL + "\tbulkSQL_";
  protected final String TEXT_122 = " += \"MAXERROR \" + ";
  protected final String TEXT_123 = " + \" \";";
  protected final String TEXT_124 = NL + "\tbulkSQL_";
  protected final String TEXT_125 = " += \"DATEFORMAT '\" + ";
  protected final String TEXT_126 = " + \"' \";";
  protected final String TEXT_127 = NL + "\tbulkSQL_";
  protected final String TEXT_128 = " += \"TIMEFORMAT '\" + ";
  protected final String TEXT_129 = " + \"' \";";
  protected final String TEXT_130 = NL + "\tbulkSQL_";
  protected final String TEXT_131 = " += ";
  protected final String TEXT_132 = " + \" \";";
  protected final String TEXT_133 = " " + NL + "if (";
  protected final String TEXT_134 = " > 0) {" + NL + "\tjava.io.Writer output_";
  protected final String TEXT_135 = " = new java.io.FileWriter(";
  protected final String TEXT_136 = ", true);" + NL + "\tjava.sql.DriverManager.setLogWriter(new java.io.PrintWriter(output_";
  protected final String TEXT_137 = ",true));" + NL + "}\t" + NL + "com.paraccel.Driver.setLogLevel(";
  protected final String TEXT_138 = ");" + NL + "" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_144 = " = \"com.paraccel.Driver\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_145 = ").newInstance();" + NL + "\t\tString url_";
  protected final String TEXT_146 = " = \"jdbc:paraccel://\" + ";
  protected final String TEXT_147 = " + \":\" + ";
  protected final String TEXT_148 = " + \"/\" + ";
  protected final String TEXT_149 = "+\"?prepareThreshold=100&loglevel=\"+";
  protected final String TEXT_150 = "+\"&protocolVersion=3\";" + NL + "\t\tString dbUser_";
  ...
  protected final String TEXT_160 = NL + "\t   \t" + NL + "\t\tString dbPwd_";
  ...
  protected final String TEXT_169 = " - Droping table ";
  ...
  protected final String TEXT_177 = " - Drop table ";
  ...
  protected final String TEXT_186 = " - Creating table ";
  ...
  protected final String TEXT_194 = " - Create table ";
  ...
  protected final String TEXT_204 = " - Creating table ";
  ...
  protected final String TEXT_212 = " - Create table ";
  ...
  protected final String TEXT_248 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_261 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_265 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_266 = ".equals(schema_";
  protected final String TEXT_267 = ") || (schema_";
  protected final String TEXT_268 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_269 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_432 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_433 = " = conn_";
  protected final String TEXT_434 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");";
  protected final String TEXT_435 = NL + "\t";
  protected final String TEXT_436 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_437 = " - Paralle bulk SQL:\"+xpxSQL_";
  protected final String TEXT_438 = "+\".\");" + NL + "\t\tlog.debug(\"";
  protected final String TEXT_439 = " - Executing parallel bulk SQL.\");" + NL + "\t";
  protected final String TEXT_440 = NL + "    java.sql.Statement stmtXPX_";
  protected final String TEXT_441 = " = conn_";
  protected final String TEXT_442 = ".createStatement();" + NL + "    stmtXPX_";
  protected final String TEXT_443 = ".execute(xpxSQL_";
  protected final String TEXT_444 = ");";
  protected final String TEXT_445 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_446 = " - Execute parallel bulk SQL has finished.\");" + NL + "\t";
  protected final String TEXT_447 = NL + "    stmtXPX_";
  protected final String TEXT_448 = ".close();    ";
  protected final String TEXT_449 = NL + "\t";
  protected final String TEXT_450 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_451 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_452 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_453 = " - Bulk inserting data into ";
  protected final String TEXT_454 = "\" + tableName_";
  protected final String TEXT_455 = " + \"";
  protected final String TEXT_456 = ".\" );" + NL + "\t";
  protected final String TEXT_457 = NL + "    stmtBulk_";
  protected final String TEXT_458 = ".execute(bulkSQL_";
  ...
  protected final String TEXT_465 = NL + "    stmtBulk_";
