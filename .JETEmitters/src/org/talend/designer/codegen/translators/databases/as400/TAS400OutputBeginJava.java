...
public class TAS400OutputBeginJava {
  ...
  protected final String TEXT_55 = " = 0;" + NL + "" + NL + "int nb_line_rejected_";
  protected final String TEXT_56 = " = 0;" + NL + "int rejectedCount_";
  protected final String TEXT_57 = "=0;" + NL + "int tmp_batchUpdateCount_";
  ...
  protected final String TEXT_68 = NL + "    String dbProperties_";
  protected final String TEXT_69 = " = ";
  protected final String TEXT_70 = ";" + NL + "    String url_";
  protected final String TEXT_71 = " = null;" + NL + "    if(dbProperties_";
  protected final String TEXT_72 = " == null || dbProperties_";
  protected final String TEXT_73 = ".trim().length() == 0) {" + NL + "        url_";
  protected final String TEXT_74 = " = \"jdbc:as400://\" + ";
  protected final String TEXT_75 = " + \"/\" + ";
  protected final String TEXT_76 = ";" + NL + "    } else {" + NL + "        url_";
  protected final String TEXT_77 = " = \"jdbc:as400://\" + ";
  protected final String TEXT_78 = " + \"/\" + ";
  protected final String TEXT_79 = "+ \";\" + ";
  protected final String TEXT_80 = ";" + NL + "    }" + NL + "    String dbUser_";
  ...
  protected final String TEXT_92 = ";" + NL + "    " + NL + "    java.lang.Class.forName(\"com.ibm.as400.access.AS400JDBCDriver\");";
  ...
  protected final String TEXT_98 = NL + "    " + NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_106 = NL + "       int batchSize_";
  protected final String TEXT_107 = " = ";
  protected final String TEXT_108 = ";" + NL + "       int batchSizeCounter_";
  protected final String TEXT_109 = "=0;";
  protected final String TEXT_110 = NL + "int count_";
  ...
  protected final String TEXT_120 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_177 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_178 = " = conn_";
  protected final String TEXT_179 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_180 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_184 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_189 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_190 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_191 = " = tableNameForSearch_";
  protected final String TEXT_192 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_193 = " = tableNameForSearch_";
  protected final String TEXT_194 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_195 = " = dbMetaData_";
  protected final String TEXT_196 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_197 = ", tableNameForSearch_";
  protected final String TEXT_198 = ", new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_199 = " = false;" + NL + "                \t            if(rsTable_";
  protected final String TEXT_200 = ".next()) {" + NL + "                \t            \twhetherExist_";
  protected final String TEXT_201 = " = true;" + NL + "                \t            }" + NL + "    \t            \t\t\trsTable_";
  protected final String TEXT_202 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_240 = ".toUpperCase()";
  ...
  protected final String TEXT_256 = " = false;" + NL + "                \t            String defaultSchema_";
  protected final String TEXT_257 = " = \"public\";" + NL + "                \t            if(dbschema_";
  protected final String TEXT_258 = " == null || dbschema_";
  protected final String TEXT_259 = ".trim().length() == 0) {" + NL + "                \t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_260 = " = conn_";
  protected final String TEXT_261 = ".createStatement();" + NL + "                \t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_262 = " = stmtSchema_";
  protected final String TEXT_263 = ".executeQuery(\"select current_schema() \");" + NL + "                \t            \twhile(rsSchema_";
  protected final String TEXT_264 = ".next()){" + NL + "                \t            \t\tdefaultSchema_";
  protected final String TEXT_265 = " = rsSchema_";
  protected final String TEXT_266 = ".getString(\"current_schema\");" + NL + "                \t            \t}" + NL + "                \t            \trsSchema_";
  protected final String TEXT_267 = ".close();" + NL + "                \t            \tstmtSchema_";
  protected final String TEXT_268 = ".close();" + NL + "                \t            }" + NL + "                \t            while(rsTable_";
  ...
  protected final String TEXT_283 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_284 = ".equals";
  protected final String TEXT_285 = "IgnoreCase";
  protected final String TEXT_286 = "(schema_";
  ...
  protected final String TEXT_299 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_322 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_323 = NL + "                                if(whetherExist_";
  protected final String TEXT_324 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_353 = ", true);" + NL + "    " + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_368 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_369 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_370 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  ...
  protected final String TEXT_374 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_388 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_412 = NL + "\t    String insert_";
  ...
  protected final String TEXT_419 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  ...
  protected final String TEXT_440 = " = \"UPDATE \" + ";
  protected final String TEXT_441 = " + \" SET ";
  protected final String TEXT_442 = " WHERE ";
  protected final String TEXT_443 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_448 = " = \"UPDATE \" + ";
  protected final String TEXT_449 = " + \" SET ";
  protected final String TEXT_450 = " WHERE ";
  protected final String TEXT_451 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_463 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_500 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_501 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_502 = " =null;" + NL + "\t";
  protected final String TEXT_503 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_510 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_514 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_515 = " = null;";
  protected final String TEXT_516 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_520 = NL + NL + NL;
