...
public class TAccessInputBeginJava
{
  ...
  protected final String TEXT_179 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=\" + ";
  protected final String TEXT_180 = ";";
  protected final String TEXT_181 = NL + "\t            String url_";
  protected final String TEXT_182 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=\" + ";
  protected final String TEXT_183 = ";            ";
  protected final String TEXT_184 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_185 = " = \"";
  protected final String TEXT_186 = "\";" + NL + "\t\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_187 = ");" + NL + "\t\t\t";
  protected final String TEXT_188 = NL + "\t        String dbUser_";
  ...
  protected final String TEXT_198 = NL + "\t\t   \t" + NL + "\t        String dbPwd_";
  protected final String TEXT_199 = " = decryptedPassword_";
  ...
  protected final String TEXT_221 = NL + "            java.sql.Timestamp timestamp_";
  ...
  protected final String TEXT_225 = ");" + NL + "            if(timestamp_";
  protected final String TEXT_226 = " != null) {";
  protected final String TEXT_227 = NL + "                ";
  protected final String TEXT_228 = ".";
  protected final String TEXT_229 = " = new java.util.Date(timestamp_";
  protected final String TEXT_230 = ".getTime());" + NL + "            } else {";
  protected final String TEXT_231 = NL + "                ";
  protected final String TEXT_232 = ".";
  protected final String TEXT_233 = " =  null;" + NL + "            }";
  protected final String TEXT_234 = NL + "\t        Object value = rs_";
  protected final String TEXT_235 = ".getObject(";
  protected final String TEXT_236 = "column_index_";
  protected final String TEXT_237 = ");" + NL + "\t        if(value != null) {";
  protected final String TEXT_238 = NL + "\t   \t\t \t\t\t\tvalue = new ";
  protected final String TEXT_239 = "(";
  protected final String TEXT_240 = ".parse";
  protected final String TEXT_241 = "(value.toString()));";
  protected final String TEXT_242 = NL + "\t   \t\t \t\t\t\tvalue = new ";
  protected final String TEXT_243 = "(";
  protected final String TEXT_244 = ".parse";
  protected final String TEXT_245 = "(value.toString()));";
  protected final String TEXT_246 = NL + "\t \t   \t\t \t\t";
  protected final String TEXT_247 = ".";
  protected final String TEXT_248 = " = (";
  protected final String TEXT_249 = ")value;" + NL + "\t                } else {";
  protected final String TEXT_250 = NL + "\t                ";
  protected final String TEXT_251 = ".";
  protected final String TEXT_252 = " = null;";
  protected final String TEXT_253 = "    " + NL + "\t                throw new RuntimeException(\"Null value in non-Nullable column\");";
  ...
  protected final String TEXT_272 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_273 = " =  conn_";
  protected final String TEXT_274 = ".getAutoCommit();          " + NL + "             conn_";
  protected final String TEXT_275 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_276 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  ...
  protected final String TEXT_292 = "_QUERY\",dbquery_";
  ...
  protected final String TEXT_317 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_318 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_319 = ".setName(rsmd_";
  protected final String TEXT_320 = ".getColumnName(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_329 = ".getColumnTypeName(i));";
  protected final String TEXT_330 = NL + "                \tdcm_";
  protected final String TEXT_331 = ".setFormat(";
  protected final String TEXT_332 = ");";
  protected final String TEXT_333 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_334 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_335 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_336 = ".setLength(rsmd_";
  protected final String TEXT_337 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_338 = ".setLength(rsmd_";
  protected final String TEXT_339 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_340 = NL + "\t\t\tdcm_";
  protected final String TEXT_341 = ".setLength(rsmd_";
  protected final String TEXT_342 = ".getPrecision(i));";
  protected final String TEXT_343 = NL + "                \tdcm_";
  protected final String TEXT_344 = ".setPrecision(rsmd_";
  protected final String TEXT_345 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_346 = ".setNullable(rsmd_";
  protected final String TEXT_347 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_348 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_349 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_350 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_351 = ".metadatas.add(dcm_";
  protected final String TEXT_352 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_353 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_354 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_355 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_356 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_357 = NL + "\t\t    ";
  protected final String TEXT_358 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_359 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_360 = NL + "\t\t    while (rs_";
  protected final String TEXT_361 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_362 = "++;" + NL + "\t\t        ";
  protected final String TEXT_363 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_364 = " = ";
  protected final String TEXT_365 = " + dcg_";
  protected final String TEXT_366 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_367 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_368 = " = ";
  protected final String TEXT_369 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_370 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_371 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_410 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_411 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_433 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  ...
  protected final String TEXT_443 = NL + "                                  Object geom = rs_";
  protected final String TEXT_444 = ".getObject(";
  protected final String TEXT_445 = "column_index_";
  protected final String TEXT_446 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o = " + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_447 = ".";
  protected final String TEXT_448 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
