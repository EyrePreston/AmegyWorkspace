...
public class TEXAInputBeginJava
{
  ...
  protected final String TEXT_71 = ").getConnection();" + NL + "            } else {";
  protected final String TEXT_72 = NL + "\t\t\t\tString driverClass_";
  protected final String TEXT_73 = " = \"";
  protected final String TEXT_74 = "\";" + NL + "\t\t\t    java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_91 = ",dbUser_";
  protected final String TEXT_92 = ",dbPwd_";
  ...
  protected final String TEXT_102 = NL + "\t\t\tjava.sql.Statement stmt_";
  protected final String TEXT_103 = " = conn_";
  protected final String TEXT_104 = ".createStatement(java.sql.ResultSet.TYPE_FORWARD_ONLY," + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tjava.sql.ResultSet.CONCUR_READ_ONLY);" + NL + "\t\t\t";
  protected final String TEXT_105 = NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_106 = " = rs_";
  protected final String TEXT_107 = ".getString(";
  protected final String TEXT_108 = "column_index_";
  ...
  protected final String TEXT_120 = ".charAt(0);\t\t\t  \t\t" + NL + "                    } else {\t\t\t  \t";
  ...
  protected final String TEXT_129 = "\t\t\t  \t\t" + NL + "                            if((\"\").equals(tmpContent_";
  protected final String TEXT_130 = ")) {\t\t\t  \t\t";
  protected final String TEXT_131 = NL + "                                ";
  protected final String TEXT_132 = ".";
  protected final String TEXT_133 = " = '\\0';\t\t\t  \t\t\t" + NL + "                            } else {" + NL + "        \t\t\t  \t\t\tthrow new RuntimeException(" + NL + "        \t\t\t\t\t\t\t\"Value is empty for column : '";
  protected final String TEXT_134 = "' in '";
  protected final String TEXT_135 = "' connection, value is invalid or this column should be nullable or have a default value.\");\t\t\t\t\t\t\t" + NL + "                            }\t\t\t  \t\t";
  protected final String TEXT_136 = NL + "                    }";
  protected final String TEXT_137 = NL + "\t\t\tif(rs_";
  protected final String TEXT_138 = ".getTimestamp(";
  protected final String TEXT_139 = "column_index_";
  protected final String TEXT_140 = ") != null) {" + NL + "\t\t\t    ";
  protected final String TEXT_141 = ".";
  protected final String TEXT_142 = " = new java.util.Date(rs_";
  protected final String TEXT_143 = ".getTimestamp(";
  protected final String TEXT_144 = "column_index_";
  protected final String TEXT_145 = ").getTime());" + NL + "\t\t\t} else {" + NL + "\t\t\t    ";
  protected final String TEXT_146 = ".";
  protected final String TEXT_147 = " =  null;" + NL + "\t\t\t}\t\t\t ";
  protected final String TEXT_148 = NL + "            tmpContent_";
  protected final String TEXT_149 = " = rs_";
  protected final String TEXT_150 = ".getString(";
  ...
  protected final String TEXT_156 = " = tmpContent_";
  protected final String TEXT_157 = ";" + NL + "            } else {";
  protected final String TEXT_158 = NL + "                ";
  protected final String TEXT_159 = ".";
  protected final String TEXT_160 = " = null;" + NL + "            }";
  protected final String TEXT_161 = NL + "            if(rs_";
  protected final String TEXT_162 = ".getObject(";
  protected final String TEXT_163 = "column_index_";
  ...
  protected final String TEXT_175 = NL + "                    throw new RuntimeException(\"Null value in non-Nullable column\");";
  protected final String TEXT_176 = NL + "            }";
  protected final String TEXT_177 = NL + "                String url_";
  protected final String TEXT_178 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_179 = " + \":\" + ";
  protected final String TEXT_180 = "+ \";schema=\" + ";
  ...
  protected final String TEXT_207 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_208 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  ...
  protected final String TEXT_249 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_261 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_365 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_366 = ".";
  protected final String TEXT_367 = ", rs_";
  protected final String TEXT_368 = ", fixedColumnCount_";
  protected final String TEXT_369 = ");";
  protected final String TEXT_370 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_371 = ".";
  protected final String TEXT_372 = ", rs_";
  protected final String TEXT_373 = ", fixedColumnCount_";
  protected final String TEXT_374 = ");";
  protected final String TEXT_375 = NL + "                                  Object geom = rs_";
  protected final String TEXT_376 = ".getObject(";
  protected final String TEXT_377 = "column_index_";
  protected final String TEXT_378 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o = " + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_379 = ".";
  protected final String TEXT_380 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_387 = " - Retrieving the record \" + nb_line_";
