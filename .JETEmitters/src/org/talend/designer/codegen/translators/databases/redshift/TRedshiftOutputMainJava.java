...
public class TRedshiftOutputMainJava {
  ...
  protected final String TEXT_44 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_45 = " = buffersSize_";
  ...
  protected final String TEXT_66 = NL + "\t\t\t\t\t\t\trejectedCount_";
  protected final String TEXT_67 = " = rejectedCount_";
  protected final String TEXT_68 = " + 1;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_69 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_79 = ",java.sql.Types.CHAR);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_84 = ",java.sql.Types.DATE);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_89 = ",java.sql.Types.ARRAY);         " + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_90 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_91 = ".";
  protected final String TEXT_92 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_93 = ".setNull(counter";
  protected final String TEXT_94 = ",java.sql.Types.INTEGER);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_99 = ",java.sql.Types.VARCHAR);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_100 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_101 = ".";
  protected final String TEXT_102 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_103 = ".setNull(counter";
  protected final String TEXT_104 = ",java.sql.Types.OTHER);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_109 = ",java.sql.Types.BOOLEAN);   " + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_114 = ",java.sql.Types.DOUBLE);    " + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_115 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_116 = ".";
  protected final String TEXT_117 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_118 = ".setNull(counter";
  protected final String TEXT_119 = ",java.sql.Types.FLOAT); " + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_125 = NL + "\t\t\t\t\t\t\t\tif((\"null\").equals(String.valueOf(";
  protected final String TEXT_126 = ".";
  protected final String TEXT_127 = ").toLowerCase())){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_129 = ".setNull(counter";
  protected final String TEXT_130 = ",java.sql.Types.CHAR);" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t}else if(";
  protected final String TEXT_131 = ".";
  protected final String TEXT_132 = " == '\\0'){" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_133 = ".setString(counter";
  protected final String TEXT_134 = ",\"\");" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_141 = "!=null){" + NL + "\t\t\t\t\t\t\t\t// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t\t\t\t\t\t\tdate_";
  protected final String TEXT_142 = " = ";
  protected final String TEXT_143 = ".";
  protected final String TEXT_144 = ".getTime();" + NL + "\t\t\t\t\t\t\t\tif (date_";
  protected final String TEXT_145 = " < year1_";
  protected final String TEXT_146 = " || date_";
  protected final String TEXT_147 = " >= year10000_";
  protected final String TEXT_148 = ") {" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_149 = ".setString(counter";
  protected final String TEXT_150 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_151 = ".setTimestamp(counter";
  protected final String TEXT_152 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_153 = "));" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_154 = ".setNull(counter";
  protected final String TEXT_155 = ",java.sql.Types.DATE);" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_156 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_157 = ".set";
  protected final String TEXT_158 = "(counter";
  protected final String TEXT_159 = ",";
  protected final String TEXT_160 = ".";
  protected final String TEXT_161 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_162 = NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_163 = NL + "\t\t\t\tint counter";
  protected final String TEXT_164 = " = rowCount";
  protected final String TEXT_165 = " * ";
  protected final String TEXT_166 = " + 1;";
  protected final String TEXT_167 = NL + "\t\t\t\t\t\tcounter";
  protected final String TEXT_168 = "++;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_169 = NL + "\t\t\t\texInsertColValue";
  protected final String TEXT_170 = " = new BufferLine_";
  protected final String TEXT_171 = "(";
  protected final String TEXT_172 = NL + "\t                            ,";
  protected final String TEXT_173 = NL + "\t                        ";
  protected final String TEXT_174 = ".";
  protected final String TEXT_175 = "              ";
  protected final String TEXT_176 = "  " + NL + "\t\t\t\t); " + NL + "\t               " + NL + "\t\t\t\texInsertColValueList";
  protected final String TEXT_177 = ".add(exInsertColValue";
  protected final String TEXT_178 = ");" + NL + "\t\t\t\trowCount";
  protected final String TEXT_179 = "++;" + NL + "\t\t\t\t" + NL + "\t\t\t\tif(rowCount";
  protected final String TEXT_180 = " == ";
  protected final String TEXT_181 = "){ " + NL + "\t                    insertedCount_";
  protected final String TEXT_182 = " = insertedCount_";
  protected final String TEXT_183 = " + pstmt_";
  protected final String TEXT_184 = ".executeUpdate();" + NL + "\t                    exInsertColValueList";
  protected final String TEXT_185 = ".clear();" + NL + "\t                    rowCount";
  protected final String TEXT_186 = " = 0;" + NL + "\t\t\t\t\t\tcounter";
  protected final String TEXT_187 = "=1;" + NL + "\t\t\t\t} ";
  ...
  protected final String TEXT_196 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_197 = " = updatedCount_";
  ...
  protected final String TEXT_226 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_227 = " = pstmt_";
  protected final String TEXT_228 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_229 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_230 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_231 = " = rs_";
  protected final String TEXT_232 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_241 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_242 = " = updatedCount_";
  protected final String TEXT_243 = " + pstmtUpdate_";
  protected final String TEXT_244 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_245 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_246 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_268 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_269 = NL + "                        ";
  protected final String TEXT_270 = NL + "                try {" + NL + "                    insertedCount_";
  ...
  protected final String TEXT_275 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_298 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_307 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_308 = "=pstmtUpdate_";
  protected final String TEXT_309 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_310 = " = updatedCount_";
  protected final String TEXT_311 = "+updateFlag_";
  protected final String TEXT_312 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_313 = " == 0) {";
  protected final String TEXT_314 = NL + "                        ";
  protected final String TEXT_315 = NL + "                    insertedCount_";
  protected final String TEXT_316 = " = insertedCount_";
  protected final String TEXT_317 = " + pstmtInsert_";
  protected final String TEXT_318 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_319 = "++;";
  protected final String TEXT_320 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_321 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_322 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_323 = " = true;";
  protected final String TEXT_324 = NL + "                        throw(e);";
  protected final String TEXT_325 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_335 = NL + "                            rejectedCount_";
  protected final String TEXT_336 = " = rejectedCount_";
  protected final String TEXT_337 = " + 1;";
  ...
  protected final String TEXT_347 = NL + "\t                        query_";
  protected final String TEXT_348 = " = ";
  protected final String TEXT_349 = ";" + NL + "\t                        ";
  protected final String TEXT_350 = NL + "                    ";
  protected final String TEXT_351 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_352 = " = deletedCount_";
  protected final String TEXT_353 = " + pstmt_";
  protected final String TEXT_354 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_355 = "++;";
  protected final String TEXT_356 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_357 = " = true;";
  protected final String TEXT_358 = NL + "                    throw(e);";
  protected final String TEXT_359 = NL + "                \tnb_line_";
  protected final String TEXT_360 = "++;" + NL + "                \t";
  protected final String TEXT_361 = NL + "                        ";
  protected final String TEXT_362 = " = new ";
  protected final String TEXT_363 = "Struct();";
  protected final String TEXT_364 = NL + "                            ";
  protected final String TEXT_365 = ".";
  protected final String TEXT_366 = " = ";
  protected final String TEXT_367 = ".";
  protected final String TEXT_368 = ";";
  protected final String TEXT_369 = NL + "                        rejectedCount_";
  protected final String TEXT_370 = " = rejectedCount_";
  protected final String TEXT_371 = " + 1;";
  protected final String TEXT_372 = NL + "                        ";
  protected final String TEXT_373 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_374 = NL + "                        ";
  protected final String TEXT_375 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_376 = ";";
  protected final String TEXT_377 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_378 = NL + "            }";
  protected final String TEXT_379 = NL + "            if(!whetherReject_";
  protected final String TEXT_380 = ") {";
  protected final String TEXT_381 = NL + "                            ";
  protected final String TEXT_382 = " = new ";
  protected final String TEXT_383 = "Struct();";
  ...
  protected final String TEXT_395 = ".commit();" + NL + "    \t\t\t\t";
  protected final String TEXT_396 = "                                    " + NL + "                    commitCounter_";
  protected final String TEXT_397 = "=0;" + NL + "        " + NL + "                }";
