...
public class TRedshiftOutputBeginJava {
  ...
  protected final String TEXT_76 = "=0;" + NL + "" + NL + "java.util.Calendar calendar_";
  protected final String TEXT_77 = " = java.util.Calendar.getInstance();" + NL + "calendar_";
  protected final String TEXT_78 = ".set(1, 0, 1, 0, 0, 0);" + NL + "long year1_";
  protected final String TEXT_79 = " = calendar_";
  protected final String TEXT_80 = ".getTime().getTime();" + NL + "calendar_";
  protected final String TEXT_81 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "long year10000_";
  protected final String TEXT_82 = " = calendar_";
  protected final String TEXT_83 = ".getTime().getTime();" + NL + "long date_";
  protected final String TEXT_84 = ";" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_85 = " = false;" + NL + "" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_91 = "\t" + NL + "" + NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");    ";
  ...
  protected final String TEXT_117 = ".setAutoCommit(false);" + NL + "\t";
  ...
  protected final String TEXT_187 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_188 = " + \"\\\" (";
  protected final String TEXT_189 = ") VALUES (";
  protected final String TEXT_190 = ")\");";
  protected final String TEXT_191 = NL + "\t\t\tint rowCount";
  protected final String TEXT_192 = " = 0;" + NL + "\t\t\tclass BufferLine_";
  protected final String TEXT_193 = " {";
  protected final String TEXT_194 = NL + "                            ";
  protected final String TEXT_195 = " ";
  protected final String TEXT_196 = ";                ";
  protected final String TEXT_197 = "   " + NL + "\t            " + NL + "\t            public BufferLine_";
  protected final String TEXT_198 = "(";
  protected final String TEXT_199 = NL + "                                ,";
  protected final String TEXT_200 = NL + "                            ";
  protected final String TEXT_201 = " ";
  protected final String TEXT_202 = " " + NL + "\t\t\t\t){";
  protected final String TEXT_203 = NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_204 = " = ";
  protected final String TEXT_205 = ";              ";
  protected final String TEXT_206 = "   \t                " + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t            " + NL + "\t\t\tjava.util.List<BufferLine_";
  protected final String TEXT_207 = "> exInsertColValueList";
  protected final String TEXT_208 = " = new java.util.ArrayList();" + NL + "\t\t\tBufferLine_";
  protected final String TEXT_209 = " exInsertColValue";
  protected final String TEXT_210 = " = null; " + NL + "\t\t\t" + NL + "\t\t\t" + NL + "\t\t\tStringBuilder extendInsertValueStmt_";
  protected final String TEXT_211 = " = new StringBuilder();" + NL + "\t\t\tfor(int i=0;i < ";
  protected final String TEXT_212 = ";i++){" + NL + "\t\t\t\t extendInsertValueStmt_";
  protected final String TEXT_213 = ".append(\"(";
  protected final String TEXT_214 = ")\");" + NL + "\t\t\t\t if (i!=";
  protected final String TEXT_215 = "-1) extendInsertValueStmt_";
  protected final String TEXT_216 = ".append(\",\");" + NL + "\t\t\t}" + NL + "            " + NL + "\t\t\tString insert_";
  protected final String TEXT_217 = " = \"INSERT INTO \"+";
  protected final String TEXT_218 = "+\" (";
  protected final String TEXT_219 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_220 = ".toString();" + NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_232 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_233 = " + \"\\\" WHERE ";
  protected final String TEXT_234 = "\");\t" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_235 = " = conn_";
  protected final String TEXT_236 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_241 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_242 = " + \"\\\" SET ";
  protected final String TEXT_243 = " WHERE ";
  ...
  protected final String TEXT_250 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_251 = " = conn_";
  protected final String TEXT_252 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_258 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_259 = " + \"\\\" WHERE ";
  protected final String TEXT_260 = "\");" + NL + "\t    ";
  protected final String TEXT_261 = "    " + NL + "            int commitEvery_";
  protected final String TEXT_262 = " = ";
  protected final String TEXT_263 = ";            " + NL + "            int commitCounter_";
