...
public class TJDBCOutputBeginJava {
  ...
  protected final String TEXT_41 = NL + "        int updateKeyCount_";
  protected final String TEXT_42 = " = ";
  protected final String TEXT_43 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_44 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_45 = NL + "        int deleteKeyCount_";
  protected final String TEXT_46 = " = ";
  protected final String TEXT_47 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_48 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_49 = NL + NL + "int nb_line_";
  protected final String TEXT_50 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_51 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_52 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_53 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_54 = " = 0;" + NL + "" + NL + "int tmp_batchUpdateCount_";
  protected final String TEXT_55 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_56 = " = 0;" + NL + "int updatedCount_";
  protected final String TEXT_57 = " = 0;" + NL + "int insertedCount_";
  ...
  protected final String TEXT_64 = " " + NL + "\t\tif (null == connection_";
  protected final String TEXT_65 = ") {" + NL + "\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_66 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES); " + NL + "\t\t\tconnection_";
  protected final String TEXT_67 = " = dataSources_";
  protected final String TEXT_68 = ".get(";
  protected final String TEXT_69 = ").getConnection();" + NL + "\t\t\tif (connection_";
  protected final String TEXT_70 = " != null) { " + NL + "\t\t\t\tconnection_";
  protected final String TEXT_71 = ".setAutoCommit(";
  protected final String TEXT_72 = ");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_73 = NL + "\t" + NL + "\tjava.sql.Connection connection_";
  ...
  protected final String TEXT_80 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_81 = NL + "\t\t\t";
  protected final String TEXT_82 = NL + "\t\t\tjava.lang.Class.forName(";
  protected final String TEXT_83 = ");" + NL + "\t\t\tString connectionString_";
  ...
  protected final String TEXT_95 = " = java.sql.DriverManager.getConnection(connectionString_";
  ...
  protected final String TEXT_114 = NL + "\tjava.sql.Statement statementClear_";
  ...
  protected final String TEXT_118 = " + statementClear_";
  protected final String TEXT_119 = ".executeUpdate(\"delete from \" + ";
  ...
  protected final String TEXT_146 = " = connection_";
  protected final String TEXT_147 = ".prepareStatement(insert_";
  protected final String TEXT_148 = ");" + NL + "\t\tString update_";
  protected final String TEXT_149 = " = \"UPDATE \" + ";
  protected final String TEXT_150 = " + \" SET ";
  protected final String TEXT_151 = " WHERE ";
  protected final String TEXT_152 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_153 = " = connection_";
  protected final String TEXT_154 = ".prepareStatement(update_";
  protected final String TEXT_155 = ");" + NL + "\t\t";
  protected final String TEXT_156 = NL + "\t\tString update_";
  protected final String TEXT_157 = " = \"UPDATE \" + ";
  protected final String TEXT_158 = " + \" SET ";
  protected final String TEXT_159 = " WHERE ";
  protected final String TEXT_160 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_161 = " = connection_";
  protected final String TEXT_162 = ".prepareStatement(update_";
  ...
  protected final String TEXT_167 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_168 = " = connection_";
  protected final String TEXT_169 = ".prepareStatement(insert_";
  protected final String TEXT_170 = ");" + NL + "\t\t";
  protected final String TEXT_171 = NL + "\t\tString delete_";
  protected final String TEXT_172 = " = \"DELETE  FROM \" + ";
  ...
  protected final String TEXT_176 = ".prepareStatement(delete_";
  protected final String TEXT_177 = ");" + NL + "\t\t";
  protected final String TEXT_178 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_190 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_191 = " = insert_";
  protected final String TEXT_192 = ".split(\"\\\\?\");";
  protected final String TEXT_193 = NL + "\t\t\tdelete_";
  protected final String TEXT_194 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_195 = " = delete_";
  protected final String TEXT_196 = ".split(\"\\\\?\");";
  protected final String TEXT_197 = NL + "\t\t\treplace_";
  protected final String TEXT_198 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_199 = " = replace_";
  protected final String TEXT_200 = ".split(\"\\\\?\");";
  protected final String TEXT_201 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_202 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_203 = " = insertIgnore_";
  protected final String TEXT_204 = ".split(\"\\\\?\");";
  protected final String TEXT_205 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_206 = " = insert_";
  protected final String TEXT_207 = ".split(\"\\\\?\");";
