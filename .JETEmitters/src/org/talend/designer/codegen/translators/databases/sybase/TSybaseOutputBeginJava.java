...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_50 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_51 = " = ";
  protected final String TEXT_52 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_53 = " = false;" + NL + "String dbschema_";
  ...
  protected final String TEXT_83 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");" + NL + "\t";
  protected final String TEXT_84 = NL + "\t\tString url_";
  protected final String TEXT_85 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_86 = " + \":\" + ";
  protected final String TEXT_87 = " + \"/\" + ";
  protected final String TEXT_88 = "; ";
  protected final String TEXT_89 = NL + "\t\tString url_";
  protected final String TEXT_90 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_114 = " " + NL + "" + NL + "if(dbschema_";
  protected final String TEXT_115 = " != null && dbschema_";
  protected final String TEXT_116 = ".trim().length() != 0) {" + NL + "\ttableName_";
  protected final String TEXT_117 = " = dbschema_";
  protected final String TEXT_118 = " + \".\" + ";
  protected final String TEXT_119 = ";" + NL + "} ";
  protected final String TEXT_120 = NL + "int count_";
  ...
  protected final String TEXT_140 = ".toUpperCase()";
  ...
  protected final String TEXT_193 = " = true;" + NL + "                \t\t\t\t} catch (java.lang.Exception e){" + NL + "                \t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_199 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_200 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_201 = " = tableNameForSearch_";
  protected final String TEXT_202 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_203 = " = tableNameForSearch_";
  protected final String TEXT_204 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_205 = " = dbMetaData_";
  protected final String TEXT_206 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_207 = ", tableNameForSearch_";
  protected final String TEXT_208 = ", new String[]{\"TABLE\"});" + NL + "                \t            boolean whetherExist_";
  protected final String TEXT_209 = " = false;" + NL + "                \t            if(rsTable_";
  protected final String TEXT_210 = ".next()) {" + NL + "                \t            \twhetherExist_";
  protected final String TEXT_211 = " = true;" + NL + "                \t            }" + NL + "    \t            \t\t\trsTable_";
  ...
  protected final String TEXT_257 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_363 = ", true);" + NL + "    " + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_379 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_380 = ".next()) {" + NL + "\t\t\t\trsTruncCountNumber_";
  ...
  protected final String TEXT_384 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_393 = NL + "                if(!conn_";
  ...
  protected final String TEXT_398 = " += rsTruncCountNumber_";
  protected final String TEXT_399 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_400 = ".close();            " + NL + "\t\t";
  protected final String TEXT_401 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_402 = " = conn_";
  protected final String TEXT_403 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_404 = " = stmtTruncCount_";
  protected final String TEXT_405 = ".executeQuery(\"";
  protected final String TEXT_406 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
