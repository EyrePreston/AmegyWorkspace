...
public class TTeradataRollbackMainJava
{
  ...
  protected final String TEXT_107 = "\");" + NL + "" + NL + "if(conn_";
  ...
  protected final String TEXT_112 = NL + "            //add query band support for teradata12+" + NL + "            // end query band for session" + NL + "            conn_";
  protected final String TEXT_113 = ".setAutoCommit(true);          " + NL + "            try{" + NL + "                 conn_";
  protected final String TEXT_114 = ".createStatement().execute(\"SET QUERY_BAND = NONE FOR SESSION\");               " + NL + "                 conn_";
  protected final String TEXT_115 = ".createStatement().execute(\"END QUERY LOGGING ON ALL\");                 " + NL + "             }catch(Exception e){";
