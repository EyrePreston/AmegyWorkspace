...
public class TMysqlConnectionBeginJava
{
  ...
  protected final String TEXT_34 = NL + "\t\tString properties_";
  protected final String TEXT_35 = " = ";
  protected final String TEXT_36 = ";" + NL + "\t\tif (properties_";
  protected final String TEXT_37 = " == null || properties_";
  protected final String TEXT_38 = ".trim().length() == 0) {" + NL + "\t\t\tproperties_";
  protected final String TEXT_39 = " += \"rewriteBatchedStatements=true\";" + NL + "\t\t}else if (properties_";
  protected final String TEXT_40 = " != null && !properties_";
  protected final String TEXT_41 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\tproperties_";
  ...
  protected final String TEXT_97 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\tlog.info(\"";
  ...
  protected final String TEXT_100 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_145 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
