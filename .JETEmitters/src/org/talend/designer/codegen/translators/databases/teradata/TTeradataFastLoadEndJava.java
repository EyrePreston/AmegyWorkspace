...
public class TTeradataFastLoadEndJava
{
  ...
  protected final String TEXT_7 = " += sum;" + NL + "}" + NL + "pstmt_";
  ...
  protected final String TEXT_26 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_27 = ");" + NL;
  protected final String TEXT_28 = NL + "\tlog.info(\"";
  protected final String TEXT_29 = " - Loaded records count:\" + nb_line_inserted_";
