...
public class TNetezzaOutputBeginJava {
  ...
  protected final String TEXT_78 = " = \"org.netezza.Driver\";" + NL + "\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_79 = ");" + NL + "\t";
  protected final String TEXT_80 = NL + "\t";
  protected final String TEXT_81 = NL + "\t    String url_";
  protected final String TEXT_82 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_164 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_165 = " = conn_";
  protected final String TEXT_166 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_167 = " = stmtClearCount_";
  ...
  protected final String TEXT_172 = NL + "            stmtClear_";
  protected final String TEXT_173 = ".executeUpdate(\"";
  protected final String TEXT_174 = "\");";
  protected final String TEXT_175 = NL + "            while(rsClearCount_";
  protected final String TEXT_176 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_177 = " += rsClearCount_";
  protected final String TEXT_178 = ".getInt(1);" + NL + "            }";
  ...
  protected final String TEXT_182 = NL + "            deletedCount_";
  protected final String TEXT_183 = " = deletedCount_";
  protected final String TEXT_184 = " + stmtClear_";
  ...
  protected final String TEXT_190 = ".setAutoCommit(false);";
  protected final String TEXT_191 = "      \t    " + NL + "\t        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_192 = " = conn_";
  protected final String TEXT_193 = ".prepareStatement(\"INSERT INTO \"+";
  protected final String TEXT_194 = "+\" (";
  protected final String TEXT_195 = ") VALUES (";
  protected final String TEXT_196 = ")\");\t        " + NL + "\t        ";
  protected final String TEXT_197 = NL + "\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_198 = " = conn_";
  protected final String TEXT_199 = ".prepareStatement(\"UPDATE \" + ";
  ...
  protected final String TEXT_207 = "\");\t" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_208 = " = conn_";
  protected final String TEXT_209 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_210 = " + \" (";
  protected final String TEXT_211 = ") VALUES (";
  protected final String TEXT_212 = ")\");" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_213 = " = conn_";
  protected final String TEXT_214 = ".prepareStatement(\"UPDATE \" + ";
  ...
  protected final String TEXT_223 = "\");" + NL + "" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_224 = " = conn_";
  protected final String TEXT_225 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_226 = " + \" (";
  protected final String TEXT_227 = ") VALUES (";
  protected final String TEXT_228 = ")\");" + NL + "\t\t\t\t" + NL + "\t    ";
  protected final String TEXT_229 = NL + "\t" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_230 = " = conn_";
  protected final String TEXT_231 = ".prepareStatement(\"DELETE  FROM \" + ";
  protected final String TEXT_232 = " + \" WHERE ";
  protected final String TEXT_233 = "\");" + NL + "" + NL + "\t    ";
  protected final String TEXT_234 = NL + NL + "\t    int commitEvery_";
  protected final String TEXT_235 = " = ";
  protected final String TEXT_236 = ";" + NL + "" + NL + "\t    int commitCounter_";
  protected final String TEXT_237 = " = 0;" + NL + "" + NL + "\t";
  protected final String TEXT_238 = NL + "\t   int batchSize_";
  protected final String TEXT_239 = " = ";
  protected final String TEXT_240 = ";" + NL + "\t   int batchSizeCounter_";
