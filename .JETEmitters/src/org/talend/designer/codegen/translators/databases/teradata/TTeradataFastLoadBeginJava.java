...
public class TTeradataFastLoadBeginJava
{
  ...
  protected final String TEXT_68 = " = 0;" + NL + "" + NL + "int updatedCount_";
  protected final String TEXT_69 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_70 = "=0;" + NL + "" + NL + "String driverClass_";
  protected final String TEXT_71 = " = \"com.teradata.jdbc.TeraDriver\";" + NL + "java.lang.Class.forName(driverClass_";
  protected final String TEXT_72 = ");" + NL + "String url_";
  protected final String TEXT_73 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_74 = "+\"/TYPE=FASTLOAD\";" + NL + "" + NL + "String dbProperties_";
  protected final String TEXT_75 = " = ";
  protected final String TEXT_76 = ";" + NL + "if(dbProperties_";
  protected final String TEXT_77 = " != null && dbProperties_";
  protected final String TEXT_78 = ".trim().length() > 0) {" + NL + "\turl_";
  protected final String TEXT_79 = " +=\",\"+dbProperties_";
  protected final String TEXT_80 = ";" + NL + "}";
  protected final String TEXT_81 = NL + NL + "String dbUser_";
  ...
  protected final String TEXT_90 = NL + "String dbPwd_";
  protected final String TEXT_91 = " = decryptedPassword_";
  protected final String TEXT_92 = ";" + NL + "" + NL + "java.sql.Connection conn_";
  protected final String TEXT_93 = " = null;";
  protected final String TEXT_94 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_95 = " =null;";
  protected final String TEXT_96 = NL + "\t String tableName_";
  protected final String TEXT_97 = " = ";
  protected final String TEXT_98 = ";" + NL + "\t String dbname_";
  protected final String TEXT_99 = " = ";
  protected final String TEXT_100 = ";" + NL + "\t " + NL + "\tif(dbname_";
  protected final String TEXT_101 = " == null || dbname_";
  protected final String TEXT_102 = ".trim().length() == 0) {" + NL + "    \ttableName_";
  protected final String TEXT_103 = " = ";
  protected final String TEXT_104 = ";" + NL + "\t} else {" + NL + "    \ttableName_";
  protected final String TEXT_105 = " = dbname_";
  protected final String TEXT_106 = " + \".\" + ";
  protected final String TEXT_107 = ";" + NL + "\t}" + NL + "\t\tpstmt_";
  protected final String TEXT_108 = " = conn_";
  protected final String TEXT_109 = ".prepareStatement(\"INSERT INTO \"+tableName_";
