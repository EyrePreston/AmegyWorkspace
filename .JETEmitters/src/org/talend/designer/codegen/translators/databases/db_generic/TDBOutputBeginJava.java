...
public class TDBOutputBeginJava {
  ...
  protected final String TEXT_53 = " = \"jdbc:odbc:\" + ";
  protected final String TEXT_54 = ";";
  protected final String TEXT_55 = NL + "    String url_";
  protected final String TEXT_56 = " = \"jdbc:odbc:\" + ";
  protected final String TEXT_57 = ";";
  protected final String TEXT_58 = NL + "    String url_";
  protected final String TEXT_59 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_60 = " + \":\" + ";
  protected final String TEXT_61 = " + \":\" + ";
  protected final String TEXT_62 = ";";
  protected final String TEXT_63 = NL + "    String url_";
  protected final String TEXT_64 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_65 = " + \":\" + ";
  protected final String TEXT_66 = " + \"/\" + ";
  protected final String TEXT_67 = ";";
  protected final String TEXT_68 = NL + "    String url_";
  protected final String TEXT_69 = " = \"jdbc:mysql://\" + ";
  ...
  protected final String TEXT_82 = " " + NL + "java.lang.Class.forName(\"";
  ...
  protected final String TEXT_96 = ";" + NL + "" + NL + "String dbProperties_";
  protected final String TEXT_97 = " = ";
  protected final String TEXT_98 = ";" + NL + "java.sql.Connection conn_";
  protected final String TEXT_99 = " = null;";
  protected final String TEXT_100 = "\t" + NL + "if(dbProperties_";
  protected final String TEXT_101 = " == null || dbProperties_";
  protected final String TEXT_102 = ".trim().length() == 0) {" + NL + "\tconn_";
  ...
  protected final String TEXT_106 = ");" + NL + "}else{" + NL + "\tdbProperties_";
  protected final String TEXT_107 = " = dbProperties_";
  protected final String TEXT_108 = ".replaceAll(\"&\", \"\\n\");" + NL + "\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_109 = " = new java.util.Properties();" + NL + "\tatnParamsPrope_";
  protected final String TEXT_110 = ".put(\"user\",dbUser_";
  protected final String TEXT_111 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_112 = ".put(\"password\",dbPwd_";
  protected final String TEXT_113 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_114 = ".load(new java.io.ByteArrayInputStream(dbProperties_";
  protected final String TEXT_115 = ".getBytes()));" + NL + "\tconn_";
  protected final String TEXT_116 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_117 = ", atnParamsPrope_";
  ...
  protected final String TEXT_123 = ".setAutoCommit(false);" + NL + "\t\t\t  ";
  protected final String TEXT_124 = NL;
  protected final String TEXT_125 = NL + "    java.sql.Statement stmtClear_";
  protected final String TEXT_126 = " = conn_";
  protected final String TEXT_127 = ".createStatement();" + NL + "    deletedCount_";
  protected final String TEXT_128 = " = deletedCount_";
  protected final String TEXT_129 = " + stmtClear_";
  protected final String TEXT_130 = ".executeUpdate(\"delete from \" + ";
  ...
  protected final String TEXT_137 = NL + "\t    \tjava.sql.Statement pstmt_";
  ...
  protected final String TEXT_149 = NL + "\t    \tjava.sql.Statement pstmt_";
  ...
  protected final String TEXT_154 = ".prepareStatement(update_";
  protected final String TEXT_155 = ");" + NL + "\t    ";
  protected final String TEXT_156 = NL + "\t    \tString checkExist_";
  protected final String TEXT_157 = " = \"SELECT COUNT(1) FROM \" + ";
  ...
  protected final String TEXT_164 = " = \"UPDATE \" + ";
  protected final String TEXT_165 = " + \" SET ";
  protected final String TEXT_166 = " WHERE ";
  protected final String TEXT_167 = "\";" + NL + "\t    ";
  protected final String TEXT_168 = NL + "\t    \tString[] checkExistSQLSplits_";
  protected final String TEXT_169 = " = (checkExist_";
  protected final String TEXT_170 = "+\" \").split(\"\\\\?\");" + NL + "\t    \tjava.sql.Statement pstmt_";
  protected final String TEXT_171 = " = conn_";
  protected final String TEXT_172 = ".createStatement();" + NL + "\t    \tjava.sql.Statement pstmtInsert_";
  protected final String TEXT_173 = " = conn_";
  protected final String TEXT_174 = ".createStatement();" + NL + "\t    \tjava.sql.Statement pstmtUpdate_";
  ...
  protected final String TEXT_179 = ".prepareStatement(checkExist_";
  ...
  protected final String TEXT_183 = ");" + NL + "\t\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_191 = "\";" + NL + "\t    String insert_";
  protected final String TEXT_192 = " = \"INSERT INTO \" + ";
  protected final String TEXT_193 = " + \" (";
  protected final String TEXT_194 = ") VALUES (";
  protected final String TEXT_195 = ")\";" + NL + "\t    ";
  protected final String TEXT_196 = NL + "\t\t    java.sql.Statement pstmtUpdate_";
  protected final String TEXT_197 = " = conn_";
  protected final String TEXT_198 = ".createStatement();" + NL + "\t\t    java.sql.Statement pstmtInsert_";
  protected final String TEXT_199 = " = conn_";
  protected final String TEXT_200 = ".createStatement();\t\t" + NL + "\t    ";
  protected final String TEXT_201 = NL + "\t\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_208 = NL + "\t    String delete_";
  protected final String TEXT_209 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_210 = " + \" WHERE ";
  protected final String TEXT_211 = "\";" + NL + "\t    ";
  protected final String TEXT_212 = NL + "\t    \tjava.sql.Statement pstmt_";
  protected final String TEXT_213 = " = conn_";
  protected final String TEXT_214 = ".createStatement();" + NL + "\t    ";
  protected final String TEXT_215 = NL + "\t    \tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_216 = " = conn_";
  protected final String TEXT_217 = ".prepareStatement(delete_";
  protected final String TEXT_218 = ");" + NL + "\t    ";
  protected final String TEXT_219 = NL + "        StringBuffer query_";
  protected final String TEXT_220 = " = null;" + NL + "       \t";
  protected final String TEXT_221 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_222 = " = insert_";
  protected final String TEXT_223 = ".split(\"\\\\?\");";
  protected final String TEXT_224 = NL + "\t\t\tupdate_";
  protected final String TEXT_225 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_226 = " = update_";
  ...
  protected final String TEXT_231 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_232 = " = insert_";
  protected final String TEXT_233 = ".split(\"\\\\?\");";
  protected final String TEXT_234 = NL + "\t\t\tdelete_";
  protected final String TEXT_235 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_236 = " = delete_";
  protected final String TEXT_237 = ".split(\"\\\\?\");";
  protected final String TEXT_238 = NL + "\t\t\treplace_";
  protected final String TEXT_239 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_240 = " = replace_";
  protected final String TEXT_241 = ".split(\"\\\\?\");";
  protected final String TEXT_242 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_243 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_244 = " = insertIgnore_";
  ...
  protected final String TEXT_249 = NL + "\t    int commitEvery_";
  protected final String TEXT_250 = " = ";
  protected final String TEXT_251 = ";" + NL + "\t    int commitCounter_";
