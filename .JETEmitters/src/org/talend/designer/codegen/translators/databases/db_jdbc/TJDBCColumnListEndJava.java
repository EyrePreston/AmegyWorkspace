...
public class TJDBCColumnListEndJava
{
  ...
  protected final String TEXT_65 = NL + "}" + NL + "}catch(Exception e_";
  ...
  protected final String TEXT_71 = NL + "}finally{" + NL + "    try{" + NL + "        if(stmt2_";
  protected final String TEXT_72 = "!=null){" + NL + "            stmt2_";
  protected final String TEXT_73 = ".close();" + NL + "        }" + NL + "    }catch(Exception e2_";
  protected final String TEXT_74 = "){";
  protected final String TEXT_75 = NL + "            throw(e2_";
  protected final String TEXT_76 = ");";
  protected final String TEXT_77 = NL + "            System.err.println(e2_";
  protected final String TEXT_78 = ".getMessage());";
  protected final String TEXT_79 = NL + "    }" + NL + "}" + NL + "globalMap.put(\"";
  protected final String TEXT_80 = "_NB_COLUMN\", nb_column_";
