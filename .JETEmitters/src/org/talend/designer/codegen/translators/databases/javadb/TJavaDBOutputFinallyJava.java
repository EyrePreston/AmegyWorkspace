...
public class TJavaDBOutputFinallyJava
{
  ...
  protected final String TEXT_41 = NL + "\tif(resourceMap.get(\"finish_";
  protected final String TEXT_42 = "\")==null){" + NL + "\t\tif(resourceMap.get(\"conn_";
  protected final String TEXT_43 = "\")!=null){" + NL + "\t\t\ttry" + NL + "\t    \t{" + NL + "\t    \t\t";
  protected final String TEXT_44 = NL + "\t\t\t\t((java.sql.Connection)resourceMap.get(\"conn_";
  protected final String TEXT_45 = "\")).close();" + NL + "\t\t\t\t";
  protected final String TEXT_46 = NL + "\t\t\t";
  protected final String TEXT_47 = NL + "\t    \t\tjava.sql.DriverManager.getConnection(\"jdbc:derby:;shutdown=true\");" + NL + "\t\t\t";
  protected final String TEXT_48 = NL + "\t    \t}" + NL + "\t    \tcatch(java.sql.SQLException sqlEx_";
  protected final String TEXT_49 = ")" + NL + "\t    \t{" + NL + "\t    \t\tString errorMessage_";
  protected final String TEXT_50 = " = \"failed to close the connection in ";
  protected final String TEXT_51 = " :\" + sqlEx_";
