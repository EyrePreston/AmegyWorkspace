...
public class TMSSqlOutputEndJava {
  ...
  protected final String TEXT_41 = NL + "\t\tif ( isShareIdentity_";
  protected final String TEXT_42 = " ) {" + NL + "\t\t\tString setIdentityInsertONSQL_";
  protected final String TEXT_43 = " = \"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_44 = " +\"] ON\";" + NL + "\t\t\t";
  protected final String TEXT_45 = NL + "        \tstmt_";
  protected final String TEXT_46 = ".execute(setIdentityInsertONSQL_";
  protected final String TEXT_47 = ");" + NL + "\t\t\t";
  protected final String TEXT_48 = "\t\t\t\t\t\t\t\t\t\t\t\t" + NL + "        }";
  protected final String TEXT_49 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_50 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_51 = ".close();" + NL + "            " + NL + "        } " + NL + "        if(pstmtInsert_";
  protected final String TEXT_52 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_53 = ".close();" + NL + "            " + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_54 = " != null) {" + NL + "" + NL + "            pstmt_";
  ...
  protected final String TEXT_58 = ".close();" + NL + "            " + NL + "        } " + NL + "        if(pstmtInsert_";
  protected final String TEXT_59 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_60 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_61 = NL + "        if(pstmtInsert_";
  protected final String TEXT_62 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_63 = ".close();" + NL + "        }" + NL + "        if(pstmt_";
  ...
  protected final String TEXT_72 = ",java.sql.Types.CHAR);" + NL + "\t\t";
  ...
  protected final String TEXT_77 = ",java.sql.Types.DATE);" + NL + "\t\t";
  ...
  protected final String TEXT_82 = ",java.sql.Types.ARRAY);         " + NL + "\t\t";
  ...
  protected final String TEXT_87 = ",java.sql.Types.INTEGER);" + NL + "\t\t";
  ...
  protected final String TEXT_92 = ",java.sql.Types.VARCHAR);" + NL + "\t\t";
  ...
  protected final String TEXT_97 = ",java.sql.Types.OTHER);" + NL + "\t\t";
  protected final String TEXT_98 = NL + "\t\t        if(bufferL";
  protected final String TEXT_99 = ".";
  protected final String TEXT_100 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_101 = ".setNull(count";
  protected final String TEXT_102 = ",java.sql.Types.BOOLEAN);   " + NL + "\t\t";
  protected final String TEXT_103 = NL + "\t\t        if(bufferL";
  protected final String TEXT_104 = ".";
  protected final String TEXT_105 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_106 = ".setNull(count";
  protected final String TEXT_107 = ",java.sql.Types.DOUBLE);    " + NL + "\t\t";
  protected final String TEXT_108 = NL + "\t\t        if(bufferL";
  protected final String TEXT_109 = ".";
  protected final String TEXT_110 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_111 = ".setNull(count";
  protected final String TEXT_112 = ",java.sql.Types.FLOAT); " + NL + "\t\t";
  ...
  protected final String TEXT_118 = NL + "\t\t        if((\"null\").equals(String.valueOf(bufferL";
  protected final String TEXT_119 = ".";
  protected final String TEXT_120 = ").toLowerCase())){" + NL + "\t\t";
  protected final String TEXT_121 = NL + "\t\t    ";
  protected final String TEXT_122 = ".setNull(count";
  protected final String TEXT_123 = ",java.sql.Types.CHAR);" + NL + "\t\t        " + NL + "\t\t    } else if(bufferL";
  protected final String TEXT_124 = ".";
  protected final String TEXT_125 = " == '\\0') {" + NL + "\t\t    " + NL + "\t\t        ";
  protected final String TEXT_126 = ".setString(count";
  protected final String TEXT_127 = ",\"\");" + NL + "\t\t        " + NL + "\t\t    } else {" + NL + "\t\t        " + NL + "\t\t        ";
  protected final String TEXT_128 = ".setString(count";
  protected final String TEXT_129 = ",String.valueOf(bufferL";
  protected final String TEXT_130 = ".";
  protected final String TEXT_131 = "));" + NL + "\t\t    }" + NL + "\t\t";
  protected final String TEXT_132 = NL + "\t\t        if(bufferL";
  protected final String TEXT_133 = ".";
  protected final String TEXT_134 = "!=null){" + NL + "\t\t            // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t            date_";
  protected final String TEXT_135 = " = bufferL";
  protected final String TEXT_136 = ".";
  protected final String TEXT_137 = ".getTime();" + NL + "\t\t            if (date_";
  protected final String TEXT_138 = " < year1_";
  protected final String TEXT_139 = " || date_";
  protected final String TEXT_140 = " >= year10000_";
  protected final String TEXT_141 = ") {" + NL + "\t\t                ";
  protected final String TEXT_142 = ".setString(count";
  protected final String TEXT_143 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t            } else {" + NL + "\t\t\t\t";
  protected final String TEXT_144 = NL + "                    \t";
  protected final String TEXT_145 = ".setString(count";
  protected final String TEXT_146 = ",TalendDate.formatDate(";
  protected final String TEXT_147 = ", ";
  protected final String TEXT_148 = ".";
  protected final String TEXT_149 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_150 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_151 = ".setString(count";
  protected final String TEXT_152 = ",TalendDate.formatDatetimeoffset(";
  protected final String TEXT_153 = ".";
  protected final String TEXT_154 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_155 = NL + "\t\t                ";
  protected final String TEXT_156 = ".setTimestamp(count";
  protected final String TEXT_157 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_158 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_159 = NL + "\t\t         ";
  protected final String TEXT_160 = NL + "\t\t                ";
  protected final String TEXT_161 = ".setTimestamp(count";
  protected final String TEXT_162 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_163 = "),calendar_datetimeoffset_";
  protected final String TEXT_164 = ");" + NL + "\t\t         ";
  protected final String TEXT_165 = NL + "\t\t         \t\t";
  protected final String TEXT_166 = ".setTimestamp(count";
  protected final String TEXT_167 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_168 = "));" + NL + "\t\t         ";
  protected final String TEXT_169 = NL + "\t\t\t\t";
  protected final String TEXT_170 = NL + "\t\t            }" + NL + "\t\t        }else{" + NL + "\t\t            ";
  protected final String TEXT_171 = ".setNull(count";
  protected final String TEXT_172 = ",java.sql.Types.DATE);" + NL + "\t\t        }" + NL + "\t\t";
  protected final String TEXT_173 = NL + "\t\t        ";
  protected final String TEXT_174 = ".set";
  protected final String TEXT_175 = "(count";
  protected final String TEXT_176 = ",bufferL";
  protected final String TEXT_177 = ".";
  protected final String TEXT_178 = ");" + NL + "\t\t        ";
  protected final String TEXT_179 = NL + "\t\t        }" + NL + "\t\t";
  protected final String TEXT_180 = NL + "\t\tif(rowCount";
  protected final String TEXT_181 = "!=0){" + NL + "\t\t" + NL + "\t\tStringBuilder singleQueryInsertValueStmt = new StringBuilder();" + NL + "\t\tfor(int i=0 ; i < rowCount";
  protected final String TEXT_182 = " ; i++){" + NL + "\t\t     singleQueryInsertValueStmt.append(\"(\"+insertColValue";
  protected final String TEXT_183 = "+\")\");" + NL + "\t\t     if (i != rowCount";
  protected final String TEXT_184 = " - 1) " + NL + "\t\t    \t singleQueryInsertValueStmt.append(\",\");" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tinsert_";
  protected final String TEXT_185 = " = \"INSERT INTO \"+";
  protected final String TEXT_186 = "+\" (\"+insertColName";
  protected final String TEXT_187 = "+\") VALUES \"+singleQueryInsertValueStmt.toString();" + NL + "\t\t        " + NL + "\t\tpstmt_";
  protected final String TEXT_188 = " = conn_";
  protected final String TEXT_189 = ".prepareStatement(insert_";
  protected final String TEXT_190 = ");" + NL + "\t\tint row2Count";
  protected final String TEXT_191 = " = 0;" + NL + "\t\t";
  protected final String TEXT_192 = NL + "\t\t\tint count";
  protected final String TEXT_193 = " = 1;" + NL + "\t\t";
  protected final String TEXT_194 = NL + "\t\tint count";
  protected final String TEXT_195 = " = 0;" + NL + "\t\t";
  protected final String TEXT_196 = NL + "\t\t" + NL + "\t\tfor(BufferLine_";
  protected final String TEXT_197 = " bufferL";
  protected final String TEXT_198 = " : sInsertColValueList";
  protected final String TEXT_199 = "){            " + NL + "\t\t";
  protected final String TEXT_200 = NL + "\t\t    count";
  protected final String TEXT_201 = " = row2Count";
  protected final String TEXT_202 = "*";
  protected final String TEXT_203 = "+1;         \t          " + NL + "\t\t";
  protected final String TEXT_204 = NL + "\t\t            count";
  protected final String TEXT_205 = "++;" + NL + "\t\t            ";
  protected final String TEXT_206 = NL + "\t\t\t\tint count_dyn_";
  protected final String TEXT_207 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_208 = ".";
  protected final String TEXT_209 = ", pstmt_";
  protected final String TEXT_210 = ", count";
  protected final String TEXT_211 = "-1, \"";
  protected final String TEXT_212 = "\");" + NL + "\t\t\t\tcount";
  protected final String TEXT_213 = "+=count_dyn_";
  protected final String TEXT_214 = ";" + NL + "\t\t\t";
  protected final String TEXT_215 = NL + "\t\t" + NL + "\t\t    row2Count";
  protected final String TEXT_216 = "++;" + NL + "\t\t}        " + NL + "\t\tinsertedCount_";
  protected final String TEXT_217 = " = insertedCount_";
  protected final String TEXT_218 = " + pstmt_";
  protected final String TEXT_219 = ".executeUpdate();" + NL + "\t\t}";
  protected final String TEXT_220 = "                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_221 = " = 0;" + NL + "\t\t\t\t\t\tif (pstmt_";
  protected final String TEXT_222 = " != null) {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_223 = NL + "\t\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_224 = ": pstmt_";
  protected final String TEXT_225 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_226 = " == -2 || countEach_";
  protected final String TEXT_227 = " == -3) {" + NL + "\t\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_240 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_241 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_242 = NL + "                \tint countSum_";
  protected final String TEXT_243 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_244 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_245 = " += (countEach_";
  protected final String TEXT_246 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_257 = "     " + NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_258 = "                \t" + NL + "            \t}                                  ";
  protected final String TEXT_259 = "   " + NL + "        if(pstmt_";
  protected final String TEXT_260 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_261 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_262 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_263 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_264 = ");   " + NL + "\t\t\t";
  protected final String TEXT_265 = "            " + NL + "        }        ";
  protected final String TEXT_266 = NL + "    String setIdentityInsertOFFSQL_";
  protected final String TEXT_267 = " = \"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_268 = " +\"] OFF\";";
  protected final String TEXT_269 = NL + "    stmt_";
  protected final String TEXT_270 = ".execute(setIdentityInsertOFFSQL_";
  protected final String TEXT_271 = ");";
  protected final String TEXT_272 = NL + "    stmt_";
