...
public class TTeradataOutputBeginJava {
  ...
  protected final String TEXT_67 = NL + "\t\t\t\tif(log.is";
  protected final String TEXT_68 = "Enabled())" + NL + "\t\t\t";
  protected final String TEXT_69 = NL + "\t\t\tlog.";
  protected final String TEXT_70 = "(\"";
  protected final String TEXT_71 = " - \" ";
  protected final String TEXT_72 = " + ";
  protected final String TEXT_73 = " ";
  protected final String TEXT_74 = ");" + NL + "\t\t";
  protected final String TEXT_75 = NL + "    \t\tStringBuilder ";
  protected final String TEXT_76 = " = new StringBuilder();" + NL + "    \t   \t";
  protected final String TEXT_77 = ".append(\"Parameters:\");" + NL + "    \t   \t";
  protected final String TEXT_78 = NL + "                    ";
  protected final String TEXT_79 = ".append(\"";
  protected final String TEXT_80 = "\" + \" = \" + String.valueOf(";
  protected final String TEXT_81 = ").substring(0, 4) + \"...\");\t\t" + NL + "       \t\t\t";
  ...
  protected final String TEXT_88 = NL + "        \tStringBuilder ";
  protected final String TEXT_89 = " = new StringBuilder();\t" + NL + "        \t";
  ...
  protected final String TEXT_97 = ".append(\"<null>\");" + NL + "    \t\t\t\t}else{" + NL + "        \t\t\t\t";
  protected final String TEXT_98 = ".append(";
  protected final String TEXT_99 = ".";
  protected final String TEXT_100 = ");" + NL + "        \t\t\t}\t" + NL + "        \t\t";
  protected final String TEXT_101 = NL + "    \t\t\t";
  protected final String TEXT_102 = ".append(\"|\");" + NL + "    \t\t";
  protected final String TEXT_103 = NL + "\t";
  protected final String TEXT_104 = NL;
  protected final String TEXT_105 = NL + NL + "int nb_line_";
  protected final String TEXT_106 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_107 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_108 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_109 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_110 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_111 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_112 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_113 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_114 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_115 = " = ";
  protected final String TEXT_116 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_117 = " = false;";
  protected final String TEXT_118 = NL + "   int batchSize_";
  protected final String TEXT_119 = " = ";
  protected final String TEXT_120 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_121 = "=0;";
  protected final String TEXT_122 = " " + NL + NL + NL;
  protected final String TEXT_123 = NL + "        int updateKeyCount_";
  protected final String TEXT_124 = " = ";
  protected final String TEXT_125 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_126 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_127 = NL + "        int deleteKeyCount_";
  protected final String TEXT_128 = " = ";
  protected final String TEXT_129 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_130 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_131 = NL + "\t String dbname_";
  ...
  protected final String TEXT_141 = ";" + NL + "    String driverClass_";
  protected final String TEXT_142 = " = \"com.teradata.jdbc.TeraDriver\";";
  protected final String TEXT_143 = NL + "    " + NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_144 = ");" + NL + "    String dbProperties_";
  protected final String TEXT_145 = " = ";
  protected final String TEXT_146 = ";" + NL + "\tString url_";
  protected final String TEXT_147 = " = null;" + NL + "\tif(dbProperties_";
  protected final String TEXT_148 = " == null || dbProperties_";
  protected final String TEXT_149 = ".trim().length() == 0) {" + NL + "\t\turl_";
  protected final String TEXT_150 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_151 = ";     " + NL + "\t} else {" + NL + "\t    url_";
  protected final String TEXT_152 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_153 = " + \"/\" + ";
  protected final String TEXT_154 = ";" + NL + "\t}       " + NL + "    String dbUser_";
  ...
  protected final String TEXT_164 = NL + NL + "    String dbPwd_";
  ...
  protected final String TEXT_169 = ",dbUser_";
  protected final String TEXT_170 = ",dbPwd_";
  ...
  protected final String TEXT_176 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_177 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  protected final String TEXT_178 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" + ";
  protected final String TEXT_179 = NL + "               ";
  protected final String TEXT_180 = " + \"=\" + ";
  protected final String TEXT_181 = " + \";\" +";
  protected final String TEXT_182 = " \"' FOR SESSION\"" + NL + "           );           " + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());              " + NL + "      }" + NL + "      conn_";
  protected final String TEXT_183 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_184 = ");";
  protected final String TEXT_185 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_186 = "\", conn_";
  protected final String TEXT_187 = ");";
  protected final String TEXT_188 = NL + "        conn_";
  protected final String TEXT_189 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_190 = " = ";
  protected final String TEXT_191 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_192 = " = 0;        ";
  protected final String TEXT_193 = NL + "String dbschema_";
  protected final String TEXT_194 = " = dbname_";
  protected final String TEXT_195 = ";" + NL + "if(dbname_";
  protected final String TEXT_196 = " == null || dbname_";
  protected final String TEXT_197 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_198 = " = ";
  protected final String TEXT_199 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_200 = " = dbname_";
  protected final String TEXT_201 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_202 = ";" + NL + "}";
  protected final String TEXT_203 = NL + "int count_";
  ...
  protected final String TEXT_213 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_253 = NL + "\t\t    \t\tString keyCheckTable_";
  protected final String TEXT_254 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_255 = "+\"][\"+";
  protected final String TEXT_256 = "+\"][\"+";
  protected final String TEXT_257 = "+\"][\"+";
  protected final String TEXT_258 = "+\"][\"+";
  protected final String TEXT_259 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_260 = " + \"]\";" + NL + "\t\t    \t";
  protected final String TEXT_261 = NL + "        \t\t    // [%connection%][checktable][tableName]" + NL + "        \t\t    String keyCheckTable_";
  protected final String TEXT_262 = " = conn_";
  protected final String TEXT_263 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_264 = " + \"]\";" + NL + "    \t\t    ";
  protected final String TEXT_265 = NL + "\t\t    " + NL + "\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_266 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_267 = ")) {" + NL + "\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_268 = ")== null){" + NL + "\t\t\t";
  protected final String TEXT_269 = "              " + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_270 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_271 = " = conn_";
  protected final String TEXT_272 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_273 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  protected final String TEXT_274 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_275 = " + \"]\" );" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_276 = " = true;" + NL + "                \t\t\t\t} catch (java.lang.Exception e){" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_277 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_282 = ".getMetaData();" + NL + "                \t            if(tableNameForSearch_";
  protected final String TEXT_283 = ".indexOf(\"\\\"\")==-1){" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_284 = " = tableNameForSearch_";
  protected final String TEXT_285 = ".toUpperCase();" + NL + "                            \t}else{" + NL + "                            \t\ttableNameForSearch_";
  protected final String TEXT_286 = " = tableNameForSearch_";
  protected final String TEXT_287 = ".replaceAll(\"\\\"\",\"\");" + NL + "                            \t}" + NL + "                \t            java.sql.ResultSet rsTable_";
  protected final String TEXT_288 = " = dbMetaData_";
  protected final String TEXT_289 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_290 = ", tableNameForSearch_";
  ...
  protected final String TEXT_315 = ".trim().length() ==0)) {" + NL + "                \t                    whetherExist_";
  ...
  protected final String TEXT_326 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_327 = " = rsTable_";
  protected final String TEXT_328 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  ...
  protected final String TEXT_339 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_340 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_349 = " = false;" + NL + "                \t            String defaultSchema_";
  protected final String TEXT_350 = " = \"public\";" + NL + "                \t            if(dbschema_";
  protected final String TEXT_351 = " == null || dbschema_";
  protected final String TEXT_352 = ".trim().length() == 0) {" + NL + "                \t            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_353 = " = conn_";
  protected final String TEXT_354 = ".createStatement();" + NL + "                \t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_355 = " = stmtSchema_";
  protected final String TEXT_356 = ".executeQuery(\"select current_schema() \");" + NL + "                \t            \twhile(rsSchema_";
  protected final String TEXT_357 = ".next()){" + NL + "                \t            \t\tdefaultSchema_";
  protected final String TEXT_358 = " = rsSchema_";
  protected final String TEXT_359 = ".getString(\"current_schema\");" + NL + "                \t            \t}" + NL + "                \t            \trsSchema_";
  protected final String TEXT_360 = ".close();" + NL + "                \t            \tstmtSchema_";
  protected final String TEXT_361 = ".close();" + NL + "                \t            }" + NL + "                \t            while(rsTable_";
  protected final String TEXT_362 = ".next()) {" + NL + "                \t                String table_";
  protected final String TEXT_363 = " = rsTable_";
  protected final String TEXT_364 = ".getString(\"TABLE_NAME\");" + NL + "                \t                String schema_";
  protected final String TEXT_365 = " = rsTable_";
  protected final String TEXT_366 = ".getString(\"TABLE_SCHEM\");" + NL + "                \t                if(table_";
  protected final String TEXT_367 = ".equals";
  protected final String TEXT_368 = "IgnoreCase";
  protected final String TEXT_369 = "(";
  protected final String TEXT_370 = ") " + NL + "                \t                \t&& (schema_";
  protected final String TEXT_371 = ".equals";
  protected final String TEXT_372 = "IgnoreCase";
  protected final String TEXT_373 = "(dbschema_";
  protected final String TEXT_374 = ") || ((dbschema_";
  protected final String TEXT_375 = " ==null || dbschema_";
  protected final String TEXT_376 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_377 = ".equals";
  protected final String TEXT_378 = "IgnoreCase";
  protected final String TEXT_379 = "(schema_";
  ...
  protected final String TEXT_415 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_425 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_446 = ", true);" + NL + "    " + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_476 = NL + "                if(!conn_";
  protected final String TEXT_477 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_478 = ".commit();" + NL + "                }";
  ...
  protected final String TEXT_494 = ".commit();" + NL + "\t\t\t";
