...
public class TOracleConnectionBeginJava
{
  ...
  protected final String TEXT_155 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_156 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_157 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_158 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_159 = NL + "\t\t\tconn_";
  protected final String TEXT_160 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_161 = ", dbUser_";
  protected final String TEXT_162 = ", dbPwd_";
  protected final String TEXT_163 = ");" + NL + "\t\t\t";
  protected final String TEXT_164 = NL + "\t\t\tconn_";
  protected final String TEXT_165 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_166 = NL + "\t\t\tconn_";
  protected final String TEXT_167 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_168 = NL + "\t\t\tconn_";
  protected final String TEXT_169 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_170 = NL + "\t\t\t\tconn_";
  protected final String TEXT_171 = ".setAutoCommit(";
  protected final String TEXT_172 = ");" + NL + "\t\t\t";
  protected final String TEXT_173 = NL + "\t\t\t\tlog.";
  protected final String TEXT_174 = "(\"";
  protected final String TEXT_175 = " - \" + ";
  protected final String TEXT_176 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_177 = NL + "\t    \t\tlog.";
  protected final String TEXT_178 = "(\"";
  protected final String TEXT_179 = "\");" + NL + "\t\t\t";
  protected final String TEXT_180 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_181 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_182 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_183 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_184 = ": pstmt_";
  protected final String TEXT_185 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_186 = " += (countEach_";
  protected final String TEXT_187 = " < 0 ? 0 : ";
  protected final String TEXT_188 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_189 = NL + "\t";
  protected final String TEXT_190 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  ...
  protected final String TEXT_201 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_202 = "\",conn_";
  protected final String TEXT_203 = ");";
  protected final String TEXT_204 = NL + "  \tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_205 = "\",conn_";
  protected final String TEXT_206 = ".getMetaData().getUserName());";
  protected final String TEXT_207 = NL + "\tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_208 = "\", ";
  protected final String TEXT_209 = ");";
  protected final String TEXT_210 = NL + "\tglobalMap.put(\"username_\" + \"";
  protected final String TEXT_211 = "\",";
  protected final String TEXT_212 = ");" + NL + "\tglobalMap.put(\"password_\" + \"";
