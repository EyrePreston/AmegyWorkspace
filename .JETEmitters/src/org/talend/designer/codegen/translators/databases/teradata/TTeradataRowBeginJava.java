...
public class TTeradataRowBeginJava
{
  ...
  protected final String TEXT_118 = NL + "\t\t\t\tif(log.is";
  protected final String TEXT_119 = "Enabled())" + NL + "\t\t\t";
  ...
  protected final String TEXT_126 = NL + "    \t\tStringBuilder ";
  protected final String TEXT_127 = " = new StringBuilder();" + NL + "    \t   \t";
  protected final String TEXT_128 = ".append(\"Parameters:\");" + NL + "    \t   \t";
  protected final String TEXT_129 = NL + "                    ";
  protected final String TEXT_130 = ".append(\"";
  protected final String TEXT_131 = "\" + \" = \" + String.valueOf(";
  protected final String TEXT_132 = ").substring(0, 4) + \"...\");\t\t" + NL + "       \t\t\t";
  ...
  protected final String TEXT_139 = NL + "        \tStringBuilder ";
  ...
  protected final String TEXT_148 = ".append(\"<null>\");" + NL + "    \t\t\t\t}else{" + NL + "        \t\t\t\t";
  protected final String TEXT_149 = ".append(";
  protected final String TEXT_150 = ".";
  protected final String TEXT_151 = ");" + NL + "        \t\t\t}\t" + NL + "        \t\t";
  protected final String TEXT_152 = NL + "    \t\t\t";
  protected final String TEXT_153 = ".append(\"|\");" + NL + "    \t\t";
  protected final String TEXT_154 = NL + "\t";
  protected final String TEXT_155 = NL;
  protected final String TEXT_156 = NL + "\t\t\tString dbProperties_";
  protected final String TEXT_157 = " = ";
  protected final String TEXT_158 = ";" + NL + "\t\t\tString url_";
  protected final String TEXT_159 = " = null;" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_160 = " == null || dbProperties_";
  protected final String TEXT_161 = ".trim().length() == 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_162 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_163 = ";" + NL + "\t\t\t} else {" + NL + "\t\t\t    url_";
  protected final String TEXT_164 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_165 = " + \"/\" + ";
  protected final String TEXT_166 = ";" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_167 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_168 = " = null;" + NL + "\tString query_";
  protected final String TEXT_169 = " = \"\";" + NL + "\tboolean whetherReject_";
  ...
  protected final String TEXT_175 = NL + "\t\tjava.sql.Statement stmt_";
  ...
  protected final String TEXT_183 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_184 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  protected final String TEXT_185 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" + ";
  protected final String TEXT_186 = NL + "               ";
  protected final String TEXT_187 = " + \"=\" + ";
  protected final String TEXT_188 = " + \";\" +";
  protected final String TEXT_189 = " \"' FOR SESSION\"" + NL + "           );           " + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());              " + NL + "      }" + NL + "      conn_";
  protected final String TEXT_190 = ".setAutoCommit(currentAutoCommitMode";
