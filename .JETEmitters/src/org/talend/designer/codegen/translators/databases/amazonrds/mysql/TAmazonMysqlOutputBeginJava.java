...
public class TAmazonMysqlOutputBeginJava {
  ...
  protected final String TEXT_59 = "=0;" + NL + "" + NL + "int rejectedCount_";
  protected final String TEXT_60 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_61 = " = ";
  protected final String TEXT_62 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_63 = " = false;" + NL + "" + NL + "java.util.Calendar calendar_";
  protected final String TEXT_64 = " = java.util.Calendar.getInstance();" + NL + "calendar_";
  protected final String TEXT_65 = ".set(1, 0, 1, 0, 0, 0);" + NL + "long year1_";
  protected final String TEXT_66 = " = calendar_";
  protected final String TEXT_67 = ".getTime().getTime();" + NL + "calendar_";
  protected final String TEXT_68 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "long year10000_";
  ...
  protected final String TEXT_77 = NL + "\tString dbProperties_";
  protected final String TEXT_78 = " = ";
  protected final String TEXT_79 = ";" + NL + "\tString url_";
  protected final String TEXT_80 = " = null;" + NL + "\tif(dbProperties_";
  protected final String TEXT_81 = " == null || dbProperties_";
  protected final String TEXT_82 = ".trim().length() == 0) {" + NL + "\t    url_";
  protected final String TEXT_83 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_84 = " + \":\" + ";
  protected final String TEXT_85 = " + \"/\" + ";
  protected final String TEXT_86 = " + \"?\" + \"rewriteBatchedStatements=true\";" + NL + "\t} else {" + NL + "\t\tString properties_";
  protected final String TEXT_87 = " = ";
  protected final String TEXT_88 = ";" + NL + "\t\tif (!properties_";
  protected final String TEXT_89 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\tproperties_";
  protected final String TEXT_90 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t}" + NL + "\t\t" + NL + "\t    url_";
  protected final String TEXT_91 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_92 = " + \":\" + ";
  protected final String TEXT_93 = " + \"/\" + ";
  protected final String TEXT_94 = " + \"?\" + properties_";
  protected final String TEXT_95 = ";" + NL + "\t}" + NL + "    String dbUser_";
  ...
  protected final String TEXT_125 = ";" + NL + "   int batchSizeCounter_";
  ...
  protected final String TEXT_139 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_145 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_146 = ".";
  protected final String TEXT_147 = ", \"";
  protected final String TEXT_148 = "\")";
  protected final String TEXT_149 = ".toUpperCase()";
  ...
  protected final String TEXT_196 = NL + "    \t\t\t\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_197 = " = conn_";
  protected final String TEXT_198 = ".createStatement();" + NL + "                \t\t\t\tboolean whetherExist_";
  protected final String TEXT_199 = " = false;" + NL + "                \t\t\t\ttry {" + NL + "                \t\t\t\t\tisExistStmt_";
  protected final String TEXT_200 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_201 = " + \"]\" );" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_202 = " = true;" + NL + "                \t\t\t\t} catch (java.lang.Exception e){" + NL + "                \t\t\t\t\twhetherExist_";
  protected final String TEXT_203 = " = false;" + NL + "                \t\t\t\t}" + NL + "                \t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_221 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_259 = ".toUpperCase()";
  ...
  protected final String TEXT_265 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_266 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_275 = " = false;" + NL + "                \t            String defaultSchema_";
  protected final String TEXT_276 = " = \"public\";" + NL + "                \t            if(dbschema_";
  ...
  protected final String TEXT_280 = ".createStatement();" + NL + "                \t            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_281 = " = stmtSchema_";
  protected final String TEXT_282 = ".executeQuery(\"select current_schema() \");" + NL + "                \t            \twhile(rsSchema_";
  protected final String TEXT_283 = ".next()){" + NL + "                \t            \t\tdefaultSchema_";
  protected final String TEXT_284 = " = rsSchema_";
  protected final String TEXT_285 = ".getString(\"current_schema\");" + NL + "                \t            \t}" + NL + "                \t            \trsSchema_";
  protected final String TEXT_286 = ".close();" + NL + "                \t            \tstmtSchema_";
  protected final String TEXT_287 = ".close();" + NL + "                \t            }" + NL + "                \t            while(rsTable_";
  ...
  protected final String TEXT_323 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_333 = ".toUpperCase()";
  ...
  protected final String TEXT_372 = ", true);" + NL + "    " + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_382 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_383 = " = conn_";
  protected final String TEXT_384 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_385 = " = stmtTruncCount_";
  protected final String TEXT_386 = ".executeQuery(\"";
  protected final String TEXT_387 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_388 = " = 0;" + NL + "            if(rsTruncCount_";
  ...
  protected final String TEXT_393 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_431 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_432 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");\t" + NL + "\t\t\t\t";
  protected final String TEXT_433 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_434 = ".append(\",\");" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_438 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_448 = " += \tduplidateClause_";
  ...
  protected final String TEXT_459 = "    " + NL + "" + NL + "                java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_463 = "\t            " + NL + "\t            class BufferLine_";
  protected final String TEXT_464 = " {" + NL + "    \t            ";
  protected final String TEXT_465 = NL + "                            ";
  protected final String TEXT_466 = " ";
  protected final String TEXT_467 = ";                ";
  protected final String TEXT_468 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_469 = "(";
  protected final String TEXT_470 = NL + "                                ,";
  protected final String TEXT_471 = NL + "                            ";
  protected final String TEXT_472 = " ";
  protected final String TEXT_473 = " " + NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_474 = NL + "                                this.";
  protected final String TEXT_475 = " = ";
  protected final String TEXT_476 = ";              ";
  protected final String TEXT_477 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "\t            " + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_478 = "> exInsertColValueList";
  protected final String TEXT_479 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_480 = " exInsertColValue";
  protected final String TEXT_481 = " = null; " + NL + "\t            " + NL + "\t            " + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_482 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_483 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_484 = ".append(\"(";
  protected final String TEXT_485 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_486 = "-1) extendInsertValueStmt_";
  protected final String TEXT_487 = ".append(\",\");" + NL + "                }" + NL + "               " + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_488 = " = \"INSERT INTO `\"+";
  ...
  protected final String TEXT_496 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_497 = " = new StringBuffer(insert_";
  protected final String TEXT_498 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_499 = ".insert(insert_";
  protected final String TEXT_500 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_501 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_502 = " =insertStringBuffer_";
  ...
  protected final String TEXT_507 = ");" + NL + "\t            " + NL + "\t            String insertColName";
  protected final String TEXT_508 = " = \"";
  protected final String TEXT_509 = "\";" + NL + "\t            String insertColValue";
  ...
  protected final String TEXT_519 = " += \tduplidateClause_";
  protected final String TEXT_520 = ".toString();";
  protected final String TEXT_521 = NL + "\t\t        int batchSize_";
  protected final String TEXT_522 = " = ";
  protected final String TEXT_523 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_524 = "=0;" + NL + "\t\t        ";
  ...
  protected final String TEXT_538 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_556 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_557 = " + \"` WHERE ";
  protected final String TEXT_558 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_559 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_575 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_592 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_608 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_625 = " = \"DELETE  FROM `\" + ";
  ...
  protected final String TEXT_640 = NL + "\t    String replace_";
  protected final String TEXT_641 = " = \"REPLACE INTO `\" + ";
  ...
  protected final String TEXT_646 = ".prepareStatement(replace_";
  protected final String TEXT_647 = ");" + NL + "\t    ";
  protected final String TEXT_648 = NL + "\t    String insertIgnore_";
  protected final String TEXT_649 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_650 = " + \"` (";
  protected final String TEXT_651 = ") VALUES (";
  protected final String TEXT_652 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_653 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_654 = " = conn_";
  protected final String TEXT_655 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_656 = ");" + NL + "\t    ";
  protected final String TEXT_657 = NL + "\t    String insert_";
  protected final String TEXT_658 = " = \"INSERT IGNORE INTO `\" + ";
  ...
  protected final String TEXT_681 = " = update_";
  protected final String TEXT_682 = ".split(\"\\\\?\");";
  protected final String TEXT_683 = NL + "\t\t\tupdate_";
  protected final String TEXT_684 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_685 = " = update_";
  protected final String TEXT_686 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_687 = " = insert_";
  protected final String TEXT_688 = ".split(\"\\\\?\");";
  protected final String TEXT_689 = NL + "\t\t\tdelete_";
  protected final String TEXT_690 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_691 = " = delete_";
  protected final String TEXT_692 = ".split(\"\\\\?\");";
  protected final String TEXT_693 = NL + "\t\t\treplace_";
  protected final String TEXT_694 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_695 = " = replace_";
  protected final String TEXT_696 = ".split(\"\\\\?\");";
  protected final String TEXT_697 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_698 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_699 = " = insertIgnore_";
  ...
  protected final String TEXT_704 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_705 = " {" + NL + "    \t            ";
  protected final String TEXT_706 = NL + "                            ";
  protected final String TEXT_707 = " ";
  protected final String TEXT_708 = ";                ";
  protected final String TEXT_709 = NL + "\t\t\t\tDynamic ";
  protected final String TEXT_710 = ";" + NL + "\t\t\t";
  protected final String TEXT_711 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_712 = "(";
  protected final String TEXT_713 = NL + "                                ,";
  protected final String TEXT_714 = NL + "                            ";
  protected final String TEXT_715 = " ";
  protected final String TEXT_716 = NL + "\t\t\t\t, Dynamic ";
  ...
  protected final String TEXT_725 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_726 = "> exInsertColValueList";
  protected final String TEXT_727 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_728 = " exInsertColValue";
  protected final String TEXT_729 = " = null; " + NL + "\t\t    String insert_";
  protected final String TEXT_730 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_731 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_732 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_733 = "=1;";
  protected final String TEXT_734 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_735 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_736 = "=0;";
  protected final String TEXT_737 = NL + NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_738 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_739 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_740 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_741 = "=0;" + NL + "\t";
  protected final String TEXT_742 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_746 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_747 = " =  null;";
  protected final String TEXT_748 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_749 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_753 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_754 = " = null;";
  protected final String TEXT_755 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
