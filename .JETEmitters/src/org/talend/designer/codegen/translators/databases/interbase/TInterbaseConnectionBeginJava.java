...
public class TInterbaseConnectionBeginJava
{
  ...
  protected final String TEXT_83 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\tlog.info(\"";
  ...
  protected final String TEXT_86 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_118 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  protected final String TEXT_119 = ")) {";
  protected final String TEXT_120 = NL + "\t\t";
  protected final String TEXT_121 = NL + "\t\t";
  protected final String TEXT_122 = NL + NL + "\t\tglobalMap.put(\"conn_";
  ...
  protected final String TEXT_129 = NL + "\t" + NL + " \t" + NL + " \tglobalMap.put(\"conn_\" + \"";
