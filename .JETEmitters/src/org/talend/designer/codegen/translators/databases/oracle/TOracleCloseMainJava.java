...
public class TOracleCloseMainJava
{
  ...
  protected final String TEXT_70 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES); " + NL + "\t\t\tif(dataSources_";
  protected final String TEXT_71 = "!=null) {" + NL + "\t\t\t\tif(dataSources_";
  protected final String TEXT_72 = ".get(";
  protected final String TEXT_73 = ")!=null) {" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_74 = " = dataSources_";
  protected final String TEXT_75 = ".get(";
  protected final String TEXT_76 = ").getConnection();" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_77 = NL + "\t" + NL + "\tif(conn_";
  protected final String TEXT_78 = " != null && !conn_";
  protected final String TEXT_79 = ".isClosed())" + NL + "\t{" + NL + "\t\t";
