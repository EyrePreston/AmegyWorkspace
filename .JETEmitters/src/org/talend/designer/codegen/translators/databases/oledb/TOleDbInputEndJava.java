...
public class TOleDbInputEndJava
{
  ...
  protected final String TEXT_39 = NL + "oBool_";
  protected final String TEXT_40 = " = (Boolean)reader_";
  protected final String TEXT_41 = ".invokeGeneric(\"Read\");" + NL + "bool_";
  protected final String TEXT_42 = " = oBool_";
  protected final String TEXT_43 = " != null && oBool_";
  protected final String TEXT_44 = ".booleanValue();" + NL + "}" + NL + "//stmt_";
  protected final String TEXT_45 = ".close();" + NL + "//conn_";
  protected final String TEXT_46 = " .close();" + NL + "globalMap.put(\"";
