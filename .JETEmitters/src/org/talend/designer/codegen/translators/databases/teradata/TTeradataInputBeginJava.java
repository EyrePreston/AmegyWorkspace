...
public class TTeradataInputBeginJava
{
  ...
  protected final String TEXT_180 = " = null;" + NL + "\t\t\tif(dbProperties_";
  protected final String TEXT_181 = " == null || dbProperties_";
  protected final String TEXT_182 = ".trim().length() == 0) {" + NL + "\t\t\t\turl_";
  protected final String TEXT_183 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_184 = " + \"/DATABASE=\" + ";
  protected final String TEXT_185 = ";    " + NL + "\t\t\t} else {" + NL + "\t\t\t    url_";
  protected final String TEXT_186 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_187 = " + \"/DATABASE=\" + ";
  protected final String TEXT_188 = " + \",\" + ";
  protected final String TEXT_189 = ";" + NL + "\t\t\t}       ";
  protected final String TEXT_190 = NL + "                stmt_";
  protected final String TEXT_191 = ".setFetchSize(200000);";
