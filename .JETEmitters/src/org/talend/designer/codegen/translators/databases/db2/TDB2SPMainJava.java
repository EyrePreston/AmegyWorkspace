...
public class TDB2SPMainJava
{
  ...
  protected final String TEXT_59 = ".setDate(";
  protected final String TEXT_60 = ", new java.sql.Date(";
  ...
  protected final String TEXT_85 = NL + "\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_86 = " = statement_";
  protected final String TEXT_87 = ".getString(";
  protected final String TEXT_88 = ");" + NL + "\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_89 = " != null && tmpString_";
  protected final String TEXT_90 = ".length() > 0) {" + NL + "\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_91 = ".";
  protected final String TEXT_92 = " = tmpString_";
  protected final String TEXT_93 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_94 = NL + "\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_95 = " = statement_";
  protected final String TEXT_96 = ".getDate(";
  protected final String TEXT_97 = ");" + NL + "\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_98 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_99 = ".";
  protected final String TEXT_100 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_101 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_108 = NL + "\t\t\t\t\t\t\t\t\tif (statement_";
  protected final String TEXT_109 = ".wasNull()) {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_122 = NL + "\t\t// No code generated: define a schema for ";
