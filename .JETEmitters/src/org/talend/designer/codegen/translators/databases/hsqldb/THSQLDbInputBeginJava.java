...
public class THSQLDbInputBeginJava
{
  ...
  protected final String TEXT_181 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_182 = " + \":\" + ";
  protected final String TEXT_183 = " + \"/\" + ";
  protected final String TEXT_184 = ";";
  protected final String TEXT_185 = NL + "\t\t            url_";
  protected final String TEXT_186 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_187 = " + \":\" + ";
  protected final String TEXT_188 = " + \"/\" + ";
  protected final String TEXT_189 = ";";
  protected final String TEXT_190 = NL + "\t\t            url_";
  protected final String TEXT_191 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_192 = " + \":\" + ";
  protected final String TEXT_193 = " + \"/\" + ";
  protected final String TEXT_194 = ";";
  protected final String TEXT_195 = NL + "\t\t            url_";
  protected final String TEXT_196 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_197 = " + \":\" + ";
  protected final String TEXT_198 = " + \"/\" + ";
  protected final String TEXT_199 = ";";
  protected final String TEXT_200 = NL + "\t\t        url_";
  protected final String TEXT_201 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_202 = " + \"/\" + ";
  protected final String TEXT_203 = ";";
  protected final String TEXT_204 = NL + "\t\t\t\turl_";
  protected final String TEXT_205 = " = \"jdbc:hsqldb:mem:\" + ";
  protected final String TEXT_206 = " ;";
  protected final String TEXT_207 = NL + "\t\t\t\turl_";
  protected final String TEXT_208 = " += \";\" + ";
  protected final String TEXT_209 = ";";
  protected final String TEXT_210 = NL + "    " + NL + "\t";
  protected final String TEXT_211 = NL + "\t\t    int nb_line_";
  protected final String TEXT_212 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_213 = " = null;";
  protected final String TEXT_214 = NL + "\t\t        conn_";
  protected final String TEXT_215 = " = (java.sql.Connection)globalMap.get(\"";
  ...
  protected final String TEXT_219 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_220 = " = dataSources_";
  ...
  protected final String TEXT_230 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_231 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  protected final String TEXT_232 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" + ";
  protected final String TEXT_233 = NL + "               ";
  protected final String TEXT_234 = " + \"=\" + ";
  protected final String TEXT_235 = " + \";\" +";
  protected final String TEXT_236 = " \"' FOR SESSION\"" + NL + "           );           " + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());              " + NL + "      }" + NL + "      conn_";
  protected final String TEXT_237 = ".setAutoCommit(currentAutoCommitMode";
  ...
  protected final String TEXT_393 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
