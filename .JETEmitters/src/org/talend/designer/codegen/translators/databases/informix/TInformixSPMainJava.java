...
public class TInformixSPMainJava
{
  ...
  protected final String TEXT_45 = " == null) {" + NL + "\t\t\t\t\t\tstatement_";
  protected final String TEXT_46 = ".setNull(";
  protected final String TEXT_47 = ", java.sql.Types.";
  protected final String TEXT_48 = ");" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t";
  protected final String TEXT_49 = NL + "\t\t\t\t\tif (";
  protected final String TEXT_50 = ".";
  protected final String TEXT_51 = " == '\\0') {" + NL + "\t\t\t\t\t\tstatement_";
  protected final String TEXT_52 = ".setString(";
  protected final String TEXT_53 = ", \"\");" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\tstatement_";
  protected final String TEXT_54 = ".setString(";
  protected final String TEXT_55 = ", String.valueOf(";
  protected final String TEXT_56 = ".";
  protected final String TEXT_57 = "));" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_58 = NL + "\t\t\t\t\tstatement_";
  protected final String TEXT_59 = ".setTimestamp(";
  protected final String TEXT_60 = ", new java.sql.Timestamp(";
  ...
  protected final String TEXT_71 = ".registerOutParameter(";
  protected final String TEXT_72 = ", java.sql.Types.";
  protected final String TEXT_73 = ");" + NL + "\t  \t\t\t";
  protected final String TEXT_74 = NL + "\t\tstatement_";
  protected final String TEXT_75 = ".execute();" + NL + "\t\t";
  ...
  protected final String TEXT_84 = ".getResultSet();";
  protected final String TEXT_85 = NL + "\t\t\t\t\t\t\t\tjava.sql.ResultSet tmpResult_";
  protected final String TEXT_86 = " = statement_";
  protected final String TEXT_87 = ".getResultSet();" + NL + "\t\t\t\t\t\t\t\tif (tmpResult_";
  protected final String TEXT_88 = ".next()) {";
  protected final String TEXT_89 = NL + "\t\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_90 = " = tmpResult_";
  protected final String TEXT_91 = ".getString(";
  protected final String TEXT_92 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_93 = " != null && tmpString_";
  protected final String TEXT_94 = ".length() > 0) {" + NL + "\t\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_95 = ".";
  protected final String TEXT_96 = " = tmpString_";
  protected final String TEXT_97 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_98 = NL + "\t\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_99 = " = tmpResult_";
  protected final String TEXT_100 = ".getTimestamp(";
  protected final String TEXT_101 = ");" + NL + "\t\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_102 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_103 = ".";
  protected final String TEXT_104 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_105 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_106 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_107 = ".";
  protected final String TEXT_108 = " = tmpResult_";
  protected final String TEXT_109 = ".get";
  protected final String TEXT_110 = "(";
  protected final String TEXT_111 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_112 = NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t}";
  protected final String TEXT_113 = NL + "\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_114 = " = statement_";
  protected final String TEXT_115 = ".getString(";
  protected final String TEXT_116 = ");" + NL + "\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_117 = " != null && tmpString_";
  protected final String TEXT_118 = ".length() > 0) {" + NL + "\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_119 = ".";
  protected final String TEXT_120 = " = tmpString_";
  protected final String TEXT_121 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_122 = NL + "\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_123 = " = statement_";
  protected final String TEXT_124 = ".getTimestamp(";
  protected final String TEXT_125 = ");" + NL + "\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_126 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_127 = ".";
  protected final String TEXT_128 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_129 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_130 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_131 = ".";
  protected final String TEXT_132 = " = statement_";
  protected final String TEXT_133 = ".get";
  protected final String TEXT_134 = "(";
  protected final String TEXT_135 = ");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_136 = NL + "\t\t\t\t\t\t\t\t\tif (statement_";
  protected final String TEXT_137 = ".wasNull()) {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_138 = ".";
  protected final String TEXT_139 = " = null;" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_150 = NL + "\t\t// No code generated: define a schema for ";
