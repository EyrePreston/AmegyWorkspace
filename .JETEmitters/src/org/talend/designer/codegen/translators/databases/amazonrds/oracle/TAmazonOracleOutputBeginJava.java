...
public class TAmazonOracleOutputBeginJava {
  ...
  protected final String TEXT_42 = NL + "\t \t// TODO unable to parse integer: ";
  protected final String TEXT_43 = NL + "\t \t// TODO error: ";
  protected final String TEXT_44 = NL + "\t";
  protected final String TEXT_45 = NL + "\t/* initialize feature count */" + NL + "\tint nbFeature_";
  protected final String TEXT_46 = " = 0;" + NL + "\t" + NL + "\tjava.util.Map<String, com.vividsolutions.jts.geom.Envelope> geometryColumnToExtends = new java.util.HashMap<String, com.vividsolutions.jts.geom.Envelope>();" + NL + "\t";
  ...
  protected final String TEXT_79 = NL + "\t\tjava.lang.Class.forName(\"oracle.jdbc.OracleDriver\");" + NL + "\t\t";
  protected final String TEXT_80 = "\t" + NL + "\t";
  protected final String TEXT_81 = NL + "\t\tjava.lang.Class.forName(\"oracle.jdbc.driver.OracleDriver\");" + NL + "\t\t";
  ...
  protected final String TEXT_87 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_88 = " + \":\" + ";
  protected final String TEXT_89 = " + \":\" + ";
  protected final String TEXT_90 = ";" + NL + "\t\t";
  protected final String TEXT_91 = NL + "\t\turl_";
  protected final String TEXT_92 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_93 = " + \")(port=\" + ";
  protected final String TEXT_94 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_95 = " + \")))\";" + NL + "\t\t";
  protected final String TEXT_96 = NL + "\t    url_";
  protected final String TEXT_97 = " = \"jdbc:oracle:oci8:@\" + ";
  ...
  protected final String TEXT_112 = NL + "  \t" + NL + "\t" + NL + "\tString dbPwd_";
  protected final String TEXT_113 = " = decryptedPassword_";
  protected final String TEXT_114 = ";" + NL + "    dbschema_";
  ...
  protected final String TEXT_121 = "==null||\"\".equals(dbschema_";
  protected final String TEXT_122 = ")) //get schema from connection" + NL + "\t\t\t{" + NL + "\t\t\tdbschema_";
  protected final String TEXT_123 = "=conn_";
  protected final String TEXT_124 = ".getMetaData().getUserName();" + NL + "\t\t\t}" + NL + "\t" + NL + "\t";
  ...
  protected final String TEXT_146 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_147 = "\", conn_";
  protected final String TEXT_148 = ");" + NL + "\t" + NL + "\t";
  protected final String TEXT_149 = NL + "        conn_";
  protected final String TEXT_150 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_151 = " = ";
  protected final String TEXT_152 = ";        " + NL + "        int commitCounter_";
  protected final String TEXT_153 = " = 0;        ";
  protected final String TEXT_154 = NL + "   int batchSize_";
  protected final String TEXT_155 = " = ";
  protected final String TEXT_156 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_157 = "=0;";
  protected final String TEXT_158 = " " + NL;
  protected final String TEXT_159 = NL + "int count_";
  protected final String TEXT_160 = "=0;";
  protected final String TEXT_161 = NL + NL + "if(dbschema_";
  protected final String TEXT_162 = " == null || dbschema_";
  protected final String TEXT_163 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_164 = " = ";
  protected final String TEXT_165 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_166 = " = dbschema_";
  protected final String TEXT_167 = " + \".\" + ";
  protected final String TEXT_168 = ";    " + NL + "}";
  protected final String TEXT_169 = NL + "  \ttableName_";
  ...
  protected final String TEXT_477 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_478 = " = new StringBuffer(insert_";
  protected final String TEXT_479 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_480 = ".insert(insert_";
  protected final String TEXT_481 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_482 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_483 = " =insertStringBuffer_";
  protected final String TEXT_484 = ".toString(); ";
  protected final String TEXT_485 = "    \t    " + NL + "\t    " + NL + "        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_494 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_495 = " = new StringBuffer(update_";
  protected final String TEXT_496 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_497 = ".insert(update_";
  protected final String TEXT_498 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_499 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_500 = " =updateStringBuffer_";
  ...
  protected final String TEXT_548 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_549 = " = new StringBuffer(update_";
  protected final String TEXT_550 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_551 = ".insert(update_";
  protected final String TEXT_552 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_553 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_554 = " =updateStringBuffer_";
  protected final String TEXT_555 = ".toString(); ";
  protected final String TEXT_556 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_557 = " = conn_";
  protected final String TEXT_558 = ".prepareStatement(update_";
  protected final String TEXT_559 = ");\t    " + NL + "\t    String insert_";
  protected final String TEXT_560 = " = \"INSERT INTO \" + tableName_";
  ...
  protected final String TEXT_572 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_592 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_599 = " = update_";
  ...
  protected final String TEXT_604 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_605 = " = insert_";
  protected final String TEXT_606 = ".split(\"\\\\?\");";
  protected final String TEXT_607 = NL + "\t\t\tdelete_";
  protected final String TEXT_608 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_609 = " = delete_";
  protected final String TEXT_610 = ".split(\"\\\\?\");";
  protected final String TEXT_611 = NL + "\t\t\treplace_";
  protected final String TEXT_612 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_613 = " = replace_";
  protected final String TEXT_614 = ".split(\"\\\\?\");";
  protected final String TEXT_615 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_616 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_617 = " = insertIgnore_";
  protected final String TEXT_618 = ".split(\"\\\\?\");";
  protected final String TEXT_619 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_620 = " = insert_";
  protected final String TEXT_621 = ".split(\"\\\\?\");";
  protected final String TEXT_622 = NL + "\t   ";
  protected final String TEXT_623 = NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_624 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_625 = " = 0; " + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_626 = " = true;" + NL + "    \t";
  protected final String TEXT_627 = NL + NL + "\tclass ClobTypeUtil_";
  protected final String TEXT_628 = " {" + NL + "\t\tpublic Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "\t\t\toracle.sql.CLOB tempClob = null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\t// If the temporary CLOB has not yet been created, create one" + NL + "\t\t\t\ttempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "\t\t\t\t// Open the temporary CLOB in readwrite mode, to enable writing" + NL + "\t\t\t\ttempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "\t\t\t\t// Get the output stream to write" + NL + "\t\t\t\tjava.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "\t\t\t\tif(data instanceof oracle.sql.CLOB) {" + NL + "\t\t\t\t\toracle.sql.CLOB inClob = (oracle.sql.CLOB) data;" + NL + "\t\t\t        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "\t\t\t        char[] chs = new char[128];" + NL + "\t\t\t       \tint len = 0;" + NL + "\t\t\t\t\twhile ((len = inReader.read(chs)) != -1) {" + NL + "\t\t\t        \ttempClobWriter.write(chs, 0, len);" + NL + "\t\t\t        }" + NL + "\t\t\t    }else if(data instanceof String) {" + NL + "\t\t\t       // Write the data into the temporary CLOB" + NL + "\t\t\t\t\ttempClobWriter.write((String)data);" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\treturn data;" + NL + "\t\t\t\t}" + NL + "\t\t\t\t// Flush and close the stream" + NL + "\t\t\t\ttempClobWriter.flush();" + NL + "\t\t\t\ttempClobWriter.close();" + NL + "\t\t\t\t// Close the temporary CLOB" + NL + "\t\t\t\ttempClob.close();" + NL + "\t\t\t} catch( java.sql.SQLException sqlexp){" + NL + "\t  \t\t\t";
  protected final String TEXT_629 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\tsqlexp.printStackTrace();" + NL + "\t\t\t} catch(java.lang.Exception exp){" + NL + "\t  \t\t\t";
  protected final String TEXT_630 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\texp.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t\treturn tempClob;" + NL + "\t\t}" + NL + "\t}" + NL + "\tClobTypeUtil_";
  protected final String TEXT_631 = " clobTypeUtil_";
  protected final String TEXT_632 = "=new ClobTypeUtil_";
  protected final String TEXT_633 = "();";
  protected final String TEXT_634 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_635 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_636 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_642 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_643 = " =  null;";
  protected final String TEXT_644 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_645 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_646 = " = null;";
  protected final String TEXT_647 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_648 = " = null;";
  protected final String TEXT_649 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_650 = " = null;";
  protected final String TEXT_651 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_652 = " = null;";
  protected final String TEXT_653 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_654 = " = null;";
  protected final String TEXT_655 = NL + NL + NL + NL;
