...
public class TSQLiteInputBeginJava
{
  ...
  protected final String TEXT_179 = " = \"jdbc:sqlite:\" + \"/\" + ";
  protected final String TEXT_180 = ";";
  protected final String TEXT_181 = NL + "\t\t\t    String driverClass_";
  ...
  protected final String TEXT_197 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_198 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_199 = " = dataSources_";
  protected final String TEXT_200 = ".get(";
  protected final String TEXT_201 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_209 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_210 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  ...
  protected final String TEXT_251 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_263 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_344 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_345 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_350 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_351 = ".getColumnTypeName(i_";
  protected final String TEXT_352 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_353 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_354 = ".getClob(i_";
  protected final String TEXT_355 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_356 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_357 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_358 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_359 = ".add(tNTextImpl_";
  protected final String TEXT_360 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_361 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_362 = ".";
  protected final String TEXT_363 = ", rs_";
  protected final String TEXT_364 = ", fixedColumnCount_";
  protected final String TEXT_365 = ",list_";
  protected final String TEXT_366 = ");";
  protected final String TEXT_367 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_368 = ".";
  protected final String TEXT_369 = ", rs_";
  protected final String TEXT_370 = ", fixedColumnCount_";
  protected final String TEXT_371 = ");";
  protected final String TEXT_372 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_373 = ".";
  protected final String TEXT_374 = ", rs_";
  protected final String TEXT_375 = ", fixedColumnCount_";
  protected final String TEXT_376 = ");";
  protected final String TEXT_377 = NL + "                                  Object geom = rs_";
  protected final String TEXT_378 = ".getObject(";
  protected final String TEXT_379 = "column_index_";
  protected final String TEXT_380 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o = " + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_381 = ".";
  protected final String TEXT_382 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_383 = ".";
  protected final String TEXT_384 = " = null;" + NL + "                                  }";
  protected final String TEXT_385 = NL + "\t\t                          ";
  protected final String TEXT_386 = NL + "\t\t                    }";
  protected final String TEXT_387 = NL + "\t\t\t\t\t";
  protected final String TEXT_388 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_389 = " - Retrieving the record \" + nb_line_";
