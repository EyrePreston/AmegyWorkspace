...
public class TEXistXUpdateBeginJava
{
  ...
  protected final String TEXT_66 = NL + "\torg.xmldb.api.modules.XUpdateQueryService service_";
  protected final String TEXT_67 = " = (org.xmldb.api.modules.XUpdateQueryService) col_";
  protected final String TEXT_68 = ".getService(\"XUpdateQueryService\", \"1.0\");" + NL + "\tjava.io.File file_";
  protected final String TEXT_69 = " = new java.io.File(";
  protected final String TEXT_70 = ");" + NL + "\tjava.io.BufferedReader br_";
  protected final String TEXT_71 = " = new java.io.BufferedReader(new java.io.FileReader(file_";
  protected final String TEXT_72 = "));" + NL + "\tchar[] characters_";
  protected final String TEXT_73 = " = new char[new Long(file_";
  protected final String TEXT_74 = ".length()).intValue()];" + NL + "\tbr_";
  protected final String TEXT_75 = ".read(characters_";
  protected final String TEXT_76 = ", 0, new Long(file_";
  protected final String TEXT_77 = ".length()).intValue());" + NL + "\tbr_";
  protected final String TEXT_78 = ".close();" + NL + "\tString xUpdateModifications_";
  protected final String TEXT_79 = " = new String(characters_";
  protected final String TEXT_80 = ");" + NL + "\tservice_";
  protected final String TEXT_81 = ".update(xUpdateModifications_";
