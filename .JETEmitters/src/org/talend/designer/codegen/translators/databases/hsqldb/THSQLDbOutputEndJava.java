...
public class THSQLDbOutputEndJava
{
  ...
  protected final String TEXT_41 = NL + "    if (commitCounter_";
  protected final String TEXT_42 = " > 0) {";
  protected final String TEXT_43 = NL + "        conn_";
  protected final String TEXT_44 = ".commit();";
  ...
  protected final String TEXT_50 = ".close();" + NL + "            " + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_51 = " != null) {" + NL + "" + NL + "            pstmt_";
  ...
  protected final String TEXT_58 = NL + "        if(pstmt_";
  ...
  protected final String TEXT_65 = NL + "\tnb_line_deleted_";
  protected final String TEXT_66 = "=nb_line_deleted_";
  protected final String TEXT_67 = "+ deletedCount_";
  protected final String TEXT_68 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_69 = "=nb_line_update_";
  protected final String TEXT_70 = " + updatedCount_";
  protected final String TEXT_71 = ";" + NL + "\tnb_line_inserted_";
  ...
  protected final String TEXT_75 = "=nb_line_rejected_";
  protected final String TEXT_76 = " + rejectedCount_";
  protected final String TEXT_77 = ";" + NL + "\t";
  protected final String TEXT_78 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_79 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_80 = "_NB_LINE\",nb_line_";
  protected final String TEXT_81 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_82 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_83 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_84 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_85 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_86 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_87 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_88 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_89 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_90 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_91 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_106 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
