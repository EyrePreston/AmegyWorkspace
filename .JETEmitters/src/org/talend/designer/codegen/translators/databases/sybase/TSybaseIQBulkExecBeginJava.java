...
public class TSybaseIQBulkExecBeginJava {
  ...
  protected final String TEXT_67 = "\");" + NL + "\tString dbschema_";
  ...
  protected final String TEXT_79 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_90 = " = \"com.sybase.jdbc3.jdbc.SybDriver\";";
  protected final String TEXT_91 = NL + "\t\t\tString url_";
  protected final String TEXT_92 = " = \"jdbc:odbc:dsn=\"+";
  protected final String TEXT_93 = ";";
  protected final String TEXT_94 = NL + "\t\t\tString url_";
  protected final String TEXT_95 = " = \"jdbc:odbc:FileDSN=\"+";
  ...
  protected final String TEXT_101 = " = \"ianywhere.ml.jdbcodbc.IDriver\";";
  ...
  protected final String TEXT_115 = NL + NL + "\tString tableName_";
  ...
  protected final String TEXT_124 = NL + "int deletedCount_";
  ...
  protected final String TEXT_128 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_129 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_130 = " - Droping table ";
  ...
  protected final String TEXT_138 = " - Drop table ";
  ...
  protected final String TEXT_143 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_147 = " - Creating table ";
  ...
  protected final String TEXT_155 = " - Create table ";
  protected final String TEXT_156 = "\" + tableName_";
  protected final String TEXT_157 = " + \"";
  protected final String TEXT_158 = " has succeeded.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_182 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_183 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_184 = " = tableNameForSearch_";
  protected final String TEXT_185 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_186 = " = tableNameForSearch_";
  protected final String TEXT_187 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_188 = " = dbMetaData_";
  protected final String TEXT_189 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_190 = ", tableNameForSearch_";
  protected final String TEXT_191 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_192 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_193 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_194 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  ...
  protected final String TEXT_209 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_222 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_226 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_227 = ".equals(schema_";
  protected final String TEXT_228 = ") || (schema_";
  protected final String TEXT_229 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_230 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_293 = " - Creating table ";
  protected final String TEXT_294 = "\" + tableName_";
  ...
  protected final String TEXT_301 = " - Create table ";
  ...
  protected final String TEXT_306 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_312 = " - Droping table ";
  ...
  protected final String TEXT_320 = " - Drop table ";
  ...
  protected final String TEXT_325 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_329 = " - Creating table ";
  ...
  protected final String TEXT_337 = " - Create table ";
  ...
  protected final String TEXT_347 = " - Clearing table ";
  ...
  protected final String TEXT_355 = "- Clear table ";
  ...
  protected final String TEXT_370 = " - Trancating table ";
  ...
  protected final String TEXT_378 = " - Truncate table ";
  protected final String TEXT_379 = "\" + tableName_";
  protected final String TEXT_380 = " + \"";
  protected final String TEXT_381 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_382 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_383 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  ...
  protected final String TEXT_387 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_388 = ".close();" + NL + "\t\t";
  protected final String TEXT_389 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_390 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_391 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_392 = NL + "\t";
  protected final String TEXT_393 = NL + NL + "\t\tStringBuilder loadingCols_";
  protected final String TEXT_394 = " = new StringBuilder();";
  protected final String TEXT_395 = NL + "    \tloadingCols_";
  protected final String TEXT_396 = ".append(\"(\");";
  protected final String TEXT_397 = NL + "        loadingCols_";
  protected final String TEXT_398 = ".append(\"";
  protected final String TEXT_399 = "\" + \" \");";
  protected final String TEXT_400 = NL + "\t\tloadingCols_";
  protected final String TEXT_401 = ".append(\"ASCII(\" + ";
  protected final String TEXT_402 = " + \"),\");";
  protected final String TEXT_403 = NL + "        loadingCols_";
  protected final String TEXT_404 = ".append(\"'\" + ";
  protected final String TEXT_405 = " + \"'\" + \",\");";
  protected final String TEXT_406 = NL + "\t\tloadingCols_";
  protected final String TEXT_407 = ".append(\"ASCII(\" + ";
  protected final String TEXT_408 = " + \")\");";
  protected final String TEXT_409 = NL + "        \tloadingCols_";
  protected final String TEXT_410 = ".append(\"'\" + ";
  protected final String TEXT_411 = " + \"'\");";
  protected final String TEXT_412 = NL + "    loadingCols_";
  protected final String TEXT_413 = ".append(\")\");";
  protected final String TEXT_414 = " " + NL + "" + NL + "    java.sql.Statement stmt_";
  protected final String TEXT_415 = "=conn_";
  protected final String TEXT_416 = ".createStatement();" + NL + "    stmt_";
  protected final String TEXT_417 = ".execute(\"SET TEMPORARY OPTION ESCAPE_CHARACTER='ON'\");" + NL + "    " + NL + "    //stmt_";
  protected final String TEXT_418 = ".execute(\"SET TEMPORARY OPTION ALLOW_READ_CLIENT_FILE='ON'\");//sybaseIQ 15 whether is set?" + NL + "        " + NL + "    String strSQL_";
  protected final String TEXT_419 = " = \"LOAD TABLE \" + tableName_";
  protected final String TEXT_420 = " + loadingCols_";
  protected final String TEXT_421 = ".toString() ;";
  protected final String TEXT_422 = NL + "\t\tstrSQL_";
  protected final String TEXT_423 = " +=\" from '\" + ";
  protected final String TEXT_424 = " + \"' \";";
  protected final String TEXT_425 = NL + "\t\tstrSQL_";
  protected final String TEXT_426 = " +=\" USING CLIENT FILE '\" + ";
  protected final String TEXT_427 = " + \"' \";";
  protected final String TEXT_428 = NL + "    ";
  protected final String TEXT_429 = NL + "     strSQL_";
  protected final String TEXT_430 = " = strSQL_";
  protected final String TEXT_431 = " + \" row delimited by '\" + ";
  protected final String TEXT_432 = " + \"'\";    " + NL + "\t strSQL_";
  protected final String TEXT_433 = "=strSQL_";
  protected final String TEXT_434 = " + \" quotes off\";";
  protected final String TEXT_435 = NL + "\tstrSQL_";
  protected final String TEXT_436 = "=strSQL_";
  protected final String TEXT_437 = " + \" quotes on \";";
  protected final String TEXT_438 = NL + "\tstrSQL_";
  protected final String TEXT_439 = "=strSQL_";
  protected final String TEXT_440 = " + \" quotes off \";";
  protected final String TEXT_441 = NL + "    strSQL_";
  protected final String TEXT_442 = " =strSQL_";
  protected final String TEXT_443 = " + \" escapes off \";" + NL + "    ";
  protected final String TEXT_444 = NL + "\tstrSQL_";
  protected final String TEXT_445 = " =strSQL_";
  protected final String TEXT_446 = " + \" skip 1 \";";
  protected final String TEXT_447 = NL + "\t\tlog.info(\"";
  protected final String TEXT_448 = " - Bulk load SQL:\"+strSQL_";
  protected final String TEXT_449 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_450 = " - Bulk loading data into ";
  protected final String TEXT_451 = "\" + tableName_";
  protected final String TEXT_452 = " + \"";
  protected final String TEXT_453 = ".\" );" + NL + "\t";
  protected final String TEXT_454 = NL + "    " + NL + "    stmt_";
  protected final String TEXT_455 = ".execute(strSQL_";
  protected final String TEXT_456 = ");" + NL;
  protected final String TEXT_457 = NL + "    if(conn_";
  protected final String TEXT_458 = " != null && !conn_";
  protected final String TEXT_459 = ".isClosed()) {";
