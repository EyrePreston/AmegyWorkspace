...
public class THSQLDbOutputMainJava {
  ...
  protected final String TEXT_237 = ".executeUpdate();  " + NL + "         \t\t\tnb_line_";
  protected final String TEXT_238 = "++;";
  protected final String TEXT_239 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_240 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_241 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_242 = " = true;";
  protected final String TEXT_243 = NL + "                        throw(e);";
  ...
  protected final String TEXT_271 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_272 = " = deletedCount_";
  protected final String TEXT_273 = " + pstmt_";
  protected final String TEXT_274 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_275 = "++;";
  protected final String TEXT_276 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_317 = "=0;" + NL + "            " + NL + "            }" + NL + "        ";
