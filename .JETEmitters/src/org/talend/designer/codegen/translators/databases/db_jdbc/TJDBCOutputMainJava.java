...
public class TJDBCOutputMainJava {
  ...
  protected final String TEXT_104 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_105 = "++;    \t\t " + NL + "\t\t\t";
  protected final String TEXT_106 = NL + "    \t\t  \tbatchSizeCounter_";
  ...
  protected final String TEXT_152 = "_QUERY\", query_";
  protected final String TEXT_153 = ".toString().trim());";
  protected final String TEXT_154 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_155 = " = updatedCount_";
  protected final String TEXT_156 = " + pstmtUpdate_";
  protected final String TEXT_157 = ".executeUpdate();" + NL + "        \t\t\tnb_line_";
  ...
  protected final String TEXT_172 = NL + "                            rejectedCount_";
  protected final String TEXT_173 = " = rejectedCount_";
  ...
  protected final String TEXT_181 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_192 = ".executeUpdate();" + NL + "                    nb_line_";
  ...
  protected final String TEXT_207 = NL + "                            rejectedCount_";
  protected final String TEXT_208 = " = rejectedCount_";
  protected final String TEXT_209 = " + 1;";
  protected final String TEXT_210 = NL + "                            ";
  protected final String TEXT_211 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_217 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_230 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_231 = " = pstmtUpdate_";
  protected final String TEXT_232 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_233 = " = updatedCount_";
  protected final String TEXT_234 = " + updateFlag_";
  protected final String TEXT_235 = ";" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_246 = NL + "                    insertedCount_";
  ...
  protected final String TEXT_251 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  ...
  protected final String TEXT_256 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_266 = NL + "                            rejectedCount_";
  protected final String TEXT_267 = " = rejectedCount_";
  ...
  protected final String TEXT_284 = ".addBatch();" + NL + "    \t\t\tnb_line_";
  protected final String TEXT_285 = "++;" + NL + "    \t\t\t";
  protected final String TEXT_286 = NL + "    \t\t  \tbatchSizeCounter_";
  protected final String TEXT_287 = "++;";
  protected final String TEXT_288 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_289 = " = deletedCount_";
  protected final String TEXT_290 = " + pstmt_";
  protected final String TEXT_291 = ".executeUpdate();" + NL + "            \tnb_line_";
  protected final String TEXT_292 = "++;" + NL + "            \t";
  protected final String TEXT_293 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_316 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_327 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_328 = " <= batchSizeCounter_";
  protected final String TEXT_329 = ") {                ";
  protected final String TEXT_330 = "                                                " + NL + "\t\t\t\t\tint[] status_";
  protected final String TEXT_331 = " = null;" + NL + "\t\t\t\t\tint countSum_";
  protected final String TEXT_332 = " = 0;" + NL + "\t                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_333 = " = 0;" + NL + "            \t    \t";
  protected final String TEXT_334 = NL + "\t\t\t\t\t\tstatus_";
  protected final String TEXT_335 = " = pstmt_";
  protected final String TEXT_336 = ".executeBatch();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_337 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_338 = ": status_";
  protected final String TEXT_339 = ") {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_340 = " += (countEach_";
  protected final String TEXT_341 = " < 0 ? 0 : countEach_";
  protected final String TEXT_342 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t                }catch (java.sql.BatchUpdateException e){" + NL + "\t                \t";
  protected final String TEXT_343 = NL + "\t                \t\tthrow(e);" + NL + "\t                \t";
  protected final String TEXT_344 = NL + "\t                \tfor(int countEach_";
  protected final String TEXT_345 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_346 = " += (countEach_";
  protected final String TEXT_347 = " < 0 ? 0 : countEach_";
  protected final String TEXT_348 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_349 = NL + "\t                \tSystem.err.println(e.getMessage());" + NL + "\t                \t";
  protected final String TEXT_350 = NL + "\t                }" + NL + "\t                try {" + NL + "        \t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_351 = " = pstmt_";
  protected final String TEXT_352 = ".getUpdateCount();" + NL + "\t\t\t\t\t}catch (java.sql.SQLException e){" + NL + "\t                \t" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_353 = " = tmp_batchUpdateCount_";
  protected final String TEXT_354 = " > countSum_";
  protected final String TEXT_355 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_356 = " : countSum_";
  protected final String TEXT_357 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_358 = NL + "\t    \t    \t\tinsertedCount_";
  protected final String TEXT_359 = " += tmp_batchUpdateCount_";
  protected final String TEXT_360 = "; " + NL + "\t    \t    \t";
  protected final String TEXT_361 = NL + "\t    \t    \t\tupdatedCount_";
  protected final String TEXT_362 = " += tmp_batchUpdateCount_";
  protected final String TEXT_363 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_364 = NL + "\t    \t    \t    deletedCount_";
  ...
  protected final String TEXT_369 = "++;            " + NL + "                if (commitEvery_";
  protected final String TEXT_370 = " <= commitCounter_";
  protected final String TEXT_371 = ") {" + NL + "                \t";
  protected final String TEXT_372 = NL + "                    connection_";
  protected final String TEXT_373 = ".commit();";
  protected final String TEXT_374 = NL + "                    commitCounter_";
