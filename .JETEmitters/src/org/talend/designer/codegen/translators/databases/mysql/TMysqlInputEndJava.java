...
public class TMysqlInputEndJava
{
  ...
  protected final String TEXT_65 = NL + "\t}" + NL + "}finally{" + NL + "\tif(rs_";
  protected final String TEXT_66 = " !=null){" + NL + "\t\trs_";
  protected final String TEXT_67 = ".close();" + NL + "\t}" + NL + "\tstmt_";
  protected final String TEXT_68 = ".close();";
  protected final String TEXT_69 = NL + "\t\tif(conn_";
  protected final String TEXT_70 = " != null && !conn_";
  protected final String TEXT_71 = ".isClosed()) {" + NL + "\t\t\t";
