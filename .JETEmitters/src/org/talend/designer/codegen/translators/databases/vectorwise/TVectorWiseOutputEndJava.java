...
public class TVectorWiseOutputEndJava
{
  ...
  protected final String TEXT_54 = "                " + NL + "            try {" + NL + "\t\t\t\tint countSum_";
  protected final String TEXT_55 = " = 0;" + NL + "\t\t\t\tif (pstmt_";
  protected final String TEXT_56 = " != null) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_57 = NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_58 = ": pstmt_";
  protected final String TEXT_59 = ".executeBatch()) {" + NL + "\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_60 = " == -2 || countEach_";
  protected final String TEXT_61 = " == -3) {" + NL + "\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_62 = " += countEach_";
  protected final String TEXT_63 = ";" + NL + "\t\t\t\t\t}    " + NL + "\t\t\t\t\t";
  protected final String TEXT_64 = "         \t" + NL + "\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_65 = " += countSum_";
  protected final String TEXT_66 = "; " + NL + "            }catch (java.sql.BatchUpdateException e){" + NL + "            \t";
  protected final String TEXT_67 = NL + "            \t\tthrow(e);" + NL + "            \t";
  protected final String TEXT_68 = NL + "            \tint countSum_";
  protected final String TEXT_69 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_70 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_71 = " += (countEach_";
  protected final String TEXT_72 = " < 0 ? 0 : countEach_";
  protected final String TEXT_73 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t    \t\tinsertedCount_";
  ...
  protected final String TEXT_80 = ".close();" + NL + "            }        " + NL + "        \t";
  ...
  protected final String TEXT_92 = NL + NL + "\tint rejectedCount_";
  protected final String TEXT_93 = " = 0;";
  protected final String TEXT_94 = NL + "\tnb_line_deleted_";
  protected final String TEXT_95 = "=nb_line_deleted_";
  protected final String TEXT_96 = "+ deletedCount_";
  protected final String TEXT_97 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_98 = "=nb_line_update_";
  protected final String TEXT_99 = " + updatedCount_";
  protected final String TEXT_100 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_101 = "=nb_line_inserted_";
  protected final String TEXT_102 = " + insertedCount_";
  protected final String TEXT_103 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_104 = "=nb_line_rejected_";
  protected final String TEXT_105 = " + rejectedCount_";
  protected final String TEXT_106 = ";" + NL + "\t";
  protected final String TEXT_107 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_108 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_109 = "_NB_LINE\",nb_line_";
  protected final String TEXT_110 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_111 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_112 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_113 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_114 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_115 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_116 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_117 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_118 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_119 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_120 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_123 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_126 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_129 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_130 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_131 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_132 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_135 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
