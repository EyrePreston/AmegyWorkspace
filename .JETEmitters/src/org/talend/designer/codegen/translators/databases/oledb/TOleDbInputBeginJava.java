...
public class TOleDbInputBeginJava
{
  ...
  protected final String TEXT_39 = NL + "org.talend.net.Object conn_";
  protected final String TEXT_40 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_41 = ",";
  protected final String TEXT_42 = ", " + NL + "new java.lang.Object[] { ";
  protected final String TEXT_43 = NL;
  protected final String TEXT_44 = " " + NL + "});" + NL;
  protected final String TEXT_45 = NL + "conn_";
  protected final String TEXT_46 = ".invokeGeneric(\"Open\");";
  protected final String TEXT_47 = NL + NL + "org.talend.net.Object cmd_";
  protected final String TEXT_48 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_49 = ",\"System.Data.OleDb.OleDbCommand\"," + NL + "new java.lang.Object[] { ";
  protected final String TEXT_50 = NL;
  protected final String TEXT_51 = NL + ", " + NL + "conn_";
  protected final String TEXT_52 = " " + NL + "});" + NL + "" + NL + "org.talend.net.Object reader_";
  protected final String TEXT_53 = " = cmd_";
  protected final String TEXT_54 = ".invoke(\"ExecuteReader\");";
  protected final String TEXT_55 = NL + "               //";
  protected final String TEXT_56 = NL + "               Integer id";
  protected final String TEXT_57 = "_";
  protected final String TEXT_58 = " = (Integer)reader_";
  protected final String TEXT_59 = ".invokeGeneric(\"GetOrdinal\"," + NL + "               new java.lang.Object[] { \"";
  protected final String TEXT_60 = "\" });" + NL + "                ";
  protected final String TEXT_61 = NL + "class TypeConverter_";
  protected final String TEXT_62 = " {" + NL + "    void doConversion(Object val, Object targetStruct, String colName) {" + NL + "            try {" + NL + "            java.lang.reflect.Field f = targetStruct.getClass().getField(colName);" + NL + "            f.setAccessible(true);" + NL + "            f.set(targetStruct,val);" + NL + "          } catch (java.lang.Exception ex) {" + NL + "            throw new RuntimeException(\"Can not convert value of type: \"+val.getClass().getName()+\" to target column\");" + NL + "          }" + NL + "    }" + NL + "}" + NL + "Boolean oBool_";
  protected final String TEXT_63 = " = (Boolean)reader_";
  protected final String TEXT_64 = ".invokeGeneric(\"Read\");" + NL + "boolean bool_";
  protected final String TEXT_65 = " = oBool_";
  protected final String TEXT_66 = " != null && oBool_";
  protected final String TEXT_67 = ".booleanValue();" + NL + "java.lang.Object val_";
  protected final String TEXT_68 = ";" + NL + "int nb_line_";
  protected final String TEXT_69 = " = 0;" + NL + "while (bool_";
