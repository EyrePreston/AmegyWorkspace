...
public class TMSSqlRowBeginJava
{
  ...
  protected final String TEXT_116 = NL + "\t\t\tString port_";
  protected final String TEXT_117 = " = ";
  protected final String TEXT_118 = ";" + NL + "\t\t    String dbname_";
  protected final String TEXT_119 = " = ";
  protected final String TEXT_120 = " ;" + NL + "\t\t    String url_";
  protected final String TEXT_121 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_122 = " ; " + NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_123 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_124 = " += \":\" + ";
  protected final String TEXT_125 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  protected final String TEXT_126 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_127 = " += \"//\" + ";
  protected final String TEXT_128 = "; " + NL + "\t\t    }" + NL + "\t\t    url_";
  protected final String TEXT_129 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_130 = ";" + NL + "\t\t";
  protected final String TEXT_131 = NL + "\t\t\t\t\tString dbschema_";
  ...
  protected final String TEXT_137 = NL + "\t\t        String  tableName_";
  protected final String TEXT_138 = " = null;" + NL + "\t\t        if(dbschema_";
  protected final String TEXT_139 = " == null || dbschema_";
  protected final String TEXT_140 = ".trim().length() == 0) {" + NL + "\t\t            tableName_";
  protected final String TEXT_141 = " = \"[\" + ";
  protected final String TEXT_142 = " + \"]\";" + NL + "\t\t        } else {" + NL + "\t\t            tableName_";
  protected final String TEXT_143 = " = \"[\" + dbschema_";
  protected final String TEXT_144 = " + \"].[\" + ";
  protected final String TEXT_145 = " + \"]\";" + NL + "\t\t        }" + NL + "\t\t        stmt_";
  protected final String TEXT_146 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_147 = " +\" ON\");" + NL + "\t\t\t";
  protected final String TEXT_148 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_149 = " = null;" + NL + "\tString query_";
  protected final String TEXT_150 = " = \"\";" + NL + "\tboolean whetherReject_";
