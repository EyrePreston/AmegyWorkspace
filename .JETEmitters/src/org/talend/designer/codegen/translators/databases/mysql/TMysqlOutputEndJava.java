...
public class TMysqlOutputEndJava {
  ...
  protected final String TEXT_183 = "++;" + NL + "\t        }        " + NL + "\t        try{" + NL + "\t        \tinsertedCount_";
  protected final String TEXT_184 = " = insertedCount_";
  protected final String TEXT_185 = " + pstmt_";
  protected final String TEXT_186 = ".executeUpdate();" + NL + "\t        }catch(java.lang.Exception e){" + NL + "\t        \t";
  protected final String TEXT_187 = NL + "\t       \t\tthrow e;" + NL + "\t        \t";
  protected final String TEXT_188 = NL + "\t        \t\tSystem.err.println(e.getMessage());" + NL + "\t        \t";
  protected final String TEXT_189 = NL + "\t        }" + NL + "\t    }";
  protected final String TEXT_190 = "                                                " + NL + "                try {" + NL + "                \t\tif (batchSizeCounter_";
  protected final String TEXT_191 = " != 0) {" + NL + "\t\t\t\t\t\t\tint countSum_";
  protected final String TEXT_192 = " = 0;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_193 = NL + "\t\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_194 = ": pstmt_";
  protected final String TEXT_195 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_196 = " += (countEach_";
  protected final String TEXT_197 = " < 0 ? 0 : 1);" + NL + "\t\t\t\t\t\t\t}                \t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_198 = "       \t" + NL + "\t            \t    \t";
  protected final String TEXT_199 = NL + "\t            \t    \t\tinsertedCount_";
  protected final String TEXT_200 = " += countSum_";
  protected final String TEXT_201 = ";" + NL + "\t            \t    \t";
  protected final String TEXT_202 = "                         \t    \t" + NL + "            \t    \t}" + NL + "            \t    \t\t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  ...
  protected final String TEXT_230 = "                " + NL + "    try {" + NL + "    \tif(pstmt_";
  protected final String TEXT_231 = " != null){" + NL + "\t\t\tint countSum_";
  protected final String TEXT_232 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_233 = NL + "\t\t\tfor(int countEach_";
  protected final String TEXT_234 = ": pstmt_";
  protected final String TEXT_235 = ".executeBatch()) {" + NL + "\t\t\t\tcountSum_";
  ...
  protected final String TEXT_246 = "            \t    " + NL + "\t    }" + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  ...
  protected final String TEXT_260 = NL + "    \tSystem.err.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_261 = "                \t" + NL + "\t}                                  ";
  protected final String TEXT_262 = "  " + NL + "    " + NL + "        if(pstmt_";
  protected final String TEXT_263 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_264 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_265 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_266 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
...
DBLogUtil dbLog = null;
    ...
    if ((rejectConnName==null && "MYSQL_5".equals(dbVersion) && useBatchSize) && (("UPDATE").equals(dataAction) || ("DELETE").equals(dataAction))) {
