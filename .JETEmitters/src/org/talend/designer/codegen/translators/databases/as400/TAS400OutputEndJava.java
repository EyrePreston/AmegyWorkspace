...
public class TAS400OutputEndJava
{
  ...
  protected final String TEXT_55 = " >0) { " + NL + "    try {" + NL + "    \t";
  protected final String TEXT_56 = NL + "            pstmt_";
  protected final String TEXT_57 = ".executeBatch();";
  ...
  protected final String TEXT_71 = NL + "    }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_72 = "){";
  protected final String TEXT_73 = NL + "            throw(e_";
  protected final String TEXT_74 = ");";
  protected final String TEXT_75 = "                          " + NL + "                int countSum_";
  protected final String TEXT_76 = " = 0;" + NL + "                for(int countEach_";
  protected final String TEXT_77 = ": e_";
  protected final String TEXT_78 = ".getUpdateCounts()) {" + NL + "                    countSum_";
  protected final String TEXT_79 = " += (countEach_";
  protected final String TEXT_80 = " < 0 ? 0 : countEach_";
  protected final String TEXT_81 = ");" + NL + "                }";
  protected final String TEXT_82 = "                          " + NL + "                updatedCount_";
  protected final String TEXT_83 = " += countSum_";
  protected final String TEXT_84 = ";";
  protected final String TEXT_85 = NL + "                deletedCount_";
  ...
  protected final String TEXT_91 = NL + "            tmp_batchUpdateCount_";
  protected final String TEXT_92 = " = pstmt_";
  protected final String TEXT_93 = ".getUpdateCount();" + NL + "            insertedCount_";
  protected final String TEXT_94 = "+= (tmp_batchUpdateCount_";
  protected final String TEXT_95 = " >0 ? tmp_batchUpdateCount_";
  protected final String TEXT_96 = ":0);";
  protected final String TEXT_97 = " " + NL + "    }";
  protected final String TEXT_98 = "   " + NL + "                " + NL + "        if(pstmt_";
  protected final String TEXT_99 = " != null) {" + NL + "" + NL + "            pstmt_";
  ...
  protected final String TEXT_109 = " .close();" + NL + "        resourceMap.put(\"finish_";
