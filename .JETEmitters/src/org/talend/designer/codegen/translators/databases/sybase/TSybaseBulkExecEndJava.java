...
public class TSybaseBulkExecEndJava {
  ...
  protected final String TEXT_68 = " = \"tmp_";
  protected final String TEXT_69 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        if(dbschema_";
  protected final String TEXT_70 = " != null && dbschema_";
  protected final String TEXT_71 = ".trim().length() != 0) {" + NL + "    \t\ttmpTableName_";
  protected final String TEXT_72 = "=dbschema_";
  protected final String TEXT_73 = " + \".\" + tmpTableName_";
  protected final String TEXT_74 = ";" + NL + "    \t}" + NL + "        java.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_89 = ".close();" + NL + "        tableName_";
  protected final String TEXT_90 = " = tmpTableName_";
  ...
  protected final String TEXT_112 = ".isClosed()) {" + NL + "\t        ";
