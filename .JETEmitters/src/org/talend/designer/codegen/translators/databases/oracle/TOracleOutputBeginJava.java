...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_41 = NL + "    \t \t// TODO unable to parse integer: ";
  protected final String TEXT_42 = NL + "    \t \t// TODO error: ";
  protected final String TEXT_43 = NL + "    \t\t";
  protected final String TEXT_44 = NL + "    \t/* initialize feature count */" + NL + "    \tint nbFeature_";
  protected final String TEXT_45 = " = 0;" + NL + "    \t" + NL + "    \tjava.util.Map<String, com.vividsolutions.jts.geom.Envelope> geometryColumnToExtends = new java.util.HashMap<String, com.vividsolutions.jts.geom.Envelope>();";
  ...
  protected final String TEXT_51 = " < 1) {" + NL + "                throw new RuntimeException(\"For update, the schema must have a key\");" + NL + "            }";
  protected final String TEXT_52 = NL + "            int deleteKeyCount_";
  protected final String TEXT_53 = " = ";
  protected final String TEXT_54 = ";" + NL + "            if(deleteKeyCount_";
  protected final String TEXT_55 = " < 1) {" + NL + "                throw new RuntimeException(\"For delete, the schema must have a key\");" + NL + "            }";
  ...
  protected final String TEXT_61 = " = 0;" + NL + "    " + NL + "    int tmp_batchUpdateCount_";
  ...
  protected final String TEXT_94 = " = \"oracle.jdbc.OracleDriver\";" + NL + "        \t\t";
  protected final String TEXT_95 = NL + "        \t\t\tString driverClass_";
  protected final String TEXT_96 = " = \"oracle.jdbc.driver.OracleDriver\";" + NL + "        \t\t";
  ...
  protected final String TEXT_143 = ".getMetaData().getUserName();" + NL + "        \t\t\t}" + NL + "    \t\t" + NL + "    \t\t\t";
  ...
  protected final String TEXT_167 = NL + "    \tresourceMap.put(\"conn_";
  protected final String TEXT_168 = "\", conn_";
  protected final String TEXT_169 = ");" + NL + "    \t";
  protected final String TEXT_170 = NL + "            conn_";
  protected final String TEXT_171 = ".setAutoCommit(false);" + NL + "            int commitEvery_";
  protected final String TEXT_172 = " = ";
  protected final String TEXT_173 = ";        " + NL + "            int commitCounter_";
  protected final String TEXT_174 = " = 0;        ";
  protected final String TEXT_175 = NL + "    \t\tint batchSize_";
  protected final String TEXT_176 = " = ";
  protected final String TEXT_177 = ";" + NL + "       \t\tint batchSizeCounter_";
  protected final String TEXT_178 = "=0;" + NL + "    \t";
  protected final String TEXT_179 = NL + "    \tint count_";
  protected final String TEXT_180 = "=0;";
  protected final String TEXT_181 = NL + "    " + NL + "        if(dbschema_";
  protected final String TEXT_182 = " == null || dbschema_";
  protected final String TEXT_183 = ".trim().length() == 0) {" + NL + "            tableName_";
  protected final String TEXT_184 = " = ";
  protected final String TEXT_185 = ";" + NL + "        } else {" + NL + "            tableName_";
  ...
  protected final String TEXT_283 = ".close();" + NL + "    \t            " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_403 = ".close();            " + NL + "                    \t\t\t}                " + NL + "    \t\t\t\t\t\t";
  ...
  protected final String TEXT_434 = ", true);" + NL + "    " + NL + "    \t\t\t\t\t} // end of if" + NL + "    \t\t\t\t} // end synchronized" + NL + "    \t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_512 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_513 = " = conn_";
  protected final String TEXT_514 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_515 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_516 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_517 = ",insert_";
  protected final String TEXT_518 = ",keyPsmt_";
  ...
  protected final String TEXT_539 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_607 = NL + "        \t    String delete_";
  protected final String TEXT_608 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_609 = " + \" WHERE ";
  protected final String TEXT_610 = "\";" + NL + "        \t    ";
  protected final String TEXT_611 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_612 = " = new StringBuffer(delete_";
  protected final String TEXT_613 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_614 = ".insert(delete_";
  protected final String TEXT_615 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_616 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_617 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_621 = ".prepareStatement(delete_";
  protected final String TEXT_622 = ");" + NL + "        \t";
  protected final String TEXT_623 = NL + "                StringBuffer query_";
  ...
  protected final String TEXT_647 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_648 = " = insertIgnore_";
  protected final String TEXT_649 = ".split(\"\\\\?\");";
  protected final String TEXT_650 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_651 = " = insert_";
  protected final String TEXT_652 = ".split(\"\\\\?\");";
  protected final String TEXT_653 = NL + "        \t";
  protected final String TEXT_654 = NL + "            \t// Initialize SRID" + NL + "            \tint SRID_";
  protected final String TEXT_655 = " = 0;" + NL + "            \tint dimension_";
  protected final String TEXT_656 = " = 0; " + NL + "            \tboolean firstGeometry_";
  protected final String TEXT_657 = " = true;";
  protected final String TEXT_658 = NL + "    \t\t" + NL + "\t\tclass ClobTypeUtil_";
  protected final String TEXT_659 = " {" + NL + "\t\t\tpublic Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "\t\t\t\toracle.sql.CLOB tempClob = null;" + NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\t// If the temporary CLOB has not yet been created, create one" + NL + "\t\t\t\t\ttempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "\t\t\t\t\t// Open the temporary CLOB in readwrite mode, to enable writing" + NL + "\t\t\t\t\ttempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "\t\t\t\t\t// Get the output stream to write" + NL + "\t\t\t\t\tjava.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "\t\t\t\t\tif(data instanceof oracle.sql.CLOB) {" + NL + "\t\t\t\t\t\toracle.sql.CLOB inClob = (oracle.sql.CLOB) data;" + NL + "\t\t\t\t        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "\t\t\t\t        char[] chs = new char[128];" + NL + "\t\t\t\t       \tint len = 0;" + NL + "\t\t\t\t\t\twhile ((len = inReader.read(chs)) != -1) {" + NL + "\t\t\t\t        \ttempClobWriter.write(chs, 0, len);" + NL + "\t\t\t\t        }" + NL + "\t\t\t\t    }else if(data instanceof String) {" + NL + "\t\t\t\t       // Write the data into the temporary CLOB" + NL + "\t\t\t\t\t\ttempClobWriter.write((String)data);" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\treturn data;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t// Flush and close the stream" + NL + "\t\t\t\t\ttempClobWriter.flush();" + NL + "\t\t\t\t\ttempClobWriter.close();" + NL + "\t\t\t\t\t// Close the temporary CLOB" + NL + "\t\t\t\t\ttempClob.close();" + NL + "\t\t\t\t} catch( java.sql.SQLException sqlexp){" + NL + "    \t\t  \t";
  protected final String TEXT_660 = NL + "\t\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\t\tsqlexp.printStackTrace();" + NL + "\t\t\t\t} catch(java.lang.Exception exp){" + NL + "    \t\t  \t";
  protected final String TEXT_661 = NL + "\t\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\t\texp.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t\treturn tempClob;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tClobTypeUtil_";
  protected final String TEXT_662 = " clobTypeUtil_";
  protected final String TEXT_663 = "=new ClobTypeUtil_";
  protected final String TEXT_664 = "();" + NL + "\t";
  protected final String TEXT_665 = NL + "    \tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_666 = " =null;" + NL + "    \tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_667 = " =null;" + NL + "    \tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_668 = " =null;" + NL + "    \t";
  protected final String TEXT_669 = NL + "    \t\tStringBuffer query_";
  protected final String TEXT_670 = " = null;" + NL + "    \t\t";
  ...
  protected final String TEXT_675 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_676 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_680 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_681 = " = null;";
  protected final String TEXT_682 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_687 = NL + NL + NL + NL;
...
DBLogUtil dbLog = null;
    ...
    for(Column column : stmtStructure) {
    	...
    	if (column.getColumn()!= null) {
    		...
    		if ("CLOB".equals(column.getColumn().getType()) && typeToGenerate.equals("Object") && !column.isDynamic()) {
    			clobTypeExist = true;
    		}
    	}
    }
