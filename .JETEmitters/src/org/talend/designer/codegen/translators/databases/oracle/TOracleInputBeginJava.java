...
public class TOracleInputBeginJava
{
  ...
  protected final String TEXT_183 = NL + "\t\t\t\turl_";
  protected final String TEXT_184 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_185 = " + \":\" + ";
  protected final String TEXT_186 = " + \":\" + ";
  protected final String TEXT_187 = ";";
  protected final String TEXT_188 = NL + "\t\t\t\turl_";
  protected final String TEXT_189 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_190 = " + \")(port=\" + ";
  protected final String TEXT_191 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_192 = " + \")))\";";
  protected final String TEXT_193 = NL + "\t\t\t\turl_";
  protected final String TEXT_194 = " = \"jdbc:oracle:oci8:@\" + ";
  ...
  protected final String TEXT_201 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\tif (null != dataSources_";
  protected final String TEXT_202 = ") {" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_203 = " = dataSources_";
  protected final String TEXT_204 = ".get(";
  protected final String TEXT_205 = ").getConnection();" + NL + "\t\t\t\t} else {";
  ...
  protected final String TEXT_247 = NL + "\t\t\t\tjava.sql.Statement stmtGetTZ_";
  protected final String TEXT_248 = " = conn_";
  protected final String TEXT_249 = ".createStatement();" + NL + "\t\t\t\tjava.sql.ResultSet rsGetTZ_";
  protected final String TEXT_250 = " = stmtGetTZ_";
  protected final String TEXT_251 = ".executeQuery(\"select sessiontimezone from dual\");" + NL + "\t\t\t\tString sessionTimezone_";
  protected final String TEXT_252 = " = java.util.TimeZone.getDefault().getID();" + NL + "\t\t\t\twhile (rsGetTZ_";
  protected final String TEXT_253 = ".next()) {" + NL + "\t\t\t\t\tsessionTimezone_";
  protected final String TEXT_254 = " = rsGetTZ_";
  protected final String TEXT_255 = ".getString(1);" + NL + "\t\t\t\t}" + NL + "\t\t\t\t((oracle.jdbc.OracleConnection)conn_";
  protected final String TEXT_256 = ").setSessionTimeZone(sessionTimezone_";
  protected final String TEXT_257 = ");";
  protected final String TEXT_258 = NL + "\t\t\t\tif(((oracle.jdbc.OracleConnection)conn_";
  protected final String TEXT_259 = ").getSessionTimeZone() == null){" + NL + "\t\t\t\t\tjava.sql.Statement stmtGetTZ_";
  protected final String TEXT_260 = " = conn_";
  protected final String TEXT_261 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsGetTZ_";
  protected final String TEXT_262 = " = stmtGetTZ_";
  protected final String TEXT_263 = ".executeQuery(\"select sessiontimezone from dual\");" + NL + "\t\t\t\t\tString sessionTimezone_";
  protected final String TEXT_264 = " = java.util.TimeZone.getDefault().getID();" + NL + "\t\t\t\t\twhile (rsGetTZ_";
  protected final String TEXT_265 = ".next()) {" + NL + "\t\t\t\t\t\tsessionTimezone_";
  protected final String TEXT_266 = " = rsGetTZ_";
  protected final String TEXT_267 = ".getString(1);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t((oracle.jdbc.OracleConnection)conn_";
  protected final String TEXT_268 = ").setSessionTimeZone(sessionTimezone_";
  protected final String TEXT_269 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_270 = NL + "                stmt_";
  protected final String TEXT_271 = ".setFetchSize(";
  protected final String TEXT_272 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_273 = NL + "\t\t\t\tjava.io.Reader reader_";
  protected final String TEXT_274 = " = rs_";
  protected final String TEXT_275 = ".getCharacterStream(";
  ...
  protected final String TEXT_297 = "column_index_";
  protected final String TEXT_298 = ");" + NL + "\t\t\t        if(tmpContent_";
  protected final String TEXT_299 = " != null) {" + NL + "\t\t\t            ";
  protected final String TEXT_300 = ".";
  protected final String TEXT_301 = " = tmpContent_";
  protected final String TEXT_302 = ";" + NL + "\t\t\t        } else {" + NL + "\t\t\t            ";
  protected final String TEXT_303 = ".";
  protected final String TEXT_304 = " = null;" + NL + "\t\t\t        }                 \t                    ";
  protected final String TEXT_305 = NL + "\t\t\tbyte [] tmpBytes_";
  protected final String TEXT_306 = " = rs_";
  protected final String TEXT_307 = ".getBytes(";
  protected final String TEXT_308 = "column_index_";
  protected final String TEXT_309 = ");" + NL + "\t\t\tif(tmpBytes_";
  protected final String TEXT_310 = " != null) {" + NL + "\t\t\t\t";
  protected final String TEXT_311 = ".";
  protected final String TEXT_312 = " = tmpBytes_";
  protected final String TEXT_313 = ";" + NL + "\t\t\t} else {" + NL + "\t\t\t\t";
  protected final String TEXT_314 = ".";
  protected final String TEXT_315 = " = null;" + NL + "\t\t\t}\t\t";
  protected final String TEXT_316 = NL + "    \t\t\tTalendTimestampWithTZ talendTimestampWithTZ = null;" + NL + "    \t\t\tif(((oracle.jdbc.OracleResultSet) rs_";
  protected final String TEXT_317 = ").getTIMESTAMPTZ(";
  protected final String TEXT_318 = "column_index_";
  protected final String TEXT_319 = ") != null){" + NL + "    \t\t\t\ttalendTimestampWithTZ = org.talend.oracle.OracleTSTZUtil.toTalendTSTZ(((oracle.jdbc.OracleResultSet) rs_";
  protected final String TEXT_320 = ").getTIMESTAMPTZ(";
  protected final String TEXT_321 = "column_index_";
  protected final String TEXT_322 = ").toBytes());" + NL + "                }" + NL + "                if(talendTimestampWithTZ != null){" + NL + "                \t";
  protected final String TEXT_323 = ".";
  protected final String TEXT_324 = " = talendTimestampWithTZ;" + NL + "                }else{" + NL + "                \t";
  protected final String TEXT_325 = ".";
  protected final String TEXT_326 = " = null;" + NL + "                }" + NL + "    \t\t";
  protected final String TEXT_327 = NL + "\t\t\t\t\tjava.sql.Timestamp timestamp = rs_";
  protected final String TEXT_328 = ".getTimestamp(";
  protected final String TEXT_329 = "column_index_";
  protected final String TEXT_330 = ");" + NL + "\t\t\t\t\tif(timestamp != null) {" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_331 = ".";
  protected final String TEXT_332 = " = new java.util.Date(timestamp.getTime());" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_333 = ".";
  protected final String TEXT_334 = " = null;" + NL + "\t\t\t\t\t}\t\t\t " + NL + "\t\t\t\t";
  protected final String TEXT_335 = NL + "\t\t\t\t\tif(rs_";
  ...
  protected final String TEXT_340 = " = new java.util.Date(rs_";
  protected final String TEXT_341 = ".getTimestamp(";
  protected final String TEXT_342 = "column_index_";
  protected final String TEXT_343 = ").getTime());" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_344 = ".";
  protected final String TEXT_345 = " =  null;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_346 = NL + "\t\t\t\tObject tmpObj_";
  protected final String TEXT_347 = "_";
  protected final String TEXT_348 = " = rs_";
  protected final String TEXT_349 = ".getObject(";
  protected final String TEXT_350 = "column_index_";
  protected final String TEXT_351 = ");" + NL + "\t\t\t\tif(tmpObj_";
  protected final String TEXT_352 = "_";
  protected final String TEXT_353 = " != null) {";
  protected final String TEXT_354 = NL + "\t\t\t\t\t";
  protected final String TEXT_355 = ".";
  protected final String TEXT_356 = " = oracle.xdb.XMLType.createXML((oracle.sql.OPAQUE) tmpObj_";
  protected final String TEXT_357 = "_";
  protected final String TEXT_358 = ").getStringVal();";
  protected final String TEXT_359 = NL + "\t\t\t\t\t";
  protected final String TEXT_360 = ".";
  protected final String TEXT_361 = " = tmpObj_";
  ...
  protected final String TEXT_388 = " == 0 && rs_";
  ...
  protected final String TEXT_406 = ");" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t";
  protected final String TEXT_407 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_408 = ".";
  protected final String TEXT_409 = " = null;";
  protected final String TEXT_410 = "    " + NL + " \t                \tthrow new RuntimeException(\"Null value in non-Nullable column\");";
  protected final String TEXT_411 = NL + "\t\t\t\t\t}";
  protected final String TEXT_412 = NL + NL + "    " + NL + "\t";
  protected final String TEXT_413 = NL + "\t\t    int nb_line_";
  protected final String TEXT_414 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_415 = " = null;";
  protected final String TEXT_416 = NL + "\t\t        conn_";
  protected final String TEXT_417 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_418 = "\");";
  protected final String TEXT_419 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_420 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_421 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_422 = " = dataSources_";
  protected final String TEXT_423 = ".get(";
  protected final String TEXT_424 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_429 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_430 = " =  conn_";
  protected final String TEXT_431 = ".getAutoCommit();          " + NL + "             conn_";
  protected final String TEXT_432 = ".setAutoCommit(true);           " + NL + "             try{             " + NL + "                 conn_";
  protected final String TEXT_433 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON ALL\");" + NL + "                 conn_";
  protected final String TEXT_434 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" + ";
  protected final String TEXT_435 = NL + "               ";
  protected final String TEXT_436 = " + \"=\" + ";
  protected final String TEXT_437 = " + \";\" +";
  protected final String TEXT_438 = " \"' FOR SESSION\"" + NL + "           );           " + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());              " + NL + "      }" + NL + "      conn_";
  protected final String TEXT_439 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_440 = ");";
  protected final String TEXT_441 = NL + "\t\t    ";
  protected final String TEXT_442 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_443 = " = ";
  protected final String TEXT_444 = ";" + NL + "\t\t\t";
  protected final String TEXT_445 = NL + "                log.info(\"";
  protected final String TEXT_446 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_447 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_448 = NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_449 = "_QUERY\",dbquery_";
  protected final String TEXT_450 = ");" + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_451 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_452 = " = stmt_";
  protected final String TEXT_453 = ".executeQuery(dbquery_";
  protected final String TEXT_454 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_455 = " = rs_";
  protected final String TEXT_456 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_457 = " = rsmd_";
  protected final String TEXT_458 = ".getColumnCount();" + NL;
  protected final String TEXT_459 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_460 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_461 = ".setDbmsId(\"";
  protected final String TEXT_462 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_463 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_464 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_465 = ".add(\"";
  protected final String TEXT_466 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_467 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_468 = " = ";
  protected final String TEXT_469 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_470 = "; i <= rsmd_";
  protected final String TEXT_471 = ".getColumnCount()-";
  protected final String TEXT_472 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_473 = ".contains(rsmd_";
  protected final String TEXT_474 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_475 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_476 = ".setName(rsmd_";
  protected final String TEXT_477 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_478 = ".setDbName(rsmd_";
  protected final String TEXT_479 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_480 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_481 = "\", rsmd_";
  protected final String TEXT_482 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_483 = ".getPrecision(i), rsmd_";
  protected final String TEXT_484 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_485 = ".setDbType(rsmd_";
  protected final String TEXT_486 = ".getColumnTypeName(i));";
  protected final String TEXT_487 = NL + "                \tdcm_";
  protected final String TEXT_488 = ".setFormat(";
  protected final String TEXT_489 = ");";
  protected final String TEXT_490 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_491 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_492 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_493 = ".setLength(rsmd_";
  protected final String TEXT_494 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_495 = ".setLength(rsmd_";
  protected final String TEXT_496 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_497 = NL + "\t\t\tdcm_";
  protected final String TEXT_498 = ".setLength(rsmd_";
  protected final String TEXT_499 = ".getPrecision(i));";
  protected final String TEXT_500 = NL + "                \tdcm_";
  protected final String TEXT_501 = ".setPrecision(rsmd_";
  protected final String TEXT_502 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_503 = ".setNullable(rsmd_";
  protected final String TEXT_504 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_505 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_506 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_507 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_508 = ".metadatas.add(dcm_";
  protected final String TEXT_509 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_510 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_511 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_512 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_513 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_514 = NL + "\t\t    ";
  protected final String TEXT_515 = NL + "\t\t    \tlog.info(\"";
  protected final String TEXT_516 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_517 = NL + "\t\t    while (rs_";
  protected final String TEXT_518 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_519 = "++;" + NL + "\t\t        ";
  protected final String TEXT_520 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_521 = " = ";
  protected final String TEXT_522 = " + dcg_";
  protected final String TEXT_523 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_524 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  ...
  protected final String TEXT_541 = ".getObject(";
  protected final String TEXT_542 = "column_index_";
  protected final String TEXT_543 = ");";
  protected final String TEXT_544 = NL + "\t\t                         ";
  protected final String TEXT_545 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_546 = ".getObject(";
  protected final String TEXT_547 = "column_index_";
  protected final String TEXT_548 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_549 = NL + "                                    ";
  protected final String TEXT_550 = ".";
  protected final String TEXT_551 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_560 = ".setEPSG(";
  protected final String TEXT_561 = ");" + NL + "                                        }";
  protected final String TEXT_562 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_563 = NL + "                                  ";
  protected final String TEXT_564 = ".";
  protected final String TEXT_565 = "=dcg_";
  protected final String TEXT_566 = ";";
  protected final String TEXT_567 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_568 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_569 = " = ";
  protected final String TEXT_570 = "; i_";
  protected final String TEXT_571 = "  <= rsmd_";
  protected final String TEXT_572 = ".getColumnCount(); i_";
  protected final String TEXT_573 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_574 = ".getColumnTypeName(i_";
  protected final String TEXT_575 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_576 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_577 = ".getClob(i_";
  protected final String TEXT_578 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_579 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_580 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_581 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_582 = ".add(tNTextImpl_";
  protected final String TEXT_583 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_584 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_585 = ".";
  protected final String TEXT_586 = ", rs_";
  protected final String TEXT_587 = ", fixedColumnCount_";
  protected final String TEXT_588 = ",list_";
  protected final String TEXT_589 = ");";
  protected final String TEXT_590 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_591 = ".";
  protected final String TEXT_592 = ", rs_";
  protected final String TEXT_593 = ", fixedColumnCount_";
  protected final String TEXT_594 = ");";
  protected final String TEXT_595 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_596 = ".";
  protected final String TEXT_597 = ", rs_";
  protected final String TEXT_598 = ", fixedColumnCount_";
  protected final String TEXT_599 = ");";
  protected final String TEXT_600 = NL + "                                  Object geom = rs_";
  protected final String TEXT_601 = ".getObject(";
  protected final String TEXT_602 = "column_index_";
  protected final String TEXT_603 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o = " + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_604 = ".";
  protected final String TEXT_605 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_611 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_612 = " - Retrieving the record \" + nb_line_";
  ...
  protected final String TEXT_619 = NL + NL + "\t" + NL + "\t" + NL;
