...
public class TInformixSPBeginJava
{
  ...
  protected final String TEXT_44 = NL + "\tjava.lang.Class.forName(\"com.informix.jdbc.IfxDriver\");" + NL + "\t";
  protected final String TEXT_45 = NL + "    \tString url_";
  protected final String TEXT_46 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_47 = " + \":\" + ";
  protected final String TEXT_48 = " + \"/\" + ";
  protected final String TEXT_49 = " + \":informixserver=\" + ";
  ...
  protected final String TEXT_73 = NL + "\tif(connection_";
  protected final String TEXT_74 = ".getAutoCommit()) {" + NL + "\t    connection_";
  protected final String TEXT_75 = ".setAutoCommit(false);" + NL + "\t}";
  protected final String TEXT_76 = NL + "java.sql.CallableStatement statement_";
