...
public class TOracleRowBeginJava
{
  ...
  protected final String TEXT_137 = NL + "\t\t\t\tString atnParams_";
  protected final String TEXT_138 = " = ";
  protected final String TEXT_139 = ";" + NL + "\t\t\t\tatnParams_";
  protected final String TEXT_140 = " = atnParams_";
  protected final String TEXT_141 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_142 = " = new java.util.Properties();" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_143 = ".put(\"user\",dbUser_";
  protected final String TEXT_144 = ");" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_145 = ".put(\"password\",dbPwd_";
  protected final String TEXT_146 = ");" + NL + "\t\t\t\tatnParamsPrope_";
  protected final String TEXT_147 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_148 = ".getBytes()));" + NL + "\t\t\t\tconn_";
