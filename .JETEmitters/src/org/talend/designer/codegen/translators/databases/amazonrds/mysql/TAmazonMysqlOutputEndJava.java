...
public class TAmazonMysqlOutputEndJava {
  ...
  protected final String TEXT_46 = ",java.sql.Types.CHAR);" + NL + "\t                ";
  ...
  protected final String TEXT_51 = ",java.sql.Types.DATE);" + NL + "\t                ";
  ...
  protected final String TEXT_56 = ",java.sql.Types.ARRAY);         " + NL + "\t                ";
  ...
  protected final String TEXT_61 = ",java.sql.Types.INTEGER);" + NL + "\t                ";
  ...
  protected final String TEXT_66 = ",java.sql.Types.VARCHAR);" + NL + "\t                ";
  ...
  protected final String TEXT_71 = ",java.sql.Types.OTHER);" + NL + "\t                ";
  ...
  protected final String TEXT_76 = ",java.sql.Types.BOOLEAN);   " + NL + "\t                ";
  ...
  protected final String TEXT_81 = ",java.sql.Types.DOUBLE);    " + NL + "\t                ";
  ...
  protected final String TEXT_86 = ",java.sql.Types.FLOAT); " + NL + "\t                ";
  protected final String TEXT_87 = NL + "\t" + NL + "\t                }else{" + NL + "\t" + NL + "\t                ";
  protected final String TEXT_88 = NL + "\t\t        ";
  protected final String TEXT_89 = NL + "\t\t            if(bufferL";
  protected final String TEXT_90 = ".";
  protected final String TEXT_91 = "==null){" + NL + "\t\t        ";
  protected final String TEXT_92 = NL + "\t\t            if((\"null\").equals(String.valueOf(bufferL";
  protected final String TEXT_93 = ".";
  protected final String TEXT_94 = ").toLowerCase())){" + NL + "\t\t        ";
  protected final String TEXT_95 = NL + "\t            ";
  protected final String TEXT_96 = ".setNull(count";
  protected final String TEXT_97 = ",java.sql.Types.CHAR);" + NL + "\t\t            " + NL + "\t\t        } else if(bufferL";
  protected final String TEXT_98 = ".";
  protected final String TEXT_99 = " == '\\0') {" + NL + "\t\t        " + NL + "\t\t            ";
  protected final String TEXT_100 = ".setString(count";
  protected final String TEXT_101 = ",\"\");" + NL + "\t\t            " + NL + "\t\t        } else {" + NL + "\t\t            " + NL + "\t\t            ";
  protected final String TEXT_102 = ".setString(count";
  protected final String TEXT_103 = ",String.valueOf(bufferL";
  protected final String TEXT_104 = ".";
  protected final String TEXT_105 = "));" + NL + "\t\t        }" + NL + "\t\t        ";
  protected final String TEXT_106 = NL + "\t\t            if(bufferL";
  protected final String TEXT_107 = ".";
  protected final String TEXT_108 = "!=null){" + NL + "\t\t                // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t                date_";
  protected final String TEXT_109 = " = bufferL";
  protected final String TEXT_110 = ".";
  protected final String TEXT_111 = ".getTime();" + NL + "\t\t                if (date_";
  protected final String TEXT_112 = " < year1_";
  protected final String TEXT_113 = " || date_";
  protected final String TEXT_114 = " >= year10000_";
  protected final String TEXT_115 = ") {" + NL + "\t\t                    ";
  protected final String TEXT_116 = ".setString(count";
  protected final String TEXT_117 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t                } else {" + NL + "\t\t                    ";
  protected final String TEXT_118 = ".setTimestamp(count";
  protected final String TEXT_119 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_120 = "));" + NL + "\t\t                }" + NL + "\t\t            }else{" + NL + "\t\t        " + NL + "\t\t                ";
  protected final String TEXT_121 = ".setNull(count";
  protected final String TEXT_122 = ",java.sql.Types.DATE);" + NL + "\t\t            " + NL + "\t\t            }" + NL + "\t\t            ";
  protected final String TEXT_123 = NL + "\t\t            ";
  protected final String TEXT_124 = ".set";
  protected final String TEXT_125 = "(count";
  protected final String TEXT_126 = ",bufferL";
  protected final String TEXT_127 = ".";
  protected final String TEXT_128 = ");" + NL + "\t\t            ";
  protected final String TEXT_129 = NL + "\t\t            " + NL + "\t\t            }" + NL + "\t\t        " + NL + "\t\t        ";
  protected final String TEXT_130 = NL + "\t  " + NL + "\t" + NL + "\t    if(rowCount";
  protected final String TEXT_131 = "!=0){" + NL + "\t" + NL + "\t        StringBuilder extendInsertValueStmt = new StringBuilder();" + NL + "\t        for(int i=0 ; i < rowCount";
  protected final String TEXT_132 = " ; i++){" + NL + "\t             extendInsertValueStmt.append(\"(\"+insertColValue";
  protected final String TEXT_133 = "+\")\");" + NL + "\t             if (i != rowCount";
  protected final String TEXT_134 = " - 1) extendInsertValueStmt.append(\",\");" + NL + "\t        }" + NL + "\t        " + NL + "\t" + NL + "\t\t\t\t   insert_";
  protected final String TEXT_135 = " = \"INSERT INTO `\"+";
  protected final String TEXT_136 = "+\"` (\"+insertColName";
  protected final String TEXT_137 = "+\") VALUES \"+extendInsertValueStmt.toString();" + NL + "\t\t\t\t   ";
  protected final String TEXT_138 = NL + "\t\t\t\t    ";
  protected final String TEXT_139 = NL + "\t\t\t\t\t\tinsert_";
  protected final String TEXT_140 = " += \" ON DUPLICATE KEY UPDATE \";" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_141 = " = new StringBuffer(\"\");\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_142 = NL + "\t\t\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_143 = ".append(\",\");" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_147 = ".append (\"=\");" + NL + "\t\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_148 = ".append (";
  protected final String TEXT_149 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_150 = NL + "\t\t\t\t\t\tinsert_";
  protected final String TEXT_151 = " += \tduplidateClause_";
  protected final String TEXT_152 = ".toString();\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_153 = "\t            " + NL + "\t\t\t\t        ";
  protected final String TEXT_154 = NL + "\t\t\t" + NL + "\t\t\t        " + NL + "\t        pstmt_";
  protected final String TEXT_155 = " = conn_";
  protected final String TEXT_156 = ".prepareStatement(insert_";
  protected final String TEXT_157 = ");" + NL + "\t        " + NL + "\t        int row2Count";
  protected final String TEXT_158 = " = 0;";
  protected final String TEXT_159 = NL + "\t        \tint count";
  protected final String TEXT_160 = " = 1;";
  protected final String TEXT_161 = NL + "\t\t\tint count";
  protected final String TEXT_162 = " = 0;";
  protected final String TEXT_163 = NL + "\t        " + NL + "\t        for(BufferLine_";
  protected final String TEXT_164 = " bufferL";
  protected final String TEXT_165 = " : exInsertColValueList";
  protected final String TEXT_166 = "){            ";
  protected final String TEXT_167 = NL + "\t            count";
  protected final String TEXT_168 = " = row2Count";
  protected final String TEXT_169 = "*";
  protected final String TEXT_170 = "+1;         \t          ";
  protected final String TEXT_171 = NL + "\t                    count";
  protected final String TEXT_172 = "++;" + NL + "\t                    ";
  protected final String TEXT_173 = NL + "\t\t\t\t\tint count_dyn_";
  protected final String TEXT_174 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_175 = ".";
  protected final String TEXT_176 = ", pstmt_";
  protected final String TEXT_177 = ", count";
  protected final String TEXT_178 = "-1, \"";
  protected final String TEXT_179 = "\");" + NL + "\t\t\t\t\tcount";
  protected final String TEXT_180 = "+=count_dyn_";
  protected final String TEXT_181 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_182 = NL + "\t    " + NL + "\t            row2Count";
  protected final String TEXT_183 = "++;" + NL + "\t        }        " + NL + "\t        insertedCount_";
  ...
  protected final String TEXT_187 = "                                                " + NL + "                try {" + NL + "                \t\tif (batchSizeCounter_";
  protected final String TEXT_188 = " != 0) {" + NL + "\t\t\t\t\t\t\tint countSum_";
  protected final String TEXT_189 = " = 0;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_190 = NL + "\t\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_191 = ": pstmt_";
  protected final String TEXT_192 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_193 = " += (countEach_";
  protected final String TEXT_194 = " < 0 ? 0 : 1);" + NL + "\t\t\t\t\t\t\t}         " + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_195 = "       \t" + NL + "\t            \t    \t";
  protected final String TEXT_196 = NL + "\t            \t    \t\tinsertedCount_";
  protected final String TEXT_197 = " += countSum_";
  protected final String TEXT_198 = ";" + NL + "\t            \t    \t";
  protected final String TEXT_199 = "                         \t    \t" + NL + "            \t    \t}" + NL + "            \t    \t\t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_200 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_201 = NL + "                \tint countSum_";
  protected final String TEXT_202 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_203 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_204 = " += (countEach_";
  protected final String TEXT_205 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_211 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_212 = NL + "                }" + NL + "                batchSizeCounter_";
  protected final String TEXT_213 = " = 0;    ";
  protected final String TEXT_214 = "    \t\t\t" + NL + "    \t\t";
  protected final String TEXT_215 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_216 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_217 = ".close();" + NL + "            " + NL + "        } " + NL + "        if(pstmtInsert_";
  protected final String TEXT_218 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_219 = ".close();" + NL + "            " + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_220 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_221 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_222 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_223 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_224 = ".close();" + NL + "            " + NL + "        } " + NL + "        if(pstmtInsert_";
  protected final String TEXT_225 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_226 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_227 = NL + "\t";
  protected final String TEXT_228 = "                " + NL + "    try {" + NL + "\t\t\tint countSum_";
  ...
  protected final String TEXT_232 = ".executeBatch()) {" + NL + "\t\t\t\tcountSum_";
  protected final String TEXT_233 = " += (countEach_";
  protected final String TEXT_234 = " < 0 ? 0 : ";
  protected final String TEXT_235 = ");" + NL + "\t\t\t}       \t" + NL + "\t\t\t";
  protected final String TEXT_236 = NL + "\t    \t";
  protected final String TEXT_237 = NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_238 = " += countSum_";
  protected final String TEXT_239 = "; " + NL + "\t    \t";
  protected final String TEXT_240 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_241 = " += countSum_";
  protected final String TEXT_242 = ";" + NL + "\t    \t";
  protected final String TEXT_243 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_244 = " += countSum_";
  protected final String TEXT_245 = ";" + NL + "\t    \t";
  protected final String TEXT_246 = "            \t    " + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  protected final String TEXT_247 = NL + "    \t\tthrow(e);" + NL + "    \t";
  protected final String TEXT_248 = NL + "    \tint countSum_";
  protected final String TEXT_249 = " = 0;" + NL + "\t\tfor(int countEach_";
  protected final String TEXT_250 = ": e.getUpdateCounts()) {" + NL + "\t\t\tcountSum_";
  protected final String TEXT_251 = " += (countEach_";
  protected final String TEXT_252 = " < 0 ? 0 : countEach_";
  protected final String TEXT_253 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_254 = NL + "    \tinsertedCount_";
  protected final String TEXT_255 = " += countSum_";
  protected final String TEXT_256 = ";" + NL + "    \t";
  protected final String TEXT_257 = "            \t    \t\t" + NL + "    \tupdatedCount_";
  protected final String TEXT_258 = " += countSum_";
  protected final String TEXT_259 = ";" + NL + "    \t";
  protected final String TEXT_260 = NL + "    \tdeletedCount_";
  ...
  protected final String TEXT_266 = "  " + NL + "    " + NL + "        if(pstmt_";
  protected final String TEXT_267 = " != null) {" + NL + "\t\t\tpstmt_";
  protected final String TEXT_268 = ".close();" + NL + "        }        ";
  protected final String TEXT_269 = NL;
  protected final String TEXT_270 = NL + "    \t\tif (commitCounter_";
  protected final String TEXT_271 = " > 0) {" + NL + "        \t\t";
  protected final String TEXT_272 = NL + "        \t\tconn_";
  protected final String TEXT_273 = ".commit();" + NL + "        \t\t";
  ...
  protected final String TEXT_278 = NL + "    \tresourceMap.put(\"finish_";
