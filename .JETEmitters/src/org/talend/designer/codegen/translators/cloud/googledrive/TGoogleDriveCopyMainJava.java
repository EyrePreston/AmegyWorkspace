...
public class TGoogleDriveCopyMainJava
{
  ...
  protected final String TEXT_40 = "_listRequest.setQ(\"title = '\" + ";
  protected final String TEXT_41 = " + \"' and mimeType != 'application/vnd.google-apps.folder'\");" + NL + "\t\t";
  ...
  protected final String TEXT_49 = "_listRequest.setQ(\"title = '\" + sourceFolder_";
  protected final String TEXT_50 = " + \"' and mimeType = 'application/vnd.google-apps.folder'\");" + NL + "\t\t";
  ...
  protected final String TEXT_54 = "_files.getItems().size() > 1)" + NL + "\t\t{" + NL + "\t\t";
  protected final String TEXT_55 = NL + "\t\t\tthrow new Exception(\"More then one file found with name \\\"\" + ";
  protected final String TEXT_56 = " + \"\\\" \");" + NL + "\t\t";
  protected final String TEXT_57 = NL + "\t\t\tthrow new Exception(\"More then one folder found with name \\\"\" + ";
  protected final String TEXT_58 = " + \"\\\" \");" + NL + "\t\t";
  protected final String TEXT_59 = NL + "\t\t}" + NL + "\t\telse if (";
  protected final String TEXT_60 = "_files.getItems().isEmpty())" + NL + "\t\t{" + NL + "\t\t";
  ...
  protected final String TEXT_73 = "_client.files().list();" + NL + "\t\t\t";
  protected final String TEXT_74 = "_listRequest.setQ(\"title = '\" + ";
  ...
  protected final String TEXT_76 = "_destFolders = ";
  protected final String TEXT_77 = "_listRequest.execute();" + NL + "\t\t\tif (";
  protected final String TEXT_78 = "_destFolders.getItems().size() > 1)" + NL + "\t\t\t{" + NL + "\t\t\t\tthrow new Exception(\"More then one folder found with name \\\"\" + ";
  protected final String TEXT_79 = " + \"\\\" \");" + NL + "\t\t\t}" + NL + "\t\t\telse if (";
  protected final String TEXT_80 = "_destFolders.getItems().isEmpty())" + NL + "\t\t\t{" + NL + "\t\t\t\tthrow new Exception(\"No folder found with name \\\"\" + ";
  protected final String TEXT_81 = " + \"\\\" \");" + NL + "\t\t\t}" + NL + "\t\t\telse" + NL + "\t\t\t{" + NL + "\t\t\tString ";
  protected final String TEXT_82 = "_destFolderId = ";
  protected final String TEXT_83 = "_destFolders.getItems().get(0).getId();";
  protected final String TEXT_84 = " " + NL + "\t\t        com.google.api.services.drive.model.File copiedFile = new com.google.api.services.drive.model.File();" + NL + "\t\t        ";
  protected final String TEXT_85 = NL + "\t\t\t\t\tcopiedFile.setTitle(";
  protected final String TEXT_86 = "); " + NL + "\t\t        ";
  protected final String TEXT_87 = NL + "\t\t        copiedFile.setParents(java.util.Arrays.asList(new com.google.api.services.drive.model.ParentReference().setId(";
  protected final String TEXT_88 = "_destFolderId)));" + NL + "\t\t\t    resultFile = ";
  protected final String TEXT_89 = "_client.files().copy(";
  protected final String TEXT_90 = "_fileId, copiedFile).execute();" + NL + "\t\t        ";
  protected final String TEXT_91 = NL + "\t\t\t\t     ";
  protected final String TEXT_92 = "_client.files().delete(";
  protected final String TEXT_93 = "_fileId).execute();" + NL + "\t\t        ";
  protected final String TEXT_94 = NL + "\t\t\t\t   com.google.api.services.drive.model.File filePatch = new com.google.api.services.drive.model.File();" + NL + "                   filePatch.setTitle(";
  protected final String TEXT_95 = ");" + NL + "                   com.google.api.services.drive.Drive.Files.Patch patchRequest = ";
  protected final String TEXT_96 = "_client.files().patch(";
  protected final String TEXT_97 = "_fileId, filePatch);" + NL + "                   patchRequest.setFields(\"title\");" + NL + "                   patchRequest.execute();" + NL + "\t\t        ";
  protected final String TEXT_98 = NL + "\t\t        if (";
  protected final String TEXT_99 = "_sourceFile.getParents().size() > 1)" + NL + "\t\t        {" + NL + "\t\t        \tthrow new Exception(\"Failed to delete (this folder has more then one parent)\");" + NL + "\t\t        }" + NL + "\t\t\t\tString ";
  protected final String TEXT_100 = "_sourceFolderId = ";
  protected final String TEXT_101 = "_sourceFile.getParents().get(0).getId();" + NL + "               \t";
  protected final String TEXT_102 = "_client.parents().insert(";
  protected final String TEXT_103 = "_fileId, new com.google.api.services.drive.model.ParentReference().setId(";
  protected final String TEXT_104 = "_destFolderId)).execute();" + NL + "\t\t\t   \t";
  protected final String TEXT_105 = "_client.parents().delete(";
  protected final String TEXT_106 = "_fileId, ";
  protected final String TEXT_107 = "_sourceFolderId).execute();" + NL + "\t\t\t   \tresultFile = file;" + NL + "\t\t";
  protected final String TEXT_108 = NL + "\t\t\t";
  protected final String TEXT_109 = ".sourceFileID = ";
  protected final String TEXT_110 = "_fileId;" + NL + "\t\t\t";
  protected final String TEXT_111 = ".destinationFileID =  resultFile.getId();";
  protected final String TEXT_112 = NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_113 = "_SOURCE_FILEID\", ";
  protected final String TEXT_114 = "_fileId);" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_115 = "_DESTINATION_FILEID\", resultFile.getId());" + NL + "\t\t}" + NL + "\t}" + NL + "\t\t\t";
