...
public class TS3BucketExistMainJava
{
  ...
  protected final String TEXT_54 = NL + "\tboolean bucketExist_";
  protected final String TEXT_55 = "=false;" + NL + "\ttry{" + NL + "\t\tbucketExist_";
  protected final String TEXT_56 = " = conn_";
  protected final String TEXT_57 = ".doesBucketExist(";
  protected final String TEXT_58 = ");" + NL + "\t\t";
  protected final String TEXT_59 = "\t" + NL + "\t\t\tif(bucketExist_";
  protected final String TEXT_60 = "){" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_61 = " - Bucket \"+";
  protected final String TEXT_62 = "+\" exists.\");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_63 = " - Bucket \"+";
  protected final String TEXT_64 = "+\" does not exist.\");" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_65 = NL + "\t}catch(java.lang.Exception e_";
  ...
  protected final String TEXT_74 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_75 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_76 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_77 = NL + "\t}" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_78 = "_BUCKET_NAME\", ";
  protected final String TEXT_79 = ");" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_80 = "_BUCKET_EXIST\", bucketExist_";
