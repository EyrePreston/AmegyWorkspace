...
public class TGoogleDriveGetBeginJava
{
  ...
  protected final String TEXT_30 = "_listRequest.setQ(\"title = '\" + ";
  ...
  protected final String TEXT_34 = "_files.getItems().size() > 1)" + NL + "\t\t{" + NL + "\t\t\tthrow new Exception(\"More then one file found with name \\\"\" + ";
