...
public class TS3BucketListBeginJava
{
  ...
  protected final String TEXT_54 = NL + "\tint nb_bucket_";
  protected final String TEXT_55 = " = 0;" + NL + "\t";
  protected final String TEXT_56 = NL + "\t\tlog.info(\"";
  protected final String TEXT_57 = " - Retrieving buckets from the server.\");" + NL + "\t";
  protected final String TEXT_58 = NL + "\tjava.util.List<com.amazonaws.services.s3.model.Bucket> buckets_";
  protected final String TEXT_59 = " = conn_";
  protected final String TEXT_60 = ".listBuckets();" + NL + "\t";
  protected final String TEXT_61 = NL + "\t\ttry{" + NL + "\t";
  protected final String TEXT_62 = NL + "\tfor (com.amazonaws.services.s3.model.Bucket bucket_";
  protected final String TEXT_63 = " : buckets_";
  protected final String TEXT_64 = ") {" + NL + "\t\tnb_bucket_";
  protected final String TEXT_65 = "++;" + NL + "\t\tString currentBucketName_";
  protected final String TEXT_66 = " = bucket_";
  protected final String TEXT_67 = ".getName();" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_68 = "_CURRENT_BUCKET_NAME\", currentBucketName_";
  protected final String TEXT_69 = ");" + NL + "\t\t";
  protected final String TEXT_70 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_71 = " - Retrieving the bucket \" + nb_bucket_";
  protected final String TEXT_72 = " + \".\");" + NL + "\t\t\tlog.trace(\"";
  protected final String TEXT_73 = " - Name of current bucket : \" + currentBucketName_";
