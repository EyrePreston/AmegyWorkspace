...
public class TGoogleDriveDeleteMainJava
{
  ...
  protected final String TEXT_34 = "_listRequest.setQ(\"title = '\" + fileName_";
  ...
  protected final String TEXT_38 = "_files.getItems().size() > 1)" + NL + "\t{" + NL + "\t\tthrow new Exception(\"More then one file found with name \\\"\" + ";
