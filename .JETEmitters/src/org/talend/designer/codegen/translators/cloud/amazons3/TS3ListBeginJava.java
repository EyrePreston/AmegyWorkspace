...
public class TS3ListBeginJava
{
  ...
  protected final String TEXT_53 = " - Creating new connection successfully.\");" + NL + "\t\t";
  protected final String TEXT_54 = NL + NL + "\tint nb_bucket_";
  protected final String TEXT_55 = " = 0;" + NL + "\tint nb_bucket_object_";
  protected final String TEXT_56 = " = 0;" + NL + "\ttry{" + NL + "\t\t";
  protected final String TEXT_57 = NL + "\t\t\tjava.util.List<com.amazonaws.services.s3.model.Bucket> buckets_";
  protected final String TEXT_58 = " = conn_";
  protected final String TEXT_59 = ".listBuckets();" + NL + "\t\t\tfor (com.amazonaws.services.s3.model.Bucket bucket_";
  protected final String TEXT_60 = " : buckets_";
  protected final String TEXT_61 = ") {" + NL + "\t\t\t\tString currentBucketName_";
  protected final String TEXT_62 = " = bucket_";
  protected final String TEXT_63 = ".getName();" + NL + "\t\t\t\t";
  protected final String TEXT_64 = NL + "\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_65 = " - Retrieving objects from:\" + currentBucketName_";
  protected final String TEXT_66 = " + \".\");" + NL + "\t\t\t\t";
  protected final String TEXT_67 = NL + "\t\t\t\tcom.amazonaws.services.s3.model.ObjectListing objects_";
  protected final String TEXT_68 = " = conn_";
  protected final String TEXT_69 = ".listObjects(currentBucketName_";
  protected final String TEXT_70 = ",";
  protected final String TEXT_71 = ");" + NL + "\t\t";
  protected final String TEXT_72 = NL + "\t\t\tjava.util.List<java.util.Map<String,String>> buckets_map_list_";
  protected final String TEXT_73 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL + "\t\t\tjava.util.Map<String,String> bucket_prefix_map_";
  protected final String TEXT_74 = " = null;" + NL + "\t\t\tString object_prefix_";
  protected final String TEXT_75 = " = \"\";" + NL + "\t\t\t";
  protected final String TEXT_76 = NL + "\t\t\t\t\tobject_prefix_";
  protected final String TEXT_77 = " = ";
  protected final String TEXT_78 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_79 = NL + "\t\t\t\tbucket_prefix_map_";
  protected final String TEXT_80 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\tbucket_prefix_map_";
  protected final String TEXT_81 = ".put(";
  protected final String TEXT_82 = ",object_prefix_";
  protected final String TEXT_83 = ");" + NL + "\t\t\t\tbuckets_map_list_";
  protected final String TEXT_84 = ".add(bucket_prefix_map_";
  protected final String TEXT_85 = ");" + NL + "\t\t\t\tobject_prefix_";
  protected final String TEXT_86 = " = \"\";" + NL + "\t\t\t";
  protected final String TEXT_87 = NL + "\t\t\tfor (java.util.Map<String,String> bucketMap_";
  protected final String TEXT_88 = ": buckets_map_list_";
  protected final String TEXT_89 = ") {" + NL + "\t\t\t\tString currentBucketName_";
  protected final String TEXT_90 = " = \"\";" + NL + "\t\t\t\tString currentPrefix_";
  protected final String TEXT_91 = " = \"\";" + NL + "\t\t\t\tfor(java.util.Map.Entry<String,String> entry_";
  protected final String TEXT_92 = ":bucketMap_";
  protected final String TEXT_93 = ".entrySet()){" + NL + "\t\t\t\t\tcurrentBucketName_";
  protected final String TEXT_94 = " = entry_";
  protected final String TEXT_95 = ".getKey();" + NL + "\t\t\t\t\tcurrentPrefix_";
  protected final String TEXT_96 = " = entry_";
  protected final String TEXT_97 = ".getValue();" + NL + "\t\t\t\t}" + NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\t";
  protected final String TEXT_98 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_99 = " - Retrieving objects from:\" + currentBucketName_";
  protected final String TEXT_100 = " + \".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_101 = NL + "\t\t\t\t\tcom.amazonaws.services.s3.model.ObjectListing objects_";
  protected final String TEXT_102 = " = conn_";
  protected final String TEXT_103 = ".listObjects(currentBucketName_";
  protected final String TEXT_104 = ",currentPrefix_";
  protected final String TEXT_105 = ");" + NL + "\t\t\t";
  protected final String TEXT_106 = NL + "\t\t\t\twhile(true){" + NL + "\t\t\t\t\tjava.util.List<com.amazonaws.services.s3.model.S3ObjectSummary> list_objects_";
  protected final String TEXT_107 = " = objects_";
  protected final String TEXT_108 = ".getObjectSummaries();" + NL + "\t\t\t\t\tif(list_objects_";
  protected final String TEXT_109 = ".size()>0){" + NL + "\t\t\t\t\t\tnb_bucket_";
  protected final String TEXT_110 = "++;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tfor (com.amazonaws.services.s3.model.S3ObjectSummary objectSummary_";
  protected final String TEXT_111 = " : list_objects_";
  protected final String TEXT_112 = ") {" + NL + "\t\t\t\t\t\tnb_bucket_object_";
  protected final String TEXT_113 = "++;" + NL + "\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_114 = "_CURRENT_BUCKET\", currentBucketName_";
  protected final String TEXT_115 = ");" + NL + "\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_116 = "_CURRENT_KEY\", objectSummary_";
  protected final String TEXT_117 = ".getKey());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_118 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_119 = " - Retrieving the object \" + nb_bucket_object_";
  protected final String TEXT_120 = " + \".\");" + NL + "\t\t\t\t\t\t\tlog.trace(\"";
  protected final String TEXT_121 = " - Key of current object : \" + objectSummary_";
  protected final String TEXT_122 = ".getKey());" + NL + "\t\t\t\t\t\t";
