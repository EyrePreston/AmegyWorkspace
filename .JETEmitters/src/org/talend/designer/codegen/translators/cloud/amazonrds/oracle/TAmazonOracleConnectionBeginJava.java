...
public class TAmazonOracleConnectionBeginJava
{
  ...
  protected final String TEXT_149 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_150 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_151 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_152 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_184 = NL + NL + "\tif ((null == globalMap.get(KEY_DB_DATASOURCES)) || \"\".equals(";
  protected final String TEXT_185 = ")) {";
  protected final String TEXT_186 = NL + "\t\t";
  protected final String TEXT_187 = NL + "\t\t";
  protected final String TEXT_188 = NL + NL + "\t\tglobalMap.put(\"conn_";
  ...
  protected final String TEXT_195 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_196 = "\",conn_";
  protected final String TEXT_197 = ");" + NL + "\tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_198 = "\", ";
  protected final String TEXT_199 = ");" + NL + "\tglobalMap.put(\"username_\" + \"";
  protected final String TEXT_200 = "\",";
  protected final String TEXT_201 = ");" + NL + "\tglobalMap.put(\"password_\" + \"";
