...
public class TS3DeleteBeginJava
{
  ...
  protected final String TEXT_54 = NL + "\ttry{" + NL + "\t\tString key_";
  protected final String TEXT_55 = " = ";
  protected final String TEXT_56 = ";" + NL + "\t\tif(key_";
  protected final String TEXT_57 = "!=null && key_";
  protected final String TEXT_58 = ".trim().length()>0){" + NL + "\t\t\t";
  protected final String TEXT_59 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_60 = " - Deleting an object with key:\" + ";
  protected final String TEXT_61 = ");" + NL + "\t\t\t";
  protected final String TEXT_62 = NL + "\t\t\tconn_";
  protected final String TEXT_63 = ".deleteObject(";
  protected final String TEXT_64 = ", key_";
  protected final String TEXT_65 = ");" + NL + "\t\t\t";
  protected final String TEXT_66 = "\t" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_67 = " - Delete the object successfully.\");" + NL + "\t\t\t";
  protected final String TEXT_68 = NL + "\t\t}else{" + NL + "\t\t\tthrow(new RuntimeException(\"Please set key!\"));" + NL + "\t\t}" + NL + "\t}catch(java.lang.Exception e_";
