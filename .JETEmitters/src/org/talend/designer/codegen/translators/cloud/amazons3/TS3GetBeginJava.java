...
public class TS3GetBeginJava
{
  ...
  protected final String TEXT_56 = " - Getting an object with key:\" + ";
  protected final String TEXT_57 = ");" + NL + "\t\t";
  protected final String TEXT_58 = NL + "\t\tconn_";
  protected final String TEXT_59 = ".getObject(new com.amazonaws.services.s3.model.GetObjectRequest(";
  protected final String TEXT_60 = ", ";
  protected final String TEXT_61 = "),new java.io.File(";
  protected final String TEXT_62 = "));" + NL + "\t\t";
  protected final String TEXT_63 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_64 = " - Get the object successfully.\");" + NL + "\t\t";
