...
public class TGoogleDriveListBeginJava
{
  ...
  protected final String TEXT_36 = "_folderName.isEmpty())" + NL + "    {" + NL + "    \tthrow new Exception(\"Folder name can not be ampty\");" + NL + "    }" + NL + "\t" + NL + "    if(";
  ...
  protected final String TEXT_44 = " //without subfolders" + NL + "    do {" + NL + "      try {" + NL + "      " + NL + "      if(!";
  ...
  protected final String TEXT_59 = "_folderName.equals(\"root\")) {" + NL + "\t        if (files.getItems().size() > 1) {" + NL + "\t        \tthrow new Exception(\"More then one folder with name \" + \"\\\"\" + ";
  ...
  protected final String TEXT_75 = "_request.setPageToken(files.getNextPageToken());" + NL + "      } catch (IOException e) {" + NL + "        System.out.println(\"An error occurred: \" + e);";
  protected final String TEXT_76 = NL + "        ";
  protected final String TEXT_77 = "_request.setPageToken(null);" + NL + "      }" + NL + "    } while (";
  protected final String TEXT_78 = "_request.getPageToken() != null &&";
  protected final String TEXT_79 = NL + "             ";
  protected final String TEXT_80 = "_request.getPageToken().length() > 0);";
  protected final String TEXT_81 = NL + "    java.util.List<String> subfolders_";
  protected final String TEXT_82 = " = new java.util.ArrayList<String>(); " + NL + "    if(!";
  protected final String TEXT_83 = "_folderName.equals(\"root\")) {" + NL + "   \t\t";
  protected final String TEXT_84 = "_request.setQ(\"title = '\" + ";
  protected final String TEXT_85 = "_folderName + \"' and mimeType = 'application/vnd.google-apps.folder'\");" + NL + "   \t\tcom.google.api.services.drive.model.FileList ";
  protected final String TEXT_86 = "_files = ";
  protected final String TEXT_87 = "_request.execute();" + NL + "   \t\tif (";
  protected final String TEXT_88 = "_files.getItems().size() > 1) {" + NL + "        \tthrow new Exception(\"More then one folder with name \" + \"\\\"\" + ";
  protected final String TEXT_89 = "_folderName + \"\\\" found!\");" + NL + "        } else if (";
  protected final String TEXT_90 = "_files.getItems().isEmpty()) {" + NL + "        \tthrow new Exception(\"No folder with name \" + \"\\\"\" + ";
  protected final String TEXT_91 = "_folderName + \"\\\" found!\");" + NL + "        } else {" + NL + "        \tsubfolders_";
  protected final String TEXT_92 = ".add(";
  protected final String TEXT_93 = "_files.getItems().get(0).getId());" + NL + "   \t\t}" + NL + "   \t\t";
  protected final String TEXT_94 = "_request = ";
  protected final String TEXT_95 = "_client.files().list();" + NL + "    } else {" + NL + "\tsubfolders_";
  protected final String TEXT_96 = ".add(";
  protected final String TEXT_97 = "_folderName);" + NL + "\t}" + NL + "\twhile (subfolders_";
  protected final String TEXT_98 = ".size()>0) {" + NL + "    do {" + NL + "      try {" + NL + "\t  \t";
  protected final String TEXT_99 = NL + "\t  \t\t";
  protected final String TEXT_100 = "_request.setQ(\"'\"+subfolders_";
  protected final String TEXT_101 = ".get(0)+\"' in parents and mimeType = 'application/vnd.google-apps.folder'\");" + NL + "     \t";
  protected final String TEXT_102 = NL + "      \t\t";
  protected final String TEXT_103 = "_request.setQ(\"'\"+subfolders_";
  protected final String TEXT_104 = ".get(0)+\"' in parents\"); // check all files and folders" + NL + "      \t";
  protected final String TEXT_105 = NL + "        com.google.api.services.drive.model.FileList files = ";
  protected final String TEXT_106 = "_request.execute();" + NL + "       " + NL + "\t\tfor (com.google.api.services.drive.model.File file : files.getItems()) {" + NL + "\t\t  if (file.getMimeType().equals(\"application/vnd.google-apps.folder\")) {" + NL + "\t\t\tsubfolders_";
  protected final String TEXT_107 = ".add(file.getId());" + NL + "          } " + NL + "          if (" + NL + "\t\t\t      \"BOTH\".equals(\"";
  protected final String TEXT_108 = "\")" + NL + "\t\t\t\t || (" + NL + "\t\t\t\t       \"FILES\".equals(\"";
  protected final String TEXT_109 = "\")" + NL + "\t\t\t\t\t    &&" + NL + "\t\t\t\t\t\t!file.getMimeType().equals(\"application/vnd.google-apps.folder\")" + NL + "\t\t\t\t\t) " + NL + "\t\t\t\t || (" + NL + "\t\t\t\t        \"DIRECTORIES\".equals(\"";
  protected final String TEXT_110 = "\")" + NL + "\t\t\t\t\t\t && " + NL + "\t\t\t\t\t\t file.getMimeType().equals(\"application/vnd.google-apps.folder\")" + NL + "\t\t\t\t\t) " + NL + "\t\t    )" + NL + "\t\t  {" + NL + "\t\t\t";
  protected final String TEXT_111 = "_result.add(file);" + NL + "\t\t  }" + NL + " \t\t}";
  protected final String TEXT_112 = NL + "        ";
  protected final String TEXT_113 = "_request.setPageToken(files.getNextPageToken());" + NL + "      } catch (IOException e) {" + NL + "        System.out.println(\"An error occurred: \" + e);";
  protected final String TEXT_114 = NL + "        ";
  protected final String TEXT_115 = "_request.setPageToken(null);" + NL + "      }" + NL + "    } while (";
  protected final String TEXT_116 = "_request.getPageToken() != null &&";
  protected final String TEXT_117 = NL + "             ";
  protected final String TEXT_118 = "_request.getPageToken().length() > 0);" + NL + "    subfolders_";
  protected final String TEXT_119 = ".remove(0);" + NL + "\t}" + NL + "     ";
  protected final String TEXT_120 = NL + "\tfor (com.google.api.services.drive.model.File ";
  protected final String TEXT_121 = "_temp : ";
  protected final String TEXT_122 = "_result) {" + NL + "" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_123 = "_ID\",";
  protected final String TEXT_124 = "_temp.getId());" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_125 = "_TITLE\",";
  protected final String TEXT_126 = "_temp.getTitle());" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_127 = "_MIME_TYPE\",";
  protected final String TEXT_128 = "_temp.getMimeType());" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_129 = "_LAST_MODIFIED\",";
  protected final String TEXT_130 = "_temp.getModifiedDate().toStringRfc3339());" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_131 = "_SIZE\",";
  protected final String TEXT_132 = "_temp.getFileSize());" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_133 = "_SELF_LINK\",";
  protected final String TEXT_134 = "_temp.getSelfLink());" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_135 = "_PARENTS\",";
  protected final String TEXT_136 = "_temp.getParents());" + NL + "\t\t\ttry{" + NL + NL;
