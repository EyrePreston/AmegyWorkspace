...
public class TBoxPutBeginJava
{
  ...
  protected final String TEXT_97 = "_filePath = normalizePath(";
  protected final String TEXT_98 = ");" + NL + "\tString ";
  protected final String TEXT_99 = "_remotePath = normalizePath(";
  protected final String TEXT_100 = ");" + NL + "\t" + NL + "\tif(";
  protected final String TEXT_101 = "_remotePath == null || \"\".equals(";
  protected final String TEXT_102 = "_remotePath.trim()))" + NL + "\t{" + NL + "\t\tthrow new Exception(\"The Box remote path can't be null\");" + NL + "\t}" + NL + "\tboolean ";
  protected final String TEXT_103 = "_hasError = false;" + NL + "\tString ";
  protected final String TEXT_104 = "_remoteName = getFolderFromPath(";
  protected final String TEXT_105 = "_remotePath);" + NL + "\t" + NL + "\tcom.box.boxjavalibv2.dao.BoxFile ";
  protected final String TEXT_106 = "_boxFile = null;" + NL + "\tcom.box.boxjavalibv2.dao.BoxFolder ";
  protected final String TEXT_107 = "_boxFolder = null;";
  protected final String TEXT_108 = NL + "\tjava.io.ByteArrayOutputStream ";
  protected final String TEXT_109 = "_uploader_output = new java.io.ByteArrayOutputStream();" + NL + "\tjava.io.ByteArrayInputStream ";
  protected final String TEXT_110 = "_uploader_input = null;" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_111 = "_OUTPUTSTREAM\", ";
  protected final String TEXT_112 = "_uploader_output);" + NL + "\ttry" + NL + "\t{";
