...
public class TS3BucketDeleteBeginJava
{
  ...
  protected final String TEXT_56 = " - Deleting a bucket with name:\" + ";
  protected final String TEXT_57 = ");" + NL + "\t\t";
  protected final String TEXT_58 = NL + "\t\tconn_";
  protected final String TEXT_59 = ".deleteBucket(";
  protected final String TEXT_60 = ");" + NL + "\t\t";
  protected final String TEXT_61 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_62 = " - Delete the bucket successfully.\");" + NL + "\t\t";
  protected final String TEXT_63 = NL + "\t}catch(java.lang.Exception e_";
  ...
  protected final String TEXT_72 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_73 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_74 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
