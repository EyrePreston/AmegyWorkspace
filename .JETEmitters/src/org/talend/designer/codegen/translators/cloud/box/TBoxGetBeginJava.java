...
public class TBoxGetBeginJava
{
  ...
  protected final String TEXT_110 = "_boxFile = null;" + NL + "\tcom.box.restclientv2.requestsbase.BoxDefaultRequestObject ";
  protected final String TEXT_111 = "_requestObject = new com.box.restclientv2.requestsbase.BoxDefaultRequestObject();" + NL + "\t\tcom.box.boxjavalibv2.dao.BoxCollection ";
  protected final String TEXT_112 = "_searchResults = ";
  protected final String TEXT_113 = "_client.getSearchManager().search(";
  protected final String TEXT_114 = "_name, ";
  protected final String TEXT_115 = "_requestObject);" + NL + "\t\tfor (com.box.boxjavalibv2.dao.BoxTypedObject ";
  protected final String TEXT_116 = "_entry : ";
  protected final String TEXT_117 = "_searchResults.getEntries())" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_118 = "_entry instanceof com.box.boxjavalibv2.dao.BoxFile && ((com.box.boxjavalibv2.dao.BoxFile) ";
  protected final String TEXT_119 = "_entry).getName().equals(";
  protected final String TEXT_120 = "_name))" + NL + "\t\t\t{" + NL + "\t\t\t\tif (";
  protected final String TEXT_121 = "_path == null || ";
  protected final String TEXT_122 = "_path.isEmpty())" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\t";
  protected final String TEXT_123 = "_boxFile = ((com.box.boxjavalibv2.dao.BoxFile) ";
  protected final String TEXT_124 = "_entry);" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.lang.StringBuilder ";
  protected final String TEXT_125 = "_sBuilder = new java.lang.StringBuilder();" + NL + "\t\t\t\tfor (com.box.boxjavalibv2.dao.BoxTypedObject ";
  protected final String TEXT_126 = "_obj : ((com.box.boxjavalibv2.dao.BoxFile) ";
  protected final String TEXT_127 = "_entry).getPathCollection().getEntries())" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\t";
  protected final String TEXT_128 = "_sBuilder.append(";
  protected final String TEXT_129 = "_obj.getValue(\"name\") + \"/\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_130 = "_sBuilder.append(((com.box.boxjavalibv2.dao.BoxFile) ";
  protected final String TEXT_131 = "_entry).getName());" + NL + "\t\t\t\tif (";
  protected final String TEXT_132 = "_sBuilder.toString().equals(";
  protected final String TEXT_133 = "_path))" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\t";
  protected final String TEXT_134 = "_boxFile = (com.box.boxjavalibv2.dao.BoxFile) ";
  protected final String TEXT_135 = "_entry;" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\telse if (";
  protected final String TEXT_136 = "_entry instanceof com.box.boxjavalibv2.dao.BoxFolder && ((com.box.boxjavalibv2.dao.BoxFolder) ";
  protected final String TEXT_137 = "_entry).getName().equals(";
  protected final String TEXT_138 = "_name))" + NL + "\t\t\t{" + NL + "\t\t\t\tjava.lang.StringBuilder ";
  protected final String TEXT_139 = "_sBuilder = new java.lang.StringBuilder();" + NL + "\t\t\t\tfor (com.box.boxjavalibv2.dao.BoxTypedObject ";
  protected final String TEXT_140 = "_obj : ((com.box.boxjavalibv2.dao.BoxFolder) ";
  protected final String TEXT_141 = "_entry).getPathCollection().getEntries())" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\t";
  protected final String TEXT_142 = "_sBuilder.append(";
  protected final String TEXT_143 = "_obj.getValue(\"name\") + \"/\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_144 = "_sBuilder.append(((com.box.boxjavalibv2.dao.BoxFolder) ";
  protected final String TEXT_145 = "_entry).getName());" + NL + "\t\t\t\tif (";
  protected final String TEXT_146 = "_sBuilder.toString().equals(";
  protected final String TEXT_147 = "_path))" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\t";
  protected final String TEXT_148 = "_hasError = true;" + NL + "\t\t\t\t\tthrow new Exception(";
  protected final String TEXT_149 = " + \" exists but is a directory\");\t\t\t\t" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "" + NL + "\tif (";
  protected final String TEXT_150 = "_boxFile == null && !";
  protected final String TEXT_151 = "_hasError) {" + NL + "\t\tthrow new Exception(\"No file found in \" + ";
  protected final String TEXT_152 = "_boxPath);" + NL + "\t} else if (";
  protected final String TEXT_153 = "_boxFile == null && ";
  protected final String TEXT_154 = "_hasError) {" + NL + "\t//Do Nothing, error already occured" + NL + "\t} else {" + NL + "\t\tjava.io.OutputStream ";
  protected final String TEXT_155 = "_fos = null;" + NL + "\t\tjava.io.InputStream ";
  protected final String TEXT_156 = "_bais = null;" + NL + "\t\ttry {";
  protected final String TEXT_157 = NL + "\t\t\tString ";
  protected final String TEXT_158 = "_outputFolder = ";
  protected final String TEXT_159 = ";" + NL + "\t\t\tif (null == ";
  protected final String TEXT_160 = "_outputFolder || ";
  protected final String TEXT_161 = "_outputFolder.isEmpty()) {" + NL + "\t\t\t\tthrow new Exception(\"Output folder can not be empty\");" + NL + "\t\t\t}" + NL + "\t\t    java.io.File ";
  protected final String TEXT_162 = "_f = new java.io.File(";
  protected final String TEXT_163 = "_outputFolder);" + NL + "\t\t\tif(!";
  protected final String TEXT_164 = "_f.getParentFile().exists()){" + NL + "\t\t\t\t";
  protected final String TEXT_165 = "_f.getParentFile().mkdirs();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_166 = "_fos = new java.io.FileOutputStream(";
  protected final String TEXT_167 = "_f);" + NL + "\t\t\t";
  protected final String TEXT_168 = "_client.getFilesManager().downloadFile(";
  protected final String TEXT_169 = "_boxFile.getId(), new java.io.OutputStream[] {";
  protected final String TEXT_170 = "_fos}, null, new com.box.restclientv2.requestsbase.BoxDefaultRequestObject());" + NL + "\t\t\t" + NL + "\t";
  protected final String TEXT_171 = "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_172 = ".fileName = ";
  protected final String TEXT_173 = "_f.getName();" + NL + "\t\t\t";
  protected final String TEXT_174 = ".content = new java.io.FileInputStream(";
  protected final String TEXT_175 = "_f);" + NL + "\t";
  protected final String TEXT_176 = NL + "\t\t\t";
  protected final String TEXT_177 = "_fos = new java.io.ByteArrayOutputStream();" + NL + "\t\t\t";
  protected final String TEXT_178 = "_client.getFilesManager().downloadFile(";
  protected final String TEXT_179 = "_boxFile.getId(), new java.io.OutputStream[] {";
  protected final String TEXT_180 = "_fos}, null, new com.box.restclientv2.requestsbase.BoxDefaultRequestObject());" + NL + "\t\t\t((ByteArrayOutputStream) ";
  protected final String TEXT_181 = "_fos).flush();" + NL + "\t\t\t((ByteArrayOutputStream) ";
  protected final String TEXT_182 = "_fos).close();" + NL + "\t\t\t";
  protected final String TEXT_183 = "_bais = new java.io.ByteArrayInputStream(((ByteArrayOutputStream) ";
  protected final String TEXT_184 = "_fos).toByteArray());";
  protected final String TEXT_185 = NL + "\t\t\t";
  protected final String TEXT_186 = ".fileName = ";
  protected final String TEXT_187 = "_boxFile.getName();" + NL + "\t\t\t";
  protected final String TEXT_188 = ".content = ";
  protected final String TEXT_189 = "_bais;\t";
  protected final String TEXT_190 = NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_191 = "_INPUT_STREAM\", ";
  protected final String TEXT_192 = "_bais);" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_193 = "_FILE_NAME\", ";
  protected final String TEXT_194 = "_boxFile.getName());";
  protected final String TEXT_195 = NL + "\t\t\t" + NL + "\t\t} finally {" + NL + "\t\t\tif(";
  protected final String TEXT_196 = "_fos != null){" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\t";
  protected final String TEXT_197 = "_fos.close();" + NL + "\t\t\t\t} catch (java.io.IOException e) {" + NL + "\t\t\t\t\t// Ignore" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t" + NL + "\t\t" + NL + "\t\t" + NL + "\t}\t" + NL + "\t\t\t";
