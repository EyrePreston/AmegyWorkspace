...
public class TS3BucketCreateMainJava
{
  ...
  protected final String TEXT_56 = " - Creating a bucket with name:\" + ";
  protected final String TEXT_57 = ");" + NL + "\t\t";
  protected final String TEXT_58 = NL + "\t\tconn_";
  protected final String TEXT_59 = ".createBucket(";
  protected final String TEXT_60 = ");" + NL + "\t\t";
  protected final String TEXT_61 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_62 = " - Create the bucket successfully.\");" + NL + "\t\t";
