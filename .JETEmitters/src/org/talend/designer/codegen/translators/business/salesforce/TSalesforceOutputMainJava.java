...
public class TSalesforceOutputMainJava
{
  ...
  protected final String TEXT_40 = NL + "    String decryptedPwd_";
  protected final String TEXT_41 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_42 = ");";
  protected final String TEXT_43 = NL + "    String decryptedPwd_";
  protected final String TEXT_44 = " = ";
  protected final String TEXT_45 = ";";
  protected final String TEXT_46 = NL + "    java.util.Properties props_";
  protected final String TEXT_47 = " = System.getProperties();" + NL + "    props_";
  protected final String TEXT_48 = ".put(\"socksProxyHost\",";
  protected final String TEXT_49 = ");  " + NL + "    props_";
  protected final String TEXT_50 = ".put(\"socksProxyPort\",";
  protected final String TEXT_51 = ");" + NL + "    props_";
  protected final String TEXT_52 = ".put(\"java.net.socks.username\", ";
  protected final String TEXT_53 = ");" + NL + "    props_";
  protected final String TEXT_54 = ".put(\"java.net.socks.password\", decryptedPwd_";
  protected final String TEXT_55 = "); " + NL + "    ";
  protected final String TEXT_56 = NL;
  protected final String TEXT_57 = NL + NL + "\t";
  protected final String TEXT_58 = " = null;\t\t\t";
  protected final String TEXT_59 = NL + "///////////////////////\t\t" + NL + "" + NL + "" + NL + "Object[] resultMessageObj_";
  protected final String TEXT_60 = " = null;";
  protected final String TEXT_61 = NL;
  protected final String TEXT_62 = NL + "\t\t\t\tjava.util.List<org.apache.axiom.om.OMElement> list_";
  protected final String TEXT_63 = " = new java.util.ArrayList<org.apache.axiom.om.OMElement>();" + NL + "\t\t\t\t//the null value will be updated or inserted,so we can't treat it as key for updating(only Id can be the key) or upserting(Id,external id or indexed id)" + NL + "\t\t\t\tjava.util.List<String> nullList_";
  protected final String TEXT_64 = " = new java.util.ArrayList<String>();\t\t\t\t";
  protected final String TEXT_65 = NL + "\t\t\t\t\t\t\t\torg.apache.axiom.om.OMElement reference_";
  protected final String TEXT_66 = "_";
  protected final String TEXT_67 = "_";
  protected final String TEXT_68 = " = fac_";
  protected final String TEXT_69 = ".createOMElement(";
  protected final String TEXT_70 = ", null);" + NL + "\t\t\t\t\t\t\t\treference_";
  protected final String TEXT_71 = "_";
  protected final String TEXT_72 = "_";
  protected final String TEXT_73 = ".addChild(org.talend.salesforce.SforceManagementUtil.newOMElement(\"type\",";
  protected final String TEXT_74 = "));";
  protected final String TEXT_75 = NL + "\t\t\t\t\t\t\t\t\tif(";
  protected final String TEXT_76 = ".";
  protected final String TEXT_77 = " != null){" + NL + "\t\t\t\t\t\t\t\t\t\treference_";
  protected final String TEXT_78 = "_";
  protected final String TEXT_79 = "_";
  protected final String TEXT_80 = ".addChild(org.talend.salesforce.SforceManagementUtil.newOMElement(";
  protected final String TEXT_81 = ",FormatterUtils.format_Date(";
  protected final String TEXT_82 = ".";
  protected final String TEXT_83 = ", ";
  protected final String TEXT_84 = ") ));" + NL + "        \t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_85 = ".add(reference_";
  protected final String TEXT_86 = "_";
  protected final String TEXT_87 = "_";
  protected final String TEXT_88 = ");" + NL + "\t\t\t\t\t\t\t\t\t}";
  protected final String TEXT_89 = NL + "\t\t\t\t\t\t\t\t\tif(";
  protected final String TEXT_90 = ".";
  protected final String TEXT_91 = " != null){" + NL + "\t\t\t\t\t\t\t\t\t\treference_";
  protected final String TEXT_92 = "_";
  protected final String TEXT_93 = "_";
  protected final String TEXT_94 = ".addChild(org.talend.salesforce.SforceManagementUtil.newOMElement(";
  protected final String TEXT_95 = ",java.nio.charset.Charset.defaultCharset().decode(java.nio.ByteBuffer.wrap(";
  protected final String TEXT_96 = ".";
  protected final String TEXT_97 = ")).toString() ));" + NL + "        \t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_98 = ".add(reference_";
  ...
  protected final String TEXT_105 = " != null && !\"\".equals(String.valueOf(";
  protected final String TEXT_106 = ".";
  protected final String TEXT_107 = "))) { " + NL + "\t\t\t\t\t    \t\t\t";
  protected final String TEXT_108 = NL + "\t\t\t\t\t    \t\t\tif(!\"\".equals(String.valueOf(";
  protected final String TEXT_109 = ".";
  protected final String TEXT_110 = "))) { " + NL + "\t\t\t\t\t    \t\t\t";
  protected final String TEXT_111 = NL + "\t\t\t\t\t\t\t\t\t\treference_";
  protected final String TEXT_112 = "_";
  protected final String TEXT_113 = "_";
  protected final String TEXT_114 = ".addChild(org.talend.salesforce.SforceManagementUtil.newOMElement(";
  protected final String TEXT_115 = ",String.valueOf(";
  protected final String TEXT_116 = ".";
  protected final String TEXT_117 = ") ));" + NL + "    \t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_118 = ".add(reference_";
  protected final String TEXT_119 = "_";
  protected final String TEXT_120 = "_";
  protected final String TEXT_121 = ");" + NL + "\t\t\t\t\t\t\t\t\t}";
  protected final String TEXT_122 = NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_123 = ".";
  protected final String TEXT_124 = " != null){" + NL + "\t\t\t\t\t\t\tlist_";
  protected final String TEXT_125 = ".add(org.talend.salesforce.SforceManagementUtil.newOMElement(\"";
  protected final String TEXT_126 = "\",FormatterUtils.format_Date(";
  ...
  protected final String TEXT_134 = "\",java.nio.charset.Charset.defaultCharset().decode(java.nio.ByteBuffer.wrap(";
  protected final String TEXT_135 = ".";
  protected final String TEXT_136 = ")).toString() ));" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_137 = "   \t\t\t\t" + NL + "\t\t    \t\t\t";
  protected final String TEXT_138 = NL + "\t\t    \t\t\tif(";
  protected final String TEXT_139 = ".";
  protected final String TEXT_140 = " != null && !\"\".equals(String.valueOf(";
  protected final String TEXT_141 = ".";
  protected final String TEXT_142 = "))) { " + NL + "\t\t    \t\t\t";
  protected final String TEXT_143 = NL + "\t\t    \t\t\tif(!\"\".equals(String.valueOf(";
  protected final String TEXT_144 = ".";
  protected final String TEXT_145 = "))) { " + NL + "\t\t    \t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\t\t\t\tlist_";
  protected final String TEXT_147 = ".add(org.talend.salesforce.SforceManagementUtil.newOMElement(\"";
  protected final String TEXT_148 = "\",String.valueOf(";
  protected final String TEXT_149 = ".";
  protected final String TEXT_150 = ") ));" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_151 = NL + "\t\t\t\t\t";
  protected final String TEXT_152 = NL + "\t\t\t\t\t    else{" + NL + "\t\t\t\t\t\t\tnullList_";
  protected final String TEXT_153 = ".add(\"";
  protected final String TEXT_154 = "\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_155 = NL + "\t\t\t\t\t\t\t" + NL + " \t\t\t" + NL + "    \t\t\t";
  protected final String TEXT_156 = " " + NL + "\t\t\t";
  protected final String TEXT_157 = NL + NL + "resultMessageObj_";
  protected final String TEXT_158 = " = sforceManagement_";
  protected final String TEXT_159 = ".insert(";
  protected final String TEXT_160 = ", (org.apache.axiom.om.OMElement[])list_";
  protected final String TEXT_161 = ".toArray(new org.apache.axiom.om.OMElement[list_";
  protected final String TEXT_162 = ".size()]));    \t\t\t" + NL;
  protected final String TEXT_163 = NL + NL + "resultMessageObj_";
  protected final String TEXT_164 = " = sforceManagement_";
  protected final String TEXT_165 = ".update(";
  protected final String TEXT_166 = ", ";
  protected final String TEXT_167 = ".Id, (org.apache.axiom.om.OMElement[])list_";
  protected final String TEXT_168 = ".toArray(new org.apache.axiom.om.OMElement[list_";
  protected final String TEXT_169 = ".size()]),(String[])nullList_";
  protected final String TEXT_170 = ".toArray(new String[nullList_";
  protected final String TEXT_171 = ".size()]));    \t\t\t" + NL;
  protected final String TEXT_172 = " " + NL + "" + NL + "resultMessageObj_";
  protected final String TEXT_173 = " = sforceManagement_";
  protected final String TEXT_174 = ".upsert(";
  protected final String TEXT_175 = ", \"";
  protected final String TEXT_176 = "\", (org.apache.axiom.om.OMElement[])list_";
  protected final String TEXT_177 = ".toArray(new org.apache.axiom.om.OMElement[list_";
  protected final String TEXT_178 = ".size()]),(String[])nullList_";
  protected final String TEXT_179 = ".toArray(new String[nullList_";
  protected final String TEXT_180 = ".size()]));    \t\t\t" + NL;
  protected final String TEXT_181 = NL + "    \t\t\t";
  protected final String TEXT_182 = NL + NL + "resultMessageObj_";
  protected final String TEXT_183 = " = sforceManagement_";
  protected final String TEXT_184 = ".delete(";
  protected final String TEXT_185 = ".Id);    \t\t\t" + NL;
  protected final String TEXT_186 = "     \t\t\t" + NL + "    \t\t\t" + NL + "\t\t\tnb_line_";
  protected final String TEXT_187 = "++;" + NL + "\t\t\t";
  protected final String TEXT_188 = NL + "\t\t\t\tjava.util.Map<String,String> resultMessage_";
  protected final String TEXT_189 = " = sforceManagement_";
  protected final String TEXT_190 = ".readResult(resultMessageObj_";
  protected final String TEXT_191 = ");" + NL + "\t\t\t\tif(resultMessage_";
  protected final String TEXT_192 = "!=null){" + NL + "\t\t\t\t\tif(\"true\".equals(resultMessage_";
  protected final String TEXT_193 = ".get(\"success\"))){" + NL + "\t\t\t\t\t\tnb_success_";
  ...
  protected final String TEXT_200 = ".salesforce_id = resultMessage_";
  protected final String TEXT_201 = ".get(\"id\");" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_208 = NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tnb_reject_";
  protected final String TEXT_209 = "++;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_210 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_211 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_212 = " = new ";
  protected final String TEXT_213 = "Struct();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_214 = ".errorCode = resultMessage_";
  protected final String TEXT_215 = ".get(\"StatusCode\");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_216 = ".errorFields = resultMessage_";
  protected final String TEXT_217 = ".get(\"Fields\");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_218 = ".errorMessage = resultMessage_";
  protected final String TEXT_219 = ".get(\"Message\");" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_226 = NL + "\t\t\t\tnb_success_";
  protected final String TEXT_227 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_228 = NL + "\t\t\t\t";
  protected final String TEXT_229 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_230 = " = new ";
  protected final String TEXT_231 = "Struct();" + NL + "\t\t\t\t\t\t";
