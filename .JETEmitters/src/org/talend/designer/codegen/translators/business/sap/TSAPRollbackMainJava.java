...
public class TSAPRollbackMainJava
{
  ...
  protected final String TEXT_46 = "!=null && connection_";
  protected final String TEXT_47 = ".isAlive()) {" + NL + "\t\torg.talend.sap.ISAPTransaction transaction_";
  protected final String TEXT_48 = " = connection_";
  protected final String TEXT_49 = ".getTransaction();" + NL + "\t\tif(transaction_";
  protected final String TEXT_50 = "!=null && transaction_";
  protected final String TEXT_51 = ".isAlive()) {" + NL + "\t\t\ttry {" + NL + "\t     \t\ttransaction_";
  protected final String TEXT_52 = ".rollback();" + NL + "\t    \t} catch (org.talend.sap.exception.SAPException e_";
  protected final String TEXT_53 = ") {" + NL + "\t    \t\tconnection_";
  protected final String TEXT_54 = ".close();" + NL + "\t    \t\tthrow new RuntimeException(e_";
  protected final String TEXT_55 = ".getMessage());" + NL + "\t\t    }" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\t";
  ...
  protected final String TEXT_59 = ".beginTransaction();" + NL + "\t\t";
