...
public class TBonitaInstantiateProcessBeginJava
{
  ...
  protected final String TEXT_21 = ".setRequestProperty(\"Content-Type\", \"application/x-www-form-urlencoded\");" + NL + "\t        " + NL + "\t\t";
  ...
  protected final String TEXT_29 = NL + "\t\t   \t" + NL + "\t    httpConn_";
  ...
  protected final String TEXT_44 = "=new java.util.HashMap<String, Object>();" + NL + "\t        " + NL + "\t\t";
  ...
  protected final String TEXT_52 = NL + "\t   \t" + NL + "\t\tloginContext_";
