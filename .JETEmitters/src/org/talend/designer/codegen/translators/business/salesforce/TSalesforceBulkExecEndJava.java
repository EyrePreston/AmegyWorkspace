...
public class TSalesforceBulkExecEndJava
{
  ...
  protected final String TEXT_39 = " " + NL + " \t" + NL + " \t}" + NL + " }" + NL + " \tsforceBulk_";
  protected final String TEXT_40 = ".closeFileRead();" + NL + " \tglobalMap.put(\"";
  protected final String TEXT_41 = "_NB_LINE\",nb_line_";
  protected final String TEXT_42 = ");" + NL + " \tglobalMap.put(\"";
  protected final String TEXT_43 = "_NB_SUCCESS\",nb_success_";
  protected final String TEXT_44 = ");" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_45 = "_NB_REJECT\",nb_reject_";
