...
public class TSAPInputBeginJava
{
  ...
  protected final String TEXT_149 = NL + "\t\ttry{";
  protected final String TEXT_150 = NL + "\t\t\t\t\tdest_";
  protected final String TEXT_151 = " = com.sap.conn.jco.JCoDestinationManager.getDestination(";
  protected final String TEXT_152 = ");";
  protected final String TEXT_153 = NL + "\t            if (null == dest_";
  protected final String TEXT_154 = ") {";
  protected final String TEXT_155 = NL + "\t\t\t\t\torg.talend.sap.TSAPDestinationData destinationData_";
  protected final String TEXT_156 = " = null;" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tjava.util.Properties properties_";
  protected final String TEXT_157 = " = new java.util.Properties();" + NL + "        \t\t\t";
  protected final String TEXT_158 = NL + "                \t\tproperties_";
  protected final String TEXT_159 = ".setProperty(\"jco.client.snc_mode\", \"1\");" + NL + "                \t\tproperties_";
  protected final String TEXT_160 = ".setProperty(\"jco.client.snc_partnername\", ";
  protected final String TEXT_161 = ");" + NL + "                \t\tproperties_";
  protected final String TEXT_162 = ".setProperty(\"jco.client.snc_qop\", String.valueOf(";
  protected final String TEXT_163 = "));" + NL + "                \t\t";
  protected final String TEXT_164 = NL + "                    \t\tif(";
  protected final String TEXT_165 = " != null){" + NL + "                    \t\t\tproperties_";
  protected final String TEXT_166 = ".setProperty(\"jco.client.snc_myname\", ";
  protected final String TEXT_167 = ");" + NL + "                    \t\t}" + NL + "                \t\t";
  protected final String TEXT_168 = NL + "                \t\t";
  protected final String TEXT_169 = NL + "                    \t\tif(";
  protected final String TEXT_170 = " != null){" + NL + "                    \t\t\tproperties_";
  protected final String TEXT_171 = ".setProperty(\"jco.client.snc_lib\", ";
  ...
  protected final String TEXT_180 = NL + "        \t\t\t\tdestinationData_";
  protected final String TEXT_181 = " = new org.talend.sap.TSAPApplicationServerDestData.Builder(";
  protected final String TEXT_182 = "," + NL + "        \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_183 = "," + NL + "        \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tdecryptedPassword_";
  protected final String TEXT_184 = "," + NL + "        \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_185 = "," + NL + "        \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_186 = "," + NL + "        \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_187 = ")" + NL + "            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_188 = NL + "            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t.setSAPGUI(\"2\")" + NL + "            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_189 = NL + "        \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t.setCustomProp(properties_";
  protected final String TEXT_190 = ")" + NL + "        \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t.build();" + NL + "        \t\t\t";
  protected final String TEXT_191 = "\t\t\t" + NL + "        \t\t\t\tdestinationData_";
  protected final String TEXT_192 = " = new org.talend.sap.TSAPMessageServerDestData.Builder(";
  protected final String TEXT_193 = "," + NL + "        \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_194 = "," + NL + "        \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tdecryptedPassword_";
  protected final String TEXT_195 = "," + NL + "        \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_196 = "," + NL + "        \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_197 = "," + NL + "        \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_198 = "," + NL + "        \t\t\t\t\t\t            \t\t\t\t \t\t\t\t\t\t\t\t";
  protected final String TEXT_199 = ")" + NL + "        \t\t\t\t\t\t            \t\t\t\t \t\t\t\t\t\t\t\t";
  protected final String TEXT_200 = NL + "            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t.setSAPGUI(\"2\")" + NL + "            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_201 = NL + "        \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t.setCustomProp(properties_";
  protected final String TEXT_202 = ")" + NL + "            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t.build();" + NL + "        \t\t\t";
  protected final String TEXT_203 = NL + "        \t\t    ";
  protected final String TEXT_204 = NL + "        \t\t\t\tcom.sap.conn.jco.JCo.setMiddlewareProperty(\"jco.middleware.allow_start_of_programs\", \"ftp;sapftp;sapftpa;sapkprotp;http;saphttp;saphttpa\");" + NL + "        \t\t\t";
  protected final String TEXT_205 = NL + "        \t\t\tdest_";
  protected final String TEXT_206 = " = org.talend.sap.TSAPDestinationFactory.getInstance().getDestination(destinationData_";
  protected final String TEXT_207 = ");" + NL + "        \t\t\t// Begins the stateful call sequence for calls to the specified destination." + NL + "\t\t    \t\tcom.sap.conn.jco.JCoContext.begin(dest_";
  protected final String TEXT_208 = ");";
  protected final String TEXT_209 = NL + "\t\t\t\t}";
  protected final String TEXT_210 = NL + "\t\t";
  protected final String TEXT_211 = " " + NL + "\t\tcom.sap.conn.jco.JCoRepository repository_";
  protected final String TEXT_212 = " = dest_";
  protected final String TEXT_213 = ".getRepository();" + NL + "\t\t" + NL + "\t\tcom.sap.conn.jco.JCoFunctionTemplate functionTemplate_";
  protected final String TEXT_214 = " = repository_";
  protected final String TEXT_215 = ".getFunctionTemplate(";
  protected final String TEXT_216 = ");" + NL + "\t\tif(functionTemplate_";
  protected final String TEXT_217 = " == null){" + NL + "\t\t\tcom.sap.conn.jco.JCoContext.end(dest_";
  protected final String TEXT_218 = ");" + NL + "\t\t\tthrow new RuntimeException(\"The RFC can't support the function: \" + ";
  protected final String TEXT_219 = " + \".\");" + NL + "\t\t}  " + NL + "\t\tcom.sap.conn.jco.JCoFunction function_";
  protected final String TEXT_220 = " = functionTemplate_";
  protected final String TEXT_221 = ".getFunction();" + NL + "\t\t" + NL + "\t\tcom.sap.conn.jco.JCoParameterList importParameterList_";
  protected final String TEXT_222 = " = function_";
  protected final String TEXT_223 = ".getImportParameterList();" + NL + "\t    com.sap.conn.jco.JCoParameterList exportParameterList_";
  protected final String TEXT_224 = " = function_";
  protected final String TEXT_225 = ".getExportParameterList();" + NL + "\t    com.sap.conn.jco.JCoParameterList tableParameterList_";
  protected final String TEXT_226 = " = function_";
  protected final String TEXT_227 = ".getTableParameterList();" + NL + "\t    " + NL + "\t    com.sap.conn.jco.JCoStructure input_structure_";
  protected final String TEXT_228 = "=null;" + NL + "\t    com.sap.conn.jco.JCoTable input_table_";
  protected final String TEXT_229 = "=null; " + NL + "\t    com.sap.conn.jco.JCoTable table_input_";
  protected final String TEXT_230 = "=null; " + NL + "\t";
  protected final String TEXT_231 = NL + "\t" + NL + "    Object isListObject_";
  protected final String TEXT_232 = "=null;" + NL + "        " + NL + "\t";
  protected final String TEXT_233 = NL + "\t\t\t";
  protected final String TEXT_234 = NL + "\t\t\t\timportParameterList_";
  protected final String TEXT_235 = ".setValue(";
  protected final String TEXT_236 = ",";
  protected final String TEXT_237 = "); // \"input_single\"" + NL + "\t\t\t";
  protected final String TEXT_238 = NL + "\t\t\t\timportParameterList_";
  protected final String TEXT_239 = ".setValue(";
  protected final String TEXT_240 = ",";
  protected final String TEXT_241 = "); // \"input_single\"" + NL + "\t\t\t";
  protected final String TEXT_242 = "\t\t" + NL + "\t\t";
  protected final String TEXT_243 = NL + "\t\t\tinput_structure_";
  protected final String TEXT_244 = " = importParameterList_";
  protected final String TEXT_245 = ".getStructure(";
  protected final String TEXT_246 = ");\t\t\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_247 = NL + "\t\t\t\t";
  protected final String TEXT_248 = NL + "\t\t\t\t\tinput_structure_";
  protected final String TEXT_249 = ".setValue(";
  protected final String TEXT_250 = ",";
  protected final String TEXT_251 = ");\t// \"input_structure\"" + NL + "\t\t\t\t";
  protected final String TEXT_252 = NL + "\t\t\t\t\tinput_structure_";
  protected final String TEXT_253 = ".setValue(";
  protected final String TEXT_254 = ",";
  protected final String TEXT_255 = ");\t// \"input_structure\"" + NL + "\t\t\t\t";
  protected final String TEXT_256 = "\t\t\t\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_257 = NL + "\t\t\t\tjava.util.List list_";
  protected final String TEXT_258 = "_";
  protected final String TEXT_259 = "_";
  protected final String TEXT_260 = " = new java.util.ArrayList();\t\t\t\t" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_266 = NL + "\t\t\t\t\tisListObject_";
  protected final String TEXT_267 = " = ";
  protected final String TEXT_268 = ";" + NL + "\t\t\t\t\tif(isListObject_";
  protected final String TEXT_269 = " instanceof java.util.List){" + NL + "\t\t\t\t\t\tlist_";
  protected final String TEXT_270 = "_";
  protected final String TEXT_271 = "_";
  protected final String TEXT_272 = ".addAll((java.util.List)isListObject_";
  protected final String TEXT_273 = ");" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tlist_";
  ...
  protected final String TEXT_278 = NL + "\t\t\tint rowSize_";
  protected final String TEXT_279 = "_";
  protected final String TEXT_280 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_281 = NL + "\t\t\t\t\trowSize_";
  ...
  protected final String TEXT_286 = ".size();\t\t\t\t\t\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_287 = NL + "\t\t\t\t\tif(rowSize_";
  ...
  protected final String TEXT_292 = ".size()){" + NL + "\t\t\t\t\t\tthrow new RuntimeException(\"The row count of column: ";
  protected final String TEXT_293 = " in table: ";
  protected final String TEXT_294 = " not equals others, please make sure the row count of every columns equal.\");" + NL + "\t\t\t\t\t}\t\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_295 = NL + "\t\t\tinput_table_";
  protected final String TEXT_296 = " = importParameterList_";
  protected final String TEXT_297 = ".getTable(";
  protected final String TEXT_298 = ");" + NL + "\t\t\tinput_table_";
  protected final String TEXT_299 = ".appendRows(rowSize_";
  protected final String TEXT_300 = "_";
  protected final String TEXT_301 = ");" + NL + "\t\t\tinput_table_";
  protected final String TEXT_302 = ".firstRow();" + NL + "\t\t\tfor(int rowNum_";
  protected final String TEXT_303 = "=0; rowNum_";
  protected final String TEXT_304 = " < rowSize_";
  protected final String TEXT_305 = "_";
  protected final String TEXT_306 = "; rowNum_";
  protected final String TEXT_307 = "++){\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_308 = NL + "\t\t\t\t\t";
  protected final String TEXT_309 = NL + "\t\t\t\t\t\tinput_table_";
  protected final String TEXT_310 = ".setValue(list_";
  protected final String TEXT_311 = "_";
  protected final String TEXT_312 = "_";
  protected final String TEXT_313 = ".get(rowNum_";
  protected final String TEXT_314 = "),";
  protected final String TEXT_315 = ");// \"table_input\"" + NL + "\t\t\t\t\t";
  protected final String TEXT_316 = NL + "\t\t\t\t\t\tinput_table_";
  protected final String TEXT_317 = ".setValue(";
  protected final String TEXT_318 = ",list_";
  protected final String TEXT_319 = "_";
  protected final String TEXT_320 = "_";
  protected final String TEXT_321 = ".get(rowNum_";
  protected final String TEXT_322 = "));// \"table_input\"" + NL + "\t\t\t\t\t";
  protected final String TEXT_323 = NL + "\t\t\t\t";
  protected final String TEXT_324 = NL + "\t\t\t\tinput_table_";
  protected final String TEXT_325 = ".nextRow();" + NL + "\t\t\t}\t" + NL + "\t\t";
  protected final String TEXT_326 = NL + "\t\t\t\tjava.util.List list_";
  protected final String TEXT_327 = "_";
  protected final String TEXT_328 = "_";
  protected final String TEXT_329 = " = new java.util.ArrayList();\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_330 = NL + "\t\t\t\t\t\tlist_";
  protected final String TEXT_331 = "_";
  protected final String TEXT_332 = "_";
  protected final String TEXT_333 = ".add(";
  protected final String TEXT_334 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_335 = NL + "\t\t\t\t\tisListObject_";
  protected final String TEXT_336 = " = ";
  protected final String TEXT_337 = ";" + NL + "\t\t\t\t\tif(isListObject_";
  protected final String TEXT_338 = " instanceof java.util.List){" + NL + "\t\t\t\t\t\tlist_";
  protected final String TEXT_339 = "_";
  protected final String TEXT_340 = "_";
  protected final String TEXT_341 = ".addAll((java.util.List)isListObject_";
  protected final String TEXT_342 = ");" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tlist_";
  ...
  protected final String TEXT_347 = NL + "\t\t\tint rowSize_";
  protected final String TEXT_348 = "_";
  protected final String TEXT_349 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_350 = NL + "\t\t\t\t\trowSize_";
  protected final String TEXT_351 = "_";
  protected final String TEXT_352 = " = list_";
  protected final String TEXT_353 = "_";
  protected final String TEXT_354 = "_";
  protected final String TEXT_355 = ".size();\t\t\t\t\t\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_356 = NL + "\t\t\t\t\tif(rowSize_";
  protected final String TEXT_357 = "_";
  protected final String TEXT_358 = "!=list_";
  protected final String TEXT_359 = "_";
  protected final String TEXT_360 = "_";
  protected final String TEXT_361 = ".size()){" + NL + "\t\t\t\t\t\tthrow new RuntimeException(\"The row count of column: ";
  protected final String TEXT_362 = " in table: ";
  protected final String TEXT_363 = " not equals others, please make sure the row count of every columns equal.\");" + NL + "\t\t\t\t\t}\t\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_364 = NL + "\t\t\ttable_input_";
  protected final String TEXT_365 = " = tableParameterList_";
  protected final String TEXT_366 = ".getTable(";
  protected final String TEXT_367 = ");" + NL + "\t\t\ttable_input_";
  protected final String TEXT_368 = ".appendRows(rowSize_";
  protected final String TEXT_369 = "_";
  protected final String TEXT_370 = ");" + NL + "\t\t\ttable_input_";
  protected final String TEXT_371 = ".firstRow();" + NL + "\t\t\tfor(int rowNum_";
  protected final String TEXT_372 = "=0;rowNum_";
  protected final String TEXT_373 = "<rowSize_";
  protected final String TEXT_374 = "_";
  protected final String TEXT_375 = ";rowNum_";
  protected final String TEXT_376 = "++){\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_377 = NL + "\t\t\t\t\t";
  protected final String TEXT_378 = NL + "\t\t\t\t\t\ttable_input_";
  protected final String TEXT_379 = ".setValue(list_";
  protected final String TEXT_380 = "_";
  protected final String TEXT_381 = "_";
  protected final String TEXT_382 = ".get(rowNum_";
  protected final String TEXT_383 = "),";
  protected final String TEXT_384 = ");// \"input_table\"" + NL + "\t\t\t\t\t";
  protected final String TEXT_385 = NL + "\t\t\t\t\t\ttable_input_";
  protected final String TEXT_386 = ".setValue(";
  protected final String TEXT_387 = ",list_";
  protected final String TEXT_388 = "_";
  protected final String TEXT_389 = "_";
  protected final String TEXT_390 = ".get(rowNum_";
  protected final String TEXT_391 = "));// \"input_table\"" + NL + "\t\t\t\t\t";
  protected final String TEXT_392 = NL + "\t\t\t\t";
  protected final String TEXT_393 = NL + "\t\t\t\ttable_input_";
  protected final String TEXT_394 = ".nextRow();" + NL + "\t\t\t}\t" + NL + "\t\t";
  protected final String TEXT_395 = "        " + NL + "\t";
  protected final String TEXT_396 = NL + "\t\ttry{" + NL + "    \t\tclient_";
  protected final String TEXT_397 = ".execute(function_";
  protected final String TEXT_398 = ");" + NL + "\t    }catch (java.lang.Exception e_";
  protected final String TEXT_399 = ") {" + NL + "\t\t\tcom.sap.mw.jco.JCO.releaseClient(client_";
  protected final String TEXT_400 = ");" + NL + "\t\t    throw new RuntimeException(e_";
  protected final String TEXT_401 = ".getMessage());" + NL + "\t\t}\t" + NL + "\t";
  protected final String TEXT_402 = NL + "\t\ttry{" + NL + "\t\t\tfunction_";
  protected final String TEXT_403 = ".execute(dest_";
  protected final String TEXT_404 = ");" + NL + "\t\t}catch (java.lang.Exception e_";
  protected final String TEXT_405 = ") {" + NL + "\t\t\tcom.sap.conn.jco.JCoContext.end(dest_";
  protected final String TEXT_406 = ");" + NL + "\t\t    throw new RuntimeException(e_";
  protected final String TEXT_407 = ".getMessage());" + NL + "\t\t}";
  protected final String TEXT_408 = NL + "\t";
  protected final String TEXT_409 = NL + "\t\tboolean go_";
  protected final String TEXT_410 = " = true;" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_411 = NL + "\t\t\t";
  protected final String TEXT_412 = NL + "\t\t\t\tcom.sap.mw.jco.JCO.Table table_";
  protected final String TEXT_413 = "_";
  protected final String TEXT_414 = " = exportParameterList_";
  protected final String TEXT_415 = ".getTable(";
  protected final String TEXT_416 = ");" + NL + "\t\t\t";
  protected final String TEXT_417 = NL + "\t\t\t\tcom.sap.conn.jco.JCoTable table_";
  protected final String TEXT_418 = "_";
  protected final String TEXT_419 = " = exportParameterList_";
  protected final String TEXT_420 = ".getTable(";
  protected final String TEXT_421 = ");" + NL + "\t\t\t";
  protected final String TEXT_422 = NL + "\t\t\tgo_";
  protected final String TEXT_423 = " = !table_";
  protected final String TEXT_424 = "_";
  protected final String TEXT_425 = ".isEmpty();" + NL + "\t\t";
  protected final String TEXT_426 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_427 = NL + "\t\t\t";
  protected final String TEXT_428 = NL + "\t\t\t\tcom.sap.mw.jco.JCO.Table table_";
  protected final String TEXT_429 = "_";
  protected final String TEXT_430 = " = tableParameterList_";
  protected final String TEXT_431 = ".getTable(";
  protected final String TEXT_432 = ");" + NL + "\t\t\t";
  protected final String TEXT_433 = NL + "\t\t\t\tcom.sap.conn.jco.JCoTable table_";
  protected final String TEXT_434 = "_";
  protected final String TEXT_435 = " = tableParameterList_";
  protected final String TEXT_436 = ".getTable(";
  protected final String TEXT_437 = ");" + NL + "\t\t\t";
  protected final String TEXT_438 = NL + "\t\t\tgo_";
  protected final String TEXT_439 = " = !table_";
  protected final String TEXT_440 = "_";
  protected final String TEXT_441 = ".isEmpty();" + NL + "\t\t";
  protected final String TEXT_442 = "\t\t" + NL + "\t";
  protected final String TEXT_443 = NL + NL + "\twhile(" + NL + "\t";
  protected final String TEXT_444 = NL + "\t\t";
  protected final String TEXT_445 = "go_";
  ...
  protected final String TEXT_452 = NL + "\t\t\t    \tif (true) {" + NL + "\t\t\t    \t\tthrow new java.lang.Exception(\"The connection for schema ";
  protected final String TEXT_453 = " is with problem, they must be the same name.\");" + NL + "    \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_454 = NL + "\t" + NL + "\t\t\t\t";
  protected final String TEXT_455 = NL + "\t\t\t    \tif (true) {" + NL + "\t\t\t    \t\tthrow new java.lang.Exception(\"Please make sure to configure the \\\"Outputs->Mapping->Schema XpathQuerys\\\" for schema ";
  protected final String TEXT_456 = "\");    " + NL + "\t\t\t    \t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_457 = NL + "\t\t\t\tif(go_";
  protected final String TEXT_458 = "){" + NL + "\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_459 = NL + "\t\t\t\t\t\tgo_";
  protected final String TEXT_460 = " = false;\t" + NL + "\t\t\t    \t\t";
  protected final String TEXT_461 = " = new ";
  protected final String TEXT_462 = "Struct();" + NL + "\t\t\t            ";
  protected final String TEXT_463 = NL + "\t\t\t            \t// \"output_single\"--";
  protected final String TEXT_464 = NL + "\t\t\t            \t";
  protected final String TEXT_465 = NL + "\t\t\t            \t";
  protected final String TEXT_466 = "           \t" + NL + "\t\t\t        ";
  protected final String TEXT_467 = NL + "\t\t\t        \tgo_";
  protected final String TEXT_468 = " = false;" + NL + "\t\t\t        \t";
  protected final String TEXT_469 = NL + "\t\t\t\t\t\t\tcom.sap.mw.jco.JCO.Structure output_structure_";
  protected final String TEXT_470 = "_";
  protected final String TEXT_471 = " = exportParameterList_";
  protected final String TEXT_472 = ".getStructure(";
  protected final String TEXT_473 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_474 = NL + "\t\t\t\t\t\t\tcom.sap.conn.jco.JCoStructure output_structure_";
  protected final String TEXT_475 = "_";
  protected final String TEXT_476 = " = exportParameterList_";
  protected final String TEXT_477 = ".getStructure(";
  protected final String TEXT_478 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_479 = NL + "\t\t\t    \t\t";
  protected final String TEXT_480 = " = new ";
  protected final String TEXT_481 = "Struct();" + NL + "\t\t\t            ";
  protected final String TEXT_482 = NL + "\t\t\t\t            // \"output_structure\"--";
  protected final String TEXT_483 = NL + "\t\t\t\t            ";
  protected final String TEXT_484 = NL + "\t\t\t            \t";
  protected final String TEXT_485 = " " + NL + "\t\t\t\t\t";
  protected final String TEXT_486 = NL + "\t\t\t    \t\tif(table_";
  protected final String TEXT_487 = "_";
  protected final String TEXT_488 = ".isLastRow()){ //check the flag first" + NL + "\t\t\t    \t\t\tgo_";
  protected final String TEXT_489 = " = false;" + NL + "\t\t\t    \t\t}        \t" + NL + "\t    \t\t\t\t";
  protected final String TEXT_490 = " = new ";
  protected final String TEXT_491 = "Struct();" + NL + "\t            \t\t";
  protected final String TEXT_492 = "\t" + NL + "\t\t\t\t            // \"table_output\" or \"output_table\"--";
  protected final String TEXT_493 = NL + "\t\t\t\t            ";
  protected final String TEXT_494 = NL + "\t            \t\t\t";
  protected final String TEXT_495 = " \t" + NL + "\t\t\t            if(go_";
  protected final String TEXT_496 = "){" + NL + "\t            \t\t\ttable_";
  protected final String TEXT_497 = "_";
  protected final String TEXT_498 = ".nextRow();" + NL + "\t            \t\t}     " + NL + "\t\t            ";
