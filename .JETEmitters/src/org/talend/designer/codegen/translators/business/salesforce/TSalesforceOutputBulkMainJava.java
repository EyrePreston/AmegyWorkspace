...
public class TSalesforceOutputBulkMainJava
{
  ...
  protected final String TEXT_39 = "  \t " + NL + "                \tString[] row_";
  protected final String TEXT_40 = " = new String[]{";
  protected final String TEXT_41 = " \"\",";
  protected final String TEXT_42 = "\"#N/A\",";
  protected final String TEXT_43 = "};\t\t//empty value must be NULL('#N/A' in bulk file)" + NL + "                \t";
  protected final String TEXT_44 = NL + "        \t\t\t    \trow_";
  ...
  protected final String TEXT_64 = NL + "    \t\t\t    csvWriter_";
  protected final String TEXT_65 = ".writeNext(row_";
