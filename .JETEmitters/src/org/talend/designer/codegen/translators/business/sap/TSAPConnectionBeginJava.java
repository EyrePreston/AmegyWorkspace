...
public class TSAPConnectionBeginJava
{
  ...
  protected final String TEXT_153 = NL + "\tjava.util.Properties properties_";
  protected final String TEXT_154 = " = new java.util.Properties();" + NL + "    properties_";
  protected final String TEXT_155 = ".put(org.talend.sap.ISAPConnection.PROP_CLIENT, ";
  protected final String TEXT_156 = ");" + NL + "    properties_";
  protected final String TEXT_157 = ".put(org.talend.sap.ISAPConnection.PROP_USER, ";
  protected final String TEXT_158 = ");" + NL + "    properties_";
  protected final String TEXT_159 = ".put(org.talend.sap.ISAPConnection.PROP_PASSWORD, decryptedPassword_";
  protected final String TEXT_160 = ");" + NL + "    properties_";
  protected final String TEXT_161 = ".put(org.talend.sap.ISAPConnection.PROP_LANGUAGE, ";
  protected final String TEXT_162 = ");" + NL + "    ";
  protected final String TEXT_163 = NL + "    properties_";
  protected final String TEXT_164 = ".put(org.talend.sap.ISAPConnection.PROP_APPLICATION_SERVER_HOST, ";
  protected final String TEXT_165 = ");" + NL + "    properties_";
  protected final String TEXT_166 = ".put(org.talend.sap.ISAPConnection.PROP_SYSTEM_NUMBER, ";
  protected final String TEXT_167 = ");";
  protected final String TEXT_168 = NL + "    properties_";
  protected final String TEXT_169 = ".put(\"jco.client.mshost\", ";
  protected final String TEXT_170 = ");" + NL + "    properties_";
  protected final String TEXT_171 = ".put(\"jco.client.r3name\", ";
  protected final String TEXT_172 = ");" + NL + "    properties_";
  protected final String TEXT_173 = ".put(\"jco.client.group\", ";
  protected final String TEXT_174 = ");";
  protected final String TEXT_175 = NL + "    ";
  protected final String TEXT_176 = NL + "\t\tproperties_";
  protected final String TEXT_177 = ".setProperty(\"jco.client.snc_mode\", \"1\");" + NL + "\t\tproperties_";
  protected final String TEXT_178 = ".setProperty(\"jco.client.snc_partnername\", ";
  protected final String TEXT_179 = ");" + NL + "\t\tproperties_";
  protected final String TEXT_180 = ".setProperty(\"jco.client.snc_qop\", String.valueOf(";
  protected final String TEXT_181 = "));" + NL + "\t\t";
  protected final String TEXT_182 = NL + "    \t\tif(";
  protected final String TEXT_183 = " != null){" + NL + "    \t\t\tproperties_";
  protected final String TEXT_184 = ".setProperty(\"jco.client.snc_myname\", ";
  protected final String TEXT_185 = ");" + NL + "    \t\t}" + NL + "\t\t";
  protected final String TEXT_186 = NL + "\t\t";
  protected final String TEXT_187 = NL + "    \t\tif(";
  protected final String TEXT_188 = " != null){" + NL + "    \t\t\tproperties_";
  protected final String TEXT_189 = ".setProperty(\"jco.client.snc_lib\", ";
  protected final String TEXT_190 = ");" + NL + "    \t\t}" + NL + "\t\t";
  protected final String TEXT_191 = NL + "\t";
  protected final String TEXT_192 = NL + "\t";
  protected final String TEXT_193 = "\t" + NL + "\t\tproperties_";
  protected final String TEXT_194 = ".put(";
  protected final String TEXT_195 = " ,";
  protected final String TEXT_196 = ");" + NL + "\t\t";
  protected final String TEXT_197 = NL + "    " + NL + "\torg.talend.sap.ISAPConnection connection_";
  protected final String TEXT_198 = " = org.talend.sap.impl.SAPConnectionFactory.getInstance().createConnection(properties_";
  protected final String TEXT_199 = ");" + NL + "\tconnection_";
  protected final String TEXT_200 = ".beginTransaction();" + NL + "\tglobalMap.put(\"conn_";
