...
public class TSalesforceOutputBulkBeginJava
{
  ...
  protected final String TEXT_40 = " = 0;" + NL + "\t\tjava.io.File file_";
  protected final String TEXT_41 = " = new java.io.File(";
  protected final String TEXT_42 = ");" + NL + "\t\t";
  protected final String TEXT_43 = NL + "\t\tfile_";
  protected final String TEXT_44 = ".getParentFile().mkdirs();" + NL + "\t\t";
  protected final String TEXT_45 = NL + "\t\tcom.talend.csv.CSVWriter csvWriter_";
  protected final String TEXT_46 = " = new com.talend.csv.CSVWriter(new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "\t\t        new java.io.FileOutputStream(file_";
  protected final String TEXT_47 = ", ";
  protected final String TEXT_48 = "), \"UTF-8\")));" + NL + "\t\tresourceMap.put(\"csvWriter_";
  protected final String TEXT_49 = "\", csvWriter_";
  protected final String TEXT_50 = "); " + NL + "\t\t";
  protected final String TEXT_51 = "  \t" + NL + "\t\t\t\t\tif(file_";
  protected final String TEXT_52 = ".length() == 0){" + NL + "                \t\tString[] header_";
  protected final String TEXT_53 = " = new String[";
  protected final String TEXT_54 = "];" + NL + "\t                \t";
  protected final String TEXT_55 = NL + "\t\t\t\t\t\t\t\theader_";
  protected final String TEXT_56 = "[";
  protected final String TEXT_57 = "] = \"";
  protected final String TEXT_58 = "\";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_59 = NL + "\t\t\t\t\t\t\t\theader_";
  ...
  protected final String TEXT_67 = NL + "\t\t\t\t\t\tcsvWriter_";
  protected final String TEXT_68 = ".writeNext(header_";
