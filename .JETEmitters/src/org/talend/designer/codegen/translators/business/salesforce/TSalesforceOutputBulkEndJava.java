...
public class TSalesforceOutputBulkEndJava
{
  ...
  protected final String TEXT_39 = NL + "\tif(csvWriter_";
  protected final String TEXT_40 = "!=null) {" + NL + "\t\tcsvWriter_";
  protected final String TEXT_41 = ".close();" + NL + "\t}" + NL + "\tresourceMap.put(\"finish_";
  protected final String TEXT_42 = "\", true); " + NL + "\tglobalMap.put(\"";
