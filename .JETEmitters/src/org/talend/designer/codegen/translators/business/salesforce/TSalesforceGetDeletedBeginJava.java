...
public class TSalesforceGetDeletedBeginJava
{
  ...
  protected final String TEXT_51 = ".getCalendar();" + NL + "\t\t\t" + NL + "\t        " + NL + "\t\t\torg.talend.salesforce.SforceConnection sforceConn_";
  ...
  protected final String TEXT_120 = "\t" + NL + "\t\t\tcom.salesforce.soap.partner.GetDeletedResult gdr_";
  protected final String TEXT_121 = " = sfMgr_";
  protected final String TEXT_122 = ".getDeleted(";
  protected final String TEXT_123 = ", startCal_";
  protected final String TEXT_124 = ", endCal_";
  protected final String TEXT_125 = ");" + NL + "    \t\tcom.salesforce.soap.partner.QueryResult qr_";
  protected final String TEXT_126 = " = null;" + NL + "    \t\tcom.salesforce.soap.partner.DeletedRecord[] drs_";
  protected final String TEXT_127 = " = gdr_";
  protected final String TEXT_128 = ".getDeletedRecords();" + NL + "    \t\t" + NL + "    \t\tif (drs_";
  protected final String TEXT_129 = " != null && drs_";
  protected final String TEXT_130 = ".length > 0) {" + NL + "    \t\t\tint batchSize_";
  protected final String TEXT_131 = " = 500;" + NL + "    \t\t\tint count_";
  protected final String TEXT_132 = " = 0;" + NL + "    \t\t\tStringBuilder soql_";
  protected final String TEXT_133 = " = new StringBuilder();" + NL + "    \t\t\tString soqlBase_";
  protected final String TEXT_134 = " = \"SELECT \" + \"";
  protected final String TEXT_135 = "\" + \" FROM \" + ";
  protected final String TEXT_136 = " + \" WHERE \";" + NL + "\t\t\t\tfor(com.salesforce.soap.partner.DeletedRecord dr_";
  protected final String TEXT_137 = " : drs_";
  protected final String TEXT_138 = "){" + NL + "\t\t\t\t\tcount_";
  protected final String TEXT_139 = "++;" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tsoql_";
  protected final String TEXT_140 = ".append(\"Id='\"+dr_";
  protected final String TEXT_141 = ".getId().getID()+\"'\");" + NL + "\t\t\t\t\tsoql_";
  protected final String TEXT_142 = ".append(\" or \");" + NL + "\t\t\t\t\t";
  protected final String TEXT_143 = NL + "\t\t\t\t\tif((soql_";
  protected final String TEXT_144 = ".length() > (10000 - 23 - soqlBase_";
  protected final String TEXT_145 = ".length())) || count_";
  protected final String TEXT_146 = " == drs_";
  protected final String TEXT_147 = ".length){" + NL + "\t\t\t\t\t\tsoql_";
  protected final String TEXT_148 = ".delete(soql_";
  protected final String TEXT_149 = ".length() - 4, soql_";
  protected final String TEXT_150 = ".length());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_151 = NL + "\t\t\t\t\t\t\tSystem.out.println(soqlBase_";
  protected final String TEXT_152 = " + soql_";
  protected final String TEXT_153 = ".toString());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_154 = NL + "\t\t\t\t\t\tqr_";
  protected final String TEXT_155 = " = sfMgr_";
  protected final String TEXT_156 = ".queryAll(soqlBase_";
  protected final String TEXT_157 = " + soql_";
  protected final String TEXT_158 = ".toString(),batchSize_";
  protected final String TEXT_159 = ");" + NL + "" + NL + "\t\t\t\t\t\tboolean bContinue_";
  protected final String TEXT_160 = " = true;" + NL + "\t\t\t\t\t\twhile (bContinue_";
  protected final String TEXT_161 = " && qr_";
  protected final String TEXT_162 = " != null && qr_";
  protected final String TEXT_163 = ".getRecords() != null) {" + NL + "\t\t\t\t\t\t\tnb_line_";
  protected final String TEXT_164 = "++;" + NL + "\t\t        \t\t    for(int i_";
  protected final String TEXT_165 = " = 0; i_";
  protected final String TEXT_166 = " < qr_";
  protected final String TEXT_167 = ".getRecords().length; i_";
  protected final String TEXT_168 = "++){" + NL + "\t\t\t        \t\t\torg.apache.axiom.om.OMElement[] fields_";
  protected final String TEXT_169 = " = qr_";
  protected final String TEXT_170 = ".getRecords()[i_";
  protected final String TEXT_171 = "].getExtraElement();" + NL + "\t\t\t" + NL + "\t\t\t\t\t\t\t\tint len_";
  protected final String TEXT_172 = " = fields_";
  protected final String TEXT_173 = ".length;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_174 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\tif (";
  protected final String TEXT_175 = " < len_";
  protected final String TEXT_176 = " && fields_";
  protected final String TEXT_177 = "[";
  protected final String TEXT_178 = "].getText() != null && !\"\".equals(fields_";
  protected final String TEXT_179 = "[";
  protected final String TEXT_180 = "].getText())){" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_181 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_182 = ".";
  protected final String TEXT_183 = " = fields_";
  protected final String TEXT_184 = "[";
  protected final String TEXT_185 = "].getText();" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_186 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_187 = ".";
  protected final String TEXT_188 = " = ParserUtils.parseTo_Date(fields_";
  protected final String TEXT_189 = "[";
  protected final String TEXT_190 = "].getText(), ";
  protected final String TEXT_191 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_192 = NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_193 = ".";
  protected final String TEXT_194 = " = fields_";
  protected final String TEXT_195 = "[";
  protected final String TEXT_196 = "].getText().getBytes();" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_197 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_198 = ".";
  protected final String TEXT_199 = " = ParserUtils.parseTo_";
  protected final String TEXT_200 = "(fields_";
  protected final String TEXT_201 = "[";
  protected final String TEXT_202 = "].getText());" + NL + "\t\t\t\t\t\t\t\t\t\t";
