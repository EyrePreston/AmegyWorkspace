...
public class TSalesforceBulkExecBeginJava
{
  ...
  protected final String TEXT_44 = " = 0;" + NL + "\tSystem.setProperty(\"org.apache.commons.logging.Log\", \"org.apache.commons.logging.impl.NoOpLog\");" + NL + "\t" + NL + "\torg.talend.salesforceBulk.SforceBulkConnection sforceConn_";
  ...
  protected final String TEXT_48 = "\");" + NL + "\t\t}" + NL + "\t\tsforceConn_";
  protected final String TEXT_49 = " = (org.talend.salesforceBulk.SforceBulkConnection)globalMap.get(\"conn_";
  ...
  protected final String TEXT_59 = " " + NL + "        \t\t= new org.talend.salesforceBulk.SforceOAuthBulkConnection.Builder(";
  ...
  protected final String TEXT_68 = NL + "        \t\t\t.build();" + NL + "\t\t";
  ...
  protected final String TEXT_80 = NL + "        \t\t\tString decryptedPwd_";
  protected final String TEXT_81 = " = ";
  protected final String TEXT_82 = ";" + NL + "        \t\t";
  protected final String TEXT_83 = NL + "    \t\t";
  protected final String TEXT_84 = NL + "\t\t\tsforceConn_";
  protected final String TEXT_85 = " " + NL + "    \t\t\t= new org.talend.salesforceBulk.SforceBasicBulkConnection.Builder(";
  protected final String TEXT_86 = ",";
  protected final String TEXT_87 = ",decryptedPassword_";
  protected final String TEXT_88 = ",";
  protected final String TEXT_89 = ")" + NL + "    \t\t\t\t";
  protected final String TEXT_90 = NL + "            \t\t\t.setProxy(true,";
  protected final String TEXT_91 = ",";
  protected final String TEXT_92 = ",";
  protected final String TEXT_93 = ",decryptedPwd_";
  protected final String TEXT_94 = ")" + NL + "            \t\t";
  protected final String TEXT_95 = NL + "    \t\t\t\t.build();" + NL + "\t\t";
  protected final String TEXT_96 = NL + "\torg.talend.salesforceBulk.SalesforceBulkAPI\tsforceBulk_";
  protected final String TEXT_97 = " = new org.talend.salesforceBulk.SalesforceBulkAPI(sforceConn_";
  protected final String TEXT_98 = ");" + NL + "\tsforceBulk_";
  protected final String TEXT_99 = ".setConcurrencyMode(\"";
  protected final String TEXT_100 = "\");" + NL + "\tsforceBulk_";
  protected final String TEXT_101 = ".setAwaitTime(";
  protected final String TEXT_102 = ");" + NL + "\t";
  protected final String TEXT_103 = NL + "\tsforceBulk_";
  protected final String TEXT_104 = ".executeBulk(";
  ...
  protected final String TEXT_112 = NL + "\t\t\tint j_";
  protected final String TEXT_113 = "=0;" + NL + "\t\t\tint batchCount_";
  protected final String TEXT_114 = " = sforceBulk_";
  protected final String TEXT_115 = ".getBatchCount();" + NL + "\t\t\tfor(int i = 0; i < batchCount_";
  protected final String TEXT_116 = "; i++){" + NL + "\t\t\t\tjava.util.List<java.util.Map<String,String>> resultListMessage_";
  protected final String TEXT_117 = " = sforceBulk_";
  protected final String TEXT_118 = ".getBatchLog(i);" + NL + "\t\t\t\tfor(java.util.Map<String,String> resultMessage_";
  protected final String TEXT_119 = " : resultListMessage_";
  protected final String TEXT_120 = "){" + NL + "\t\t\t\t\tj_";
  protected final String TEXT_121 = "++;" + NL + "\t\t\t\t \tnb_line_";
  protected final String TEXT_122 = "++;" + NL + "\t\t\t\t\t";
  protected final String TEXT_123 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_124 = " = null;\t\t\t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_125 = "\t" + NL + "\t\t\t\t\tif(\"true\".equals(resultMessage_";
  protected final String TEXT_126 = ".get(\"Success\"))){" + NL + "\t\t\t\t\t\tnb_success_";
  protected final String TEXT_127 = "++;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_129 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_130 = " = new ";
  protected final String TEXT_131 = "Struct();" + NL + "\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_132 = ".salesforce_created = resultMessage_";
  protected final String TEXT_133 = ".get(\"Created\");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_134 = ".salesforce_id = resultMessage_";
  protected final String TEXT_135 = ".get(\"Id\");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_136 = "\t\t\t" + NL + "\t\t\t\t\t\t\t\t\tif(\"#N/A\".equals(String.valueOf(resultMessage_";
  protected final String TEXT_137 = ".get(\"";
  protected final String TEXT_138 = "\")))){" + NL + "\t\t\t\t\t\t        \t\tresultMessage_";
  protected final String TEXT_139 = ".put(\"";
  protected final String TEXT_140 = "\",null);" + NL + "\t\t\t\t\t\t        \t}" + NL + "\t\t\t\t\t\t\t\t    ";
  protected final String TEXT_141 = NL + "\t\t\t\t\t\t\t            ";
  protected final String TEXT_142 = ".";
  protected final String TEXT_143 = " = resultMessage_";
  protected final String TEXT_144 = ".get(\"";
  protected final String TEXT_145 = "\");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\t\t\t\t            ";
  protected final String TEXT_147 = ".";
  protected final String TEXT_148 = " = ParserUtils.parseTo_Date(resultMessage_";
  ...
  protected final String TEXT_155 = "(resultMessage_";
  protected final String TEXT_156 = ".get(\"";
  protected final String TEXT_157 = "\"));" + NL + "\t\t\t\t\t\t\t        ";
  protected final String TEXT_158 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_159 = ".";
  protected final String TEXT_160 = " = ParserUtils.parseTo_";
  protected final String TEXT_161 = "(resultMessage_";
  protected final String TEXT_162 = ".get(\"";
  protected final String TEXT_163 = "\"));" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_164 = NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tnb_reject_";
  protected final String TEXT_165 = "++;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_166 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_167 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_168 = " = new ";
  protected final String TEXT_169 = "Struct();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_170 = ".error = resultMessage_";
  protected final String TEXT_171 = ".get(\"Error\");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_172 = "\t\t\t" + NL + "\t\t\t\t\t\t\t\t\tif(\"#N/A\".equals(String.valueOf(resultMessage_";
  protected final String TEXT_173 = ".get(\"";
  protected final String TEXT_174 = "\")))){" + NL + "\t\t\t\t\t\t\t        \tresultMessage_";
  protected final String TEXT_175 = ".put(\"";
  protected final String TEXT_176 = "\", null);" + NL + "\t\t\t\t\t\t\t        }" + NL + "\t\t\t\t\t\t\t\t    ";
  protected final String TEXT_177 = NL + "\t\t\t\t\t\t\t            ";
  protected final String TEXT_178 = ".";
  protected final String TEXT_179 = " = resultMessage_";
  protected final String TEXT_180 = ".get(\"";
  protected final String TEXT_181 = "\");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_182 = NL + "\t\t\t\t\t\t\t            ";
  protected final String TEXT_183 = ".";
  protected final String TEXT_184 = " = ParserUtils.parseTo_Date(resultMessage_";
  ...
  protected final String TEXT_200 = NL + "\t\t\t\t\t\t\tString errorMessage_";
  protected final String TEXT_201 = " = \"Row \"+j_";
  protected final String TEXT_202 = "+\":\"+resultMessage_";
  protected final String TEXT_203 = ".get(\"Error\"); " + NL + "\t\t\t\t\t\t\tSystem.err.println(errorMessage_";
