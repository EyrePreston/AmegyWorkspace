...
public class TSalesforceConnectionBeginJava
{
  ...
  protected final String TEXT_39 = NL + "System.setProperty(\"org.apache.commons.logging.Log\", \"org.apache.commons.logging.impl.NoOpLog\");";
  protected final String TEXT_40 = NL + "\t";
  protected final String TEXT_41 = NL + "    \t\tString decryptedQauthClientPwd_";
  protected final String TEXT_42 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_43 = ");" + NL + "    \t";
  protected final String TEXT_44 = NL + "    \t\tString decryptedQauthClientPwd_";
  protected final String TEXT_45 = " = ";
  protected final String TEXT_46 = ";" + NL + "    \t";
  protected final String TEXT_47 = NL + "    \torg.talend.salesforceBulk.SforceBulkConnection sforceConn_";
  protected final String TEXT_48 = " " + NL + "    \t\t= new org.talend.salesforceBulk.SforceOAuthBulkConnection.Builder(";
  protected final String TEXT_49 = ", ";
  protected final String TEXT_50 = ", decryptedQauthClientPwd_";
  protected final String TEXT_51 = ", ";
  protected final String TEXT_52 = ", ";
  protected final String TEXT_53 = ", ";
  protected final String TEXT_54 = ")" + NL + "    \t\t\t";
  protected final String TEXT_55 = NL + "    \t\t\t\t.setTokenFilePath(";
  protected final String TEXT_56 = ")" + NL + "    \t\t\t";
  protected final String TEXT_57 = NL + "    \t\t\t.needCompression(";
  protected final String TEXT_58 = ").needTraceMessage(";
  protected final String TEXT_59 = ")" + NL + "    \t\t\t.build();" + NL + "\t";
  ...
  protected final String TEXT_68 = NL + "    \t\t\tString decryptedPwd_";
  protected final String TEXT_69 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_70 = ");" + NL + "    \t\t";
  protected final String TEXT_71 = NL + "    \t\t\tString decryptedPwd_";
  protected final String TEXT_72 = " = ";
  protected final String TEXT_73 = ";" + NL + "    \t\t";
  protected final String TEXT_74 = NL + "\t\t";
  protected final String TEXT_75 = NL + "\t\torg.talend.salesforceBulk.SforceBulkConnection sforceConn_";
  protected final String TEXT_76 = " " + NL + "\t\t\t= new org.talend.salesforceBulk.SforceBasicBulkConnection.Builder(";
  protected final String TEXT_77 = ",";
  protected final String TEXT_78 = ",decryptedPassword_";
  protected final String TEXT_79 = ",";
  protected final String TEXT_80 = ")" + NL + "\t\t\t\t.needCompression(";
  protected final String TEXT_81 = ").needTraceMessage(";
  protected final String TEXT_82 = ")" + NL + "\t\t\t\t";
  protected final String TEXT_83 = NL + "        \t\t\t.setProxy(true,";
  protected final String TEXT_84 = ",";
  protected final String TEXT_85 = ",";
  protected final String TEXT_86 = ",decryptedPwd_";
  protected final String TEXT_87 = ")" + NL + "        \t\t";
  protected final String TEXT_88 = NL + "\t\t\t\t.build();" + NL + "\t";
  protected final String TEXT_89 = NL + "\t";
  protected final String TEXT_90 = NL + "\t";
  protected final String TEXT_91 = NL + "    \t\tString decryptedQauthClientPwd_";
  protected final String TEXT_92 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_93 = ");" + NL + "    \t";
  protected final String TEXT_94 = NL + "    \t\tString decryptedQauthClientPwd_";
  protected final String TEXT_95 = " = ";
  protected final String TEXT_96 = ";" + NL + "    \t";
  protected final String TEXT_97 = NL + "\t\torg.talend.salesforce.SforceConnection sforceConn_";
  protected final String TEXT_98 = " " + NL + "\t\t\t= new org.talend.salesforce.SforceOAuthConnection.Builder(";
  protected final String TEXT_99 = ", ";
  protected final String TEXT_100 = ", decryptedQauthClientPwd_";
  protected final String TEXT_101 = ", ";
  protected final String TEXT_102 = ", ";
  protected final String TEXT_103 = ", ";
  protected final String TEXT_104 = ")" + NL + "\t\t\t\t";
  protected final String TEXT_105 = NL + "    \t\t\t\t.setTokenFilePath(";
  protected final String TEXT_106 = ")" + NL + "\t\t\t\t";
  protected final String TEXT_107 = NL + "\t\t\t\t.setTimeout(";
  protected final String TEXT_108 = ").needCompression(";
  protected final String TEXT_109 = ")" + NL + "            \t";
  protected final String TEXT_110 = NL + "            \t\t.setClientID(";
  protected final String TEXT_111 = ");" + NL + "            \t";
  protected final String TEXT_112 = NL + "            \t.build();" + NL + "\t";
  ...
  protected final String TEXT_137 = NL + "\t\t" + NL + "\t\torg.talend.salesforce.SforceConnection sforceConn_";
  protected final String TEXT_138 = " " + NL + "\t\t\t= new org.talend.salesforce.SforceBasicConnection.Builder(";
  protected final String TEXT_139 = ", ";
  protected final String TEXT_140 = ", decryptedPassword_";
  protected final String TEXT_141 = ")" + NL + "\t\t\t\t.setTimeout(";
  protected final String TEXT_142 = ").needCompression(";
  protected final String TEXT_143 = ")" + NL + "            \t";
  protected final String TEXT_144 = NL + "            \t\t.setClientID(";
  protected final String TEXT_145 = ");" + NL + "            \t";
  protected final String TEXT_146 = NL + "            \t.build();" + NL + "\t";
  protected final String TEXT_147 = "\t\t\t";
  protected final String TEXT_148 = NL + "globalMap.put(\"conn_";
  protected final String TEXT_149 = "\", sforceConn_";
