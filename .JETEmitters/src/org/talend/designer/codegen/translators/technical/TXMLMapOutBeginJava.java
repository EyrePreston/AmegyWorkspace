...
public class TXMLMapOutBeginJava {
  ...
  protected final String TEXT_137 = NL + "\t\t\t\torg.dom4j.Element ";
  protected final String TEXT_138 = " = org.dom4j.DocumentHelper.createElement(\"";
  protected final String TEXT_139 = "\");";
  protected final String TEXT_140 = NL + "\t\t\t\t";
  protected final String TEXT_141 = ".elements().add(";
  protected final String TEXT_142 = ");";
  protected final String TEXT_143 = NL + "\t\t\t\t";
  protected final String TEXT_144 = ".elements().add(orderHelper.getInsertLocation(";
  ...
  protected final String TEXT_210 = NL + NL + "class GenerateDocument_";
  protected final String TEXT_211 = " {" + NL;
  protected final String TEXT_212 = NL + "\t\tTreeNode_API_";
  protected final String TEXT_213 = " treeNodeAPI = null;";
  protected final String TEXT_214 = NL + "\tjava.util.Map<String,Object> valueMap = null;" + NL + "\t" + NL + "\troutines.system.DocumentGenerateOrderHelper orderHelper = new routines.system.DocumentGenerateOrderHelper(";
  protected final String TEXT_215 = ");" + NL + "\t" + NL + "\torg.dom4j.Document doc = null;" + NL + "\t" + NL + "\torg.dom4j.Element root4Group = null;" + NL + "\t" + NL + "\torg.dom4j.io.OutputFormat format = null;" + NL + "\t" + NL + "\tjava.util.List<java.util.List<String>> groupbyList = null;" + NL + "\tjava.util.List<org.dom4j.Element> groupElementList = null;" + NL + "\tint order = 0;" + NL + "\t" + NL + "\tboolean isFirst = true;" + NL + "\t" + NL + "\tboolean\tneedRoot = true;";
  protected final String TEXT_216 = NL;
  protected final String TEXT_217 = NL + "\t\torg.dom4j.Element ";
  protected final String TEXT_218 = " = null;" + NL + "\t\tpublic boolean  ";
  protected final String TEXT_219 = " = false;";
  protected final String TEXT_220 = NL + "\t" + NL + "    public GenerateDocument_";
  protected final String TEXT_221 = "() {" + NL + "//    \tthis.treeNodeAPI = treeNodeAPI;" + NL + "    \t" + NL + "    \tvalueMap = new java.util.HashMap<String,Object>();" + NL + "    \t" + NL + "    \tgroupbyList =  new java.util.ArrayList<java.util.List<String>>();" + NL + "\t\tgroupElementList = new java.util.ArrayList<org.dom4j.Element>();" + NL + "    \t" + NL + "    \tdoc = org.dom4j.DocumentHelper.createDocument();" + NL + "    \tformat = org.dom4j.io.OutputFormat.createPrettyPrint();" + NL + "    \tformat.setTrimText(false);" + NL + "    }" + NL + "    " + NL + "    public org.dom4j.Document getDocument(){" + NL + "    \treturn this.doc;" + NL + "    }" + NL + "    " + NL + "\t//We generate the TreeNode_API object only if there is a document in the main input table." + NL + "    void generateElements(";
  protected final String TEXT_222 = "TreeNode_API_";
  protected final String TEXT_223 = " treeNodeAPI,";
  protected final String TEXT_224 = "boolean isInnerJoin";
  protected final String TEXT_225 = ", ";
  protected final String TEXT_226 = " ";
  protected final String TEXT_227 = NL + "\t";
  protected final String TEXT_228 = ") {" + NL + "\t" + NL + "\t" + NL + "\t/*if(this.treeNodeAPI==null) {" + NL + "\t\tthis.treeNodeAPI = treeNodeAPI;" + NL + "\t}*/" + NL + "\t" + NL + "\torg.dom4j.Element subTreeRootParent = null;" + NL + "// build root xml tree " + NL + "if (needRoot) {" + NL + "\tneedRoot=false;";
  protected final String TEXT_229 = NL + "\t\troot4Group = subTreeRootParent;" + NL + "\t}else{" + NL + "\t\tsubTreeRootParent=root4Group;" + NL + "\t}" + NL + "\t/* build group xml tree */" + NL + "\tboolean isNewElement = false;";
  protected final String TEXT_230 = NL + "\t\tisNewElement = false;";
  protected final String TEXT_231 = NL + "\t\t\t\t\t\tif(";
  protected final String TEXT_232 = ") {";
  protected final String TEXT_233 = NL + "\t\t\t\t\t\t}";
  protected final String TEXT_234 = NL + "\t\t}" + NL + "    }" + NL + "" + NL + "\tGenerateDocument_";
  protected final String TEXT_235 = " gen_Doc_";
  protected final String TEXT_236 = "_";
  protected final String TEXT_237 = " = new GenerateDocument_";
  protected final String TEXT_238 = "();" + NL + "\tboolean docAlreadyInstanciate_";
  protected final String TEXT_239 = " = false;";
  protected final String TEXT_240 = NL;
  protected final String TEXT_241 = NL + "\t            class SortableRow_";
  protected final String TEXT_242 = " implements Comparable<SortableRow_";
  protected final String TEXT_243 = ">, routines.system.IPersistableRow<SortableRow_";
  protected final String TEXT_244 = "> { // G_TM_B_001 " + NL + "\t" + NL + "\t\t\t\t\tboolean is__rejectedInnerJoin;" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_253 = NL + "\t\t\t        public void fillFrom(";
  protected final String TEXT_254 = " ";
  protected final String TEXT_255 = "Struct ";
  protected final String TEXT_256 = " ";
  protected final String TEXT_257 = " exprKey_";
  ...
  protected final String TEXT_268 = " = exprKey_";
  protected final String TEXT_269 = "__";
  protected final String TEXT_270 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_271 = NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        public void copyDataTo(";
  protected final String TEXT_272 = "Struct ";
  protected final String TEXT_273 = ") {" + NL + "\t\t\t\t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_274 = ".";
  protected final String TEXT_275 = " = this.";
  protected final String TEXT_276 = "__";
  protected final String TEXT_277 = ";" + NL + "\t\t\t\t            \t";
  protected final String TEXT_278 = NL + "\t\t\t        }" + NL + "\t\t\t\t\tpublic String toString() {" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tStringBuilder sb = new StringBuilder();" + NL + "\t\t\t\t\t\tsb.append(super.toString());" + NL + "\t\t\t\t\t\tsb.append(\"[\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_279 = NL + "\t\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_280 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_281 = NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_282 = "__";
  protected final String TEXT_283 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"=\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(String.valueOf(this.";
  protected final String TEXT_284 = "__";
  protected final String TEXT_285 = "));" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_286 = NL + "\t\t\t\t\t\tsb.append(\"]\");" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\treturn sb.toString();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t        public int compareTo(SortableRow_";
  protected final String TEXT_287 = " other) {" + NL + "\t\t\t            int returnValue = 0;" + NL + "\t\t\t            ";
  protected final String TEXT_288 = NL + "\t\t\t            \treturnValue = checkNullsAndCompare(this.exprKey_";
  protected final String TEXT_289 = "__";
  protected final String TEXT_290 = ", other.exprKey_";
  protected final String TEXT_291 = "__";
  protected final String TEXT_292 = ");" + NL + "\t\t\t            \tif (returnValue != 0) {" + NL + "\t\t\t                    return returnValue;" + NL + "\t\t\t            \t}" + NL + "\t\t\t            ";
  protected final String TEXT_293 = NL + "\t\t\t            return returnValue;" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        private int checkNullsAndCompare(Object object1, Object object2) {" + NL + "\t\t\t            int returnValue = 0;" + NL + "\t\t\t            if (object1 instanceof Comparable && object2 instanceof Comparable) {" + NL + "\t\t\t                returnValue = ((Comparable) object1).compareTo(object2);" + NL + "\t\t\t            } else if (object1 != null && object2 != null) {" + NL + "\t\t\t                returnValue = compareStrings(object1.toString(), object2" + NL + "\t\t\t                        .toString());" + NL + "\t\t\t            } else if (object1 == null && object2 != null) {" + NL + "\t\t\t                returnValue = 1;" + NL + "\t\t\t            } else if (object1 != null && object2 == null) {" + NL + "\t\t\t                returnValue = -1;" + NL + "\t\t\t            } else {" + NL + "\t\t\t                returnValue = 0;" + NL + "\t\t\t            }" + NL + "\t\t\t            return returnValue;" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        private int compareStrings(String string1, String string2) {" + NL + "\t\t\t            return string1.compareTo(string2);" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t\t\tpublic void readData(ObjectInputStream dis) {" + NL + "\t\t\t\t\t\tsynchronized(";
  protected final String TEXT_294 = "Struct.commonByteArrayLock_";
  protected final String TEXT_295 = "_";
  protected final String TEXT_296 = ") {" + NL + "\t\t\t\t\t\t    try {" + NL + "\t\t\t\t\t\t\t\tint length = 0;" + NL + "\t\t\t\t\t\t\t\tthis.is__rejectedInnerJoin = dis.readBoolean();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_297 = NL + "\t\t\t\t            this.";
  protected final String TEXT_298 = "__";
  protected final String TEXT_299 = " = dis.read";
  protected final String TEXT_300 = "();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_301 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_302 = "__";
  protected final String TEXT_303 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_304 = "Struct.commonByteArray_";
  protected final String TEXT_305 = "_";
  protected final String TEXT_306 = ".length) {" + NL + "\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_307 = "Struct.commonByteArray_";
  protected final String TEXT_308 = "_";
  protected final String TEXT_309 = ".length == 0) {" + NL + "\t\t\t           \t\t\t\t\t";
  protected final String TEXT_310 = "Struct.commonByteArray_";
  protected final String TEXT_311 = "_";
  protected final String TEXT_312 = " = new byte[1024];" + NL + "\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t           \t\t\t\t\t";
  protected final String TEXT_313 = "Struct.commonByteArray_";
  protected final String TEXT_314 = "_";
  protected final String TEXT_315 = " = new byte[2 * length];" + NL + "\t\t\t           \t\t\t\t}" + NL + "\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t       \t\t\t\tdis.readFully(";
  protected final String TEXT_316 = "Struct.commonByteArray_";
  protected final String TEXT_317 = "_";
  protected final String TEXT_318 = ", 0, length);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_319 = "__";
  protected final String TEXT_320 = " = new String(";
  protected final String TEXT_321 = "Struct.commonByteArray_";
  protected final String TEXT_322 = "_";
  protected final String TEXT_323 = ", 0, length);" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_324 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_325 = "__";
  protected final String TEXT_326 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tthis.";
  protected final String TEXT_327 = "__";
  protected final String TEXT_328 = " = new Date(dis.readLong());" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_329 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_330 = "__";
  protected final String TEXT_331 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_332 = "__";
  protected final String TEXT_333 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_334 = NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_335 = "__";
  protected final String TEXT_336 = " = (";
  protected final String TEXT_337 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_338 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_339 = "__";
  protected final String TEXT_340 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tthis.";
  protected final String TEXT_341 = "__";
  protected final String TEXT_342 = " = dis.read";
  protected final String TEXT_343 = "();" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_344 = NL + "\t\t\t            ";
  protected final String TEXT_345 = NL + "\t\t\t\t            this.exprKey_";
  protected final String TEXT_346 = "__";
  protected final String TEXT_347 = " = dis.read";
  protected final String TEXT_348 = "();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_349 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_350 = "__";
  protected final String TEXT_351 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tthis.exprKey_";
  protected final String TEXT_352 = "__";
  protected final String TEXT_353 = " = new Date(dis.readLong());" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_354 = NL + "\t\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_355 = "__";
  protected final String TEXT_356 = " = null;" + NL + "\t\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_357 = "Struct.commonByteArray_";
  protected final String TEXT_358 = "_";
  protected final String TEXT_359 = ".length) {" + NL + "\t\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_360 = "Struct.commonByteArray_";
  protected final String TEXT_361 = "_";
  protected final String TEXT_362 = ".length == 0) {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_363 = "Struct.commonByteArray_";
  protected final String TEXT_364 = "_";
  protected final String TEXT_365 = " = new byte[1024];" + NL + "\t\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_366 = "Struct.commonByteArray_";
  protected final String TEXT_367 = "_";
  protected final String TEXT_368 = " = new byte[2 * length];" + NL + "\t\t\t\t           \t\t\t\t}" + NL + "\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t       \t\t\t\tdis.readFully(";
  protected final String TEXT_369 = "Struct.commonByteArray_";
  protected final String TEXT_370 = "_";
  protected final String TEXT_371 = ", 0, length);" + NL + "\t\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_372 = "__";
  protected final String TEXT_373 = " = new String(";
  protected final String TEXT_374 = "Struct.commonByteArray_";
  protected final String TEXT_375 = "_";
  protected final String TEXT_376 = ", 0, length);" + NL + "\t\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_377 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_378 = "__";
  protected final String TEXT_379 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_380 = "__";
  protected final String TEXT_381 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_382 = NL + "\t\t\t   \t\t\t\tthis.exprKey_";
  protected final String TEXT_383 = "__";
  protected final String TEXT_384 = " = (";
  protected final String TEXT_385 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_386 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_387 = "__";
  protected final String TEXT_388 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tthis.exprKey_";
  protected final String TEXT_389 = "__";
  protected final String TEXT_390 = " = dis.read";
  protected final String TEXT_391 = "();" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_392 = NL + "\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t";
  protected final String TEXT_393 = NL + "\t\t\t\t";
  protected final String TEXT_394 = NL + "\t\t\t\t\t} catch(ClassNotFoundException eCNFE) {" + NL + "\t\t\t\t\t\t\t throw new RuntimeException(eCNFE);" + NL + "\t\t\t\t";
  protected final String TEXT_395 = NL + "\t\t\t\t\t    \t}" + NL + "\t\t\t\t\t\t} " + NL + "\t\t\t\t\t}" + NL + "\t\t\t\tpublic void writeData(ObjectOutputStream dos) {" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t   \tdos.writeBoolean(this.is__rejectedInnerJoin);" + NL + "\t\t\t\t\t";
  protected final String TEXT_396 = NL + "\t\t\t            \tdos.write";
  protected final String TEXT_397 = "(this.";
  protected final String TEXT_398 = "__";
  protected final String TEXT_399 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_400 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_401 = "__";
  protected final String TEXT_402 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.";
  protected final String TEXT_403 = "__";
  protected final String TEXT_404 = ".getBytes();" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "\t\t\t       \t\t\t\tdos.write(byteArray);" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_405 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_406 = "__";
  protected final String TEXT_407 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.";
  protected final String TEXT_408 = "__";
  protected final String TEXT_409 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_410 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_411 = "__";
  protected final String TEXT_412 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.";
  protected final String TEXT_413 = "__";
  protected final String TEXT_414 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.";
  protected final String TEXT_415 = "__";
  protected final String TEXT_416 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_417 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.";
  ...
  protected final String TEXT_422 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.write";
  protected final String TEXT_423 = "(this.";
  protected final String TEXT_424 = "__";
  protected final String TEXT_425 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_426 = NL + "\t\t\t            ";
  protected final String TEXT_427 = NL + "\t\t\t\t            dos.write";
  protected final String TEXT_428 = "(this.exprKey_";
  protected final String TEXT_429 = "__";
  protected final String TEXT_430 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_431 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_432 = "__";
  protected final String TEXT_433 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.exprKey_";
  protected final String TEXT_434 = "__";
  protected final String TEXT_435 = ".getBytes();" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "\t\t\t       \t\t\t\tdos.write(byteArray);" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_436 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_437 = "__";
  protected final String TEXT_438 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.exprKey_";
  protected final String TEXT_439 = "__";
  protected final String TEXT_440 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_441 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_442 = "__";
  protected final String TEXT_443 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.exprKey_";
  protected final String TEXT_444 = "__";
  protected final String TEXT_445 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.exprKey_";
  protected final String TEXT_446 = "__";
  protected final String TEXT_447 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_448 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.exprKey_";
  ...
  protected final String TEXT_453 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.write";
  protected final String TEXT_454 = "(this.exprKey_";
  protected final String TEXT_455 = "__";
  protected final String TEXT_456 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_457 = NL + "\t\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_458 = NL + "\t\t\t    }" + NL + "\t\t\t}" + NL + "\t     }" + NL + "\t   ";
