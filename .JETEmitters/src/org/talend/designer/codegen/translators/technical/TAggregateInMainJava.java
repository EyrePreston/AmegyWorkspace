...
public class TAggregateInMainJava
{
  ...
  protected final String TEXT_44 = NL + "            \t\t\t\t    String s_";
  protected final String TEXT_45 = "_";
  protected final String TEXT_46 = "_";
  protected final String TEXT_47 = " = String.valueOf(aggregated_row_";
  ...
  protected final String TEXT_59 = "(\"null\").equals(s_";
  protected final String TEXT_60 = "_";
  protected final String TEXT_61 = "_";
  protected final String TEXT_62 = ") ? null : ParserUtils.parseTo_Date(s_";
  ...
  protected final String TEXT_73 = NL + "                                if(aggregated_row_";
  protected final String TEXT_74 = ".";
  protected final String TEXT_75 = "_count > 0){" + NL + "                                \t";
  protected final String TEXT_76 = NL + "\t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_77 = ".";
  protected final String TEXT_78 = " = aggregated_row_";
  protected final String TEXT_79 = ".";
  protected final String TEXT_80 = "_sum.divide(new BigDecimal(String.valueOf(aggregated_row_";
  protected final String TEXT_81 = ".";
  protected final String TEXT_82 = "_count)), ";
  protected final String TEXT_83 = ", BigDecimal.ROUND_HALF_UP)" + NL + "\t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_84 = NL + "\t    \t\t\t\t\t\t\t\t\t.";
  protected final String TEXT_85 = "Value()" + NL + "\t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_86 = NL + "\t    \t\t\t\t\t\t\t\t;" + NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_87 = NL + "\t    \t\t\t\t\t\t\t\tdouble ";
  protected final String TEXT_88 = "_";
  protected final String TEXT_89 = "_temp = (double) aggregated_row_";
  protected final String TEXT_90 = ".";
  protected final String TEXT_91 = "_sum / (double) aggregated_row_";
  protected final String TEXT_92 = ".";
  protected final String TEXT_93 = "_count;" + NL + "\t    \t\t\t\t\t\t\t\t" + NL + "\t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_94 = NL + "\t\t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_95 = ".";
  protected final String TEXT_96 = " = String.valueOf(";
  protected final String TEXT_97 = "_";
  protected final String TEXT_98 = "_temp);" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_105 = NL + "                                } else {" + NL + "                                \t\tString count = \"0\";" + NL + "   \t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_106 = NL + "    \t\t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_107 = ".";
  protected final String TEXT_108 = " = count;" + NL + "    \t\t\t\t\t\t\t\t\t";
  protected final String TEXT_109 = NL + "    \t\t    \t\t\t\t\t\t\t";
  protected final String TEXT_110 = ".";
  protected final String TEXT_111 = " = ParserUtils.parseTo_";
  protected final String TEXT_112 = "(count);" + NL + "    \t\t\t\t\t\t\t\t\t";
  protected final String TEXT_113 = NL + "                                }";
  protected final String TEXT_114 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_115 = ".";
  protected final String TEXT_116 = " = new BigDecimal(aggregated_row_";
  protected final String TEXT_117 = ".count);" + NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_118 = ".";
  protected final String TEXT_119 = " = new BigDecimal(aggregated_row_";
  protected final String TEXT_120 = ".";
  protected final String TEXT_121 = "_clmCount);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_122 = ".";
  protected final String TEXT_123 = " = String.valueOf(aggregated_row_";
  protected final String TEXT_124 = ".count);" + NL + "\t    \t\t\t\t\t\t\t\t  ";
  protected final String TEXT_125 = ".";
  protected final String TEXT_126 = " = String.valueOf(aggregated_row_";
  protected final String TEXT_127 = ".";
  protected final String TEXT_128 = "_clmCount);" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_129 = ".";
  protected final String TEXT_130 = " = (";
  protected final String TEXT_131 = ") aggregated_row_";
  protected final String TEXT_132 = ".count;" + NL + "\t                                \t";
  protected final String TEXT_133 = ".";
  protected final String TEXT_134 = " = (";
  protected final String TEXT_135 = ") aggregated_row_";
  protected final String TEXT_136 = ".";
  protected final String TEXT_137 = "_clmCount;" + NL + "\t                                \t";
  protected final String TEXT_138 = NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_139 = ".";
  protected final String TEXT_140 = " = new BigDecimal(aggregated_row_";
  protected final String TEXT_141 = ".distinctValues_";
  protected final String TEXT_142 = ".size());" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_143 = ".";
  protected final String TEXT_144 = " = String.valueOf(aggregated_row_";
  protected final String TEXT_145 = ".distinctValues_";
  protected final String TEXT_146 = ".size());" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_147 = ".";
  protected final String TEXT_148 = " = (";
  protected final String TEXT_149 = ") aggregated_row_";
  protected final String TEXT_150 = ".distinctValues_";
  protected final String TEXT_151 = ".size();" + NL + "\t                                \t";
  protected final String TEXT_152 = ".";
  protected final String TEXT_153 = " = String.valueOf(aggregated_row_";
  protected final String TEXT_154 = ".";
  protected final String TEXT_155 = "_";
  protected final String TEXT_156 = ");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_157 = NL + "    \t\t\t\t\t\t\t\tif(aggregated_row_";
  protected final String TEXT_158 = ".";
  protected final String TEXT_159 = "_";
  protected final String TEXT_160 = " != null) {" + NL + "    \t\t\t\t\t\t\t\t";
  protected final String TEXT_161 = ".";
  protected final String TEXT_162 = " = aggregated_row_";
  protected final String TEXT_163 = ".";
  protected final String TEXT_164 = "_";
  protected final String TEXT_165 = ".";
  protected final String TEXT_166 = "Value();" + NL + "\t\t\t\t\t\t\t\t\t\t" + NL + "    \t\t\t\t\t\t\t\t}else{" + NL + "    \t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_175 = " = aggregated_row_";
  ...
  protected final String TEXT_191 = "double result_";
  protected final String TEXT_192 = "_";
  protected final String TEXT_193 = "_";
  protected final String TEXT_194 = " = utilClass_";
  protected final String TEXT_195 = ".sd(aggregated_row_";
  protected final String TEXT_196 = ".";
  protected final String TEXT_197 = "_";
  protected final String TEXT_198 = ".toArray(new Double[0]));" + NL + "\t\t    \t\t\t\t\t\t\tif(((Double)result_";
  protected final String TEXT_199 = "_";
  protected final String TEXT_200 = "_";
  protected final String TEXT_201 = ").equals((Double)Double.NaN)) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_202 = ".";
  protected final String TEXT_203 = " = null;" + NL + "\t\t    \t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_204 = ".";
  protected final String TEXT_205 = " = new BigDecimal(result_";
  protected final String TEXT_206 = "_";
  protected final String TEXT_207 = "_";
  protected final String TEXT_208 = ");" + NL + "\t\t    \t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_209 = ".";
  protected final String TEXT_210 = " = (";
  protected final String TEXT_211 = ") utilClass_";
  protected final String TEXT_212 = ".sd(aggregated_row_";
  protected final String TEXT_213 = ".";
  protected final String TEXT_214 = "_";
  protected final String TEXT_215 = ".toArray(new Double[0]));" + NL + "\t    \t\t\t\t\t\t\t\t";
  protected final String TEXT_216 = ".";
  protected final String TEXT_217 = " = String.valueOf(utilClass_";
  ...
  protected final String TEXT_224 = " = aggregated_row_";
