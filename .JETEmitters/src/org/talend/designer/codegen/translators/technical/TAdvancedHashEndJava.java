...
public class TAdvancedHashEndJava
{
  ...
  protected final String TEXT_5 = " = " + NL + "\t(java.util.List<java.util.concurrent.ConcurrentHashMap<String,Object>>)globalMap.get(\"THREAD_MAPS_";
  protected final String TEXT_6 = "_\"+jobName);" + NL + "\tif (mapsList_";
  protected final String TEXT_7 = " != null) {" + NL + "\t" + NL + "" + NL + "\t\t\tfor (java.util.concurrent.ConcurrentHashMap<String,Object> map : mapsList_";
