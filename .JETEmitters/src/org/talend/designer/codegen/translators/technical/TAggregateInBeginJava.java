...
public class TAggregateInBeginJava
{
  ...
  protected final String TEXT_39 = NL + "java.util.Collection<AggOperationStruct_";
  protected final String TEXT_40 = "> values_";
  protected final String TEXT_41 = " = hash_";
  protected final String TEXT_42 = ".values();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_43 = "_NB_LINE\", values_";
  protected final String TEXT_44 = ".size());" + NL;
  protected final String TEXT_45 = NL + "for(AggOperationStruct_";
  protected final String TEXT_46 = " aggregated_row_";
  protected final String TEXT_47 = " : values_";
  protected final String TEXT_48 = ") { // G_AggR_600" + NL + NL;
