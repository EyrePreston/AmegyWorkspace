...
public class TXMLMapBeginJava {
  ...
  protected final String TEXT_120 = ".getNamespaceForPrefix(\"";
  ...
  protected final String TEXT_132 = ".elements().add(orderHelper.getInsertLocation(";
  ...
  protected final String TEXT_141 = NL + "\t\tsubTreeRootParent = ";
  protected final String TEXT_142 = ";";
  protected final String TEXT_143 = NL + "//\t\tif(";
  protected final String TEXT_144 = "!=null){" + NL + "\t\t\tvalueMap.put(\"";
  protected final String TEXT_145 = "\",";
  protected final String TEXT_146 = ");" + NL + "\t\t\tif(valueMap.get(\"";
  protected final String TEXT_147 = "\")!=null) {" + NL + "\t\t\t\t";
  protected final String TEXT_148 = ".addAttribute(\"";
  protected final String TEXT_149 = "\",FormatterUtils.format(";
  protected final String TEXT_150 = ",";
  protected final String TEXT_151 = "));" + NL + "\t\t\t}";
  protected final String TEXT_152 = " else {" + NL + "\t\t\t\t";
  protected final String TEXT_153 = ".addAttribute(\"";
  protected final String TEXT_154 = "\",\"\");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_155 = NL + "//\t\t}";
  protected final String TEXT_156 = NL + "\t\t\t";
  protected final String TEXT_157 = ".addAttribute(\"";
  protected final String TEXT_158 = "\",\"\");";
  protected final String TEXT_159 = NL + "\t\tvalueMap.put(\"";
  protected final String TEXT_160 = "\",";
  protected final String TEXT_161 = ");" + NL + "\t\tif(valueMap.get(\"";
  protected final String TEXT_162 = "\")!=null) {" + NL + "\t\t\troutines.system.NestXMLTool.setText(";
  protected final String TEXT_163 = ",FormatterUtils.format(";
  protected final String TEXT_164 = ",";
  protected final String TEXT_165 = "));" + NL + "\t\t}";
  protected final String TEXT_166 = NL + "\t\t\tisNewElement = false;";
  protected final String TEXT_167 = NL + "\t\t\t\t\tif(isNewElement || groupbyList.size()<=";
  protected final String TEXT_168 = " || groupbyList.get(";
  protected final String TEXT_169 = ")==null";
  protected final String TEXT_170 = NL + "\t\t\t\t\t|| ( groupbyList.get(";
  protected final String TEXT_171 = ").get(";
  protected final String TEXT_172 = ")!=null ? !groupbyList.get(";
  protected final String TEXT_173 = ").get(";
  protected final String TEXT_174 = ").equals(FormatterUtils.format(";
  protected final String TEXT_175 = ",";
  protected final String TEXT_176 = ")) : FormatterUtils.format(";
  protected final String TEXT_177 = ",";
  protected final String TEXT_178 = ")!=null )";
  protected final String TEXT_179 = NL + "\t\t\t\t\t){" + NL;
  protected final String TEXT_180 = "\t" + NL + "\t\t\t\t\tif(groupbyList.size()<=";
  protected final String TEXT_181 = "){" + NL + "\t\t\t\t\t\tgroupbyList.add(new java.util.ArrayList<String>());" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tgroupbyList.get(";
  protected final String TEXT_182 = ").clear();" + NL + "\t\t\t\t\t}";
  protected final String TEXT_183 = NL + "\t\t\t\t\t\tgroupbyList.get(";
  protected final String TEXT_184 = ").add(FormatterUtils.format(";
  protected final String TEXT_185 = ",";
  protected final String TEXT_186 = "));";
  protected final String TEXT_187 = NL + "\t\t\t\t\tisNewElement=true;" + NL + "\t\t\t\t\tif(groupElementList.size()<=";
  protected final String TEXT_188 = "){" + NL + "\t\t\t\t\t\tgroupElementList.add(group";
  protected final String TEXT_189 = "_);" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tgroupElementList.set(";
  protected final String TEXT_190 = ",group";
  protected final String TEXT_191 = "_);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\tsubTreeRootParent=groupElementList.get(";
  protected final String TEXT_192 = ");" + NL + "\t\t\t\t}" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_193 = NL + "class GenerateDocument_";
  protected final String TEXT_194 = " {" + NL;
  protected final String TEXT_195 = NL + "\t\tTreeNode_API_";
  protected final String TEXT_196 = " treeNodeAPI = null;";
  protected final String TEXT_197 = NL + "\tjava.util.Map<String,Object> valueMap = null;" + NL + "\t" + NL + "\troutines.system.DocumentGenerateOrderHelper orderHelper = new routines.system.DocumentGenerateOrderHelper(";
  protected final String TEXT_198 = ");" + NL + "\t\t" + NL + "\torg.dom4j.Document doc = null;" + NL + "\t" + NL + "\torg.dom4j.Element root4Group = null;" + NL + "\t" + NL + "\torg.dom4j.io.OutputFormat format = null;" + NL + "\t" + NL + "\tjava.util.List<java.util.List<String>> groupbyList = null;" + NL + "\tjava.util.List<org.dom4j.Element> groupElementList = null;" + NL + "\tint order = 0;" + NL + "\t" + NL + "\tboolean isFirst = true;" + NL + "\t" + NL + "\tboolean\tneedRoot = true;";
  protected final String TEXT_199 = NL + "\t" + NL + "    public GenerateDocument_";
  protected final String TEXT_200 = "() {" + NL + "//    \tthis.treeNodeAPI = treeNodeAPI;" + NL + "    \t" + NL + "    \tvalueMap = new java.util.HashMap<String,Object>();" + NL + "    \t" + NL + "    \tgroupbyList =  new java.util.ArrayList<java.util.List<String>>();" + NL + "\t\tgroupElementList = new java.util.ArrayList<org.dom4j.Element>();" + NL + "    \t" + NL + "    \tdoc = org.dom4j.DocumentHelper.createDocument();" + NL + "    \tformat = org.dom4j.io.OutputFormat.createPrettyPrint();" + NL + "    \tformat.setTrimText(false);" + NL + "    }" + NL + "    " + NL + "    public org.dom4j.Document getDocument(){" + NL + "\t\tgenerateOk();" + NL + "    \treturn this.doc;" + NL + "    }" + NL + "    " + NL + "    //do some work after document has been generated" + NL + "    private void generateOk() {" + NL + "    \troutines.system.NestXMLTool.replaceDefaultNameSpace(this.doc.getRootElement(),null);";
  protected final String TEXT_201 = NL + "\t\troutines.system.NestXMLTool.removeEmptyElement(this.doc.getRootElement());";
  protected final String TEXT_202 = NL + "    }" + NL + "\t" + NL + "\t//We generate the TreeNode_API object only if there is a document in the main input table." + NL + "    void generateElements(";
  protected final String TEXT_203 = "TreeNode_API_";
  protected final String TEXT_204 = " treeNodeAPI,";
  protected final String TEXT_205 = "boolean isInnerJoin";
  protected final String TEXT_206 = ", ";
  protected final String TEXT_207 = " ";
  protected final String TEXT_208 = NL + "\t";
  protected final String TEXT_209 = ") {" + NL + "\t" + NL + "\t" + NL + "\t/*if(this.treeNodeAPI==null) {" + NL + "\t\tthis.treeNodeAPI = treeNodeAPI;" + NL + "\t}*/" + NL + "\t" + NL + "\torg.dom4j.Element subTreeRootParent = null;" + NL + "// build root xml tree " + NL + "if (needRoot) {" + NL + "\tneedRoot=false;";
  protected final String TEXT_210 = NL + "\t\troot4Group = subTreeRootParent;" + NL + "\t}else{" + NL + "\t\tsubTreeRootParent=root4Group;" + NL + "\t}" + NL + "\t/* build group xml tree */" + NL + "\tboolean isNewElement = false;";
  protected final String TEXT_211 = NL + "\t\tisNewElement = false;";
  protected final String TEXT_212 = NL + "\t\t}" + NL + "    }" + NL;
  protected final String TEXT_213 = NL;
  protected final String TEXT_214 = NL + "\t            class SortableRow_";
  protected final String TEXT_215 = " implements Comparable<SortableRow_";
  protected final String TEXT_216 = ">, routines.system.IPersistableRow<SortableRow_";
  protected final String TEXT_217 = "> { // G_TM_B_001 " + NL + "\t" + NL + "\t\t\t\t\tboolean is__rejectedInnerJoin;" + NL + "\t\t\t\t\t";
  protected final String TEXT_218 = " exprKey_";
  ...
  protected final String TEXT_226 = NL + "\t\t\t        public void fillFrom(";
  ...
  protected final String TEXT_251 = NL + "\t\t\t        }" + NL + "\t\t\t\t\tpublic String toString() {" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tStringBuilder sb = new StringBuilder();" + NL + "\t\t\t\t\t\tsb.append(super.toString());" + NL + "\t\t\t\t\t\tsb.append(\"[\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_252 = NL + "\t\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_253 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_254 = NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_255 = "__";
  protected final String TEXT_256 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"=\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(String.valueOf(this.";
  protected final String TEXT_257 = "__";
  protected final String TEXT_258 = "));" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_259 = NL + "\t\t\t\t\t\tsb.append(\"]\");" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\treturn sb.toString();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t        public int compareTo(SortableRow_";
  protected final String TEXT_260 = " other) {" + NL + "\t\t\t            int returnValue = 0;" + NL + "\t\t\t            ";
  protected final String TEXT_261 = NL + "\t\t\t            \treturnValue = checkNullsAndCompare(this.exprKey_";
  protected final String TEXT_262 = "__";
  protected final String TEXT_263 = ", other.exprKey_";
  protected final String TEXT_264 = "__";
  protected final String TEXT_265 = ");" + NL + "\t\t\t            \tif (returnValue != 0) {" + NL + "\t\t\t                    return returnValue;" + NL + "\t\t\t            \t}" + NL + "\t\t\t            ";
  ...
  protected final String TEXT_267 = "Struct.commonByteArrayLock_";
  protected final String TEXT_268 = "_";
  protected final String TEXT_269 = ") {" + NL + "\t\t\t\t\t\t    try {" + NL + "\t\t\t\t\t\t\t\tint length = 0;" + NL + "\t\t\t\t\t\t\t\tthis.is__rejectedInnerJoin = dis.readBoolean();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_270 = NL + "\t\t\t\t            this.";
  protected final String TEXT_271 = "__";
  protected final String TEXT_272 = " = dis.read";
  protected final String TEXT_273 = "();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_274 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_275 = "__";
  protected final String TEXT_276 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_277 = "Struct.commonByteArray_";
  protected final String TEXT_278 = "_";
  protected final String TEXT_279 = ".length) {" + NL + "\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_280 = "Struct.commonByteArray_";
  protected final String TEXT_281 = "_";
  protected final String TEXT_282 = ".length == 0) {" + NL + "\t\t\t           \t\t\t\t\t";
  protected final String TEXT_283 = "Struct.commonByteArray_";
  protected final String TEXT_284 = "_";
  protected final String TEXT_285 = " = new byte[1024];" + NL + "\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t           \t\t\t\t\t";
  protected final String TEXT_286 = "Struct.commonByteArray_";
  protected final String TEXT_287 = "_";
  protected final String TEXT_288 = " = new byte[2 * length];" + NL + "\t\t\t           \t\t\t\t}" + NL + "\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t       \t\t\t\tdis.readFully(";
  protected final String TEXT_289 = "Struct.commonByteArray_";
  protected final String TEXT_290 = "_";
  protected final String TEXT_291 = ", 0, length);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_292 = "__";
  protected final String TEXT_293 = " = new String(";
  protected final String TEXT_294 = "Struct.commonByteArray_";
  protected final String TEXT_295 = "_";
  protected final String TEXT_296 = ", 0, length);" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_297 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_298 = "__";
  protected final String TEXT_299 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tthis.";
  protected final String TEXT_300 = "__";
  protected final String TEXT_301 = " = new Date(dis.readLong());" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_302 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_303 = "__";
  protected final String TEXT_304 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_305 = "__";
  protected final String TEXT_306 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_307 = NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_308 = "__";
  protected final String TEXT_309 = " = (";
  protected final String TEXT_310 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_311 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_312 = "__";
  protected final String TEXT_313 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tthis.";
  protected final String TEXT_314 = "__";
  protected final String TEXT_315 = " = dis.read";
  protected final String TEXT_316 = "();" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_317 = NL + "\t\t\t            ";
  protected final String TEXT_318 = NL + "\t\t\t\t            this.exprKey_";
  protected final String TEXT_319 = "__";
  protected final String TEXT_320 = " = dis.read";
  protected final String TEXT_321 = "();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_322 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_323 = "__";
  protected final String TEXT_324 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tthis.exprKey_";
  protected final String TEXT_325 = "__";
  protected final String TEXT_326 = " = new Date(dis.readLong());" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_327 = NL + "\t\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_328 = "__";
  protected final String TEXT_329 = " = null;" + NL + "\t\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_330 = "Struct.commonByteArray_";
  protected final String TEXT_331 = "_";
  protected final String TEXT_332 = ".length) {" + NL + "\t\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_333 = "Struct.commonByteArray_";
  protected final String TEXT_334 = "_";
  protected final String TEXT_335 = ".length == 0) {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_336 = "Struct.commonByteArray_";
  protected final String TEXT_337 = "_";
  protected final String TEXT_338 = " = new byte[1024];" + NL + "\t\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_339 = "Struct.commonByteArray_";
  protected final String TEXT_340 = "_";
  protected final String TEXT_341 = " = new byte[2 * length];" + NL + "\t\t\t\t           \t\t\t\t}" + NL + "\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t       \t\t\t\tdis.readFully(";
  protected final String TEXT_342 = "Struct.commonByteArray_";
  protected final String TEXT_343 = "_";
  protected final String TEXT_344 = ", 0, length);" + NL + "\t\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_345 = "__";
  protected final String TEXT_346 = " = new String(";
  protected final String TEXT_347 = "Struct.commonByteArray_";
  protected final String TEXT_348 = "_";
  protected final String TEXT_349 = ", 0, length);" + NL + "\t\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_350 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_351 = "__";
  protected final String TEXT_352 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_353 = "__";
  protected final String TEXT_354 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t   \t\t\t\tthis.exprKey_";
  protected final String TEXT_356 = "__";
  protected final String TEXT_357 = " = (";
  protected final String TEXT_358 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_363 = " = dis.read";
  protected final String TEXT_364 = "();" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_365 = NL + "\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t";
  protected final String TEXT_366 = NL + "\t\t\t\t";
  protected final String TEXT_367 = NL + "\t\t\t\t\t} catch(ClassNotFoundException eCNFE) {" + NL + "\t\t\t\t\t\t\t throw new RuntimeException(eCNFE);" + NL + "\t\t\t\t";
  protected final String TEXT_368 = NL + "\t\t\t\t\t    \t}" + NL + "\t\t\t\t\t\t} " + NL + "\t\t\t\t\t}" + NL + "\t\t\t\tpublic void writeData(ObjectOutputStream dos) {" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t   \tdos.writeBoolean(this.is__rejectedInnerJoin);" + NL + "\t\t\t\t\t";
  protected final String TEXT_369 = NL + "\t\t\t            \tdos.write";
  protected final String TEXT_370 = "(this.";
  protected final String TEXT_371 = "__";
  protected final String TEXT_372 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_373 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_374 = "__";
  protected final String TEXT_375 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.";
  protected final String TEXT_376 = "__";
  protected final String TEXT_377 = ".getBytes();" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "\t\t\t       \t\t\t\tdos.write(byteArray);" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_378 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_379 = "__";
  protected final String TEXT_380 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.";
  protected final String TEXT_381 = "__";
  protected final String TEXT_382 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_383 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_384 = "__";
  protected final String TEXT_385 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.";
  protected final String TEXT_386 = "__";
  protected final String TEXT_387 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.";
  protected final String TEXT_388 = "__";
  protected final String TEXT_389 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_390 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.";
  protected final String TEXT_391 = "__";
  protected final String TEXT_392 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_393 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_394 = "__";
  protected final String TEXT_395 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.write";
  protected final String TEXT_396 = "(this.";
  protected final String TEXT_397 = "__";
  protected final String TEXT_398 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_399 = NL + "\t\t\t            ";
  protected final String TEXT_400 = NL + "\t\t\t\t            dos.write";
  protected final String TEXT_401 = "(this.exprKey_";
  protected final String TEXT_402 = "__";
  protected final String TEXT_403 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_404 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_405 = "__";
  protected final String TEXT_406 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.exprKey_";
  protected final String TEXT_407 = "__";
  protected final String TEXT_408 = ".getBytes();" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "\t\t\t       \t\t\t\tdos.write(byteArray);" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_409 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_410 = "__";
  protected final String TEXT_411 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.exprKey_";
  protected final String TEXT_412 = "__";
  protected final String TEXT_413 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_414 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_415 = "__";
  protected final String TEXT_416 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.exprKey_";
  protected final String TEXT_417 = "__";
  protected final String TEXT_418 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.exprKey_";
  protected final String TEXT_419 = "__";
  protected final String TEXT_420 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_421 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.exprKey_";
  ...
  protected final String TEXT_426 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.write";
  protected final String TEXT_427 = "(this.exprKey_";
  protected final String TEXT_428 = "__";
  protected final String TEXT_429 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_430 = NL + "\t\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_431 = NL + "\t\t\t    }" + NL + "\t\t\t}" + NL + "\t     }" + NL + "\t   ";
