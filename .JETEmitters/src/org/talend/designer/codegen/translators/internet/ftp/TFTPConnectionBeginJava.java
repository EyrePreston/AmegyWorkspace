...
public class TFTPConnectionBeginJava
{
  ...
  protected final String TEXT_164 = ");" + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_165 = "\", c_";
  protected final String TEXT_166 = ");";
  protected final String TEXT_167 = NL + "\tclass MyTrust_";
  ...
  protected final String TEXT_175 = NL + "\t        " + NL + "     \t\tks.load(new java.io.FileInputStream(";
  protected final String TEXT_176 = "), decryptedKeyStorePassword_";
  protected final String TEXT_177 = ".toCharArray());" + NL + "      \t\tjavax.net.ssl.TrustManagerFactory tmf = javax.net.ssl.TrustManagerFactory.getInstance(javax.net.ssl.KeyManagerFactory.getDefaultAlgorithm());" + NL + "      \t\ttmf.init(ks);" + NL + "      \t\treturn tmf.getTrustManagers();" + NL + "    \t}" + NL + "\t}" + NL + "\tjavax.net.ssl.SSLContext sslContext = null;" + NL + "\tjavax.net.ssl.TrustManager[] trustManager = null;" + NL + "\tjavax.net.ssl.SSLSocketFactory sslSocketFactory = null;" + NL + "\tit.sauronsoftware.ftp4j.FTPClient ftp_";
  protected final String TEXT_178 = " =null;" + NL + "\tMyTrust_";
  protected final String TEXT_179 = " myTrust_";
  protected final String TEXT_180 = " = null;" + NL + "" + NL + "\ttry {" + NL + "\t\tsslContext = javax.net.ssl.SSLContext.getInstance(\"SSL\");" + NL + "\t\tmyTrust_";
  protected final String TEXT_181 = " = new MyTrust_";
  protected final String TEXT_182 = "();" + NL + "\t\ttrustManager = myTrust_";
  protected final String TEXT_183 = ".getTrustManagers();" + NL + "\t\tsslContext.init(null, trustManager, new java.security.SecureRandom());" + NL + "\t\tsslSocketFactory = sslContext.getSocketFactory();" + NL + "\t\tftp_";
  protected final String TEXT_184 = " = new it.sauronsoftware.ftp4j.FTPClient();" + NL + "\t\tftp_";
  protected final String TEXT_185 = ".setSSLSocketFactory(sslSocketFactory);";
  protected final String TEXT_186 = NL + "\t\t\tftp_";
  protected final String TEXT_187 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPS);";
  protected final String TEXT_188 = NL + "\t\t\tftp_";
  protected final String TEXT_189 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPES);";
  protected final String TEXT_190 = NL + "\t\t";
  protected final String TEXT_191 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_192 = " -FTPS security Mode is ";
  ...
  protected final String TEXT_198 = ".connect(";
  protected final String TEXT_199 = ",";
  protected final String TEXT_200 = ");" + NL + "  \t\t";
  protected final String TEXT_201 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_202 = " - Connect to '\" + ";
  ...
  protected final String TEXT_215 = ");" + NL + "  \t} catch (java.lang.IllegalStateException e) {" + NL + "\t\t";
  protected final String TEXT_216 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_217 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_218 = NL + "    \te.printStackTrace();" + NL + "\t} catch (java.io.IOException e) {" + NL + "\t\t";
  protected final String TEXT_219 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_220 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_221 = NL + "\t\te.printStackTrace();" + NL + "\t} catch (it.sauronsoftware.ftp4j.FTPIllegalReplyException e) {" + NL + "\t\t";
  protected final String TEXT_222 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_223 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_224 = NL + "\t\te.printStackTrace();" + NL + "\t} catch (it.sauronsoftware.ftp4j.FTPException e) {" + NL + "\t\t";
  protected final String TEXT_225 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_226 = " - \" + e.getMessage());" + NL + "\t\t";
  protected final String TEXT_227 = NL + "\t\te.printStackTrace();" + NL + "\t}" + NL + "\tglobalMap.put(\"conn_";
