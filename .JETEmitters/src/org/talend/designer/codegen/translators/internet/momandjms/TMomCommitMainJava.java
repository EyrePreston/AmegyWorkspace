...
public class TMomCommitMainJava
{
  ...
  protected final String TEXT_36 = "\");" + NL + "\t    com.ibm.mq.MQQueue remoteQ_";
  protected final String TEXT_37 = " = (com.ibm.mq.MQQueue)globalMap.get(\"remoteQ_";
  protected final String TEXT_38 = "\");" + NL + "\t\tif(qMgr_";
  protected final String TEXT_39 = " != null && remoteQ_";
  protected final String TEXT_40 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_41 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_42 = " - Committing ...\");" + NL + "\t\t\t";
  protected final String TEXT_43 = NL + "\t\t\tqMgr_";
  protected final String TEXT_44 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_45 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_46 = " - Commit successfully.\");" + NL + "\t\t\t";
  protected final String TEXT_47 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_48 = " - Closing connection...\");" + NL + "\t\t\t\t";
  protected final String TEXT_49 = NL + "\t\t\t\tremoteQ_";
  protected final String TEXT_50 = ".close();" + NL + "\t\t\t    qMgr_";
  protected final String TEXT_51 = ".disconnect();;" + NL + "\t\t\t\t";
  protected final String TEXT_52 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_53 = " - Closed successfully.\");" + NL + "\t\t\t\t";
