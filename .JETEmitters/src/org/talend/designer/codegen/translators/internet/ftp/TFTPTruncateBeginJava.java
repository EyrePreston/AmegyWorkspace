...
public class TFTPTruncateBeginJava
{
  ...
  protected final String TEXT_146 = " " + NL + "\tjava.util.List<java.util.Map<String,String>> list";
  protected final String TEXT_147 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL + "" + NL + "\t";
  protected final String TEXT_148 = "    " + NL + "\t    java.util.Map<String,String> map";
  protected final String TEXT_149 = " = new java.util.HashMap<String,String>();" + NL + "\t    map";
  protected final String TEXT_150 = ".put(";
  protected final String TEXT_151 = ",\"\");" + NL + "\t    list";
  protected final String TEXT_152 = ".add(map";
  protected final String TEXT_153 = ");" + NL + "\t";
  protected final String TEXT_154 = NL;
  protected final String TEXT_155 = NL + "    \tlog.info(\"";
  protected final String TEXT_156 = " - Truncating file from the server.\");";
  protected final String TEXT_157 = NL + "\tfor (java.util.Map<String, String> map";
  protected final String TEXT_158 = " : list";
  protected final String TEXT_159 = ") {" + NL;
  protected final String TEXT_160 = NL + "\tcom.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_161 = " = null;" + NL + "" + NL + "\t";
  protected final String TEXT_162 = NL + "\t\tftp_";
  protected final String TEXT_163 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_164 = "\");" + NL + "\t\t";
  protected final String TEXT_165 = NL + "\t\t\tif(ftp_";
  protected final String TEXT_166 = "!=null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_167 = " - Use an existing connection. Connection hostname: \" + ftp_";
  protected final String TEXT_168 = ".getRemoteHost() + \", Connection port: \" + ftp_";
  protected final String TEXT_169 = ".getRemotePort() + \".\"); " + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_170 = NL + "\t\t";
  protected final String TEXT_171 = NL + "\t\t  String rootDir_";
  protected final String TEXT_172 = " = ftp_";
  protected final String TEXT_173 = ".pwd();" + NL + "\t\t";
  protected final String TEXT_174 = NL + "\t";
  protected final String TEXT_175 = "    " + NL + "\t    ftp_";
  protected final String TEXT_176 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "\t    ftp_";
  protected final String TEXT_177 = ".setRemoteHost(";
  protected final String TEXT_178 = ");" + NL + "\t    ftp_";
  protected final String TEXT_179 = ".setRemotePort(";
  ...
  protected final String TEXT_186 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);" + NL + "\t    ";
  protected final String TEXT_187 = NL + "\t      ftp_";
  protected final String TEXT_188 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);" + NL + "\t    ";
  protected final String TEXT_189 = NL + "    \tftp_";
  protected final String TEXT_190 = ".setControlEncoding(";
  protected final String TEXT_191 = ");" + NL + "\t\t";
  protected final String TEXT_192 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_193 = " - Attempt to connect to '\" + ";
  protected final String TEXT_194 = " + \"' with username '\" +";
  protected final String TEXT_195 = "+ \"'.\");" + NL + "\t\t";
  protected final String TEXT_196 = NL + "\t    ftp_";
  protected final String TEXT_197 = ".connect();" + NL + "\t    " + NL + "\t    ";
  ...
  protected final String TEXT_205 = NL + "\t\t\t" + NL + "\t    ftp_";
  protected final String TEXT_206 = ".login(";
  protected final String TEXT_207 = ", decryptedPassword_";
  protected final String TEXT_208 = ");" + NL + "\t\t";
  protected final String TEXT_209 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_210 = " - Connect to '\" + ";
  protected final String TEXT_211 = " + \"' has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_212 = "   " + NL + "  \t";
  protected final String TEXT_213 = " " + NL + "\tjava.util.List<java.util.Map<String,String>> list";
  protected final String TEXT_214 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL + "" + NL + "\t";
  protected final String TEXT_215 = "    " + NL + "\t\tjava.util.Map<String,String> map";
  protected final String TEXT_216 = " = new java.util.HashMap<String,String>();" + NL + "\t\tmap";
  protected final String TEXT_217 = ".put(";
  protected final String TEXT_218 = ",\"\");" + NL + "\t\tlist";
  protected final String TEXT_219 = ".add(map";
  protected final String TEXT_220 = ");       " + NL + "\t";
  protected final String TEXT_221 = NL + "\tString remotedir";
  protected final String TEXT_222 = " = ";
  protected final String TEXT_223 = ";" + NL + "\tftp_";
  protected final String TEXT_224 = ".chdir(remotedir";
  protected final String TEXT_225 = ");" + NL + "\tString root";
  protected final String TEXT_226 = " = ftp_";
  protected final String TEXT_227 = ".pwd();" + NL + "" + NL + "\t";
  protected final String TEXT_228 = NL + "\t\tlog.info(\"";
  protected final String TEXT_229 = " - Truncating file from the server.\");" + NL + "\t";
  protected final String TEXT_230 = NL + "\tfor (java.util.Map<String, String> map";
  protected final String TEXT_231 = " : list";
