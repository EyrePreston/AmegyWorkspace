...
public class TWebServiceMainJava
{
  ...
  protected final String TEXT_39 = NL + "\t\tinMap_";
  protected final String TEXT_40 = " = new java.util.HashMap<String,Object>();" + NL + "\t\tjava.util.Map<String,Object> paramMap_";
  protected final String TEXT_41 = " = new java.util.HashMap<String,Object>();" + NL + "\t\tObject inputValueObject_";
  protected final String TEXT_42 = ";" + NL + "\t\tjavax.xml.namespace.QName anyTypeQName_";
  protected final String TEXT_43 = ";";
  protected final String TEXT_44 = "\t" + NL + "    \t\t\t\tinputValueObject_";
  protected final String TEXT_45 = " = util_";
  protected final String TEXT_46 = ".";
  protected final String TEXT_47 = ";";
  protected final String TEXT_48 = "\t" + NL + "\t\t\t\t\tinputValueObject_";
  protected final String TEXT_49 = " = ";
  protected final String TEXT_50 = ";";
  protected final String TEXT_51 = NL + "\t\t\t\tparamMap_";
  protected final String TEXT_52 = ".put(util_";
  protected final String TEXT_53 = ".removePunctuation(\"";
  protected final String TEXT_54 = "\"),inputValueObject_";
  protected final String TEXT_55 = ");";
  protected final String TEXT_56 = NL + "\t\tutil_";
  protected final String TEXT_57 = ".resolveInputPath(paramMap_";
  protected final String TEXT_58 = ");" + NL + "\t\tif(!paramMap_";
  protected final String TEXT_59 = ".isEmpty()){" + NL + "\t\t\tinMap_";
  protected final String TEXT_60 = " = org.talend.webservice.helper.map.MapConverter.mapToDeepMap(paramMap_";
  protected final String TEXT_61 = ");" + NL + "\t\t}" + NL + "\t\tif(inMap_";
  protected final String TEXT_62 = ".isEmpty()){" + NL + "\t\t\tinMap_";
  protected final String TEXT_63 = " = null;" + NL + "\t\t}";
  protected final String TEXT_64 = "\t" + NL + "\t java.util.Map<String, Object> results_";
  protected final String TEXT_65 = " = null;" + NL + "\t try{" + NL + "\t \t";
  protected final String TEXT_66 = NL + "\t \tresults_";
  protected final String TEXT_67 = " = serviceInvokerHelper_";
  protected final String TEXT_68 = ".invoke(serviceName_";
  protected final String TEXT_69 = ", portName_";
  protected final String TEXT_70 = ", \"";
  protected final String TEXT_71 = "\", inMap_";
  protected final String TEXT_72 = ");" + NL + "\t \t";
  protected final String TEXT_73 = NL + "\t }catch(java.lang.Exception e){";
  protected final String TEXT_74 = NL + "\t\tthrow(e);";
  protected final String TEXT_75 = NL + "\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_76 = NL + "\t }";
  protected final String TEXT_77 = "            \t\t" + NL + "\t\t\t\t\tjava.util.Map<String, Object> outMap_";
  protected final String TEXT_78 = "=null;" + NL + "\t\t\t\t\tif(results_";
  protected final String TEXT_79 = "!=null&&!results_";
  protected final String TEXT_80 = ".isEmpty()){" + NL + "\t\t\t\t\t\toutMap_";
  protected final String TEXT_81 = " = org.talend.webservice.helper.map.MapConverter.deepMapToMap(results_";
  protected final String TEXT_82 = ");" + NL + "\t\t\t\t\t}" + NL + "            \t\tjava.util.Map<String,Object> returnValuesMap_";
  protected final String TEXT_83 = " = new java.util.HashMap<String,Object>();" + NL + "            \t\tObject outputValue_";
  protected final String TEXT_84 = ";";
  protected final String TEXT_85 = NL + "\t\t\t\t\toutputValue_";
  protected final String TEXT_86 = " = util_";
  protected final String TEXT_87 = ".normalize(util_";
  protected final String TEXT_88 = ".getValue(outMap_";
  protected final String TEXT_89 = ",util_";
  protected final String TEXT_90 = ".removePunctuation(\"";
  protected final String TEXT_91 = "\")).toString(),\"";
  protected final String TEXT_92 = "\");";
  protected final String TEXT_93 = "    \t\t\t\t" + NL + "        \t\t\toutputValue_";
  protected final String TEXT_94 = " = util_";
  protected final String TEXT_95 = ".denormalize((List)util_";
  protected final String TEXT_96 = ".getValue(outMap_";
  protected final String TEXT_97 = ",util_";
  protected final String TEXT_98 = ".removePunctuation(\"";
  protected final String TEXT_99 = "\")),\"";
  protected final String TEXT_100 = "\");    \t\t\t\t";
  protected final String TEXT_101 = NL + " \t\t\t\t\toutputValue_";
  protected final String TEXT_102 = " = util_";
  protected final String TEXT_103 = ".getValue(outMap_";
  protected final String TEXT_104 = ",util_";
  protected final String TEXT_105 = ".removePunctuation(\"";
  protected final String TEXT_106 = "\"));";
  protected final String TEXT_107 = NL + "\t\t\t\t\treturnValuesMap_";
  protected final String TEXT_108 = ".put(\"";
  protected final String TEXT_109 = "\",outputValue_";
  protected final String TEXT_110 = ");\t\t";
  protected final String TEXT_111 = "\t\t\t\t" + NL + "\t\t\tif(returnValuesMap_";
  protected final String TEXT_112 = "!=null&&!returnValuesMap_";
  protected final String TEXT_113 = ".isEmpty()){";
  protected final String TEXT_114 = NL + NL + "\t\t\t\tif(returnValuesMap_";
  protected final String TEXT_115 = ".get(\"";
  protected final String TEXT_116 = "\")!=null){";
  protected final String TEXT_117 = "\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_118 = ".";
  protected final String TEXT_119 = " = returnValuesMap_";
  protected final String TEXT_120 = ".get(\"";
  protected final String TEXT_121 = "\").toString();";
  protected final String TEXT_122 = NL + "\t\t\t\t\t";
  protected final String TEXT_123 = ".";
  protected final String TEXT_124 = " = ParserUtils.parseTo_Date(returnValuesMap_";
  protected final String TEXT_125 = ".get(\"";
  protected final String TEXT_126 = "\").toString(), ";
  protected final String TEXT_127 = ");";
  protected final String TEXT_128 = NL + "\t\t\t\t\tif(returnValuesMap_";
  protected final String TEXT_129 = ".get(\"";
  protected final String TEXT_130 = "\") instanceof byte[]){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_131 = ".";
  protected final String TEXT_132 = " = (byte[])returnValuesMap_";
  protected final String TEXT_133 = ".get(\"";
  protected final String TEXT_134 = "\");\t" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_135 = ".";
  protected final String TEXT_136 = " = returnValuesMap_";
  protected final String TEXT_137 = ".get(\"";
  protected final String TEXT_138 = "\").toString().getBytes();" + NL + "\t\t\t\t\t}";
  protected final String TEXT_139 = NL + "\t\t\t\t\t";
  protected final String TEXT_140 = ".";
  protected final String TEXT_141 = " = (List<Object>)returnValuesMap_";
  protected final String TEXT_142 = ".get(\"";
  protected final String TEXT_143 = "\");";
  protected final String TEXT_144 = "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_145 = ".";
  protected final String TEXT_146 = " = ParserUtils.parseTo_";
  protected final String TEXT_147 = "(returnValuesMap_";
  protected final String TEXT_148 = ".get(\"";
  protected final String TEXT_149 = "\").toString());\t";
