...
public class TJMSOutputBeginJava
{
  ...
  protected final String TEXT_39 = NL + "\tjava.util.Hashtable props_";
  ...
  protected final String TEXT_66 = ");" + NL + "\tconnection_";
  protected final String TEXT_67 = ".start();" + NL + "" + NL + "\tjavax.jms.Session session_";
  protected final String TEXT_68 = " = connection_";
  protected final String TEXT_69 = ".createSession(false, javax.jms.Session.AUTO_ACKNOWLEDGE);" + NL + "\tjavax.jms.Destination dest_";
  protected final String TEXT_70 = " = session_";
  protected final String TEXT_71 = ".create";
  protected final String TEXT_72 = "(";
  protected final String TEXT_73 = ");" + NL + "" + NL + "\tjavax.jms.MessageProducer producer_";
  protected final String TEXT_74 = " = session_";
  protected final String TEXT_75 = ".createProducer(dest_";
  protected final String TEXT_76 = ");" + NL + "" + NL + "\tproducer_";
  protected final String TEXT_77 = ".setDeliveryMode(javax.jms.DeliveryMode.";
  protected final String TEXT_78 = ");" + NL + "" + NL + "\tint nbline_";
  protected final String TEXT_79 = " = 0;" + NL + "" + NL + "" + NL + "" + NL + "\t\t";
