...
public class TJMSOutputMainJava
{
  ...
  protected final String TEXT_39 = NL + "producer_";
  protected final String TEXT_40 = ".send((javax.jms.Message)";
  protected final String TEXT_41 = ".message);" + NL + "nbline_";
  protected final String TEXT_42 = "++;";
  protected final String TEXT_43 = NL + "javax.jms.ObjectMessage message_";
  protected final String TEXT_44 = " = session_";
  protected final String TEXT_45 = ".createObjectMessage();" + NL + "message_";
  protected final String TEXT_46 = ".setObject(";
  protected final String TEXT_47 = ".messageContent);";
  protected final String TEXT_48 = NL + "javax.jms.TextMessage message_";
  protected final String TEXT_49 = " = session_";
  protected final String TEXT_50 = ".createTextMessage();" + NL + "message_";
  protected final String TEXT_51 = ".setText(";
  protected final String TEXT_52 = ".messageContent);";
  protected final String TEXT_53 = NL + "producer_";
  protected final String TEXT_54 = ".send(message_";
  protected final String TEXT_55 = ");" + NL + "" + NL + "nbline_";
