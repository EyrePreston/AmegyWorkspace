...
public class TFTPFileExistBeginJava
{
  ...
  protected final String TEXT_143 = ".getHome());" + NL + "\t  \t}";
  protected final String TEXT_144 = NL + "\tcom.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_145 = " = null;" + NL + "" + NL + "\t";
  protected final String TEXT_146 = NL + "\t\tftp_";
  protected final String TEXT_147 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_148 = "\");" + NL + "\t\t";
  protected final String TEXT_149 = NL + "\t\t\tif(ftp_";
  protected final String TEXT_150 = "!=null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_151 = " - Use an existing connection. Connection hostname: \" + ftp_";
  ...
  protected final String TEXT_155 = "    " + NL + "\t   \tftp_";
  protected final String TEXT_156 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "\t   \tftp_";
  protected final String TEXT_157 = ".setRemoteHost(";
  protected final String TEXT_158 = ");" + NL + "\t   \tftp_";
  protected final String TEXT_159 = ".setRemotePort(";
  ...
  protected final String TEXT_166 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);" + NL + "\t    ";
  protected final String TEXT_167 = NL + "\t      ftp_";
  protected final String TEXT_168 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);" + NL + "\t    ";
  protected final String TEXT_169 = NL + "\t    ftp_";
  protected final String TEXT_170 = ".setControlEncoding(";
  protected final String TEXT_171 = ");" + NL + "\t\t";
  protected final String TEXT_172 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_173 = " - Attempt to connect to '\" + ";
  protected final String TEXT_174 = " + \"' with username: '\" +";
  protected final String TEXT_175 = "+ \"'.\");" + NL + "\t\t";
  protected final String TEXT_176 = NL + "\t    ftp_";
  protected final String TEXT_177 = ".connect();  " + NL + "\t    " + NL + "\t\t";
  ...
  protected final String TEXT_185 = NL + NL + "\t    ftp_";
  ...
  protected final String TEXT_190 = " - Connect to '\" + ";
