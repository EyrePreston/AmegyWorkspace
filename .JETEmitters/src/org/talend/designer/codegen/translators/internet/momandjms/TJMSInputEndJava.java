...
public class TJMSInputEndJava
{
  ...
  protected final String TEXT_39 = NL + "\tnbline_";
  protected final String TEXT_40 = "++;" + NL + "\tmessage_";
  protected final String TEXT_41 = ".acknowledge();" + NL + "\tif(";
  protected final String TEXT_42 = " > 0 && nbline_";
  protected final String TEXT_43 = " >= ";
  protected final String TEXT_44 = "){" + NL + "\t\tbreak;" + NL + "\t}" + NL + "\t" + NL + "}" + NL + "consumer_";
  protected final String TEXT_45 = ".close();" + NL + "session_";
  protected final String TEXT_46 = ".close();" + NL + "connection_";
