...
public class TFTPDeleteBeginJava
{
  ...
  protected final String TEXT_136 = " - Uses an existing connection. Connection username: \" + c_";
  ...
  protected final String TEXT_157 = " - Deleting file from server.\");" + NL + "\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_159 = " - Deleting directory from server.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_171 = " - Uses an existing connection. Connection hostname: \" + ftp_";
  ...
  protected final String TEXT_229 = ");" + NL + "\t\t\tString root";
  protected final String TEXT_230 = " = ftp_";
  protected final String TEXT_231 = ".pwd();" + NL + "" + NL + "\t\t";
  protected final String TEXT_232 = NL + "\t\t\t";
  protected final String TEXT_233 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_234 = " - Deleting file from server.\");" + NL + "\t\t\t";
  protected final String TEXT_235 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_236 = " - Deleting directory from server.\");" + NL + "\t\t\t";
  protected final String TEXT_237 = NL + "\t\t";
  protected final String TEXT_238 = NL + "\t\t\tfor (java.util.Map<String, String> map";
  protected final String TEXT_239 = " : list";
