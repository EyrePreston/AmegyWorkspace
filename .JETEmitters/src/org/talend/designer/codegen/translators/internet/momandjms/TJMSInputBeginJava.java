...
public class TJMSInputBeginJava
{
  ...
  protected final String TEXT_39 = NL + NL + "\tjava.util.Hashtable props_";
  protected final String TEXT_40 = " = new java.util.Hashtable();" + NL + "\tprops_";
  protected final String TEXT_41 = ".put(javax.naming.Context.INITIAL_CONTEXT_FACTORY, ";
  protected final String TEXT_42 = ");" + NL + "\tprops_";
  protected final String TEXT_43 = ".put(javax.naming.Context.PROVIDER_URL, ";
  protected final String TEXT_44 = ");" + NL + "\t";
  protected final String TEXT_45 = NL + "\tprops_";
  protected final String TEXT_46 = ".put(";
  protected final String TEXT_47 = ", ";
  protected final String TEXT_48 = ");";
  protected final String TEXT_49 = NL + "\t" + NL + "\tjavax.naming.Context context_";
  protected final String TEXT_50 = " = new javax.naming.InitialContext(props_";
  protected final String TEXT_51 = ");" + NL + "\tjavax.jms.ConnectionFactory factory_";
  protected final String TEXT_52 = " = (javax.jms.ConnectionFactory) context_";
  protected final String TEXT_53 = ".lookup(";
  ...
  protected final String TEXT_62 = NL + NL + "\tjavax.jms.Connection connection_";
  protected final String TEXT_63 = " = factory_";
  protected final String TEXT_64 = ".createConnection(";
  protected final String TEXT_65 = ", decryptedPassword_";
  protected final String TEXT_66 = ");" + NL + "\tjavax.jms.Session session_";
  protected final String TEXT_67 = " = connection_";
  protected final String TEXT_68 = ".createSession(false, javax.jms.Session.CLIENT_ACKNOWLEDGE);" + NL + "\tjavax.jms.Destination dest_";
  protected final String TEXT_69 = " = session_";
  protected final String TEXT_70 = ".create";
  protected final String TEXT_71 = "(";
  protected final String TEXT_72 = ");" + NL + "\tjavax.jms.MessageConsumer consumer_";
  protected final String TEXT_73 = "\t= session_";
  protected final String TEXT_74 = ".createConsumer(dest_";
  protected final String TEXT_75 = ", ";
  protected final String TEXT_76 = ");" + NL + "" + NL + "\tconnection_";
  protected final String TEXT_77 = ".start();" + NL + "" + NL + "\tSystem.out.println(\"Ready to receive message\");" + NL + "\tSystem.out.println(\"Waiting...\");" + NL + "\t";
  protected final String TEXT_78 = NL + "\t";
  protected final String TEXT_79 = NL + NL + "\tjavax.jms.Message message_";
  protected final String TEXT_80 = ";" + NL + "" + NL + "\tint nbline_";
  protected final String TEXT_81 = " = 0;" + NL + "" + NL + "\twhile ((message_";
  protected final String TEXT_82 = " = consumer_";
  protected final String TEXT_83 = ".receive(";
  protected final String TEXT_84 = "*1000)) != null) {" + NL + "\t\t";
  protected final String TEXT_85 = NL + "\t\t";
  protected final String TEXT_86 = ".message=message_";
  protected final String TEXT_87 = ";\t";
  protected final String TEXT_88 = NL + "\t\t";
  protected final String TEXT_89 = ".messageContent=ParserUtils.parseTo_Document(((javax.jms.ObjectMessage) message_";
  protected final String TEXT_90 = ").getObject().toString());";
  protected final String TEXT_91 = NL + "\t\t";
  protected final String TEXT_92 = ".messageContent=((javax.jms.TextMessage) message_";
  protected final String TEXT_93 = ").getText();";
