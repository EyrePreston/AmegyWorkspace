...
public class TFTPRenameBeginJava
{
  ...
  protected final String TEXT_152 = ");" + NL + "\t    list";
  protected final String TEXT_153 = ".add(map";
  protected final String TEXT_154 = ");       ";
  protected final String TEXT_155 = NL;
  protected final String TEXT_156 = NL + "    \tlog.info(\"";
  protected final String TEXT_157 = " - Renaming file from server.\");";
  protected final String TEXT_158 = NL + "\tfor (java.util.Map<String, String> map";
  protected final String TEXT_159 = " : list";
  protected final String TEXT_160 = ") {" + NL;
  protected final String TEXT_161 = NL + "\tcom.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_162 = " =null;" + NL + "" + NL + "\t";
  protected final String TEXT_163 = NL + "    \tftp_";
  protected final String TEXT_164 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_165 = "\");" + NL + "\t\t";
  protected final String TEXT_166 = NL + "\t\t\tif(ftp_";
  protected final String TEXT_167 = "!=null) {" + NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_168 = " - Use an existing connection. Connection hostname: \" + ftp_";
  protected final String TEXT_169 = ".getRemoteHost() + \", Connection port: \" + ftp_";
  protected final String TEXT_170 = ".getRemotePort() + \".\"); " + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_171 = NL + "\t  \t";
  protected final String TEXT_172 = NL + "\t  \t\tString rootDir_";
  protected final String TEXT_173 = " = ftp_";
  protected final String TEXT_174 = ".pwd();" + NL + "\t  \t";
  protected final String TEXT_175 = NL + "\t";
  protected final String TEXT_176 = "    " + NL + "\t    ftp_";
  protected final String TEXT_177 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "\t    ftp_";
  protected final String TEXT_178 = ".setRemoteHost(";
  protected final String TEXT_179 = ");" + NL + "\t    ftp_";
  protected final String TEXT_180 = ".setRemotePort(";
  ...
  protected final String TEXT_187 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);" + NL + "\t\t";
  protected final String TEXT_188 = NL + "\t\t\tftp_";
  protected final String TEXT_189 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);" + NL + "\t\t";
  protected final String TEXT_190 = NL + "\t\tftp_";
  protected final String TEXT_191 = ".setControlEncoding(";
  protected final String TEXT_192 = ");" + NL + "\t\t";
  protected final String TEXT_193 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_194 = " - Attempt to connect to '\" + ";
  protected final String TEXT_195 = " + \"' with username '\" +";
  protected final String TEXT_196 = "+ \"'.\");" + NL + "\t\t";
  protected final String TEXT_197 = NL + "\t\tftp_";
  protected final String TEXT_198 = ".connect();  " + NL + "\t\t" + NL + "\t\t";
  ...
  protected final String TEXT_206 = NL + "\t\t\t" + NL + "\t\tftp_";
  protected final String TEXT_207 = ".login(";
  ...
  protected final String TEXT_215 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_229 = " - Renaming file from server.\");" + NL + "\t";
