...
public class TJMSOutputEndJava
{
  ...
  protected final String TEXT_40 = ".close();" + NL + "session_";
  protected final String TEXT_41 = ".close();" + NL + "connection_";
  protected final String TEXT_42 = ".close();" + NL + "globalMap.put(\"";
  protected final String TEXT_43 = "_NB_LINE\", nbline_";
