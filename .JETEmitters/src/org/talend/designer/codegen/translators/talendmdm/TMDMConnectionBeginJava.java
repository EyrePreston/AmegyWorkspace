...
public class TMDMConnectionBeginJava
{
  ...
  protected final String TEXT_5 = ");" + NL + "org.talend.mdm.webservice.XtentisPort_PortType xtentisWS_";
  ...
  protected final String TEXT_25 = NL + NL + "stub_";
  protected final String TEXT_26 = ".setPassword(decryptedPassword_";
  protected final String TEXT_27 = ");" + NL;
  protected final String TEXT_28 = NL + "String turl_";
  protected final String TEXT_29 = " = com.talend.mdm.transaction.client.MDMTransactionClient.getMDMTransactionURL(";
  protected final String TEXT_30 = ");" + NL + "com.talend.mdm.transaction.client.MDMTransaction mdmTransaction_";
  protected final String TEXT_31 = " = com.talend.mdm.transaction.client.MDMTransactionClient.newTransaction(turl_";
  protected final String TEXT_32 = ",stub_";
  protected final String TEXT_33 = ".getUsername(),stub_";
  protected final String TEXT_34 = ".getPassword());" + NL + "stub_";
  protected final String TEXT_35 = ".setHeader(new org.apache.axis.message.SOAPHeaderElement(\"http://www.talend.com/mdm\", \"transaction-id\", mdmTransaction_";
  protected final String TEXT_36 = ".getId()));" + NL + "globalMap.put(\"mdmTransaction_";
  protected final String TEXT_37 = "\", mdmTransaction_";
  protected final String TEXT_38 = ");";
  protected final String TEXT_39 = NL + NL + "stub_";
  protected final String TEXT_40 = ".ping(new org.talend.mdm.webservice.WSPing());";
  protected final String TEXT_41 = NL + NL + "globalMap.put(\"xtentisWS_";
  protected final String TEXT_42 = "\", xtentisWS_";
