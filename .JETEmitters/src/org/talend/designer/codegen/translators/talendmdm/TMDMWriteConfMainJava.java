...
public class TMDMWriteConfMainJava
{
  ...
  protected final String TEXT_204 = NL + "          System.err.println(e.getMessage());";
  protected final String TEXT_205 = NL + "    }";
  protected final String TEXT_206 = NL + "    flowNum_";
  protected final String TEXT_207 = "++;";
  protected final String TEXT_208 = NL + "    nb_line_";
  protected final String TEXT_209 = "++;";
  protected final String TEXT_210 = NL + "queue_";
  protected final String TEXT_211 = ".remove();";
