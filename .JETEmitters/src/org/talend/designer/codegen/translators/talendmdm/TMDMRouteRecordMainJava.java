...
public class TMDMRouteRecordMainJava
{
  ...
  protected final String TEXT_35 = "\");" + NL + "" + NL + "org.talend.mdm.webservice.WSRouteItemV2 wsRouteItem_";
  protected final String TEXT_36 = " = new org.talend.mdm.webservice.WSRouteItemV2();" + NL + "org.talend.mdm.webservice.WSItemPK wsItemPK_";
  protected final String TEXT_37 = " = new org.talend.mdm.webservice.WSItemPK();" + NL + "wsItemPK_";
  protected final String TEXT_38 = ".setConceptName(";
  protected final String TEXT_39 = ");" + NL + "wsItemPK_";
  protected final String TEXT_40 = ".setWsDataClusterPK(dataCluster_";
  protected final String TEXT_41 = ");" + NL + "wsItemPK_";
  protected final String TEXT_42 = ".setIds(new String[]{";
  protected final String TEXT_43 = NL;
  protected final String TEXT_44 = NL + "});" + NL + "wsRouteItem_";
  protected final String TEXT_45 = ".setWsItemPK(wsItemPK_";
  protected final String TEXT_46 = ");" + NL + "org.talend.mdm.webservice.WSRoutingRulePK[] wsRoutingRulePKArray_";
  protected final String TEXT_47 = " = xtentisWS_";
  protected final String TEXT_48 = ".routeItemV2(wsRouteItem_";
