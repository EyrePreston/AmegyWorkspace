...
public class Subprocess_headerJava
{
  ...
  protected final String TEXT_225 = NL + "\t\t\t" + NL + "\t\t\tpublic void run() {" + NL + "\t\t\t\tjava.util.Map threadRunResultMap = new java.util.HashMap();" + NL + "\t\t\t\tthreadRunResultMap.put(\"errorCode\", null);" + NL + "\t\t\t\tthreadRunResultMap.put(\"status\", \"\");" + NL + "\t\t\t\tthreadLocal.set(threadRunResultMap);" + NL + "\t\t\t\t" + NL + "\t\t\t\tthis.isRunning = true;" + NL + "\t\t\t\tString currentComponent = \"\";" + NL + "\t\t\t\tjava.util.Map<String, Object> resourceMap = new java.util.HashMap<String, Object>();" + NL + "\t\t\t\ttry{" + NL + "\t";
  protected final String TEXT_226 = NL + "\t\tString currentVirtualComponent = null;";
  protected final String TEXT_227 = NL + "\t";
  protected final String TEXT_228 = NL + "\t\tString iterateId = \".\" + globalMap.get(\"";
  protected final String TEXT_229 = "_THREAD_ID\");" + NL + "\t";
  protected final String TEXT_230 = NL + "\t\tString iterateId = \"\";" + NL + "\t";
  protected final String TEXT_231 = NL + "\t";
  protected final String TEXT_232 = NL + "\t\tint iterateLoop = 0;" + NL + "\t";
  protected final String TEXT_233 = NL + "\tString currentComponent = \"\";" + NL + "\tjava.util.Map<String, Object> resourceMap = new java.util.HashMap<String, Object>();" + NL + "\t\t\t\t\t" + NL + "\ttry {" + NL + "\t" + NL + "\t\t\tString currentMethodName = new java.lang.Exception().getStackTrace()[0].getMethodName();" + NL + "\t\t\tboolean resumeIt = currentMethodName.equals(resumeEntryMethodName);" + NL + "\t\t\tif( resumeEntryMethodName == null || resumeIt || globalResumeTicket){//start the resume" + NL + "\t\t\t\tglobalResumeTicket = true;" + NL;
  protected final String TEXT_234 = NL + "    \t\t\t//resumeUtil.addLog(\"CHECKPOINT\", \"CONNECTION:";
  protected final String TEXT_235 = ":";
  protected final String TEXT_236 = ":";
  protected final String TEXT_237 = "\", \"\", Thread.currentThread().getId() + \"\", \"\", \"\", \"\", \"\", \"\");" + NL + "    \t\t";
  protected final String TEXT_238 = NL + "\t\t\t\t\t";
  protected final String TEXT_239 = NL + "\t\t";
  protected final String TEXT_240 = "Process(globalMap);";
