...
public class Iterate_subprocess_footerJava
{
  ...
  protected final String TEXT_12 = "++);" + NL + "\t\t\t\tbt_";
  protected final String TEXT_13 = ".assignLock(lockWrite_";
  protected final String TEXT_14 = ");" + NL + "\t\t\t\tmtp_";
  protected final String TEXT_15 = ".execute(bt_";
  protected final String TEXT_16 = ");" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_17 = NL + "\t\t      \t\t\tif(execStat){" + NL + "\t\t\t\t\t\t\trunStat.updateStatOnIterate(\"";
  protected final String TEXT_18 = "\", RunStat.END);" + NL + "\t\t\t\t\t\t}  " + NL + "\t      \t\t\t";
  protected final String TEXT_19 = NL + "\t\t\t\t\t\tif(execStat){" + NL + "\t\t\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_20 = "\", 2, \"exec\" + NB_ITERATE_";
