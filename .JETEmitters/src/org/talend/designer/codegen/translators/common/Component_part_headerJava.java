...
public class Component_part_headerJava
{
  ...
  protected final String TEXT_41 = " ] start" + NL + "\t */" + NL + "" + NL + "\t";
  protected final String TEXT_42 = NL + "\t\t\t\tTalendThreadPool mtp_";
  protected final String TEXT_43 = " = new TalendThreadPool(";
  protected final String TEXT_44 = ");" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_45 = NL + "\t\t\t\t\tfinal Object[] lockWrite_";
  protected final String TEXT_46 = " = new Object[0];" + NL + "\t\t\t\t\tint threadIdCounter_";
