...
public class TFileOutputPositionalEndJava
{
  ...
  protected final String TEXT_32 = NL + "\tsynchronized (lockWrite) {";
  protected final String TEXT_33 = NL + "\tObject[] pLockWrite = (Object[])globalMap.get(\"PARALLEL_LOCK_WRITE\");" + NL + "\tsynchronized (pLockWrite) {";
  protected final String TEXT_34 = NL + "\tout";
  protected final String TEXT_35 = ".close();";
  protected final String TEXT_36 = NL + "\tout";
  protected final String TEXT_37 = ".flush();" + NL + "\toutWriter_";
  ...
  protected final String TEXT_47 = NL + "\tif(isFileGenerated_";
  protected final String TEXT_48 = " && nb_line_";
  protected final String TEXT_49 = " == 0){" + NL + "\t\tcreateFile";
  protected final String TEXT_50 = ".delete();" + NL + "\t}\t\t";
