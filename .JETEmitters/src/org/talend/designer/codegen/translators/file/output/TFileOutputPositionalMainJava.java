...
public class TFileOutputPositionalMainJava
{
  ...
  protected final String TEXT_49 = NL + "\t\t\tsynchronized (lockWrite) {" + NL + "\t\t\t";
  protected final String TEXT_50 = NL + "\t\t\tObject[] pLockWrite = (Object[])globalMap.get(\"PARALLEL_LOCK_WRITE\");" + NL + "\t\t\tsynchronized (pLockWrite) {" + NL + "\t\t\t";
  protected final String TEXT_51 = NL + "\t\t\tout";
  protected final String TEXT_52 = ".write(sb_";
  protected final String TEXT_53 = ".toString());" + NL + "    \t\t";
  protected final String TEXT_54 = NL + "        \t\tif(nb_line_";
  protected final String TEXT_55 = "%";
  protected final String TEXT_56 = " == 0) {" + NL + "        \t\tout";
  protected final String TEXT_57 = ".flush();" + NL + "        \t\t}" + NL + "    \t\t";
