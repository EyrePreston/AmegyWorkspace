...
public class TFileInputMailBeginJava
{
  ...
  protected final String TEXT_277 = ";" + NL + "\t                    java.io.File attachFile  = new java.io.File(path";
  protected final String TEXT_278 = ");" + NL + "\t                    out";
  protected final String TEXT_279 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(attachFile));" + NL + "\t                    in";
  protected final String TEXT_280 = " = new java.io.BufferedInputStream(mpart";
  protected final String TEXT_281 = ".getInputStream());" + NL + "\t                    int buffer";
  protected final String TEXT_282 = " = 0;" + NL + "\t                    while ((buffer";
  protected final String TEXT_283 = " = in";
  protected final String TEXT_284 = ".read()) != -1) {" + NL + "\t                           out";
  protected final String TEXT_285 = ".write(buffer";
  protected final String TEXT_286 = ");" + NL + "\t                           out";
  protected final String TEXT_287 = ".flush();" + NL + "\t\t\t\t\t\t}   " + NL + "\t                    out";
  protected final String TEXT_288 = ".close();" + NL + "\t                    in";
  protected final String TEXT_289 = ".close();    " + NL + "\t                }" + NL + "\t            }" + NL + "\t\t\t}" + NL + " \t         " + NL + " \t          " + NL + "\t\t\t// for output" + NL + "\t\t\t";
  protected final String TEXT_290 = NL + "\t\t\t\t\t\t" + NL + "\t\t\t" + NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_291 = " < list_";
  protected final String TEXT_292 = ".size() && list_";
  protected final String TEXT_293 = ".get(";
  protected final String TEXT_294 = ")!=null){\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_295 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_296 = ".";
  protected final String TEXT_297 = " = (String)list_";
  protected final String TEXT_298 = ".get(";
  protected final String TEXT_299 = ");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_300 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_301 = ".";
  protected final String TEXT_302 = " = ParserUtils.parseTo_Date(list_";
  ...
  protected final String TEXT_310 = ").getBytes();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_311 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_312 = ".";
  protected final String TEXT_313 = " = ParserUtils.parseTo_";
  protected final String TEXT_314 = "(list_";
  protected final String TEXT_315 = ".get(";
  protected final String TEXT_316 = "));" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_317 = NL + "\t\t\t\t\t\t\t} else { " + NL + "\t\t\t" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_318 = ".";
  protected final String TEXT_319 = " = ";
  protected final String TEXT_320 = ";" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_321 = NL + "\t\t\t\t\t\t\t\thasData_";
  protected final String TEXT_322 = " = true;" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_329 = NL + "\t\t\tcatch (java.lang.Exception e){" + NL + "\t\t\t\t";
  protected final String TEXT_330 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_331 = " - \" + e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_332 = NL + "\t\t\t\t//nothing to do, ignore the exception if don't die on error" + NL + "\t\t\t\tSystem.err.println(\"Exception in component ";
  protected final String TEXT_333 = ": \" + e.getMessage());" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_334 = NL + "\t\tfinally{" + NL + "\t\t\tif(fileInput";
  protected final String TEXT_335 = "!=null)" + NL + "\t\t\t\t\tfileInput";
  protected final String TEXT_336 = ".close();" + NL + "\t\t} " + NL + "\t\t////////////////////////////" + NL + "\t\tif(hasData_";
  protected final String TEXT_337 = "){" + NL + "\t\t";
  protected final String TEXT_338 = NL + "        \t";
  protected final String TEXT_339 = "\t";
  protected final String TEXT_340 = NL + "\ttry{" + NL + "\t\torg.talend.msg.utils.MsgMailUtil msgMailUtil_";
  protected final String TEXT_341 = "=new org.talend.msg.utils.MsgMailUtil(";
  protected final String TEXT_342 = ",";
  protected final String TEXT_343 = ");" + NL + "\t\t";
  protected final String TEXT_344 = NL + "\t\t\tmsgMailUtil_";
  protected final String TEXT_345 = ".activeLog(log,\"";
  protected final String TEXT_346 = "\");" + NL + "\t\t";
  protected final String TEXT_347 = NL + "\t\tmsgMailUtil_";
  protected final String TEXT_348 = ".getAttachments();" + NL + "\t\t";
  protected final String TEXT_349 = NL + "\t\t\t\t\t\tObject value_";
  protected final String TEXT_350 = "_";
  protected final String TEXT_351 = "=msgMailUtil_";
  protected final String TEXT_352 = ".processMessage(\"";
  protected final String TEXT_353 = "\");" + NL + "\t\t\t\t\t\tif(value_";
  protected final String TEXT_354 = "_";
  protected final String TEXT_355 = "!=null){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_356 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_357 = ".";
  protected final String TEXT_358 = " = String.valueOf(value_";
  protected final String TEXT_359 = "_";
  protected final String TEXT_360 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_361 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_362 = ".";
  protected final String TEXT_363 = " = ParserUtils.parseTo_Date((java.util.Date)value_";
  ...
  protected final String TEXT_374 = " = value_";
  protected final String TEXT_375 = "_";
  protected final String TEXT_376 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_377 = NL + "\t\t\t\t\t\t\t\tif(value_";
  protected final String TEXT_378 = "_";
  protected final String TEXT_379 = " instanceof Object[]){" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_380 = ".";
  protected final String TEXT_381 = " = java.util.Arrays.asList((Object[])value_";
  protected final String TEXT_382 = "_";
  protected final String TEXT_383 = ");" + NL + "\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_384 = ".";
  protected final String TEXT_385 = " = java.util.Arrays.asList(value_";
  ...
  protected final String TEXT_391 = "(value_";
  protected final String TEXT_392 = "_";
  protected final String TEXT_393 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_394 = NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_395 = NL + "\t\t\t\t\t\t\thasData_";
  protected final String TEXT_396 = " = true;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_397 = NL + "\t}catch (java.lang.Exception e_";
  protected final String TEXT_398 = "){" + NL + "\t\t";
  protected final String TEXT_399 = NL + "\t\t\tthrow e_";
  protected final String TEXT_400 = ";" + NL + "\t\t\t";
  protected final String TEXT_401 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_402 = " - \" + e_";
  protected final String TEXT_403 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_404 = NL + "\t\t\t//nothing to do, ignore the exception if don't die on error" + NL + "\t\t\tSystem.err.println(\"Exception in component ";
  protected final String TEXT_405 = ": \" + e_";
  protected final String TEXT_406 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_407 = NL + "\t}" + NL + "\tif(hasData_";
