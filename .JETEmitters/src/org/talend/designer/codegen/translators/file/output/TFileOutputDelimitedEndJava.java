...
public class TFileOutputDelimitedEndJava
{
  ...
  protected final String TEXT_33 = NL + "\t\t\tsynchronized (lockWrite) {" + NL + "\t\t";
  protected final String TEXT_34 = NL + "\t\t\tObject[] pLockWrite = (Object[])globalMap.get(\"PARALLEL_LOCK_WRITE\");" + NL + "\t\t\tsynchronized (pLockWrite) {" + NL + "\t\t";
  protected final String TEXT_35 = NL + "\t\t\t";
  protected final String TEXT_36 = NL + "\t\t\t\t\tif(out";
  protected final String TEXT_37 = "!=null) {" + NL + "\t\t\t\t\t\tout";
  protected final String TEXT_38 = ".flush();" + NL + "\t\t\t\t\t\tout";
  ...
  protected final String TEXT_42 = ".flush();" + NL + "\t\t\t\t\t\twriter_";
  ...
  protected final String TEXT_48 = "_FILE_NAME\",fileName_";
  protected final String TEXT_49 = ");" + NL + "\t\t\t";
  protected final String TEXT_50 = NL + "\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_51 = NL + "\t\t\t\t\tif(CsvWriter";
  protected final String TEXT_52 = "!=null) {" + NL + "\t\t\t\t    \tCsvWriter";
  protected final String TEXT_53 = ".close();" + NL + "\t\t\t\t    }" + NL + "\t\t\t\t\t";
  protected final String TEXT_54 = NL + "\t\t\t\t\t\tif(out";
  protected final String TEXT_55 = "!=null) {" + NL + "\t\t\t\t\t\t\tout";
  protected final String TEXT_56 = ".flush();" + NL + "\t\t\t\t\t\t\tout";
  protected final String TEXT_57 = ".close();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_58 = NL + "\t\t\t\t\t\tif(CsvWriter";
  protected final String TEXT_59 = "!=null) {" + NL + "\t\t\t\t\t\t\tCsvWriter";
  protected final String TEXT_60 = ".close();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tif(out";
  protected final String TEXT_61 = "!=null) {" + NL + "\t\t\t\t\t\t\tout";
  protected final String TEXT_62 = ".flush();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tif(outWriter_";
  protected final String TEXT_63 = "!=null) {" + NL + "\t\t\t\t\t\t\toutWriter_";
  protected final String TEXT_64 = ".flush();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_65 = NL + "\t\t\t\t\t\tif(CsvWriter";
  protected final String TEXT_66 = "!=null) {" + NL + "\t\t\t\t\t\t\tCsvWriter";
  protected final String TEXT_67 = ".flush();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tif(bufferWriter_";
  protected final String TEXT_68 = "!=null) {" + NL + "\t\t\t\t\t\t\tbufferWriter_";
  protected final String TEXT_69 = ".flush();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tif(outWriter_";
  protected final String TEXT_70 = "!=null) {" + NL + "\t\t\t\t\t\t\toutWriter_";
  protected final String TEXT_71 = ".flush();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tCsvWriter";
  ...
  protected final String TEXT_84 = NL + "\t\t\t\t\tfile_";
  protected final String TEXT_85 = ".delete();" + NL + "\t\t\t\t";
  protected final String TEXT_86 = NL + "\t\t\t\t\tfile";
  protected final String TEXT_87 = ".delete();" + NL + "\t\t\t\t";
