...
public class TFileInputRegexBeginJava
{
  ...
  protected final String TEXT_173 = NL + "\t\t\t\tSystem.err.println(e.getMessage());" + NL + "          \t\tcontinue;" + NL + "            }";
